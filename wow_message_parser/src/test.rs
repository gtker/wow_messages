use crate::error_printer::{
    ...
    ENUM_HAS_BITWISE_AND, FLAG_HAS_EQUALS, INCORRECT_OPCODE_FOR_MESSAGE, INVALID_DEFINER_VALUE,
    INVALID_INTEGER_TYPE, INVALID_SELF_SIZE, MISSING_ENUMERATOR, MULTIPLE_SELF_VALUE,
    NON_MATCHING_IF_VARIABLES, NO_VERSIONS, OVERLAPPING_VERSIONS, RECURSIVE_TYPE,
    UNSUPPORTED_UPCAST,
};
