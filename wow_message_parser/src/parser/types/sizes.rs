...
pub(crate) fn update_mask_max(version: MajorWorldVersion) -> i128 {
    let data = version.update_mask();
...
pub(crate) const ITEM_SIZE: u8 = 4;
pub(crate) const SPELL_SIZE: u8 = 4;
pub(crate) const SPELL16_SIZE: u8 = 2;
