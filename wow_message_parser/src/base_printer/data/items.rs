    ...
    let r = s
        .query_map([], |row| {
            Ok(VanillaItem {
                ...
                allowed_class: row.get(11).unwrap(),
                allowed_race: row.get(12).unwrap(),
    ...
    let r = s
        .query_map([], |row| {
            Ok(TbcItem {
                ...
                allowed_class: row.get(12).unwrap(),
                allowed_race: row.get(13).unwrap(),
    ...
    let r = s
        .query_map([], |row| {
            Ok(WrathItem {
                ...
                allowed_class: row.get(13).unwrap(),
                allowed_race: row.get(14).unwrap(),
