...
pub(crate) fn get_items(conn: &Connection, expansion: Expansion) -> Items {
    match expansion {
        Expansion::Vanilla => Items::Vanilla(vanilla(conn)),
        Expansion::BurningCrusade => Items::BurningCrusade(tbc(conn)),
        Expansion::WrathOfTheLichKing => Items::Wrath(wrath(conn)),
    }
}

fn vanilla(conn: &Connection) -> Vec<VanillaItem> {
    let mut s = conn
        .prepare(
            "SELECT
    entry,
    ...
    let r = s
        .query_map([], |row| {
            Ok(VanillaItem {
                ...
                allowed_class: i32_to_u32(row.get(11).unwrap()),
                allowed_race: i32_to_u32(row.get(12).unwrap()),
...
fn tbc(conn: &Connection) -> Vec<TbcItem> {
    let mut s = conn
        .prepare(
            "SELECT
    entry,
    ...
    let r = s
        .query_map([], |row| {
            Ok(TbcItem {
                ...
                inventory_type: row.get(11).unwrap(),
                allowed_class: i32_to_u32(row.get(12).unwrap()),
                allowed_race: i32_to_u32(row.get(13).unwrap()),
                ...
                spell_trigger_1: row.get(72).unwrap(),
                ...
                spell_trigger_2: row.get(79).unwrap(),
                ...
                spell_trigger_3: row.get(86).unwrap(),
                ...
                spell_trigger_4: row.get(93).unwrap(),
                ...
                spell_trigger_5: row.get(100).unwrap(),
...
fn wrath(conn: &Connection) -> Vec<WrathItem> {
    let mut s = conn
        .prepare(
            "SELECT
    entry,
    ...
    let r = s
        .query_map([], |row| {
            Ok(WrathItem {
                ...
                quality: row.get(6).unwrap(),
                flags: row.get(7).unwrap(),
                flags2: row.get(8).unwrap(),
                buy_count: row.get(9).unwrap(),
                buy_price: row.get(10).unwrap(),
                sell_price: row.get(11).unwrap(),
                inventory_type: row.get(12).unwrap(),
                allowed_class: i32_to_u32(row.get(13).unwrap()),
                allowed_race: i32_to_u32(row.get(14).unwrap()),
                item_level: row.get(15).unwrap(),
                required_level: row.get(16).unwrap(),
                required_skill: row.get(17).unwrap(),
                ...
                dmg_type1: row.get(52).unwrap(),
                dmg_min2: row.get(53).unwrap(),
                dmg_max2: row.get(54).unwrap(),
                dmg_type2: row.get(55).unwrap(),
                ...
                spell_trigger_1: row.get(67).unwrap(),
                ...
                spell_trigger_2: row.get(74).unwrap(),
                ...
                spell_trigger_3: row.get(81).unwrap(),
                ...
                spell_trigger_4: row.get(88).unwrap(),
                ...
                spell_trigger_5: row.get(95).unwrap(),
                ...
                bonding: row.get(101).unwrap(),
                description: row.get(102).unwrap(),
                page_text: row.get(103).unwrap(),
                language_id: row.get(104).unwrap(),
                page_material: row.get(105).unwrap(),
                ...
                area: row.get(115).unwrap(),
                map: row.get(116).unwrap(),
                bag_family: row.get(117).unwrap(),
