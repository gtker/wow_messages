...
impl VanillaItem {
    pub fn values(&self) -> Vec<Value> {
        vec![
            ...
            Value::VanillaAllowedRace(self.allowed_race),
            ...
            Value::Int(self.mana),
            Value::Int(self.health),
            Value::Int(self.agility),
            Value::Int(self.strength),
            Value::Int(self.stamina),
            Value::Int(self.intellect),
            Value::Int(self.spirit),
