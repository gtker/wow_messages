...
impl WrathItem {
    pub fn values(&self) -> Vec<Value> {
        vec![
            ...
            Value::WrathItemQuality(self.quality),
            Value::Int(self.flags),
            Value::Int(self.flags2),
            ...
            Value::WrathAllowedRace(self.allowed_race),
            ...
            Value::Int(self.scaling_stat_value),
            ...
            Value::Int(self.item_limit_category),
            Value::Int(self.holiday_id),
