pub const fn opcode_to_name(opcode: u32) -> Option<&'static str> {
    Some(match opcode {
        ...
        0x03b1 => "CMSG_GM_WHISPER",
        0x03b2 => "SMSG_GM_MESSAGECHAT",
        0x03b3 => "MSG_GM_GEARRATING",
        ...
        0x03c1 => "CMSG_CHEAT_PLAYER_LOGIN",
        0x03c2 => "CMSG_CHEAT_PLAYER_LOOKUP",
        0x03c3 => "SMSG_CHEAT_PLAYER_LOOKUP",
        ...
        0x03c9 => "CMSG_GM_SHOW_COMPLAINTS",
        0x03ca => "CMSG_GM_UNSQUELCH",
        ...
        0x03cf => "CMSG_TARGET_CAST",
        0x03d0 => "CMSG_TARGET_SCRIPT_CAST",
        ...
        0x03f9 => "CMSG_GM_CHARACTER_RESTORE",
        0x03fa => "CMSG_GM_CHARACTER_SAVE",
