...
impl crate::private::Sealed for CMSG_LFG_LEAVE {}
impl CMSG_LFG_LEAVE {
...
impl crate::Message for CMSG_LFG_LEAVE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_LFG_LEAVE {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(861, "CMSG_LFG_LEAVE", body_size, a))
    }
