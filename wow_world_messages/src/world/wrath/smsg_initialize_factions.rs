...
use crate::wrath::{
    FactionFlag, FactionInitializer,
};

#[derive(Debug, Clone, PartialEq, Eq, Hash, PartialOrd, Ord, Default)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/faction/smsg_initialize_factions.wowm:26`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/faction/smsg_initialize_factions.wowm#L26):
/// ```text
...
impl SMSG_INITIALIZE_FACTIONS {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        let factions = {
            ...
            let allocation_size = u64::from(amount_of_factions) * 5;
...
impl crate::Message for SMSG_INITIALIZE_FACTIONS {
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(290, "SMSG_INITIALIZE_FACTIONS", body_size, a))
    }
