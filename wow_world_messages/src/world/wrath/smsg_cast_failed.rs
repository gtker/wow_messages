...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/smsg_cast_failed.wowm:26`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/smsg_cast_failed.wowm#L26):
/// ```text
...
impl crate::Message for SMSG_CAST_FAILED {
    ...
    fn write_into_vec(&self, w: &mut Vec<u8>) -> Result<(), std::io::Error> {
        ...
        match &self.result {
            SMSG_CAST_FAILED_SpellCastResult::Success => {}
            ...
            SMSG_CAST_FAILED_SpellCastResult::CantBeMilled => {}
            ...
            SMSG_CAST_FAILED_SpellCastResult::IncorrectArea => {}
            ...
            SMSG_CAST_FAILED_SpellCastResult::NeedMoreItems {
                count,
                item,
            } => {
                // item: u32
            ...
            SMSG_CAST_FAILED_SpellCastResult::NotWhileLooting => {}
            ...
            SMSG_CAST_FAILED_SpellCastResult::TargetNoRangedWeapons => {}
            ...
            SMSG_CAST_FAILED_SpellCastResult::NotInRaidInstance => {}
            SMSG_CAST_FAILED_SpellCastResult::OnlyInArena => {}
            SMSG_CAST_FAILED_SpellCastResult::TargetLockedToRaidInstance => {}
            SMSG_CAST_FAILED_SpellCastResult::OnUseEnchant => {}
            SMSG_CAST_FAILED_SpellCastResult::NotOnGround => {}
            SMSG_CAST_FAILED_SpellCastResult::CustomError {
                custom_error,
            } => {
                // custom_error: u32
            ...
            SMSG_CAST_FAILED_SpellCastResult::CantDoThatRightNow => {}
            SMSG_CAST_FAILED_SpellCastResult::TooManySockets => {}
            SMSG_CAST_FAILED_SpellCastResult::InvalidGlyph => {}
            SMSG_CAST_FAILED_SpellCastResult::UniqueGlyph => {}
            SMSG_CAST_FAILED_SpellCastResult::GlyphSocketLocked => {}
            SMSG_CAST_FAILED_SpellCastResult::NoValidTargets => {}
            SMSG_CAST_FAILED_SpellCastResult::ItemAtMaxCharges => {}
            SMSG_CAST_FAILED_SpellCastResult::NotInBarbershop => {}
            SMSG_CAST_FAILED_SpellCastResult::FishingTooLow {
            ...
            SMSG_CAST_FAILED_SpellCastResult::ItemEnchantTradeWindow => {}
            SMSG_CAST_FAILED_SpellCastResult::SummonPending => {}
            SMSG_CAST_FAILED_SpellCastResult::MaxSockets => {}
            SMSG_CAST_FAILED_SpellCastResult::PetCanRename => {}
            SMSG_CAST_FAILED_SpellCastResult::TargetCannotBeResurrected => {}
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        ...
        let result_if = match result {
            ...
            SpellCastResult::CantBeMilled => SMSG_CAST_FAILED_SpellCastResult::CantBeMilled,
            ...
            SpellCastResult::IncorrectArea => SMSG_CAST_FAILED_SpellCastResult::IncorrectArea,
            ...
            SpellCastResult::NotWhileLooting => SMSG_CAST_FAILED_SpellCastResult::NotWhileLooting,
            ...
            SpellCastResult::TargetNoRangedWeapons => SMSG_CAST_FAILED_SpellCastResult::TargetNoRangedWeapons,
            ...
            SpellCastResult::NotInRaidInstance => SMSG_CAST_FAILED_SpellCastResult::NotInRaidInstance,
            ...
            SpellCastResult::OnUseEnchant => SMSG_CAST_FAILED_SpellCastResult::OnUseEnchant,
            SpellCastResult::NotOnGround => SMSG_CAST_FAILED_SpellCastResult::NotOnGround,
            ...
            SpellCastResult::CantDoThatRightNow => SMSG_CAST_FAILED_SpellCastResult::CantDoThatRightNow,
            SpellCastResult::TooManySockets => SMSG_CAST_FAILED_SpellCastResult::TooManySockets,
            SpellCastResult::InvalidGlyph => SMSG_CAST_FAILED_SpellCastResult::InvalidGlyph,
            SpellCastResult::UniqueGlyph => SMSG_CAST_FAILED_SpellCastResult::UniqueGlyph,
            SpellCastResult::GlyphSocketLocked => SMSG_CAST_FAILED_SpellCastResult::GlyphSocketLocked,
            SpellCastResult::NoValidTargets => SMSG_CAST_FAILED_SpellCastResult::NoValidTargets,
            SpellCastResult::ItemAtMaxCharges => SMSG_CAST_FAILED_SpellCastResult::ItemAtMaxCharges,
            SpellCastResult::NotInBarbershop => SMSG_CAST_FAILED_SpellCastResult::NotInBarbershop,
            ...
            SpellCastResult::ItemEnchantTradeWindow => SMSG_CAST_FAILED_SpellCastResult::ItemEnchantTradeWindow,
            SpellCastResult::SummonPending => SMSG_CAST_FAILED_SpellCastResult::SummonPending,
            SpellCastResult::MaxSockets => SMSG_CAST_FAILED_SpellCastResult::MaxSockets,
            SpellCastResult::PetCanRename => SMSG_CAST_FAILED_SpellCastResult::PetCanRename,
            SpellCastResult::TargetCannotBeResurrected => SMSG_CAST_FAILED_SpellCastResult::TargetCannotBeResurrected,
