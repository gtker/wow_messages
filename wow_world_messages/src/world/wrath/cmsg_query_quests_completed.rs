...
impl CMSG_QUERY_QUESTS_COMPLETED {
...
impl crate::Message for CMSG_QUERY_QUESTS_COMPLETED {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_QUERY_QUESTS_COMPLETED {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 1280_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1280, "CMSG_QUERY_QUESTS_COMPLETED", body_size, a))
    }
