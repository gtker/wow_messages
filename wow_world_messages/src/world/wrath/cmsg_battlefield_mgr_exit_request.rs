...
impl crate::Message for CMSG_BATTLEFIELD_MGR_EXIT_REQUEST {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_BATTLEFIELD_MGR_EXIT_REQUEST {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 1255_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1255, "CMSG_BATTLEFIELD_MGR_EXIT_REQUEST", body_size, a))
    }
