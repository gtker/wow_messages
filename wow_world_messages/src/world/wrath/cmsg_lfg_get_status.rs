...
impl CMSG_LFG_GET_STATUS {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_LFG_GET_STATUS {{").unwrap();
        // Members
...
impl crate::private::Sealed for CMSG_LFG_GET_STATUS {}
impl crate::Message for CMSG_LFG_GET_STATUS {
    const OPCODE: u32 = 0x0296;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_LFG_GET_STATUS::to_test_case_string(self)
    }
