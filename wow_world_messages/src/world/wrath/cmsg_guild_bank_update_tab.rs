...
impl crate::Message for CMSG_GUILD_BANK_UPDATE_TAB {
    ...
    fn write_into_vec(&self, mut w: impl Write) -> Result<(), std::io::Error> {
        ...
        // icon: CString
        // TODO: Guard against strings that are already null-terminated
        assert_ne!(self.icon.as_bytes().iter().next_back(), Some(&0_u8), "String `icon` must not be null-terminated.");
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1003, "CMSG_GUILD_BANK_UPDATE_TAB", body_size, a))
    }
