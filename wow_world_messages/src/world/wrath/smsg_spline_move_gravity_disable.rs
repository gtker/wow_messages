...
impl crate::Message for SMSG_SPLINE_MOVE_GRAVITY_DISABLE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_SPLINE_MOVE_GRAVITY_DISABLE {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1235, "SMSG_SPLINE_MOVE_GRAVITY_DISABLE", body_size, a))
    }
