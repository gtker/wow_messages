...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/social/smsg_group_list.wowm:88`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/social/smsg_group_list.wowm#L88):
/// ```text
...
impl SMSG_GROUP_LIST {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        let members = {
            ...
            let allocation_size = u64::from(amount_of_members) * 13;
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        if !self.members.is_empty() {
            ...
            for (i, v) in self.members.iter().enumerate() {
                ...
                crate::util::write_bytes(&mut s, &mut bytes, 1, "group_id", "        ");
                crate::util::write_bytes(&mut s, &mut bytes, 1, "flags", "        ");
                crate::util::write_bytes(&mut s, &mut bytes, 1, "lfg_roles", "        ");
        ...
        if let Some(group_not_empty) = &self.group_not_empty {
            ...
            crate::util::write_bytes(&mut s, &mut bytes, 1, "raid_difficulty", "    ");
            crate::util::write_bytes(&mut s, &mut bytes, 1, "heroic", "    ");
        }
