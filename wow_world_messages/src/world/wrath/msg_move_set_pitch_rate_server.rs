...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/msg_move_set_pitch_rate.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/msg_move_set_pitch_rate.wowm#L1):
/// ```text
...
#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for MSG_MOVE_SET_PITCH_RATE_Server {}
