...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/smsg_update_instance_encounter_unit.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/smsg_update_instance_encounter_unit.wowm#L1):
/// ```text
...
impl TryFrom<u32> for EncounterFrame {
    ...
    fn try_from(value: u32) -> std::result::Result<Self, Self::Error> {
        match value {
            ...
            v => Err(crate::errors::EnumError::new("EncounterFrame", v as u32),)
        }
    }
}
