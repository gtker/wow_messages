...
use crate::wrath::{
    ...
    SpellCastTargets, TransportInfo, Vector3d, Vector4d,
};

/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/item/cmsg_use_item.wowm:36`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/item/cmsg_use_item.wowm#L36):
/// ```text
            ...
            crate::wrath::CMSG_USE_ITEM_ClientCastFlags::Extra {
                ...
                match &movement_data {
                    crate::wrath::CMSG_USE_ITEM_ClientMovementData::Present {
                        ...
                        writeln!(s, "            orientation = {};", if info.position.orientation.to_string().contains('.') { info.position.orientation.to_string() } else { format!("{}.0", info.position.orientation) }).unwrap();
