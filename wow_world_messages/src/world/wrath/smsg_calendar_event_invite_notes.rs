...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/calendar/smsg_calendar_event_invite_notes.wowm:2`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/calendar/smsg_calendar_event_invite_notes.wowm#L2):
/// ```text
...
impl SMSG_CALENDAR_EVENT_INVITE_NOTES {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        // unknown: Bool
        let unknown = crate::util::read_bool_u8(&mut r)?;
...
impl crate::Message for SMSG_CALENDAR_EVENT_INVITE_NOTES {
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1120, "SMSG_CALENDAR_EVENT_INVITE_NOTES", body_size, a))
    }
