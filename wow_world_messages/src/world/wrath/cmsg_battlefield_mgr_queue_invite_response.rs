...
impl crate::Message for CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        let [a, b, c, d] = 1250_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1250, "CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE", body_size, a))
    }
