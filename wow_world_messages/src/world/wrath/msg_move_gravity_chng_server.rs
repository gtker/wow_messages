...
impl MSG_MOVE_GRAVITY_CHNG_Server {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_GRAVITY_CHNG_Server {{").unwrap();
        // Members
...
impl crate::private::Sealed for MSG_MOVE_GRAVITY_CHNG_Server {}
impl crate::Message for MSG_MOVE_GRAVITY_CHNG_Server {
    const OPCODE: u32 = 0x04d2;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_GRAVITY_CHNG_Server::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(32..=97).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x04D2, size: body_size });
        }
