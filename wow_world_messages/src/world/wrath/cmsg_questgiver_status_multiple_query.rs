...
impl crate::Message for CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        let [a, b, c, d] = 1047_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1047, "CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY", body_size, a))
    }
