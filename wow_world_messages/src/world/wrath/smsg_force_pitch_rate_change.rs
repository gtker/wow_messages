...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/smsg_force_pitch_rate_change.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/smsg_force_pitch_rate_change.wowm#L1):
/// ```text
...
/// }
/// ```
pub struct SMSG_FORCE_PITCH_RATE_CHANGE {
    pub guid: Guid,
