...
impl SMSG_FORCE_PITCH_RATE_CHANGE {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_FORCE_PITCH_RATE_CHANGE {{").unwrap();
        // Members
...
impl crate::Message for SMSG_FORCE_PITCH_RATE_CHANGE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_FORCE_PITCH_RATE_CHANGE::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(10..=17).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x045C, size: body_size });
        }
