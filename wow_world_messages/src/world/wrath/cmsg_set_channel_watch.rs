...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/chat/cmsg_set_channel_watch.wowm:7`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/chat/cmsg_set_channel_watch.wowm#L7):
/// ```text
...
impl crate::Message for CMSG_SET_CHANNEL_WATCH {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_SET_CHANNEL_WATCH {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1007, "CMSG_SET_CHANNEL_WATCH", body_size, a))
    }

}

#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_SET_CHANNEL_WATCH {}
