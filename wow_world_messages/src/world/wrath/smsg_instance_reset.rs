...
impl SMSG_INSTANCE_RESET {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_INSTANCE_RESET {{").unwrap();
        // Members
...
impl crate::Message for SMSG_INSTANCE_RESET {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_INSTANCE_RESET::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 4 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x031E, size: body_size });
        }
...
#[cfg(feature = "wrath")]
impl crate::wrath::ServerMessage for SMSG_INSTANCE_RESET {}
