...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/cmsg_guild_bank_buy_tab.wowm:8`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/cmsg_guild_bank_buy_tab.wowm#L8):
/// ```text
...
#[cfg(feature = "wrath")]
impl crate::world::wrath::ClientMessage for CMSG_GUILD_BANK_BUY_TAB {}
