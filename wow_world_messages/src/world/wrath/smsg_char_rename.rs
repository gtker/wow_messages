...
impl SMSG_CHAR_RENAME {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        let result_if = match result {
            ...
            WorldResult::CharCreateExpansionClass => SMSG_CHAR_RENAME::CharCreateExpansionClass,
            WorldResult::CharCreateLevelRequirement => SMSG_CHAR_RENAME::CharCreateLevelRequirement,
            WorldResult::CharCreateUniqueClassLimit => SMSG_CHAR_RENAME::CharCreateUniqueClassLimit,
            WorldResult::CharCreateCharacterInGuild => SMSG_CHAR_RENAME::CharCreateCharacterInGuild,
            WorldResult::CharCreateRestrictedRaceclass => SMSG_CHAR_RENAME::CharCreateRestrictedRaceclass,
            WorldResult::CharCreateCharacterChooseRace => SMSG_CHAR_RENAME::CharCreateCharacterChooseRace,
            WorldResult::CharCreateCharacterArenaLeader => SMSG_CHAR_RENAME::CharCreateCharacterArenaLeader,
            WorldResult::CharCreateCharacterDeleteMail => SMSG_CHAR_RENAME::CharCreateCharacterDeleteMail,
            WorldResult::CharCreateCharacterSwapFaction => SMSG_CHAR_RENAME::CharCreateCharacterSwapFaction,
            WorldResult::CharCreateCharacterRaceOnly => SMSG_CHAR_RENAME::CharCreateCharacterRaceOnly,
            WorldResult::CharCreateCharacterGoldLimit => SMSG_CHAR_RENAME::CharCreateCharacterGoldLimit,
            WorldResult::CharCreateForceLogin => SMSG_CHAR_RENAME::CharCreateForceLogin,
            ...
            WorldResult::CharLoginLockedByMobileAh => SMSG_CHAR_RENAME::CharLoginLockedByMobileAh,
...
impl crate::Message for SMSG_CHAR_RENAME {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        match &self {
            crate::wrath::SMSG_CHAR_RENAME::ResponseSuccess {
                character,
                new_name,
            } => {
