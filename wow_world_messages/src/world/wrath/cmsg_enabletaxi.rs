...
impl CMSG_ENABLETAXI {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_ENABLETAXI {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 1171_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_ENABLETAXI {}
impl crate::Message for CMSG_ENABLETAXI {
    const OPCODE: u32 = 0x0493;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_ENABLETAXI::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 8 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0493, size: body_size });
        }
