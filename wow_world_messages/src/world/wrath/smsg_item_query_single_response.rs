...
use crate::world::wrath::ItemDamageType;
use crate::world::wrath::ItemSocket;
use crate::world::wrath::ItemSpells;
use crate::world::wrath::ItemStat;
...
use crate::world::wrath::AllowedClass;
use crate::world::wrath::AllowedRace;
use std::io::{Write, Read};

#[derive(Debug, Clone, PartialEq, Default)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/queries/smsg_item_query_single_response.wowm:230`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/queries/smsg_item_query_single_response.wowm#L230):
/// ```text
...
#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for SMSG_ITEM_QUERY_SINGLE_RESPONSE {}
...
impl SMSG_ITEM_QUERY_SINGLE_RESPONSE_found {
    pub(crate) fn size(&self) -> usize {
        ...
        + 4 // container_slots: u32
        + 4 // amount_of_stats: u32
        + self.stats.len() * 8 // stats: ItemStat[amount_of_stats]
        + 4 // scaling_stats_entry: u32
        + 4 // scaling_stats_flag: u32
        + 2 * 12 // damages: ItemDamageType[2]
        + 4 // armor: i32
