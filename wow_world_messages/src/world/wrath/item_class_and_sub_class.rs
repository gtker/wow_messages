...
///
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/enums/item_class_and_sub_class.wowm:193`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/enums/item_class_and_sub_class.wowm#L193):
/// ```text
...
impl TryFrom<u64> for ItemClassAndSubClass {
    ...
    fn try_from(value: u64) -> std::result::Result<Self, Self::Error> {
        match value {
            ...
            v => Err(crate::errors::EnumError::new("ItemClassAndSubClass", v as u32),)
        }
    }
}
