...
impl crate::Message for SMSG_CALENDAR_EVENT_UPDATED_ALERT {
    ...
    fn write_into_vec(&self, mut w: impl Write) -> Result<(), std::io::Error> {
        ...
        // description: CString
        // TODO: Guard against strings that are already null-terminated
        assert_ne!(self.description.as_bytes().iter().next_back(), Some(&0_u8), "String `description` must not be null-terminated.");
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1092, "SMSG_CALENDAR_EVENT_UPDATED_ALERT", body_size, a))
    }
