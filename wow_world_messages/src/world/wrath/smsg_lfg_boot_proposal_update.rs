...
impl crate::Message for SMSG_LFG_BOOT_PROPOSAL_UPDATE {
    ...
    fn write_into_vec(&self, mut w: impl Write) -> Result<(), std::io::Error> {
        ...
        assert_ne!(self.reason.as_bytes().iter().next_back(), Some(&0_u8), "String `reason` must not be null-terminated.");
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(877, "SMSG_LFG_BOOT_PROPOSAL_UPDATE", body_size, a))
    }
