...
use crate::world::wrath::GuildLogEvent;
use std::io::{Write, Read};

#[derive(Debug, Clone, PartialEq, Eq, Hash, PartialOrd, Ord, Default)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/msg_guild_event_log_query.wowm:34`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/msg_guild_event_log_query.wowm#L34):
/// ```text
...
#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for MSG_GUILD_EVENT_LOG_QUERY_Server {}
