...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/gamemaster/smsg_gmticket_getticket.wowm:28`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/gamemaster/smsg_gmticket_getticket.wowm#L28):
/// ```text
    ...
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        let status_if = match status {
            ...
            GmTicketStatus::HasText => {
                ...
                // need_more_help: Bool
                let need_more_help = crate::util::read_bool_u8(&mut r)?;
...
impl crate::Message for SMSG_GMTICKET_GETTICKET {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        match &self {
            crate::wrath::SMSG_GMTICKET_GETTICKET::HasText {
                days_since_last_updated,
                days_since_oldest_ticket_creation,
                days_since_ticket_creation,
                escalation_status,
