...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/cmsg/cmsg_force_run_speed_change_ack.wowm:54`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/cmsg/cmsg_force_run_speed_change_ack.wowm#L54):
/// ```text
...
impl CMSG_FORCE_RUN_SPEED_CHANGE_ACK {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        if !(40..=105).contains(&body_size) {
            return Err(crate::errors::ParseErrorKind::InvalidSize { opcode: 0x00E3, size: body_size });
        }
...
impl crate::Message for CMSG_FORCE_RUN_SPEED_CHANGE_ACK {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_FORCE_RUN_SPEED_CHANGE_ACK {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 227_u32.to_le_bytes();
...
#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_FORCE_RUN_SPEED_CHANGE_ACK {}
