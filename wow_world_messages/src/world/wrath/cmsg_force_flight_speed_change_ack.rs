...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/cmsg_force_flight_speed_change_ack.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/cmsg_force_flight_speed_change_ack.wowm#L1):
/// ```text
...
#[cfg(feature = "wrath")]
impl crate::world::wrath::ClientMessage for CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK {}
