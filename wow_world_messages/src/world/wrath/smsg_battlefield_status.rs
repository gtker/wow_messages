...
impl crate::Message for SMSG_BATTLEFIELD_STATUS {
    ...
    fn write_into_vec(&self, w: &mut impl std::io::Write) -> Result<(), std::io::Error> {
        ...
        match &self.status_id {
            ...
            SMSG_BATTLEFIELD_STATUS_StatusId::WaitJoin {
                ...
                // map1: Map
                w.write_all(&(map1.as_int() as u32).to_le_bytes())?;
            ...
            SMSG_BATTLEFIELD_STATUS_StatusId::InProgress {
                ...
                // map2: Map
                w.write_all(&(map2.as_int() as u32).to_le_bytes())?;
                ...
                w.write_all(&(faction.as_int() as u8).to_le_bytes())?;
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        ...
        // is_arena: u8
        let is_arena = crate::util::read_u8_le(r)?;
        ...
        let status_id_if = match status_id {
            ...
            StatusId::WaitJoin => {
                // map1: Map
                let map1: Map = crate::util::read_u32_le(r)?.try_into()?;

                // unknown2: u64
                let unknown2 = crate::util::read_u64_le(r)?;
            ...
            StatusId::InProgress => {
                // map2: Map
                let map2: Map = crate::util::read_u32_le(r)?.try_into()?;

                // unknown3: u64
                let unknown3 = crate::util::read_u64_le(r)?;
                ...
                // faction: ArenaFaction
                let faction: ArenaFaction = crate::util::read_u8_le(r)?.try_into()?;
