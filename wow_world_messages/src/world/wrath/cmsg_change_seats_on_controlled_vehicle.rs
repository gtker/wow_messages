...
impl crate::Message for CMSG_CHANGE_SEATS_ON_CONTROLLED_VEHICLE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        let [a, b, c, d] = 1179_u32.to_le_bytes();
        writeln!(s, "    {a:#04X}, {b:#04X}, {c:#04X}, {d:#04X}, /* opcode */").unwrap();
        let mut bytes: Vec<u8> = Vec::new();
        self.write_into_vec(&mut bytes).unwrap();
        let mut bytes = bytes.into_iter();

        crate::util::write_bytes(&mut s, &mut bytes, crate::util::packed_guid_size(&self.vehicle), "vehicle", "    ");
        ...
        crate::util::write_bytes(&mut s, &mut bytes, crate::util::packed_guid_size(&self.accessory), "accessory", "    ");
        crate::util::write_bytes(&mut s, &mut bytes, 1, "seat", "    ");
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1179, "CMSG_CHANGE_SEATS_ON_CONTROLLED_VEHICLE", body_size, a))
    }
