...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/smsg_userlist_add.wowm:11`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/smsg_userlist_add.wowm#L11):
/// ```text
...
#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for SMSG_USERLIST_ADD {}
