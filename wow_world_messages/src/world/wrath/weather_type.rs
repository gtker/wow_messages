...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/world/smsg_weather.wowm:52`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/world/smsg_weather.wowm#L52):
/// ```text
...
impl TryFrom<u32> for WeatherType {
    ...
    fn try_from(value: u32) -> std::result::Result<Self, Self::Error> {
        match value {
            ...
            v => Err(crate::errors::EnumError::new("WeatherType", v),)
        }
    }
}
