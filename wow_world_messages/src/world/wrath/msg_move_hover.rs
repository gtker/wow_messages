...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/msg_move_hover.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/msg_move_hover.wowm#L1):
/// ```text
...
#[cfg(feature = "wrath")]
impl crate::world::wrath::ClientMessage for MSG_MOVE_HOVER {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for MSG_MOVE_HOVER {}
