...
impl SMSG_TRADE_STATUS {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        let status_if = match status {
            TradeStatus::Busy => SMSG_TRADE_STATUS::Busy,
            ...
            TradeStatus::OpenWindow => SMSG_TRADE_STATUS::OpenWindow,
            TradeStatus::TradeCanceled => SMSG_TRADE_STATUS::TradeCanceled,
            TradeStatus::TradeAccept => SMSG_TRADE_STATUS::TradeAccept,
            TradeStatus::Busy2 => SMSG_TRADE_STATUS::Busy2,
            TradeStatus::NoTarget => SMSG_TRADE_STATUS::NoTarget,
            TradeStatus::BackToTrade => SMSG_TRADE_STATUS::BackToTrade,
            TradeStatus::TradeComplete => SMSG_TRADE_STATUS::TradeComplete,
            TradeStatus::TradeRejected => SMSG_TRADE_STATUS::TradeRejected,
            TradeStatus::TargetToFar => SMSG_TRADE_STATUS::TargetToFar,
            TradeStatus::WrongFaction => SMSG_TRADE_STATUS::WrongFaction,
            ...
            TradeStatus::Unknown13 => SMSG_TRADE_STATUS::Unknown13,
            TradeStatus::IgnoreYou => SMSG_TRADE_STATUS::IgnoreYou,
            TradeStatus::YouStunned => SMSG_TRADE_STATUS::YouStunned,
            TradeStatus::TargetStunned => SMSG_TRADE_STATUS::TargetStunned,
            TradeStatus::YouDead => SMSG_TRADE_STATUS::YouDead,
            TradeStatus::TargetDead => SMSG_TRADE_STATUS::TargetDead,
            TradeStatus::YouLogout => SMSG_TRADE_STATUS::YouLogout,
            TradeStatus::TargetLogout => SMSG_TRADE_STATUS::TargetLogout,
            TradeStatus::TrialAccount => SMSG_TRADE_STATUS::TrialAccount,
            TradeStatus::OnlyConjured => {
                // slot: u8
                let slot = crate::util::read_u8_le(&mut r)?;

                SMSG_TRADE_STATUS::OnlyConjured {
                    slot,
                }
            }
            TradeStatus::NotOnTaplist => {
                ...
                SMSG_TRADE_STATUS::NotOnTaplist {
                    slot,
                }
            }
        };
...
impl crate::Message for SMSG_TRADE_STATUS {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        // Members
        writeln!(s, "    status = {};", TradeStatus::try_from(self.as_int()).unwrap().as_test_case_value()).unwrap();
        match &self {
            crate::wrath::SMSG_TRADE_STATUS::BeginTrade {
                unknown1,
            } => {
                writeln!(s, "    unknown1 = {};", unknown1.guid()).unwrap();
            }
            crate::wrath::SMSG_TRADE_STATUS::CloseWindow {
                inventory_result,
                item_limit_category_id,
                target_error,
            } => {
            ...
            crate::wrath::SMSG_TRADE_STATUS::OnlyConjured {
                slot,
            } => {
                writeln!(s, "    slot = {};", slot).unwrap();
            }
            crate::wrath::SMSG_TRADE_STATUS::NotOnTaplist {
                slot,
            } => {
                writeln!(s, "    slot = {};", slot).unwrap();
            }
...
#[cfg(feature = "wrath")]
impl crate::wrath::ServerMessage for SMSG_TRADE_STATUS {}
...
impl SMSG_TRADE_STATUS {
    pub(crate) const fn size(&self) -> usize {
        (match self {
            ...
            _ => 4,
        }) // status: SMSG_TRADE_STATUS
    }
}

impl Default for SMSG_TRADE_STATUS {
    fn default() -> Self {
...
impl std::fmt::Display for SMSG_TRADE_STATUS {
