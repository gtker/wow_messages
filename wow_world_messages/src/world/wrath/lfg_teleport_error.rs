...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/smsg_lfg_teleport_denied.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/smsg_lfg_teleport_denied.wowm#L1):
/// ```text
...
impl TryFrom<u32> for LfgTeleportError {
    ...
    fn try_from(value: u32) -> std::result::Result<Self, Self::Error> {
        match value {
            ...
            8 => Ok(Self::Combat),
            v => Err(crate::errors::EnumError::new("LfgTeleportError", v as u32),)
        }
    }
}
