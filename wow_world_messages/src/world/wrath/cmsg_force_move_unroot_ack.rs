...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/cmsg/cmsg_force_move_unroot_ack.wowm:17`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/cmsg/cmsg_force_move_unroot_ack.wowm#L17):
/// ```text
...
impl CMSG_FORCE_MOVE_UNROOT_ACK {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_FORCE_MOVE_UNROOT_ACK {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 235_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_FORCE_MOVE_UNROOT_ACK {}
impl crate::Message for CMSG_FORCE_MOVE_UNROOT_ACK {
    const OPCODE: u32 = 0x00eb;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_FORCE_MOVE_UNROOT_ACK::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(36..=101).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00EB, size: body_size });
        }
...
#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_FORCE_MOVE_UNROOT_ACK {}
