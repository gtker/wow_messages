...
impl SMSG_PET_UNLEARNED_SPELL {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_PET_UNLEARNED_SPELL {{").unwrap();
        // Members
...
impl crate::private::Sealed for SMSG_PET_UNLEARNED_SPELL {}
impl crate::Message for SMSG_PET_UNLEARNED_SPELL {
    const OPCODE: u32 = 0x049a;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_PET_UNLEARNED_SPELL::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 4 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x049A, size: body_size });
        }
