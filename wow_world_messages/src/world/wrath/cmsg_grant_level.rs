...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/gamemaster/cmsg_grant_level.wowm:7`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/gamemaster/cmsg_grant_level.wowm#L7):
/// ```text
...
impl CMSG_GRANT_LEVEL {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        let [a, b, c, d] = 1037_u32.to_le_bytes();
...
impl crate::Message for CMSG_GRANT_LEVEL {
    const OPCODE: u32 = 0x040d;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_GRANT_LEVEL::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(2..=9).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x040D, size: body_size });
        }
