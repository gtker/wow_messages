...
use crate::wrath::{
    DungeonDifficulty, Map, RaidInfo,
};
...
impl SMSG_RAID_INSTANCE_INFO {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        let raid_infos = {
            ...
            let allocation_size = u64::from(amount_of_raid_infos) * 22;
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        if !self.raid_infos.is_empty() {
            ...
            for (i, v) in self.raid_infos.iter().enumerate() {
                ...
                crate::util::write_bytes(&mut s, &mut bytes, 1, "expired", "        ");
                crate::util::write_bytes(&mut s, &mut bytes, 1, "extended", "        ");
                crate::util::write_bytes(&mut s, &mut bytes, 4, "time_until_reset", "        ");
...
impl SMSG_RAID_INSTANCE_INFO {
    pub(crate) fn size(&self) -> usize {
        ...
        + self.raid_infos.len() * 22 // raid_infos: RaidInfo[amount_of_raid_infos]
    }
}
