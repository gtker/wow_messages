...
use crate::world::wrath::CMSG_SEARCH_LFG_LEAVE;
...
use crate::world::wrath::MSG_RAID_READY_CHECK_FINISHED_Client;
...
use crate::world::wrath::CMSG_CHANNEL_VOICE_ON;
use crate::world::wrath::CMSG_REPORT_PVP_AFK;
use crate::world::wrath::CMSG_GUILD_BANKER_ACTIVATE;
use crate::world::wrath::CMSG_GUILD_BANK_QUERY_TAB;
...
use crate::world::wrath::CMSG_GUILD_BANK_WITHDRAW_MONEY;
use crate::world::wrath::MSG_GUILD_BANK_LOG_QUERY_Client;
use crate::world::wrath::CMSG_SET_CHANNEL_WATCH;
use crate::world::wrath::CMSG_CLEAR_CHANNEL_WATCH;
use crate::world::wrath::CMSG_SPELLCLICK;
use crate::world::wrath::MSG_GUILD_PERMISSIONS_Client;
use crate::world::wrath::MSG_GUILD_EVENT_LOG_QUERY_Client;
...
use crate::world::wrath::CMSG_CALENDAR_GET_CALENDAR;
use crate::world::wrath::CMSG_CALENDAR_GET_EVENT;
...
use crate::world::wrath::CMSG_CALENDAR_REMOVE_EVENT;
use crate::world::wrath::CMSG_CALENDAR_COPY_EVENT;
use crate::world::wrath::CMSG_CALENDAR_EVENT_INVITE;
use crate::world::wrath::CMSG_CALENDAR_EVENT_RSVP;
...
use crate::world::wrath::CMSG_REMOVE_GLYPH;
...
use crate::world::wrath::CMSG_HEARTH_AND_RESURRECT;
use crate::world::wrath::CMSG_PLAYER_VEHICLE_ENTER;
use crate::world::wrath::CMSG_CONTROLLER_EJECT_PASSENGER;
use crate::world::wrath::CMSG_ITEM_REFUND_INFO;
use crate::world::wrath::CMSG_ITEM_REFUND;
...
use crate::world::wrath::CMSG_EQUIPMENT_SET_USE;
...
impl ClientOpcodeMessage {
    fn read_opcodes(opcode: u32, body_size: u32, mut r: &[u8]) -> std::result::Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x03ED => Ok(Self::CMSG_GUILD_BANK_WITHDRAW_MONEY(<CMSG_GUILD_BANK_WITHDRAW_MONEY as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03ED, size: body_size, io, } } else { a } })?)),
            0x03EE => Ok(Self::MSG_GUILD_BANK_LOG_QUERY(<MSG_GUILD_BANK_LOG_QUERY_Client as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03EE, size: body_size, io, } } else { a } })?)),
            ...
            0x042F => Ok(Self::CMSG_CALENDAR_REMOVE_EVENT(<CMSG_CALENDAR_REMOVE_EVENT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x042F, size: body_size, io, } } else { a } })?)),
            0x0430 => Ok(Self::CMSG_CALENDAR_COPY_EVENT(<CMSG_CALENDAR_COPY_EVENT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0430, size: body_size, io, } } else { a } })?)),
            0x0431 => Ok(Self::CMSG_CALENDAR_EVENT_INVITE(<CMSG_CALENDAR_EVENT_INVITE as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0431, size: body_size, io, } } else { a } })?)),
            0x0432 => Ok(Self::CMSG_CALENDAR_EVENT_RSVP(<CMSG_CALENDAR_EVENT_RSVP as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0432, size: body_size, io, } } else { a } })?)),
            ...
            0x048A => Ok(Self::CMSG_REMOVE_GLYPH(<CMSG_REMOVE_GLYPH as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x048A, size: body_size, io, } } else { a } })?)),
            ...
            0x04B4 => Ok(Self::CMSG_ITEM_REFUND(<CMSG_ITEM_REFUND as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x04B4, size: body_size, io, } } else { a } })?)),
            ...
            0x04D5 => Ok(Self::CMSG_EQUIPMENT_SET_USE(<CMSG_EQUIPMENT_SET_USE as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x04D5, size: body_size, io, } } else { a } })?)),
...
impl From<CMSG_CALENDAR_GUILD_FILTER> for ClientOpcodeMessage {
    fn from(c: CMSG_CALENDAR_GUILD_FILTER) -> Self {
        Self::CMSG_CALENDAR_GUILD_FILTER(c)
    }
}
...
impl From<CMSG_UPDATE_MISSILE_TRAJECTORY> for ClientOpcodeMessage {
    fn from(c: CMSG_UPDATE_MISSILE_TRAJECTORY) -> Self {
        Self::CMSG_UPDATE_MISSILE_TRAJECTORY(c)
    }
}
...
impl From<CMSG_REQUEST_VEHICLE_SWITCH_SEAT> for ClientOpcodeMessage {
    fn from(c: CMSG_REQUEST_VEHICLE_SWITCH_SEAT) -> Self {
        Self::CMSG_REQUEST_VEHICLE_SWITCH_SEAT(c)
    }
}
...
impl From<CMSG_CALENDAR_EVENT_SIGNUP> for ClientOpcodeMessage {
    fn from(c: CMSG_CALENDAR_EVENT_SIGNUP) -> Self {
        Self::CMSG_CALENDAR_EVENT_SIGNUP(c)
    }
}
...
use crate::world::wrath::SMSG_BREAK_TARGET;
...
use crate::world::wrath::SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT;
...
use crate::world::wrath::SMSG_LFG_ROLE_CHECK_UPDATE;
use crate::world::wrath::SMSG_LFG_JOIN_RESULT;
use crate::world::wrath::SMSG_LFG_QUEUE_STATUS;
use crate::world::wrath::SMSG_LFG_UPDATE_PLAYER;
use crate::world::wrath::SMSG_LFG_UPDATE_PARTY;
use crate::world::wrath::SMSG_LFG_UPDATE_SEARCH;
use crate::world::wrath::SMSG_LFG_BOOT_PROPOSAL_UPDATE;
use crate::world::wrath::SMSG_LFG_PLAYER_INFO;
use crate::world::wrath::SMSG_LFG_PARTY_INFO;
...
use crate::world::wrath::SMSG_CLEAR_TARGET;
use crate::world::wrath::SMSG_CROSSED_INEBRIATION_THRESHOLD;
use crate::world::wrath::SMSG_KICK_REASON;
use crate::world::wrath::SMSG_COMPLAIN_RESULT;
use crate::world::wrath::SMSG_FEATURE_SYSTEM_STATUS;
use crate::world::wrath::SMSG_CHANNEL_MEMBER_COUNT;
...
use crate::world::wrath::SMSG_USERLIST_UPDATE;
use crate::world::wrath::SMSG_INSPECT_TALENT;
use crate::world::wrath::SMSG_LOOT_LIST;
...
use crate::world::wrath::SMSG_CALENDAR_EVENT_INVITE;
...
impl ServerOpcodeMessage {
    fn read_opcodes(opcode: u16, body_size: u32, mut r: &[u8]) -> std::result::Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x0214 => Ok(Self::SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT(<SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0214, size: body_size, io, } } else { a } })?)),
            ...
            0x0363 => Ok(Self::SMSG_LFG_ROLE_CHECK_UPDATE(<SMSG_LFG_ROLE_CHECK_UPDATE as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0363, size: body_size, io, } } else { a } })?)),
            0x0364 => Ok(Self::SMSG_LFG_JOIN_RESULT(<SMSG_LFG_JOIN_RESULT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0364, size: body_size, io, } } else { a } })?)),
            0x0365 => Ok(Self::SMSG_LFG_QUEUE_STATUS(<SMSG_LFG_QUEUE_STATUS as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0365, size: body_size, io, } } else { a } })?)),
            0x0367 => Ok(Self::SMSG_LFG_UPDATE_PLAYER(<SMSG_LFG_UPDATE_PLAYER as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0367, size: body_size, io, } } else { a } })?)),
            0x0368 => Ok(Self::SMSG_LFG_UPDATE_PARTY(<SMSG_LFG_UPDATE_PARTY as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0368, size: body_size, io, } } else { a } })?)),
            0x0369 => Ok(Self::SMSG_LFG_UPDATE_SEARCH(<SMSG_LFG_UPDATE_SEARCH as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0369, size: body_size, io, } } else { a } })?)),
            0x036D => Ok(Self::SMSG_LFG_BOOT_PROPOSAL_UPDATE(<SMSG_LFG_BOOT_PROPOSAL_UPDATE as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x036D, size: body_size, io, } } else { a } })?)),
            0x036F => Ok(Self::SMSG_LFG_PLAYER_INFO(<SMSG_LFG_PLAYER_INFO as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x036F, size: body_size, io, } } else { a } })?)),
            0x0372 => Ok(Self::SMSG_LFG_PARTY_INFO(<SMSG_LFG_PARTY_INFO as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0372, size: body_size, io, } } else { a } })?)),
            ...
            0x03BF => Ok(Self::SMSG_CLEAR_TARGET(<SMSG_CLEAR_TARGET as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03BF, size: body_size, io, } } else { a } })?)),
            0x03C1 => Ok(Self::SMSG_CROSSED_INEBRIATION_THRESHOLD(<SMSG_CROSSED_INEBRIATION_THRESHOLD as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03C1, size: body_size, io, } } else { a } })?)),
            0x03C5 => Ok(Self::SMSG_KICK_REASON(<SMSG_KICK_REASON as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03C5, size: body_size, io, } } else { a } })?)),
            0x03C8 => Ok(Self::SMSG_COMPLAIN_RESULT(<SMSG_COMPLAIN_RESULT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03C8, size: body_size, io, } } else { a } })?)),
            ...
            0x03D5 => Ok(Self::SMSG_CHANNEL_MEMBER_COUNT(<SMSG_CHANNEL_MEMBER_COUNT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03D5, size: body_size, io, } } else { a } })?)),
            ...
            0x03F2 => Ok(Self::SMSG_USERLIST_UPDATE(<SMSG_USERLIST_UPDATE as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03F2, size: body_size, io, } } else { a } })?)),
            0x03F4 => Ok(Self::SMSG_INSPECT_TALENT(<SMSG_INSPECT_TALENT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03F4, size: body_size, io, } } else { a } })?)),
            0x03F9 => Ok(Self::SMSG_LOOT_LIST(<SMSG_LOOT_LIST as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03F9, size: body_size, io, } } else { a } })?)),
            ...
            0x043A => Ok(Self::SMSG_CALENDAR_EVENT_INVITE(<SMSG_CALENDAR_EVENT_INVITE as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x043A, size: body_size, io, } } else { a } })?)),
...
impl From<SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT> for ServerOpcodeMessage {
    fn from(c: SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT) -> Self {
        Self::SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT(c)
    }
}
...
impl From<SMSG_CALENDAR_EVENT_INVITE> for ServerOpcodeMessage {
    fn from(c: SMSG_CALENDAR_EVENT_INVITE) -> Self {
        Self::SMSG_CALENDAR_EVENT_INVITE(c)
    }
}
...
impl From<MSG_MOVE_SET_PITCH_RATE_Server> for ServerOpcodeMessage {
    fn from(c: MSG_MOVE_SET_PITCH_RATE_Server) -> Self {
        Self::MSG_MOVE_SET_PITCH_RATE(c)
    }
}
