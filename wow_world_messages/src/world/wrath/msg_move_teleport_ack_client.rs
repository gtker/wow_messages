...
/// Response to [`MSG_MOVE_TELEPORT_ACK_Server`](crate::world::wrath::MSG_MOVE_TELEPORT_ACK_Server), at which point [`MSG_MOVE_TELEPORT_ACK_Server`](crate::world::wrath::MSG_MOVE_TELEPORT_ACK_Server) should be sent to observing players.
///
