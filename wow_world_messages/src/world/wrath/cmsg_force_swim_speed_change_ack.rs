...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/cmsg/cmsg_force_swim_speed_change_ack.wowm:19`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/cmsg/cmsg_force_swim_speed_change_ack.wowm#L19):
/// ```text
...
impl crate::Message for CMSG_FORCE_SWIM_SPEED_CHANGE_ACK {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_FORCE_SWIM_SPEED_CHANGE_ACK::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(40..=105).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00E7, size: body_size });
        }
...
#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_FORCE_SWIM_SPEED_CHANGE_ACK {}
