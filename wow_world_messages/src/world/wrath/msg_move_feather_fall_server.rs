...
impl crate::Message for MSG_MOVE_FEATHER_FALL_Server {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_FEATHER_FALL_Server {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(688, "MSG_MOVE_FEATHER_FALL_Server", body_size, a))
    }

}

#[cfg(feature = "wrath")]
impl crate::wrath::ServerMessage for MSG_MOVE_FEATHER_FALL_Server {}
