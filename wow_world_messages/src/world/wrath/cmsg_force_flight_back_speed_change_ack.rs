...
impl crate::Message for CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        if !(46..=100).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0384, size: body_size as u32 });
        }
...
#[cfg(feature = "wrath")]
impl crate::world::wrath::ClientMessage for CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK {}
