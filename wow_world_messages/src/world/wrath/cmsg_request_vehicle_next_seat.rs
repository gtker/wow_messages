...
impl CMSG_REQUEST_VEHICLE_NEXT_SEAT {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_REQUEST_VEHICLE_NEXT_SEAT {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 1144_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_REQUEST_VEHICLE_NEXT_SEAT {}
impl crate::Message for CMSG_REQUEST_VEHICLE_NEXT_SEAT {
    const OPCODE: u32 = 0x0478;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_REQUEST_VEHICLE_NEXT_SEAT::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0478, size: body_size });
        }
