...
impl crate::Message for CMSG_SETSHEATHED {
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(480, "CMSG_SETSHEATHED", body_size, a))
    }
...
mod test_vanilla {
    ...
    // Generated from `wow_message_parser/wowm/world/client_set/cmsg_setsheathed.wowm` line 19.
    #[cfg(feature = "sync")]
