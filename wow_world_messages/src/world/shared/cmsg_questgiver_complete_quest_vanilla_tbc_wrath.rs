...
impl CMSG_QUESTGIVER_COMPLETE_QUEST {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_QUESTGIVER_COMPLETE_QUEST {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 394_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_QUESTGIVER_COMPLETE_QUEST {}
impl crate::Message for CMSG_QUESTGIVER_COMPLETE_QUEST {
    const OPCODE: u32 = 0x018a;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_QUESTGIVER_COMPLETE_QUEST::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 12 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x018A, size: body_size });
        }
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ClientMessage for CMSG_QUESTGIVER_COMPLETE_QUEST {}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_QUESTGIVER_COMPLETE_QUEST {}

#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_QUESTGIVER_COMPLETE_QUEST {}
