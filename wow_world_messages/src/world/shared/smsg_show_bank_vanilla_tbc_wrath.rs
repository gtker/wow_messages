...
impl crate::private::Sealed for SMSG_SHOW_BANK {}
impl SMSG_SHOW_BANK {
...
impl crate::Message for SMSG_SHOW_BANK {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_SHOW_BANK {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(440, "SMSG_SHOW_BANK", body_size, a))
    }
