...
impl CMSG_CANCEL_TRADE {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_CANCEL_TRADE {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 284_u32.to_le_bytes();
        ...
        writeln!(s, "] {{").unwrap();
        writeln!(s, "    versions = \"1.12 2 3.3.5\";").unwrap();
        writeln!(s, "}}\n").unwrap();
...
impl crate::Message for CMSG_CANCEL_TRADE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_CANCEL_TRADE::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x011C, size: body_size });
        }
