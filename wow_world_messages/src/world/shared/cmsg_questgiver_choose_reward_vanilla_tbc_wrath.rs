...
impl crate::Message for CMSG_QUESTGIVER_CHOOSE_REWARD {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_QUESTGIVER_CHOOSE_REWARD {{").unwrap();
        // Members
        writeln!(s, "    guid = {};", self.guid.guid()).unwrap();
        writeln!(s, "    quest_id = {};", self.quest_id).unwrap();
        writeln!(s, "    reward = {};", self.reward).unwrap();

        writeln!(s, "}} [").unwrap();

        let [a, b] = 20_u16.to_be_bytes();
        writeln!(s, "    {a:#04X}, {b:#04X}, /* size */").unwrap();
        let [a, b, c, d] = 398_u32.to_le_bytes();
        ...
        crate::util::write_bytes(&mut s, &mut bytes, 4, "reward", "    ");
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(398, "CMSG_QUESTGIVER_CHOOSE_REWARD", body_size, a))
    }
