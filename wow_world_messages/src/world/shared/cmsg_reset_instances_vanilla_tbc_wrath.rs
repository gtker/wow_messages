...
impl CMSG_RESET_INSTANCES {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_RESET_INSTANCES {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 797_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_RESET_INSTANCES {}
impl crate::Message for CMSG_RESET_INSTANCES {
    const OPCODE: u32 = 0x031d;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_RESET_INSTANCES::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x031D, size: body_size });
        }
