...
impl crate::private::Sealed for SMSG_SPLINE_SET_WALK_SPEED {}
impl crate::Message for SMSG_SPLINE_SET_WALK_SPEED {
    const OPCODE: u32 = 0x0301;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_SPLINE_SET_WALK_SPEED::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(6..=13).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0301, size: body_size });
        }
