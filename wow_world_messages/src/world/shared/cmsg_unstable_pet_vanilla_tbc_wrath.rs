...
impl crate::Message for CMSG_UNSTABLE_PET {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        if body_size != 12 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0271, size: body_size as u32 });
        }
...
#[cfg(feature = "tbc")]
impl crate::world::tbc::ClientMessage for CMSG_UNSTABLE_PET {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ClientMessage for CMSG_UNSTABLE_PET {}
