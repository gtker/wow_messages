...
impl SMSG_SPLINE_MOVE_SET_HOVER {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_SPLINE_MOVE_SET_HOVER {{").unwrap();
        // Members
...
impl crate::private::Sealed for SMSG_SPLINE_MOVE_SET_HOVER {}
impl crate::Message for SMSG_SPLINE_MOVE_SET_HOVER {
    const OPCODE: u32 = 0x0307;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_SPLINE_MOVE_SET_HOVER::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(2..=9).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0307, size: body_size });
        }
