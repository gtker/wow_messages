...
impl SMSG_NEW_TAXI_PATH {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_NEW_TAXI_PATH {{").unwrap();
        // Members
...
impl crate::Message for SMSG_NEW_TAXI_PATH {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_NEW_TAXI_PATH::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x01AF, size: body_size });
        }
