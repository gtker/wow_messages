...
impl CMSG_INSPECT {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_INSPECT {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 276_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_INSPECT {}
impl crate::Message for CMSG_INSPECT {
    const OPCODE: u32 = 0x0114;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_INSPECT::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 8 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0114, size: body_size });
        }
