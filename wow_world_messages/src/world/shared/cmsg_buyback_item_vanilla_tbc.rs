...
use crate::Guid;
use wow_world_base::shared::buyback_slot_vanilla_tbc::BuybackSlot;

/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/item/cmsg_buyback_item.wowm:36`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/item/cmsg_buyback_item.wowm#L36):
/// ```text
...
impl crate::Message for CMSG_BUYBACK_ITEM {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "] {{").unwrap();
        writeln!(s, "    versions = \"{}\";", std::env::var("WOWM_TEST_CASE_WORLD_VERSION").unwrap_or("1.8 1.9 1.10 1.11 1.12 2".to_string())).unwrap();
        writeln!(s, "}}\n").unwrap();
