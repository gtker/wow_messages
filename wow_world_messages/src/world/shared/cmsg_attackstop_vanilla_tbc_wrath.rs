...
impl crate::Message for CMSG_ATTACKSTOP {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_ATTACKSTOP {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 322_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(322, "CMSG_ATTACKSTOP", body_size, a))
    }

}

#[cfg(feature = "vanilla")]
impl crate::vanilla::ClientMessage for CMSG_ATTACKSTOP {}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_ATTACKSTOP {}

#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_ATTACKSTOP {}
