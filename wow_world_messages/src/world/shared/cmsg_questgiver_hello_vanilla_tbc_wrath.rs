...
impl CMSG_QUESTGIVER_HELLO {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_QUESTGIVER_HELLO {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 388_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_QUESTGIVER_HELLO {}
impl crate::Message for CMSG_QUESTGIVER_HELLO {
    const OPCODE: u32 = 0x0184;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_QUESTGIVER_HELLO::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 8 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0184, size: body_size });
        }
