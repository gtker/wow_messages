...
impl crate::Message for SMSG_SPLINE_MOVE_SET_RUN_MODE {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        if body_size < 2 || body_size > 9 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x030D, size: body_size as u32 });
        }
...
#[cfg(feature = "tbc")]
impl crate::world::tbc::ServerMessage for SMSG_SPLINE_MOVE_SET_RUN_MODE {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for SMSG_SPLINE_MOVE_SET_RUN_MODE {}
