...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/msg_inspect_arena_teams.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/msg_inspect_arena_teams.wowm#L1):
/// ```text
...
#[cfg(feature = "tbc")]
impl crate::world::tbc::ServerMessage for MSG_INSPECT_ARENA_TEAMS_Server {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for MSG_INSPECT_ARENA_TEAMS_Server {}
