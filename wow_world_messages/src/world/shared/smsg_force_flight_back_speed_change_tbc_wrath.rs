...
impl SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE {{").unwrap();
        // Members
...
impl crate::private::Sealed for SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE {}
impl crate::Message for SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE {
    const OPCODE: u32 = 0x0383;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(10..=17).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0383, size: body_size });
        }
