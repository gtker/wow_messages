...
impl CMSG_ARENA_TEAM_REMOVE {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_ARENA_TEAM_REMOVE {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 852_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_ARENA_TEAM_REMOVE {}
impl crate::Message for CMSG_ARENA_TEAM_REMOVE {
    const OPCODE: u32 = 0x0354;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_ARENA_TEAM_REMOVE::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(5..=260).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0354, size: body_size });
        }
