...
impl CMSG_INITIATE_TRADE {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        if body_size != 8 {
            return Err(crate::errors::ParseErrorKind::InvalidSize { opcode: 0x0116, size: body_size });
        }
...
impl crate::Message for CMSG_INITIATE_TRADE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_INITIATE_TRADE {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 278_u32.to_le_bytes();
