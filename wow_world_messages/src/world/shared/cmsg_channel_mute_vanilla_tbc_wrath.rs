...
impl CMSG_CHANNEL_MUTE {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_CHANNEL_MUTE {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 161_u32.to_le_bytes();
...
impl crate::Message for CMSG_CHANNEL_MUTE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_CHANNEL_MUTE::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(2..=512).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00A1, size: body_size });
        }
