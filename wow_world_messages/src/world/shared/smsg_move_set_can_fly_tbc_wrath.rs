...
impl SMSG_MOVE_SET_CAN_FLY {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_MOVE_SET_CAN_FLY {{").unwrap();
        // Members
...
impl crate::private::Sealed for SMSG_MOVE_SET_CAN_FLY {}
impl crate::Message for SMSG_MOVE_SET_CAN_FLY {
    const OPCODE: u32 = 0x0343;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_MOVE_SET_CAN_FLY::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(6..=13).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0343, size: body_size });
        }
