...
impl SMSG_SPLINE_SET_RUN_BACK_SPEED {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_SPLINE_SET_RUN_BACK_SPEED {{").unwrap();
        // Members
...
impl crate::private::Sealed for SMSG_SPLINE_SET_RUN_BACK_SPEED {}
impl crate::Message for SMSG_SPLINE_SET_RUN_BACK_SPEED {
    const OPCODE: u32 = 0x02ff;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_SPLINE_SET_RUN_BACK_SPEED::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(6..=13).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x02FF, size: body_size });
        }
