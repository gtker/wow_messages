...
impl CMSG_ARENA_TEAM_ROSTER {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_ARENA_TEAM_ROSTER {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 845_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_ARENA_TEAM_ROSTER {}
impl crate::Message for CMSG_ARENA_TEAM_ROSTER {
    const OPCODE: u32 = 0x034d;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_ARENA_TEAM_ROSTER::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 4 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x034D, size: body_size });
        }
...
#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_ARENA_TEAM_ROSTER {}

#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_ARENA_TEAM_ROSTER {}
