...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/smsg_move_unset_can_fly.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/smsg_move_unset_can_fly.wowm#L1):
/// ```text
...
#[cfg(feature = "tbc")]
impl crate::world::tbc::ServerMessage for SMSG_MOVE_UNSET_CAN_FLY {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for SMSG_MOVE_UNSET_CAN_FLY {}
