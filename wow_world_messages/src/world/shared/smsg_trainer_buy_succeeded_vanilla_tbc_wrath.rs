...
impl crate::Message for SMSG_TRAINER_BUY_SUCCEEDED {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        if body_size != 12 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x01B3, size: body_size as u32 });
        }
...
#[cfg(feature = "tbc")]
impl crate::world::tbc::ServerMessage for SMSG_TRAINER_BUY_SUCCEEDED {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for SMSG_TRAINER_BUY_SUCCEEDED {}
