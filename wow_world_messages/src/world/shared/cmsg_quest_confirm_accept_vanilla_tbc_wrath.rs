...
impl crate::Message for CMSG_QUEST_CONFIRM_ACCEPT {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_QUEST_CONFIRM_ACCEPT {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 411_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(411, "CMSG_QUEST_CONFIRM_ACCEPT", body_size, a))
    }
