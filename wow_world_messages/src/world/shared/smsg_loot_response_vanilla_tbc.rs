...
use crate::shared::loot_item_vanilla_tbc::LootItem;
...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/loot/smsg_loot_response.wowm:118`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/loot/smsg_loot_response.wowm#L118):
/// ```text
...
impl crate::Message for SMSG_LOOT_RESPONSE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        match &self.loot_method {
            crate::shared::smsg_loot_response_vanilla_tbc::SMSG_LOOT_RESPONSE_LootMethod::ErrorX {
                loot_error,
            } => {
