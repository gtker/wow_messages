...
impl SMSG_MOVE_FEATHER_FALL {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_MOVE_FEATHER_FALL {{").unwrap();
        // Members
...
impl crate::private::Sealed for SMSG_MOVE_FEATHER_FALL {}
impl crate::Message for SMSG_MOVE_FEATHER_FALL {
    const OPCODE: u32 = 0x00f2;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_MOVE_FEATHER_FALL::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(6..=13).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00F2, size: body_size });
        }
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ServerMessage for SMSG_MOVE_FEATHER_FALL {}

#[cfg(feature = "tbc")]
impl crate::tbc::ServerMessage for SMSG_MOVE_FEATHER_FALL {}

#[cfg(feature = "wrath")]
impl crate::wrath::ServerMessage for SMSG_MOVE_FEATHER_FALL {}
