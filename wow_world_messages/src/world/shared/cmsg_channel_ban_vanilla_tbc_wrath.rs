...
impl CMSG_CHANNEL_BAN {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_CHANNEL_BAN {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 165_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_CHANNEL_BAN {}
impl crate::Message for CMSG_CHANNEL_BAN {
    const OPCODE: u32 = 0x00a5;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_CHANNEL_BAN::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(2..=512).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00A5, size: body_size });
        }
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ClientMessage for CMSG_CHANNEL_BAN {}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_CHANNEL_BAN {}

#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_CHANNEL_BAN {}
