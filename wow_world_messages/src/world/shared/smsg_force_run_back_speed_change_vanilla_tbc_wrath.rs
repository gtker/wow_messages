...
impl crate::Message for SMSG_FORCE_RUN_BACK_SPEED_CHANGE {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        if body_size < 10 || body_size > 17 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00E4, size: body_size as u32 });
        }
...
#[cfg(feature = "vanilla")]
impl crate::world::vanilla::ServerMessage for SMSG_FORCE_RUN_BACK_SPEED_CHANGE {}

#[cfg(feature = "tbc")]
impl crate::world::tbc::ServerMessage for SMSG_FORCE_RUN_BACK_SPEED_CHANGE {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for SMSG_FORCE_RUN_BACK_SPEED_CHANGE {}
