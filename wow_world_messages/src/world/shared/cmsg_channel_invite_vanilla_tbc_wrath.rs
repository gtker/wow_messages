...
impl crate::Message for CMSG_CHANNEL_INVITE {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        if !(2..=512).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00A3, size: body_size as u32 });
        }
...
#[cfg(feature = "vanilla")]
impl crate::world::vanilla::ClientMessage for CMSG_CHANNEL_INVITE {}

#[cfg(feature = "tbc")]
impl crate::world::tbc::ClientMessage for CMSG_CHANNEL_INVITE {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ClientMessage for CMSG_CHANNEL_INVITE {}
