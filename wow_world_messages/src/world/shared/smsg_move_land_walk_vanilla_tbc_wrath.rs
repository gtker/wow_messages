...
impl SMSG_MOVE_LAND_WALK {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_MOVE_LAND_WALK {{").unwrap();
        // Members
...
impl crate::private::Sealed for SMSG_MOVE_LAND_WALK {}
impl crate::Message for SMSG_MOVE_LAND_WALK {
    const OPCODE: u32 = 0x00df;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_MOVE_LAND_WALK::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(6..=13).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00DF, size: body_size });
        }
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ServerMessage for SMSG_MOVE_LAND_WALK {}

#[cfg(feature = "tbc")]
impl crate::tbc::ServerMessage for SMSG_MOVE_LAND_WALK {}

#[cfg(feature = "wrath")]
impl crate::wrath::ServerMessage for SMSG_MOVE_LAND_WALK {}
