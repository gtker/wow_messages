...
impl CMSG_GUILD_PROMOTE {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_GUILD_PROMOTE {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 139_u32.to_le_bytes();
...
impl crate::Message for CMSG_GUILD_PROMOTE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_GUILD_PROMOTE::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(1..=256).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x008B, size: body_size });
        }
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ClientMessage for CMSG_GUILD_PROMOTE {}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_GUILD_PROMOTE {}

#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_GUILD_PROMOTE {}
