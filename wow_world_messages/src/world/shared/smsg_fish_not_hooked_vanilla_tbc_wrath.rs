...
impl SMSG_FISH_NOT_HOOKED {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_FISH_NOT_HOOKED {{").unwrap();
        // Members
...
impl crate::private::Sealed for SMSG_FISH_NOT_HOOKED {}
impl crate::Message for SMSG_FISH_NOT_HOOKED {
    const OPCODE: u32 = 0x01c8;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        SMSG_FISH_NOT_HOOKED::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x01C8, size: body_size });
        }
