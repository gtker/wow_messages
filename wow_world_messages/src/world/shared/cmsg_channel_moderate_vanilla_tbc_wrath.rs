...
impl CMSG_CHANNEL_MODERATE {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_CHANNEL_MODERATE {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 168_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_CHANNEL_MODERATE {}
impl crate::Message for CMSG_CHANNEL_MODERATE {
    const OPCODE: u32 = 0x00a8;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_CHANNEL_MODERATE::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(1..=256).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00A8, size: body_size });
        }
