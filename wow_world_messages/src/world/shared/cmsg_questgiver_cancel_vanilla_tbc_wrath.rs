...
impl CMSG_QUESTGIVER_CANCEL {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_QUESTGIVER_CANCEL {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 400_u32.to_le_bytes();
...
impl crate::Message for CMSG_QUESTGIVER_CANCEL {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_QUESTGIVER_CANCEL::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0190, size: body_size });
        }
