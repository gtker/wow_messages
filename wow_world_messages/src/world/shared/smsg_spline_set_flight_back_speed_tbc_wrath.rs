...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/smsg/smsg_spline_set_flight_back_speed.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/smsg/smsg_spline_set_flight_back_speed.wowm#L1):
/// ```text
...
impl crate::Message for SMSG_SPLINE_SET_FLIGHT_BACK_SPEED {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_SPLINE_SET_FLIGHT_BACK_SPEED {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(902, "SMSG_SPLINE_SET_FLIGHT_BACK_SPEED", body_size, a))
    }

}

#[cfg(feature = "tbc")]
impl crate::tbc::ServerMessage for SMSG_SPLINE_SET_FLIGHT_BACK_SPEED {}

#[cfg(feature = "wrath")]
impl crate::wrath::ServerMessage for SMSG_SPLINE_SET_FLIGHT_BACK_SPEED {}
