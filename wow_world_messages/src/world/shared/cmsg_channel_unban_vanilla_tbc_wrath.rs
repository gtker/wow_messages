...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/chat/cmsg_channel_unban.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/chat/cmsg_channel_unban.wowm#L3):
/// ```text
...
impl CMSG_CHANNEL_UNBAN {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_CHANNEL_UNBAN {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 166_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_CHANNEL_UNBAN {}
impl crate::Message for CMSG_CHANNEL_UNBAN {
    const OPCODE: u32 = 0x00a6;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_CHANNEL_UNBAN::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(2..=512).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00A6, size: body_size });
        }
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ClientMessage for CMSG_CHANNEL_UNBAN {}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_CHANNEL_UNBAN {}

#[cfg(feature = "wrath")]
impl crate::wrath::ClientMessage for CMSG_CHANNEL_UNBAN {}
