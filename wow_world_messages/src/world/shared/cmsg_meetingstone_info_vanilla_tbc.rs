...
///
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/meetingstone/cmsg_meetingstone_info.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/meetingstone/cmsg_meetingstone_info.wowm#L1):
/// ```text
...
impl CMSG_MEETINGSTONE_INFO {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_MEETINGSTONE_INFO {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 662_u32.to_le_bytes();
...
impl crate::Message for CMSG_MEETINGSTONE_INFO {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_MEETINGSTONE_INFO::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0296, size: body_size });
        }
