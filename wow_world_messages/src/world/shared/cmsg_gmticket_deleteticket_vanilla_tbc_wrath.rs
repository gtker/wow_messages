...
impl CMSG_GMTICKET_DELETETICKET {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_GMTICKET_DELETETICKET {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 535_u32.to_le_bytes();
...
impl crate::private::Sealed for CMSG_GMTICKET_DELETETICKET {}
impl crate::Message for CMSG_GMTICKET_DELETETICKET {
    const OPCODE: u32 = 0x0217;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_GMTICKET_DELETETICKET::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0217, size: body_size });
        }
