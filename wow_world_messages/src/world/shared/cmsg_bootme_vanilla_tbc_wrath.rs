...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/login_logout/cmsg_bootme.wowm:2`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/login_logout/cmsg_bootme.wowm#L2):
/// ```text
...
impl crate::Message for CMSG_BOOTME {
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(1, "CMSG_BOOTME", body_size, a))
    }
