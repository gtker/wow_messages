...
impl SMSG_CLIENT_CONTROL_UPDATE {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        // allow_movement: Bool
        let allow_movement = crate::util::read_bool_u8(&mut r)?;
...
impl crate::Message for SMSG_CLIENT_CONTROL_UPDATE {
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(345, "SMSG_CLIENT_CONTROL_UPDATE", body_size, a))
    }
