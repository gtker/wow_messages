...
impl crate::Message for CMSG_BATTLEFIELD_STATUS {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x02D3, size: body_size as u32 });
        }
...
#[cfg(feature = "tbc")]
impl crate::world::tbc::ClientMessage for CMSG_BATTLEFIELD_STATUS {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ClientMessage for CMSG_BATTLEFIELD_STATUS {}
