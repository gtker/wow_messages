...
impl CMSG_PLAYER_LOGIN {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_PLAYER_LOGIN {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 61_u32.to_le_bytes();
...
impl crate::Message for CMSG_PLAYER_LOGIN {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_PLAYER_LOGIN::to_test_case_string(self)
    }
...
mod test_vanilla {
    ...
    fn assert(t: &CMSG_PLAYER_LOGIN, expected: &CMSG_PLAYER_LOGIN) {
