...
impl crate::Message for SMSG_ATTACKSWING_DEADTARGET {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_ATTACKSWING_DEADTARGET {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(328, "SMSG_ATTACKSWING_DEADTARGET", body_size, a))
    }
