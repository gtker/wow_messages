...
impl crate::Message for SMSG_ATTACKSWING_DEADTARGET {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0148, size: body_size as u32 });
        }
...
#[cfg(feature = "tbc")]
impl crate::world::tbc::ServerMessage for SMSG_ATTACKSWING_DEADTARGET {}

#[cfg(feature = "wrath")]
impl crate::world::wrath::ServerMessage for SMSG_ATTACKSWING_DEADTARGET {}
