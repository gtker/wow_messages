...
impl MSG_MOVE_SET_RUN_MODE_Client {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_SET_RUN_MODE_Client {{").unwrap();
        // Members
        // info: MovementInfo
...
impl crate::private::Sealed for MSG_MOVE_SET_RUN_MODE_Client {}
impl crate::Message for MSG_MOVE_SET_RUN_MODE_Client {
    const OPCODE: u32 = 0x00c2;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_SET_RUN_MODE_Client::to_test_case_string(self)
    }
...
mod test {
    ...
    fn assert(t: &MSG_MOVE_SET_RUN_MODE_Client, expected: &MSG_MOVE_SET_RUN_MODE_Client) {
    ...
    pub(crate) fn expected0() -> MSG_MOVE_SET_RUN_MODE_Client {
