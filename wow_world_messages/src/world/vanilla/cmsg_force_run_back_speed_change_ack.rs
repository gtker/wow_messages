...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/cmsg/cmsg_force_run_back_speed_change_ack.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/cmsg/cmsg_force_run_back_speed_change_ack.wowm#L1):
/// ```text
...
impl crate::Message for CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 229_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(229, "CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK", body_size, a))
    }

}

#[cfg(feature = "vanilla")]
impl crate::vanilla::ClientMessage for CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK {}
