...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_heartbeat.wowm:46`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_heartbeat.wowm#L46):
/// ```text
...
impl MSG_MOVE_HEARTBEAT_Server {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_HEARTBEAT_Server {{").unwrap();
        // Members
...
impl crate::private::Sealed for MSG_MOVE_HEARTBEAT_Server {}
impl crate::Message for MSG_MOVE_HEARTBEAT_Server {
    const OPCODE: u32 = 0x00ee;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_HEARTBEAT_Server::to_test_case_string(self)
    }
...
mod test {
    ...
    fn assert(t: &MSG_MOVE_HEARTBEAT_Server, expected: &MSG_MOVE_HEARTBEAT_Server) {
    ...
    pub(crate) fn expected0() -> MSG_MOVE_HEARTBEAT_Server {
