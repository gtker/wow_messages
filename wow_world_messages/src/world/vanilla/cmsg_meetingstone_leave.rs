...
impl crate::private::Sealed for CMSG_MEETINGSTONE_LEAVE {}
...
impl crate::Message for CMSG_MEETINGSTONE_LEAVE {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_MEETINGSTONE_LEAVE {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(659, "CMSG_MEETINGSTONE_LEAVE", body_size, a))
    }
