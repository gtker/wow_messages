...
impl MSG_MOVE_START_BACKWARD_Server {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_START_BACKWARD_Server {{").unwrap();
        // Members
...
impl crate::private::Sealed for MSG_MOVE_START_BACKWARD_Server {}
impl crate::Message for MSG_MOVE_START_BACKWARD_Server {
    const OPCODE: u32 = 0x00b6;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_START_BACKWARD_Server::to_test_case_string(self)
    }
...
mod test {
    ...
    fn assert(t: &MSG_MOVE_START_BACKWARD_Server, expected: &MSG_MOVE_START_BACKWARD_Server) {
    ...
    pub(crate) fn expected0() -> MSG_MOVE_START_BACKWARD_Server {
