...
impl MSG_MOVE_START_TURN_RIGHT_Client {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_START_TURN_RIGHT_Client {{").unwrap();
        // Members
        // info: MovementInfo
...
impl crate::Message for MSG_MOVE_START_TURN_RIGHT_Client {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_START_TURN_RIGHT_Client::to_test_case_string(self)
    }
...
mod test {
    ...
    fn assert(t: &MSG_MOVE_START_TURN_RIGHT_Client, expected: &MSG_MOVE_START_TURN_RIGHT_Client) {
