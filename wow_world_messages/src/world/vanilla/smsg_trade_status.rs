...
impl crate::Message for SMSG_TRADE_STATUS {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        match &self {
            crate::vanilla::SMSG_TRADE_STATUS::BeginTrade {
                unknown1,
            } => {
                writeln!(s, "    unknown1 = {};", unknown1.guid()).unwrap();
            }
            crate::vanilla::SMSG_TRADE_STATUS::CloseWindow {
                inventory_result,
                item_limit_category_id,
                target_error,
            } => {
            ...
            crate::vanilla::SMSG_TRADE_STATUS::OnlyConjured {
                slot,
            } => {
                writeln!(s, "    slot = {};", slot).unwrap();
            }
            crate::vanilla::SMSG_TRADE_STATUS::NotOnTaplist {
                slot,
            } => {
                writeln!(s, "    slot = {};", slot).unwrap();
            }
