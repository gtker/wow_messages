...
impl MSG_MOVE_START_PITCH_UP_Server {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_START_PITCH_UP_Server {{").unwrap();
        // Members
...
impl crate::private::Sealed for MSG_MOVE_START_PITCH_UP_Server {}
impl crate::Message for MSG_MOVE_START_PITCH_UP_Server {
    const OPCODE: u32 = 0x00bf;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_START_PITCH_UP_Server::to_test_case_string(self)
    }
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ServerMessage for MSG_MOVE_START_PITCH_UP_Server {}
