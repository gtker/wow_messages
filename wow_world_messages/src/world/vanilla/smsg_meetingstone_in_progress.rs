...
impl crate::Message for SMSG_MEETINGSTONE_IN_PROGRESS {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0298, size: body_size as u32 });
        }
...
#[cfg(feature = "vanilla")]
impl crate::world::vanilla::ServerMessage for SMSG_MEETINGSTONE_IN_PROGRESS {}
