...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_fall_land.wowm:45`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_fall_land.wowm#L45):
/// ```text
...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/world/movement/msg/msg_move_fall_land.wowm` line 52.
    #[cfg(feature = "sync")]
