...
impl ClientOpcodeMessage {
    fn read_opcodes(opcode: u32, body_size: u32, mut r: &[u8]) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x0066 => crate::util::assert_empty(body_size, opcode, "CMSG_FRIEND_LIST").map(|_| Self::CMSG_FRIEND_LIST),
            ...
            0x01FF => crate::util::assert_empty(body_size, opcode, "MSG_LOOKING_FOR_GROUP_Client").map(|_| Self::MSG_LOOKING_FOR_GROUP),
            ...
            0x023E => Ok(Self::CMSG_BATTLEFIELD_JOIN(<CMSG_BATTLEFIELD_JOIN as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x0292 => Ok(Self::CMSG_MEETINGSTONE_JOIN(<CMSG_MEETINGSTONE_JOIN as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            0x0293 => crate::util::assert_empty(body_size, opcode, "CMSG_MEETINGSTONE_LEAVE").map(|_| Self::CMSG_MEETINGSTONE_LEAVE),
...
impl ServerOpcodeMessage {
    fn read_opcodes(opcode: u16, body_size: u32, mut r: &[u8]) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x0067 => Ok(Self::SMSG_FRIEND_LIST(<SMSG_FRIEND_LIST as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x006B => Ok(Self::SMSG_IGNORE_LIST(<SMSG_IGNORE_LIST as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x0113 => Ok(Self::SMSG_OPEN_CONTAINER(<SMSG_OPEN_CONTAINER as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            0x0115 => Ok(Self::SMSG_INSPECT(<SMSG_INSPECT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x0130 => Ok(Self::SMSG_CAST_RESULT(<SMSG_CAST_RESULT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x016F => Ok(Self::SMSG_DISMOUNTRESULT(<SMSG_DISMOUNTRESULT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x0178 => crate::util::assert_empty(body_size, opcode, "SMSG_PET_NAME_INVALID").map(|_| Self::SMSG_PET_NAME_INVALID),
            ...
            0x01D6 => Ok(Self::SMSG_RESISTLOG(<SMSG_RESISTLOG as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x0297 => crate::util::assert_empty(body_size, opcode, "SMSG_MEETINGSTONE_COMPLETE").map(|_| Self::SMSG_MEETINGSTONE_COMPLETE),
            0x0298 => crate::util::assert_empty(body_size, opcode, "SMSG_MEETINGSTONE_IN_PROGRESS").map(|_| Self::SMSG_MEETINGSTONE_IN_PROGRESS),
            0x0299 => Ok(Self::SMSG_MEETINGSTONE_MEMBER_ADDED(<SMSG_MEETINGSTONE_MEMBER_ADDED as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x02A7 => Ok(Self::SMSG_GAMEOBJECT_RESET_STATE(<SMSG_GAMEOBJECT_RESET_STATE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x02BB => Ok(Self::SMSG_MEETINGSTONE_JOINFAILED(<SMSG_MEETINGSTONE_JOINFAILED as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x02E0 => Ok(Self::MSG_PVP_LOG_DATA(<MSG_PVP_LOG_DATA_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            ...
            0x02FB => Ok(Self::SMSG_COMPRESSED_MOVES(<SMSG_COMPRESSED_MOVES as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            0x02FD => crate::util::assert_empty(body_size, opcode, "SMSG_CHAT_RESTRICTED").map(|_| Self::SMSG_CHAT_RESTRICTED),
            ...
            0x0332 => Ok(Self::SMSG_EXPECTED_SPAM_RECORDS(<SMSG_EXPECTED_SPAM_RECORDS as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
            0x033B => Ok(Self::SMSG_DEFENSE_MESSAGE(<SMSG_DEFENSE_MESSAGE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?)),
