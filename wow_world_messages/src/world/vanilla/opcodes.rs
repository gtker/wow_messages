...
impl ClientOpcodeMessage {
    fn read_opcodes(opcode: u32, body_size: u32, mut r: &[u8]) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x023E => Ok(Self::CMSG_BATTLEFIELD_JOIN(<CMSG_BATTLEFIELD_JOIN as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x023E, size: body_size, io, } } else { a } })?)),
            ...
            0x0292 => Ok(Self::CMSG_MEETINGSTONE_JOIN(<CMSG_MEETINGSTONE_JOIN as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0292, size: body_size, io, } } else { a } })?)),
    ...
    pub fn to_test_case_string(&self) -> Option<String> {
        match self {
            ...
            Self::CMSG_FRIEND_LIST => CMSG_FRIEND_LIST{}.to_test_case_string(),
            ...
            Self::MSG_LOOKING_FOR_GROUP => MSG_LOOKING_FOR_GROUP_Client{}.to_test_case_string(),
            ...
            Self::CMSG_BATTLEFIELD_JOIN(c) => c.to_test_case_string(),
            ...
            Self::CMSG_MEETINGSTONE_JOIN(c) => c.to_test_case_string(),
            Self::CMSG_MEETINGSTONE_LEAVE => CMSG_MEETINGSTONE_LEAVE{}.to_test_case_string(),
    ...
    pub fn message_name(&self) -> &'static str {
        match self {
            ...
            Self::MSG_PETITION_DECLINE(c) => "MSG_PETITION_DECLINE",
            Self::MSG_TABARDVENDOR_ACTIVATE(c) => "MSG_TABARDVENDOR_ACTIVATE",
            Self::MSG_QUEST_PUSH_RESULT(c) => "MSG_QUEST_PUSH_RESULT",
            Self::MSG_MOVE_WATER_WALK(c) => "MSG_MOVE_WATER_WALK",
            Self::MSG_PETITION_RENAME(c) => "MSG_PETITION_RENAME",
            Self::CMSG_BOOTME => "CMSG_BOOTME",
            Self::CMSG_DBLOOKUP(c) => "CMSG_DBLOOKUP",
            Self::CMSG_WORLD_TELEPORT(c) => "CMSG_WORLD_TELEPORT",
            Self::CMSG_TELEPORT_TO_UNIT(c) => "CMSG_TELEPORT_TO_UNIT",
            Self::CMSG_CHAR_CREATE(c) => "CMSG_CHAR_CREATE",
            Self::CMSG_CHAR_ENUM => "CMSG_CHAR_ENUM",
            Self::CMSG_CHAR_DELETE(c) => "CMSG_CHAR_DELETE",
            Self::CMSG_PLAYER_LOGIN(c) => "CMSG_PLAYER_LOGIN",
            ...
            Self::CMSG_NAME_QUERY(c) => "CMSG_NAME_QUERY",
            Self::CMSG_PET_NAME_QUERY(c) => "CMSG_PET_NAME_QUERY",
            Self::CMSG_GUILD_QUERY(c) => "CMSG_GUILD_QUERY",
            Self::CMSG_ITEM_QUERY_SINGLE(c) => "CMSG_ITEM_QUERY_SINGLE",
            Self::CMSG_PAGE_TEXT_QUERY(c) => "CMSG_PAGE_TEXT_QUERY",
            Self::CMSG_QUEST_QUERY(c) => "CMSG_QUEST_QUERY",
            Self::CMSG_GAMEOBJECT_QUERY(c) => "CMSG_GAMEOBJECT_QUERY",
            Self::CMSG_CREATURE_QUERY(c) => "CMSG_CREATURE_QUERY",
            Self::CMSG_WHO(c) => "CMSG_WHO",
            Self::CMSG_WHOIS(c) => "CMSG_WHOIS",
            Self::CMSG_FRIEND_LIST => "CMSG_FRIEND_LIST",
            Self::CMSG_ADD_FRIEND(c) => "CMSG_ADD_FRIEND",
            Self::CMSG_DEL_FRIEND(c) => "CMSG_DEL_FRIEND",
            Self::CMSG_ADD_IGNORE(c) => "CMSG_ADD_IGNORE",
            Self::CMSG_DEL_IGNORE(c) => "CMSG_DEL_IGNORE",
            Self::CMSG_GROUP_INVITE(c) => "CMSG_GROUP_INVITE",
            Self::CMSG_GROUP_ACCEPT => "CMSG_GROUP_ACCEPT",
            Self::CMSG_GROUP_DECLINE => "CMSG_GROUP_DECLINE",
            Self::CMSG_GROUP_UNINVITE(c) => "CMSG_GROUP_UNINVITE",
            Self::CMSG_GROUP_UNINVITE_GUID(c) => "CMSG_GROUP_UNINVITE_GUID",
            Self::CMSG_GROUP_SET_LEADER(c) => "CMSG_GROUP_SET_LEADER",
            Self::CMSG_LOOT_METHOD(c) => "CMSG_LOOT_METHOD",
            Self::CMSG_GROUP_DISBAND => "CMSG_GROUP_DISBAND",
            Self::CMSG_GUILD_CREATE(c) => "CMSG_GUILD_CREATE",
            Self::CMSG_GUILD_INVITE(c) => "CMSG_GUILD_INVITE",
            ...
            Self::CMSG_GUILD_PROMOTE(c) => "CMSG_GUILD_PROMOTE",
            Self::CMSG_GUILD_DEMOTE(c) => "CMSG_GUILD_DEMOTE",
            Self::CMSG_GUILD_LEAVE => "CMSG_GUILD_LEAVE",
            Self::CMSG_GUILD_REMOVE(c) => "CMSG_GUILD_REMOVE",
            Self::CMSG_GUILD_DISBAND => "CMSG_GUILD_DISBAND",
            Self::CMSG_GUILD_LEADER(c) => "CMSG_GUILD_LEADER",
            Self::CMSG_GUILD_MOTD(c) => "CMSG_GUILD_MOTD",
            Self::CMSG_MESSAGECHAT(c) => "CMSG_MESSAGECHAT",
            Self::CMSG_JOIN_CHANNEL(c) => "CMSG_JOIN_CHANNEL",
            Self::CMSG_LEAVE_CHANNEL(c) => "CMSG_LEAVE_CHANNEL",
            Self::CMSG_CHANNEL_LIST(c) => "CMSG_CHANNEL_LIST",
            Self::CMSG_CHANNEL_PASSWORD(c) => "CMSG_CHANNEL_PASSWORD",
            Self::CMSG_CHANNEL_SET_OWNER(c) => "CMSG_CHANNEL_SET_OWNER",
            Self::CMSG_CHANNEL_OWNER(c) => "CMSG_CHANNEL_OWNER",
            Self::CMSG_CHANNEL_MODERATOR(c) => "CMSG_CHANNEL_MODERATOR",
            Self::CMSG_CHANNEL_UNMODERATOR(c) => "CMSG_CHANNEL_UNMODERATOR",
            Self::CMSG_CHANNEL_MUTE(c) => "CMSG_CHANNEL_MUTE",
            Self::CMSG_CHANNEL_UNMUTE(c) => "CMSG_CHANNEL_UNMUTE",
            Self::CMSG_CHANNEL_INVITE(c) => "CMSG_CHANNEL_INVITE",
            Self::CMSG_CHANNEL_KICK(c) => "CMSG_CHANNEL_KICK",
            Self::CMSG_CHANNEL_BAN(c) => "CMSG_CHANNEL_BAN",
            Self::CMSG_CHANNEL_UNBAN(c) => "CMSG_CHANNEL_UNBAN",
            Self::CMSG_CHANNEL_ANNOUNCEMENTS(c) => "CMSG_CHANNEL_ANNOUNCEMENTS",
            Self::CMSG_CHANNEL_MODERATE(c) => "CMSG_CHANNEL_MODERATE",
            Self::CMSG_USE_ITEM(c) => "CMSG_USE_ITEM",
            Self::CMSG_OPEN_ITEM(c) => "CMSG_OPEN_ITEM",
            Self::CMSG_READ_ITEM(c) => "CMSG_READ_ITEM",
            Self::CMSG_GAMEOBJ_USE(c) => "CMSG_GAMEOBJ_USE",
            Self::CMSG_AREATRIGGER(c) => "CMSG_AREATRIGGER",
            Self::MSG_MOVE_START_FORWARD(c) => "MSG_MOVE_START_FORWARD_Client",
            Self::MSG_MOVE_START_BACKWARD(c) => "MSG_MOVE_START_BACKWARD_Client",
            Self::MSG_MOVE_STOP(c) => "MSG_MOVE_STOP_Client",
            Self::MSG_MOVE_START_STRAFE_LEFT(c) => "MSG_MOVE_START_STRAFE_LEFT_Client",
            Self::MSG_MOVE_START_STRAFE_RIGHT(c) => "MSG_MOVE_START_STRAFE_RIGHT_Client",
            Self::MSG_MOVE_STOP_STRAFE(c) => "MSG_MOVE_STOP_STRAFE_Client",
            Self::MSG_MOVE_JUMP(c) => "MSG_MOVE_JUMP_Client",
            Self::MSG_MOVE_START_TURN_LEFT(c) => "MSG_MOVE_START_TURN_LEFT_Client",
            Self::MSG_MOVE_START_TURN_RIGHT(c) => "MSG_MOVE_START_TURN_RIGHT_Client",
            Self::MSG_MOVE_STOP_TURN(c) => "MSG_MOVE_STOP_TURN_Client",
            Self::MSG_MOVE_START_PITCH_UP(c) => "MSG_MOVE_START_PITCH_UP_Client",
            Self::MSG_MOVE_START_PITCH_DOWN(c) => "MSG_MOVE_START_PITCH_DOWN_Client",
            Self::MSG_MOVE_STOP_PITCH(c) => "MSG_MOVE_STOP_PITCH_Client",
            Self::MSG_MOVE_SET_RUN_MODE(c) => "MSG_MOVE_SET_RUN_MODE_Client",
            Self::MSG_MOVE_SET_WALK_MODE(c) => "MSG_MOVE_SET_WALK_MODE_Client",
            Self::MSG_MOVE_TELEPORT_ACK(c) => "MSG_MOVE_TELEPORT_ACK_Client",
            Self::MSG_MOVE_FALL_LAND(c) => "MSG_MOVE_FALL_LAND_Client",
            Self::MSG_MOVE_START_SWIM(c) => "MSG_MOVE_START_SWIM_Client",
            Self::MSG_MOVE_STOP_SWIM(c) => "MSG_MOVE_STOP_SWIM_Client",
            Self::MSG_MOVE_SET_FACING(c) => "MSG_MOVE_SET_FACING_Client",
            Self::MSG_MOVE_SET_PITCH(c) => "MSG_MOVE_SET_PITCH_Client",
            Self::CMSG_MOVE_SET_RAW_POSITION(c) => "CMSG_MOVE_SET_RAW_POSITION",
            Self::CMSG_FORCE_RUN_SPEED_CHANGE_ACK(c) => "CMSG_FORCE_RUN_SPEED_CHANGE_ACK",
            Self::CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK(c) => "CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK",
            Self::CMSG_FORCE_SWIM_SPEED_CHANGE_ACK(c) => "CMSG_FORCE_SWIM_SPEED_CHANGE_ACK",
            Self::CMSG_FORCE_MOVE_ROOT_ACK(c) => "CMSG_FORCE_MOVE_ROOT_ACK",
            Self::CMSG_FORCE_MOVE_UNROOT_ACK(c) => "CMSG_FORCE_MOVE_UNROOT_ACK",
            Self::MSG_MOVE_HEARTBEAT(c) => "MSG_MOVE_HEARTBEAT_Client",
            Self::CMSG_MOVE_KNOCK_BACK_ACK(c) => "CMSG_MOVE_KNOCK_BACK_ACK",
            Self::CMSG_MOVE_HOVER_ACK(c) => "CMSG_MOVE_HOVER_ACK",
            Self::CMSG_NEXT_CINEMATIC_CAMERA => "CMSG_NEXT_CINEMATIC_CAMERA",
            Self::CMSG_COMPLETE_CINEMATIC => "CMSG_COMPLETE_CINEMATIC",
            Self::CMSG_TUTORIAL_FLAG(c) => "CMSG_TUTORIAL_FLAG",
            Self::CMSG_TUTORIAL_CLEAR => "CMSG_TUTORIAL_CLEAR",
            Self::CMSG_TUTORIAL_RESET => "CMSG_TUTORIAL_RESET",
            Self::CMSG_STANDSTATECHANGE(c) => "CMSG_STANDSTATECHANGE",
            Self::CMSG_EMOTE(c) => "CMSG_EMOTE",
            Self::CMSG_TEXT_EMOTE(c) => "CMSG_TEXT_EMOTE",
            Self::CMSG_AUTOSTORE_LOOT_ITEM(c) => "CMSG_AUTOSTORE_LOOT_ITEM",
            Self::CMSG_AUTOEQUIP_ITEM(c) => "CMSG_AUTOEQUIP_ITEM",
            Self::CMSG_AUTOSTORE_BAG_ITEM(c) => "CMSG_AUTOSTORE_BAG_ITEM",
            Self::CMSG_SWAP_ITEM(c) => "CMSG_SWAP_ITEM",
            Self::CMSG_SWAP_INV_ITEM(c) => "CMSG_SWAP_INV_ITEM",
            Self::CMSG_SPLIT_ITEM(c) => "CMSG_SPLIT_ITEM",
            Self::CMSG_AUTOEQUIP_ITEM_SLOT(c) => "CMSG_AUTOEQUIP_ITEM_SLOT",
            Self::CMSG_DESTROYITEM(c) => "CMSG_DESTROYITEM",
            Self::CMSG_INSPECT(c) => "CMSG_INSPECT",
            Self::CMSG_INITIATE_TRADE(c) => "CMSG_INITIATE_TRADE",
            Self::CMSG_BEGIN_TRADE => "CMSG_BEGIN_TRADE",
            Self::CMSG_BUSY_TRADE => "CMSG_BUSY_TRADE",
            Self::CMSG_IGNORE_TRADE => "CMSG_IGNORE_TRADE",
            Self::CMSG_ACCEPT_TRADE(c) => "CMSG_ACCEPT_TRADE",
            Self::CMSG_UNACCEPT_TRADE => "CMSG_UNACCEPT_TRADE",
            Self::CMSG_CANCEL_TRADE => "CMSG_CANCEL_TRADE",
            Self::CMSG_SET_TRADE_ITEM(c) => "CMSG_SET_TRADE_ITEM",
            Self::CMSG_CLEAR_TRADE_ITEM(c) => "CMSG_CLEAR_TRADE_ITEM",
            Self::CMSG_SET_TRADE_GOLD(c) => "CMSG_SET_TRADE_GOLD",
            Self::CMSG_SET_FACTION_ATWAR(c) => "CMSG_SET_FACTION_ATWAR",
            Self::CMSG_SET_ACTION_BUTTON(c) => "CMSG_SET_ACTION_BUTTON",
            Self::CMSG_CAST_SPELL(c) => "CMSG_CAST_SPELL",
            Self::CMSG_CANCEL_CAST(c) => "CMSG_CANCEL_CAST",
            Self::CMSG_CANCEL_AURA(c) => "CMSG_CANCEL_AURA",
            Self::CMSG_CANCEL_CHANNELLING(c) => "CMSG_CANCEL_CHANNELLING",
            Self::CMSG_SET_SELECTION(c) => "CMSG_SET_SELECTION",
            Self::CMSG_SET_TARGET_OBSOLETE(c) => "CMSG_SET_TARGET_OBSOLETE",
            Self::CMSG_ATTACKSWING(c) => "CMSG_ATTACKSWING",
            Self::CMSG_ATTACKSTOP => "CMSG_ATTACKSTOP",
            Self::CMSG_REPOP_REQUEST => "CMSG_REPOP_REQUEST",
            Self::CMSG_RESURRECT_RESPONSE(c) => "CMSG_RESURRECT_RESPONSE",
            Self::CMSG_LOOT(c) => "CMSG_LOOT",
            Self::CMSG_LOOT_MONEY => "CMSG_LOOT_MONEY",
            Self::CMSG_LOOT_RELEASE(c) => "CMSG_LOOT_RELEASE",
            Self::CMSG_DUEL_ACCEPTED(c) => "CMSG_DUEL_ACCEPTED",
            Self::CMSG_DUEL_CANCELLED(c) => "CMSG_DUEL_CANCELLED",
            Self::CMSG_MOUNTSPECIAL_ANIM => "CMSG_MOUNTSPECIAL_ANIM",
            Self::CMSG_PET_SET_ACTION(c) => "CMSG_PET_SET_ACTION",
            Self::CMSG_PET_ACTION(c) => "CMSG_PET_ACTION",
            Self::CMSG_PET_ABANDON(c) => "CMSG_PET_ABANDON",
            Self::CMSG_PET_RENAME(c) => "CMSG_PET_RENAME",
            Self::CMSG_GOSSIP_HELLO(c) => "CMSG_GOSSIP_HELLO",
            Self::CMSG_GOSSIP_SELECT_OPTION(c) => "CMSG_GOSSIP_SELECT_OPTION",
            Self::CMSG_NPC_TEXT_QUERY(c) => "CMSG_NPC_TEXT_QUERY",
            Self::CMSG_QUESTGIVER_STATUS_QUERY(c) => "CMSG_QUESTGIVER_STATUS_QUERY",
            Self::CMSG_QUESTGIVER_HELLO(c) => "CMSG_QUESTGIVER_HELLO",
            Self::CMSG_QUESTGIVER_QUERY_QUEST(c) => "CMSG_QUESTGIVER_QUERY_QUEST",
            Self::CMSG_QUESTGIVER_QUEST_AUTOLAUNCH => "CMSG_QUESTGIVER_QUEST_AUTOLAUNCH",
            Self::CMSG_QUESTGIVER_ACCEPT_QUEST(c) => "CMSG_QUESTGIVER_ACCEPT_QUEST",
            Self::CMSG_QUESTGIVER_COMPLETE_QUEST(c) => "CMSG_QUESTGIVER_COMPLETE_QUEST",
            Self::CMSG_QUESTGIVER_REQUEST_REWARD(c) => "CMSG_QUESTGIVER_REQUEST_REWARD",
            Self::CMSG_QUESTGIVER_CHOOSE_REWARD(c) => "CMSG_QUESTGIVER_CHOOSE_REWARD",
            Self::CMSG_QUESTGIVER_CANCEL => "CMSG_QUESTGIVER_CANCEL",
            Self::CMSG_QUESTLOG_SWAP_QUEST(c) => "CMSG_QUESTLOG_SWAP_QUEST",
            Self::CMSG_QUESTLOG_REMOVE_QUEST(c) => "CMSG_QUESTLOG_REMOVE_QUEST",
            Self::CMSG_QUEST_CONFIRM_ACCEPT(c) => "CMSG_QUEST_CONFIRM_ACCEPT",
            Self::CMSG_PUSHQUESTTOPARTY(c) => "CMSG_PUSHQUESTTOPARTY",
            Self::CMSG_LIST_INVENTORY(c) => "CMSG_LIST_INVENTORY",
            Self::CMSG_SELL_ITEM(c) => "CMSG_SELL_ITEM",
            Self::CMSG_BUY_ITEM(c) => "CMSG_BUY_ITEM",
            Self::CMSG_BUY_ITEM_IN_SLOT(c) => "CMSG_BUY_ITEM_IN_SLOT",
            Self::CMSG_TAXINODE_STATUS_QUERY(c) => "CMSG_TAXINODE_STATUS_QUERY",
            Self::CMSG_TAXIQUERYAVAILABLENODES(c) => "CMSG_TAXIQUERYAVAILABLENODES",
            Self::CMSG_ACTIVATETAXI(c) => "CMSG_ACTIVATETAXI",
            Self::CMSG_TRAINER_LIST(c) => "CMSG_TRAINER_LIST",
            Self::CMSG_TRAINER_BUY_SPELL(c) => "CMSG_TRAINER_BUY_SPELL",
            Self::CMSG_BINDER_ACTIVATE(c) => "CMSG_BINDER_ACTIVATE",
            Self::CMSG_BANKER_ACTIVATE(c) => "CMSG_BANKER_ACTIVATE",
            Self::CMSG_BUY_BANK_SLOT(c) => "CMSG_BUY_BANK_SLOT",
            Self::CMSG_PETITION_SHOWLIST(c) => "CMSG_PETITION_SHOWLIST",
            Self::CMSG_PETITION_BUY(c) => "CMSG_PETITION_BUY",
            Self::CMSG_PETITION_SHOW_SIGNATURES(c) => "CMSG_PETITION_SHOW_SIGNATURES",
            Self::CMSG_PETITION_SIGN(c) => "CMSG_PETITION_SIGN",
            Self::CMSG_OFFER_PETITION(c) => "CMSG_OFFER_PETITION",
            Self::CMSG_TURN_IN_PETITION(c) => "CMSG_TURN_IN_PETITION",
            Self::CMSG_PETITION_QUERY(c) => "CMSG_PETITION_QUERY",
            Self::CMSG_BUG(c) => "CMSG_BUG",
            Self::CMSG_PLAYED_TIME => "CMSG_PLAYED_TIME",
            Self::CMSG_QUERY_TIME => "CMSG_QUERY_TIME",
            Self::CMSG_RECLAIM_CORPSE(c) => "CMSG_RECLAIM_CORPSE",
            Self::CMSG_WRAP_ITEM(c) => "CMSG_WRAP_ITEM",
            Self::MSG_MINIMAP_PING(c) => "MSG_MINIMAP_PING_Client",
            Self::CMSG_PING(c) => "CMSG_PING",
            Self::CMSG_SETSHEATHED(c) => "CMSG_SETSHEATHED",
            Self::CMSG_AUTH_SESSION(c) => "CMSG_AUTH_SESSION",
            Self::CMSG_PET_CAST_SPELL(c) => "CMSG_PET_CAST_SPELL",
            Self::MSG_SAVE_GUILD_EMBLEM(c) => "MSG_SAVE_GUILD_EMBLEM_Client",
            Self::CMSG_ZONEUPDATE(c) => "CMSG_ZONEUPDATE",
            Self::MSG_RANDOM_ROLL(c) => "MSG_RANDOM_ROLL_Client",
            Self::MSG_LOOKING_FOR_GROUP => "MSG_LOOKING_FOR_GROUP_Client",
            Self::CMSG_UNLEARN_SKILL(c) => "CMSG_UNLEARN_SKILL",
            Self::CMSG_GMTICKET_CREATE(c) => "CMSG_GMTICKET_CREATE",
            Self::CMSG_GMTICKET_UPDATETEXT(c) => "CMSG_GMTICKET_UPDATETEXT",
            Self::CMSG_REQUEST_ACCOUNT_DATA(c) => "CMSG_REQUEST_ACCOUNT_DATA",
            Self::CMSG_UPDATE_ACCOUNT_DATA(c) => "CMSG_UPDATE_ACCOUNT_DATA",
            ...
            Self::CMSG_SPIRIT_HEALER_ACTIVATE(c) => "CMSG_SPIRIT_HEALER_ACTIVATE",
            Self::CMSG_CHAT_IGNORED(c) => "CMSG_CHAT_IGNORED",
            Self::CMSG_GUILD_RANK(c) => "CMSG_GUILD_RANK",
            Self::CMSG_GUILD_ADD_RANK(c) => "CMSG_GUILD_ADD_RANK",
            Self::CMSG_GUILD_DEL_RANK => "CMSG_GUILD_DEL_RANK",
            Self::CMSG_GUILD_SET_PUBLIC_NOTE(c) => "CMSG_GUILD_SET_PUBLIC_NOTE",
            Self::CMSG_GUILD_SET_OFFICER_NOTE(c) => "CMSG_GUILD_SET_OFFICER_NOTE",
            Self::CMSG_SEND_MAIL(c) => "CMSG_SEND_MAIL",
            Self::CMSG_GET_MAIL_LIST(c) => "CMSG_GET_MAIL_LIST",
            Self::CMSG_BATTLEFIELD_LIST(c) => "CMSG_BATTLEFIELD_LIST",
            Self::CMSG_BATTLEFIELD_JOIN(c) => "CMSG_BATTLEFIELD_JOIN",
            Self::CMSG_ITEM_TEXT_QUERY(c) => "CMSG_ITEM_TEXT_QUERY",
            Self::CMSG_MAIL_TAKE_MONEY(c) => "CMSG_MAIL_TAKE_MONEY",
            Self::CMSG_MAIL_TAKE_ITEM(c) => "CMSG_MAIL_TAKE_ITEM",
            Self::CMSG_MAIL_MARK_AS_READ(c) => "CMSG_MAIL_MARK_AS_READ",
            Self::CMSG_MAIL_RETURN_TO_SENDER(c) => "CMSG_MAIL_RETURN_TO_SENDER",
            Self::CMSG_MAIL_DELETE(c) => "CMSG_MAIL_DELETE",
            Self::CMSG_MAIL_CREATE_TEXT_ITEM(c) => "CMSG_MAIL_CREATE_TEXT_ITEM",
            Self::CMSG_LEARN_TALENT(c) => "CMSG_LEARN_TALENT",
            Self::CMSG_TOGGLE_PVP(c) => "CMSG_TOGGLE_PVP",
            Self::MSG_AUCTION_HELLO(c) => "MSG_AUCTION_HELLO_Client",
            Self::CMSG_AUCTION_SELL_ITEM(c) => "CMSG_AUCTION_SELL_ITEM",
            Self::CMSG_AUCTION_REMOVE_ITEM(c) => "CMSG_AUCTION_REMOVE_ITEM",
            Self::CMSG_AUCTION_LIST_ITEMS(c) => "CMSG_AUCTION_LIST_ITEMS",
            Self::CMSG_AUCTION_LIST_OWNER_ITEMS(c) => "CMSG_AUCTION_LIST_OWNER_ITEMS",
            Self::CMSG_AUCTION_PLACE_BID(c) => "CMSG_AUCTION_PLACE_BID",
            Self::CMSG_AUCTION_LIST_BIDDER_ITEMS(c) => "CMSG_AUCTION_LIST_BIDDER_ITEMS",
            Self::CMSG_SET_AMMO(c) => "CMSG_SET_AMMO",
            Self::CMSG_SET_ACTIVE_MOVER(c) => "CMSG_SET_ACTIVE_MOVER",
            Self::CMSG_PET_CANCEL_AURA(c) => "CMSG_PET_CANCEL_AURA",
            Self::CMSG_CANCEL_AUTO_REPEAT_SPELL => "CMSG_CANCEL_AUTO_REPEAT_SPELL",
            Self::MSG_LIST_STABLED_PETS(c) => "MSG_LIST_STABLED_PETS_Client",
            Self::CMSG_STABLE_PET(c) => "CMSG_STABLE_PET",
            Self::CMSG_UNSTABLE_PET(c) => "CMSG_UNSTABLE_PET",
            Self::CMSG_BUY_STABLE_SLOT(c) => "CMSG_BUY_STABLE_SLOT",
            Self::CMSG_STABLE_SWAP_PET(c) => "CMSG_STABLE_SWAP_PET",
            Self::CMSG_REQUEST_PET_INFO => "CMSG_REQUEST_PET_INFO",
            Self::CMSG_FAR_SIGHT(c) => "CMSG_FAR_SIGHT",
            Self::CMSG_GROUP_CHANGE_SUB_GROUP(c) => "CMSG_GROUP_CHANGE_SUB_GROUP",
            Self::CMSG_REQUEST_PARTY_MEMBER_STATS(c) => "CMSG_REQUEST_PARTY_MEMBER_STATS",
            Self::CMSG_GROUP_SWAP_SUB_GROUP(c) => "CMSG_GROUP_SWAP_SUB_GROUP",
            Self::CMSG_AUTOSTORE_BANK_ITEM(c) => "CMSG_AUTOSTORE_BANK_ITEM",
            Self::CMSG_AUTOBANK_ITEM(c) => "CMSG_AUTOBANK_ITEM",
            Self::MSG_QUERY_NEXT_MAIL_TIME => "MSG_QUERY_NEXT_MAIL_TIME_Client",
            Self::CMSG_GROUP_RAID_CONVERT => "CMSG_GROUP_RAID_CONVERT",
            Self::CMSG_GROUP_ASSISTANT_LEADER(c) => "CMSG_GROUP_ASSISTANT_LEADER",
            Self::CMSG_BUYBACK_ITEM(c) => "CMSG_BUYBACK_ITEM",
            Self::CMSG_MEETINGSTONE_JOIN(c) => "CMSG_MEETINGSTONE_JOIN",
            Self::CMSG_MEETINGSTONE_LEAVE => "CMSG_MEETINGSTONE_LEAVE",
            Self::CMSG_MEETINGSTONE_INFO => "CMSG_MEETINGSTONE_INFO",
            Self::CMSG_CANCEL_GROWTH_AURA => "CMSG_CANCEL_GROWTH_AURA",
            Self::CMSG_LOOT_ROLL(c) => "CMSG_LOOT_ROLL",
            Self::CMSG_LOOT_MASTER_GIVE(c) => "CMSG_LOOT_MASTER_GIVE",
            Self::CMSG_REPAIR_ITEM(c) => "CMSG_REPAIR_ITEM",
            Self::MSG_TALENT_WIPE_CONFIRM(c) => "MSG_TALENT_WIPE_CONFIRM_Client",
            Self::CMSG_SUMMON_RESPONSE(c) => "CMSG_SUMMON_RESPONSE",
            Self::CMSG_SELF_RES => "CMSG_SELF_RES",
            Self::CMSG_TOGGLE_HELM => "CMSG_TOGGLE_HELM",
            Self::CMSG_TOGGLE_CLOAK => "CMSG_TOGGLE_CLOAK",
            Self::CMSG_SET_ACTIONBAR_TOGGLES(c) => "CMSG_SET_ACTIONBAR_TOGGLES",
            Self::CMSG_ITEM_NAME_QUERY(c) => "CMSG_ITEM_NAME_QUERY",
            Self::CMSG_CHAR_RENAME(c) => "CMSG_CHAR_RENAME",
            Self::CMSG_MOVE_SPLINE_DONE(c) => "CMSG_MOVE_SPLINE_DONE",
            Self::CMSG_MOVE_FALL_RESET(c) => "CMSG_MOVE_FALL_RESET",
            Self::CMSG_REQUEST_RAID_INFO => "CMSG_REQUEST_RAID_INFO",
            Self::CMSG_MOVE_TIME_SKIPPED(c) => "CMSG_MOVE_TIME_SKIPPED",
            Self::CMSG_MOVE_FEATHER_FALL_ACK(c) => "CMSG_MOVE_FEATHER_FALL_ACK",
            Self::CMSG_MOVE_WATER_WALK_ACK(c) => "CMSG_MOVE_WATER_WALK_ACK",
            Self::CMSG_MOVE_NOT_ACTIVE_MOVER(c) => "CMSG_MOVE_NOT_ACTIVE_MOVER",
            Self::CMSG_BATTLEFIELD_STATUS => "CMSG_BATTLEFIELD_STATUS",
            Self::CMSG_BATTLEFIELD_PORT(c) => "CMSG_BATTLEFIELD_PORT",
            Self::MSG_INSPECT_HONOR_STATS(c) => "MSG_INSPECT_HONOR_STATS_Client",
            Self::CMSG_BATTLEMASTER_HELLO(c) => "CMSG_BATTLEMASTER_HELLO",
            Self::CMSG_FORCE_WALK_SPEED_CHANGE_ACK(c) => "CMSG_FORCE_WALK_SPEED_CHANGE_ACK",
            Self::CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK(c) => "CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK",
            Self::CMSG_FORCE_TURN_RATE_CHANGE_ACK(c) => "CMSG_FORCE_TURN_RATE_CHANGE_ACK",
            Self::MSG_PVP_LOG_DATA => "MSG_PVP_LOG_DATA_Client",
            Self::CMSG_LEAVE_BATTLEFIELD(c) => "CMSG_LEAVE_BATTLEFIELD",
            Self::CMSG_AREA_SPIRIT_HEALER_QUERY(c) => "CMSG_AREA_SPIRIT_HEALER_QUERY",
            Self::CMSG_AREA_SPIRIT_HEALER_QUEUE(c) => "CMSG_AREA_SPIRIT_HEALER_QUEUE",
            Self::CMSG_WARDEN_DATA(c) => "CMSG_WARDEN_DATA",
            Self::MSG_BATTLEGROUND_PLAYER_POSITIONS => "MSG_BATTLEGROUND_PLAYER_POSITIONS_Client",
            Self::CMSG_PET_STOP_ATTACK(c) => "CMSG_PET_STOP_ATTACK",
            Self::CMSG_BATTLEMASTER_JOIN(c) => "CMSG_BATTLEMASTER_JOIN",
            Self::CMSG_PET_UNLEARN(c) => "CMSG_PET_UNLEARN",
            Self::CMSG_PET_SPELL_AUTOCAST(c) => "CMSG_PET_SPELL_AUTOCAST",
            Self::CMSG_GUILD_INFO_TEXT(c) => "CMSG_GUILD_INFO_TEXT",
            Self::CMSG_ACTIVATETAXIEXPRESS(c) => "CMSG_ACTIVATETAXIEXPRESS",
            Self::CMSG_SET_FACTION_INACTIVE(c) => "CMSG_SET_FACTION_INACTIVE",
            Self::CMSG_SET_WATCHED_FACTION(c) => "CMSG_SET_WATCHED_FACTION",
            Self::CMSG_RESET_INSTANCES => "CMSG_RESET_INSTANCES",
            Self::MSG_RAID_TARGET_UPDATE(c) => "MSG_RAID_TARGET_UPDATE_Client",
            Self::MSG_RAID_READY_CHECK(c) => "MSG_RAID_READY_CHECK_Client",
            Self::CMSG_GMSURVEY_SUBMIT(c) => "CMSG_GMSURVEY_SUBMIT",
        }
    }
...
impl ServerOpcodeMessage {
    fn read_opcodes(opcode: u16, body_size: u32, mut r: &[u8]) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x0067 => Ok(Self::SMSG_FRIEND_LIST(<SMSG_FRIEND_LIST as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0067, size: body_size, io, } } else { a } })?)),
            ...
            0x006B => Ok(Self::SMSG_IGNORE_LIST(<SMSG_IGNORE_LIST as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x006B, size: body_size, io, } } else { a } })?)),
            ...
            0x0113 => Ok(Self::SMSG_OPEN_CONTAINER(<SMSG_OPEN_CONTAINER as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0113, size: body_size, io, } } else { a } })?)),
            0x0115 => Ok(Self::SMSG_INSPECT(<SMSG_INSPECT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0115, size: body_size, io, } } else { a } })?)),
            ...
            0x0130 => Ok(Self::SMSG_CAST_RESULT(<SMSG_CAST_RESULT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0130, size: body_size, io, } } else { a } })?)),
            ...
            0x016F => Ok(Self::SMSG_DISMOUNTRESULT(<SMSG_DISMOUNTRESULT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x016F, size: body_size, io, } } else { a } })?)),
            ...
            0x01D6 => Ok(Self::SMSG_RESISTLOG(<SMSG_RESISTLOG as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x01D6, size: body_size, io, } } else { a } })?)),
            ...
            0x0299 => Ok(Self::SMSG_MEETINGSTONE_MEMBER_ADDED(<SMSG_MEETINGSTONE_MEMBER_ADDED as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0299, size: body_size, io, } } else { a } })?)),
            ...
            0x02A7 => Ok(Self::SMSG_GAMEOBJECT_RESET_STATE(<SMSG_GAMEOBJECT_RESET_STATE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x02A7, size: body_size, io, } } else { a } })?)),
            ...
            0x02BB => Ok(Self::SMSG_MEETINGSTONE_JOINFAILED(<SMSG_MEETINGSTONE_JOINFAILED as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x02BB, size: body_size, io, } } else { a } })?)),
            ...
            0x02E0 => Ok(Self::MSG_PVP_LOG_DATA(<MSG_PVP_LOG_DATA_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x02E0, size: body_size, io, } } else { a } })?)),
            ...
            0x02FB => Ok(Self::SMSG_COMPRESSED_MOVES(<SMSG_COMPRESSED_MOVES as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x02FB, size: body_size, io, } } else { a } })?)),
            ...
            0x0332 => Ok(Self::SMSG_EXPECTED_SPAM_RECORDS(<SMSG_EXPECTED_SPAM_RECORDS as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0332, size: body_size, io, } } else { a } })?)),
            0x033B => Ok(Self::SMSG_DEFENSE_MESSAGE(<SMSG_DEFENSE_MESSAGE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x033B, size: body_size, io, } } else { a } })?)),
    ...
    pub fn to_test_case_string(&self) -> Option<String> {
        match self {
            ...
            Self::SMSG_FRIEND_LIST(c) => c.to_test_case_string(),
            Self::SMSG_FRIEND_STATUS(c) => c.to_test_case_string(),
            Self::SMSG_IGNORE_LIST(c) => c.to_test_case_string(),
            ...
            Self::SMSG_OPEN_CONTAINER(c) => c.to_test_case_string(),
            Self::SMSG_INSPECT(c) => c.to_test_case_string(),
            ...
            Self::SMSG_CAST_RESULT(c) => c.to_test_case_string(),
            ...
            Self::SMSG_DISMOUNTRESULT(c) => c.to_test_case_string(),
            Self::SMSG_MOUNTSPECIAL_ANIM(c) => c.to_test_case_string(),
            Self::SMSG_PET_TAME_FAILURE(c) => c.to_test_case_string(),
            Self::SMSG_PET_NAME_INVALID => SMSG_PET_NAME_INVALID{}.to_test_case_string(),
            ...
            Self::MSG_MINIMAP_PING(c) => c.to_test_case_string(),
            Self::SMSG_RESISTLOG(c) => c.to_test_case_string(),
            ...
            Self::SMSG_MEETINGSTONE_COMPLETE => SMSG_MEETINGSTONE_COMPLETE{}.to_test_case_string(),
            Self::SMSG_MEETINGSTONE_IN_PROGRESS => SMSG_MEETINGSTONE_IN_PROGRESS{}.to_test_case_string(),
            Self::SMSG_MEETINGSTONE_MEMBER_ADDED(c) => c.to_test_case_string(),
            ...
            Self::SMSG_GAMEOBJECT_RESET_STATE(c) => c.to_test_case_string(),
            ...
            Self::SMSG_MEETINGSTONE_JOINFAILED(c) => c.to_test_case_string(),
            ...
            Self::MSG_PVP_LOG_DATA(c) => c.to_test_case_string(),
            ...
            Self::SMSG_COMPRESSED_MOVES(c) => c.to_test_case_string(),
            Self::SMSG_CHAT_RESTRICTED => SMSG_CHAT_RESTRICTED{}.to_test_case_string(),
            ...
            Self::SMSG_EXPECTED_SPAM_RECORDS(c) => c.to_test_case_string(),
    ...
    pub fn message_name(&self) -> &'static str {
        match self {
            ...
            Self::MSG_MOVE_WATER_WALK(c) => "MSG_MOVE_WATER_WALK",
            Self::MSG_PETITION_RENAME(c) => "MSG_PETITION_RENAME",
            Self::SMSG_CHAR_CREATE(c) => "SMSG_CHAR_CREATE",
            Self::SMSG_CHAR_ENUM(c) => "SMSG_CHAR_ENUM",
            Self::SMSG_CHAR_DELETE(c) => "SMSG_CHAR_DELETE",
            Self::SMSG_NEW_WORLD(c) => "SMSG_NEW_WORLD",
            Self::SMSG_TRANSFER_PENDING(c) => "SMSG_TRANSFER_PENDING",
            Self::SMSG_TRANSFER_ABORTED(c) => "SMSG_TRANSFER_ABORTED",
            Self::SMSG_CHARACTER_LOGIN_FAILED(c) => "SMSG_CHARACTER_LOGIN_FAILED",
            Self::SMSG_LOGIN_SETTIMESPEED(c) => "SMSG_LOGIN_SETTIMESPEED",
            Self::SMSG_LOGOUT_RESPONSE(c) => "SMSG_LOGOUT_RESPONSE",
            Self::SMSG_LOGOUT_COMPLETE => "SMSG_LOGOUT_COMPLETE",
            Self::SMSG_LOGOUT_CANCEL_ACK => "SMSG_LOGOUT_CANCEL_ACK",
            Self::SMSG_NAME_QUERY_RESPONSE(c) => "SMSG_NAME_QUERY_RESPONSE",
            Self::SMSG_PET_NAME_QUERY_RESPONSE(c) => "SMSG_PET_NAME_QUERY_RESPONSE",
            Self::SMSG_GUILD_QUERY_RESPONSE(c) => "SMSG_GUILD_QUERY_RESPONSE",
            Self::SMSG_ITEM_QUERY_SINGLE_RESPONSE(c) => "SMSG_ITEM_QUERY_SINGLE_RESPONSE",
            Self::SMSG_PAGE_TEXT_QUERY_RESPONSE(c) => "SMSG_PAGE_TEXT_QUERY_RESPONSE",
            Self::SMSG_QUEST_QUERY_RESPONSE(c) => "SMSG_QUEST_QUERY_RESPONSE",
            Self::SMSG_GAMEOBJECT_QUERY_RESPONSE(c) => "SMSG_GAMEOBJECT_QUERY_RESPONSE",
            Self::SMSG_CREATURE_QUERY_RESPONSE(c) => "SMSG_CREATURE_QUERY_RESPONSE",
            Self::SMSG_WHO(c) => "SMSG_WHO",
            Self::SMSG_WHOIS(c) => "SMSG_WHOIS",
            Self::SMSG_FRIEND_LIST(c) => "SMSG_FRIEND_LIST",
            Self::SMSG_FRIEND_STATUS(c) => "SMSG_FRIEND_STATUS",
            Self::SMSG_IGNORE_LIST(c) => "SMSG_IGNORE_LIST",
            Self::SMSG_GROUP_INVITE(c) => "SMSG_GROUP_INVITE",
            Self::SMSG_GROUP_DECLINE(c) => "SMSG_GROUP_DECLINE",
            Self::SMSG_GROUP_UNINVITE => "SMSG_GROUP_UNINVITE",
            Self::SMSG_GROUP_SET_LEADER(c) => "SMSG_GROUP_SET_LEADER",
            Self::SMSG_GROUP_DESTROYED => "SMSG_GROUP_DESTROYED",
            Self::SMSG_GROUP_LIST(c) => "SMSG_GROUP_LIST",
            Self::SMSG_PARTY_MEMBER_STATS(c) => "SMSG_PARTY_MEMBER_STATS",
            Self::SMSG_PARTY_COMMAND_RESULT(c) => "SMSG_PARTY_COMMAND_RESULT",
            Self::SMSG_GUILD_INVITE(c) => "SMSG_GUILD_INVITE",
            Self::SMSG_GUILD_INFO(c) => "SMSG_GUILD_INFO",
            Self::SMSG_GUILD_ROSTER(c) => "SMSG_GUILD_ROSTER",
            Self::SMSG_GUILD_EVENT(c) => "SMSG_GUILD_EVENT",
            Self::SMSG_GUILD_COMMAND_RESULT(c) => "SMSG_GUILD_COMMAND_RESULT",
            Self::SMSG_MESSAGECHAT(c) => "SMSG_MESSAGECHAT",
            Self::SMSG_CHANNEL_NOTIFY(c) => "SMSG_CHANNEL_NOTIFY",
            Self::SMSG_CHANNEL_LIST(c) => "SMSG_CHANNEL_LIST",
            Self::SMSG_UPDATE_OBJECT(c) => "SMSG_UPDATE_OBJECT",
            Self::SMSG_DESTROY_OBJECT(c) => "SMSG_DESTROY_OBJECT",
            Self::SMSG_READ_ITEM_OK(c) => "SMSG_READ_ITEM_OK",
            Self::SMSG_READ_ITEM_FAILED(c) => "SMSG_READ_ITEM_FAILED",
            Self::SMSG_ITEM_COOLDOWN(c) => "SMSG_ITEM_COOLDOWN",
            Self::SMSG_GAMEOBJECT_CUSTOM_ANIM(c) => "SMSG_GAMEOBJECT_CUSTOM_ANIM",
            Self::MSG_MOVE_START_FORWARD(c) => "MSG_MOVE_START_FORWARD_Server",
            Self::MSG_MOVE_START_BACKWARD(c) => "MSG_MOVE_START_BACKWARD_Server",
            Self::MSG_MOVE_STOP(c) => "MSG_MOVE_STOP_Server",
            Self::MSG_MOVE_START_STRAFE_LEFT(c) => "MSG_MOVE_START_STRAFE_LEFT_Server",
            Self::MSG_MOVE_START_STRAFE_RIGHT(c) => "MSG_MOVE_START_STRAFE_RIGHT_Server",
            Self::MSG_MOVE_STOP_STRAFE(c) => "MSG_MOVE_STOP_STRAFE_Server",
            Self::MSG_MOVE_JUMP(c) => "MSG_MOVE_JUMP_Server",
            Self::MSG_MOVE_START_TURN_LEFT(c) => "MSG_MOVE_START_TURN_LEFT_Server",
            Self::MSG_MOVE_START_TURN_RIGHT(c) => "MSG_MOVE_START_TURN_RIGHT_Server",
            Self::MSG_MOVE_STOP_TURN(c) => "MSG_MOVE_STOP_TURN_Server",
            Self::MSG_MOVE_START_PITCH_UP(c) => "MSG_MOVE_START_PITCH_UP_Server",
            Self::MSG_MOVE_START_PITCH_DOWN(c) => "MSG_MOVE_START_PITCH_DOWN_Server",
            Self::MSG_MOVE_STOP_PITCH(c) => "MSG_MOVE_STOP_PITCH_Server",
            Self::MSG_MOVE_SET_RUN_MODE(c) => "MSG_MOVE_SET_RUN_MODE_Server",
            Self::MSG_MOVE_SET_WALK_MODE(c) => "MSG_MOVE_SET_WALK_MODE_Server",
            Self::MSG_MOVE_TELEPORT_ACK(c) => "MSG_MOVE_TELEPORT_ACK_Server",
            Self::MSG_MOVE_FALL_LAND(c) => "MSG_MOVE_FALL_LAND_Server",
            Self::MSG_MOVE_START_SWIM(c) => "MSG_MOVE_START_SWIM_Server",
            Self::MSG_MOVE_STOP_SWIM(c) => "MSG_MOVE_STOP_SWIM_Server",
            Self::MSG_MOVE_SET_FACING(c) => "MSG_MOVE_SET_FACING_Server",
            Self::MSG_MOVE_SET_PITCH(c) => "MSG_MOVE_SET_PITCH_Server",
            Self::SMSG_MONSTER_MOVE(c) => "SMSG_MONSTER_MOVE",
            Self::SMSG_MOVE_WATER_WALK(c) => "SMSG_MOVE_WATER_WALK",
            Self::SMSG_MOVE_LAND_WALK(c) => "SMSG_MOVE_LAND_WALK",
            Self::SMSG_FORCE_RUN_SPEED_CHANGE(c) => "SMSG_FORCE_RUN_SPEED_CHANGE",
            Self::SMSG_FORCE_RUN_BACK_SPEED_CHANGE(c) => "SMSG_FORCE_RUN_BACK_SPEED_CHANGE",
            Self::SMSG_FORCE_SWIM_SPEED_CHANGE(c) => "SMSG_FORCE_SWIM_SPEED_CHANGE",
            Self::SMSG_FORCE_MOVE_ROOT(c) => "SMSG_FORCE_MOVE_ROOT",
            Self::SMSG_FORCE_MOVE_UNROOT(c) => "SMSG_FORCE_MOVE_UNROOT",
            Self::MSG_MOVE_HEARTBEAT(c) => "MSG_MOVE_HEARTBEAT_Server",
            Self::SMSG_MOVE_KNOCK_BACK(c) => "SMSG_MOVE_KNOCK_BACK",
            Self::SMSG_MOVE_FEATHER_FALL(c) => "SMSG_MOVE_FEATHER_FALL",
            Self::SMSG_MOVE_NORMAL_FALL(c) => "SMSG_MOVE_NORMAL_FALL",
            Self::SMSG_MOVE_SET_HOVER(c) => "SMSG_MOVE_SET_HOVER",
            Self::SMSG_MOVE_UNSET_HOVER(c) => "SMSG_MOVE_UNSET_HOVER",
            Self::SMSG_TRIGGER_CINEMATIC(c) => "SMSG_TRIGGER_CINEMATIC",
            Self::SMSG_TUTORIAL_FLAGS(c) => "SMSG_TUTORIAL_FLAGS",
            Self::SMSG_EMOTE(c) => "SMSG_EMOTE",
            Self::SMSG_TEXT_EMOTE(c) => "SMSG_TEXT_EMOTE",
            Self::SMSG_INVENTORY_CHANGE_FAILURE(c) => "SMSG_INVENTORY_CHANGE_FAILURE",
            Self::SMSG_OPEN_CONTAINER(c) => "SMSG_OPEN_CONTAINER",
            Self::SMSG_INSPECT(c) => "SMSG_INSPECT",
            Self::SMSG_TRADE_STATUS(c) => "SMSG_TRADE_STATUS",
            Self::SMSG_TRADE_STATUS_EXTENDED(c) => "SMSG_TRADE_STATUS_EXTENDED",
            Self::SMSG_INITIALIZE_FACTIONS(c) => "SMSG_INITIALIZE_FACTIONS",
            Self::SMSG_SET_FACTION_VISIBLE(c) => "SMSG_SET_FACTION_VISIBLE",
            Self::SMSG_SET_FACTION_STANDING(c) => "SMSG_SET_FACTION_STANDING",
            Self::SMSG_SET_PROFICIENCY(c) => "SMSG_SET_PROFICIENCY",
            Self::SMSG_ACTION_BUTTONS(c) => "SMSG_ACTION_BUTTONS",
            Self::SMSG_INITIAL_SPELLS(c) => "SMSG_INITIAL_SPELLS",
            Self::SMSG_LEARNED_SPELL(c) => "SMSG_LEARNED_SPELL",
            Self::SMSG_SUPERCEDED_SPELL(c) => "SMSG_SUPERCEDED_SPELL",
            Self::SMSG_CAST_RESULT(c) => "SMSG_CAST_RESULT",
            Self::SMSG_SPELL_START(c) => "SMSG_SPELL_START",
            Self::SMSG_SPELL_GO(c) => "SMSG_SPELL_GO",
            Self::SMSG_SPELL_FAILURE(c) => "SMSG_SPELL_FAILURE",
            Self::SMSG_SPELL_COOLDOWN(c) => "SMSG_SPELL_COOLDOWN",
            Self::SMSG_COOLDOWN_EVENT(c) => "SMSG_COOLDOWN_EVENT",
            Self::SMSG_UPDATE_AURA_DURATION(c) => "SMSG_UPDATE_AURA_DURATION",
            Self::SMSG_PET_CAST_FAILED(c) => "SMSG_PET_CAST_FAILED",
            Self::MSG_CHANNEL_START(c) => "MSG_CHANNEL_START_Server",
            Self::MSG_CHANNEL_UPDATE(c) => "MSG_CHANNEL_UPDATE_Server",
            Self::SMSG_AI_REACTION(c) => "SMSG_AI_REACTION",
            Self::SMSG_ATTACKSTART(c) => "SMSG_ATTACKSTART",
            Self::SMSG_ATTACKSTOP(c) => "SMSG_ATTACKSTOP",
            Self::SMSG_ATTACKSWING_NOTINRANGE => "SMSG_ATTACKSWING_NOTINRANGE",
            Self::SMSG_ATTACKSWING_BADFACING => "SMSG_ATTACKSWING_BADFACING",
            Self::SMSG_ATTACKSWING_NOTSTANDING => "SMSG_ATTACKSWING_NOTSTANDING",
            ...
            Self::SMSG_ATTACKERSTATEUPDATE(c) => "SMSG_ATTACKERSTATEUPDATE",
            Self::SMSG_CANCEL_COMBAT => "SMSG_CANCEL_COMBAT",
            Self::SMSG_SPELLHEALLOG(c) => "SMSG_SPELLHEALLOG",
            Self::SMSG_SPELLENERGIZELOG(c) => "SMSG_SPELLENERGIZELOG",
            Self::SMSG_BINDPOINTUPDATE(c) => "SMSG_BINDPOINTUPDATE",
            Self::SMSG_PLAYERBOUND(c) => "SMSG_PLAYERBOUND",
            Self::SMSG_CLIENT_CONTROL_UPDATE(c) => "SMSG_CLIENT_CONTROL_UPDATE",
            Self::SMSG_RESURRECT_REQUEST(c) => "SMSG_RESURRECT_REQUEST",
            Self::SMSG_LOOT_RESPONSE(c) => "SMSG_LOOT_RESPONSE",
            Self::SMSG_LOOT_RELEASE_RESPONSE(c) => "SMSG_LOOT_RELEASE_RESPONSE",
            Self::SMSG_LOOT_REMOVED(c) => "SMSG_LOOT_REMOVED",
            Self::SMSG_LOOT_MONEY_NOTIFY(c) => "SMSG_LOOT_MONEY_NOTIFY",
            Self::SMSG_LOOT_CLEAR_MONEY => "SMSG_LOOT_CLEAR_MONEY",
            Self::SMSG_ITEM_PUSH_RESULT(c) => "SMSG_ITEM_PUSH_RESULT",
            Self::SMSG_DUEL_REQUESTED(c) => "SMSG_DUEL_REQUESTED",
            Self::SMSG_DUEL_OUTOFBOUNDS => "SMSG_DUEL_OUTOFBOUNDS",
            Self::SMSG_DUEL_INBOUNDS => "SMSG_DUEL_INBOUNDS",
            Self::SMSG_DUEL_COMPLETE(c) => "SMSG_DUEL_COMPLETE",
            Self::SMSG_DUEL_WINNER(c) => "SMSG_DUEL_WINNER",
            Self::SMSG_MOUNTRESULT(c) => "SMSG_MOUNTRESULT",
            Self::SMSG_DISMOUNTRESULT(c) => "SMSG_DISMOUNTRESULT",
            Self::SMSG_MOUNTSPECIAL_ANIM(c) => "SMSG_MOUNTSPECIAL_ANIM",
            Self::SMSG_PET_TAME_FAILURE(c) => "SMSG_PET_TAME_FAILURE",
            Self::SMSG_PET_NAME_INVALID => "SMSG_PET_NAME_INVALID",
            Self::SMSG_PET_SPELLS(c) => "SMSG_PET_SPELLS",
            Self::SMSG_PET_MODE(c) => "SMSG_PET_MODE",
            Self::SMSG_GOSSIP_MESSAGE(c) => "SMSG_GOSSIP_MESSAGE",
            Self::SMSG_GOSSIP_COMPLETE => "SMSG_GOSSIP_COMPLETE",
            Self::SMSG_NPC_TEXT_UPDATE(c) => "SMSG_NPC_TEXT_UPDATE",
            Self::SMSG_QUESTGIVER_STATUS(c) => "SMSG_QUESTGIVER_STATUS",
            Self::SMSG_QUESTGIVER_QUEST_LIST(c) => "SMSG_QUESTGIVER_QUEST_LIST",
            Self::SMSG_QUESTGIVER_QUEST_DETAILS(c) => "SMSG_QUESTGIVER_QUEST_DETAILS",
            Self::SMSG_QUESTGIVER_REQUEST_ITEMS(c) => "SMSG_QUESTGIVER_REQUEST_ITEMS",
            Self::SMSG_QUESTGIVER_OFFER_REWARD(c) => "SMSG_QUESTGIVER_OFFER_REWARD",
            Self::SMSG_QUESTGIVER_QUEST_INVALID(c) => "SMSG_QUESTGIVER_QUEST_INVALID",
            Self::SMSG_QUESTGIVER_QUEST_COMPLETE(c) => "SMSG_QUESTGIVER_QUEST_COMPLETE",
            Self::SMSG_QUESTGIVER_QUEST_FAILED(c) => "SMSG_QUESTGIVER_QUEST_FAILED",
            Self::SMSG_QUESTLOG_FULL => "SMSG_QUESTLOG_FULL",
            Self::SMSG_QUESTUPDATE_FAILED(c) => "SMSG_QUESTUPDATE_FAILED",
            Self::SMSG_QUESTUPDATE_FAILEDTIMER(c) => "SMSG_QUESTUPDATE_FAILEDTIMER",
            Self::SMSG_QUESTUPDATE_COMPLETE(c) => "SMSG_QUESTUPDATE_COMPLETE",
            Self::SMSG_QUESTUPDATE_ADD_KILL(c) => "SMSG_QUESTUPDATE_ADD_KILL",
            Self::SMSG_QUESTUPDATE_ADD_ITEM(c) => "SMSG_QUESTUPDATE_ADD_ITEM",
            Self::SMSG_QUEST_CONFIRM_ACCEPT(c) => "SMSG_QUEST_CONFIRM_ACCEPT",
            Self::SMSG_LIST_INVENTORY(c) => "SMSG_LIST_INVENTORY",
            Self::SMSG_SELL_ITEM(c) => "SMSG_SELL_ITEM",
            Self::SMSG_BUY_ITEM(c) => "SMSG_BUY_ITEM",
            Self::SMSG_BUY_FAILED(c) => "SMSG_BUY_FAILED",
            Self::SMSG_SHOWTAXINODES(c) => "SMSG_SHOWTAXINODES",
            Self::SMSG_TAXINODE_STATUS(c) => "SMSG_TAXINODE_STATUS",
            Self::SMSG_ACTIVATETAXIREPLY(c) => "SMSG_ACTIVATETAXIREPLY",
            Self::SMSG_NEW_TAXI_PATH => "SMSG_NEW_TAXI_PATH",
            Self::SMSG_TRAINER_LIST(c) => "SMSG_TRAINER_LIST",
            Self::SMSG_TRAINER_BUY_SUCCEEDED(c) => "SMSG_TRAINER_BUY_SUCCEEDED",
            Self::SMSG_TRAINER_BUY_FAILED(c) => "SMSG_TRAINER_BUY_FAILED",
            Self::SMSG_SHOW_BANK(c) => "SMSG_SHOW_BANK",
            Self::SMSG_BUY_BANK_SLOT_RESULT(c) => "SMSG_BUY_BANK_SLOT_RESULT",
            Self::SMSG_PETITION_SHOWLIST(c) => "SMSG_PETITION_SHOWLIST",
            Self::SMSG_PETITION_SHOW_SIGNATURES(c) => "SMSG_PETITION_SHOW_SIGNATURES",
            Self::SMSG_PETITION_SIGN_RESULTS(c) => "SMSG_PETITION_SIGN_RESULTS",
            Self::SMSG_TURN_IN_PETITION_RESULTS(c) => "SMSG_TURN_IN_PETITION_RESULTS",
            Self::SMSG_PETITION_QUERY_RESPONSE(c) => "SMSG_PETITION_QUERY_RESPONSE",
            Self::SMSG_FISH_NOT_HOOKED => "SMSG_FISH_NOT_HOOKED",
            Self::SMSG_FISH_ESCAPED => "SMSG_FISH_ESCAPED",
            Self::SMSG_NOTIFICATION(c) => "SMSG_NOTIFICATION",
            Self::SMSG_PLAYED_TIME(c) => "SMSG_PLAYED_TIME",
            Self::SMSG_QUERY_TIME_RESPONSE(c) => "SMSG_QUERY_TIME_RESPONSE",
            Self::SMSG_LOG_XPGAIN(c) => "SMSG_LOG_XPGAIN",
            Self::SMSG_LEVELUP_INFO(c) => "SMSG_LEVELUP_INFO",
            Self::MSG_MINIMAP_PING(c) => "MSG_MINIMAP_PING_Server",
            Self::SMSG_RESISTLOG(c) => "SMSG_RESISTLOG",
            Self::SMSG_ENCHANTMENTLOG(c) => "SMSG_ENCHANTMENTLOG",
            Self::SMSG_START_MIRROR_TIMER(c) => "SMSG_START_MIRROR_TIMER",
            Self::SMSG_PAUSE_MIRROR_TIMER(c) => "SMSG_PAUSE_MIRROR_TIMER",
            Self::SMSG_STOP_MIRROR_TIMER(c) => "SMSG_STOP_MIRROR_TIMER",
            Self::SMSG_PONG(c) => "SMSG_PONG",
            Self::SMSG_CLEAR_COOLDOWN(c) => "SMSG_CLEAR_COOLDOWN",
            Self::SMSG_GAMEOBJECT_PAGETEXT(c) => "SMSG_GAMEOBJECT_PAGETEXT",
            Self::SMSG_SPELL_DELAYED(c) => "SMSG_SPELL_DELAYED",
            Self::SMSG_ITEM_TIME_UPDATE(c) => "SMSG_ITEM_TIME_UPDATE",
            Self::SMSG_ITEM_ENCHANT_TIME_UPDATE(c) => "SMSG_ITEM_ENCHANT_TIME_UPDATE",
            Self::SMSG_AUTH_CHALLENGE(c) => "SMSG_AUTH_CHALLENGE",
            Self::SMSG_AUTH_RESPONSE(c) => "SMSG_AUTH_RESPONSE",
            Self::MSG_SAVE_GUILD_EMBLEM(c) => "MSG_SAVE_GUILD_EMBLEM_Server",
            Self::SMSG_PLAY_SPELL_VISUAL(c) => "SMSG_PLAY_SPELL_VISUAL",
            Self::SMSG_PARTYKILLLOG(c) => "SMSG_PARTYKILLLOG",
            Self::SMSG_COMPRESSED_UPDATE_OBJECT(c) => "SMSG_COMPRESSED_UPDATE_OBJECT",
            Self::SMSG_PLAY_SPELL_IMPACT(c) => "SMSG_PLAY_SPELL_IMPACT",
            Self::SMSG_EXPLORATION_EXPERIENCE(c) => "SMSG_EXPLORATION_EXPERIENCE",
            Self::MSG_RANDOM_ROLL(c) => "MSG_RANDOM_ROLL_Server",
            Self::SMSG_ENVIRONMENTAL_DAMAGE_LOG(c) => "SMSG_ENVIRONMENTAL_DAMAGE_LOG",
            Self::MSG_LOOKING_FOR_GROUP(c) => "MSG_LOOKING_FOR_GROUP_Server",
            Self::SMSG_REMOVED_SPELL(c) => "SMSG_REMOVED_SPELL",
            Self::SMSG_GMTICKET_CREATE(c) => "SMSG_GMTICKET_CREATE",
            Self::SMSG_GMTICKET_UPDATETEXT(c) => "SMSG_GMTICKET_UPDATETEXT",
            Self::SMSG_ACCOUNT_DATA_TIMES(c) => "SMSG_ACCOUNT_DATA_TIMES",
            Self::SMSG_GMTICKET_GETTICKET(c) => "SMSG_GMTICKET_GETTICKET",
            Self::SMSG_GAMEOBJECT_SPAWN_ANIM(c) => "SMSG_GAMEOBJECT_SPAWN_ANIM",
            Self::SMSG_GAMEOBJECT_DESPAWN_ANIM(c) => "SMSG_GAMEOBJECT_DESPAWN_ANIM",
            Self::MSG_CORPSE_QUERY(c) => "MSG_CORPSE_QUERY_Server",
            Self::SMSG_GMTICKET_DELETETICKET(c) => "SMSG_GMTICKET_DELETETICKET",
            Self::SMSG_CHAT_WRONG_FACTION => "SMSG_CHAT_WRONG_FACTION",
            Self::SMSG_GMTICKET_SYSTEMSTATUS(c) => "SMSG_GMTICKET_SYSTEMSTATUS",
            Self::SMSG_SET_REST_START(c) => "SMSG_SET_REST_START",
            Self::SMSG_SPIRIT_HEALER_CONFIRM(c) => "SMSG_SPIRIT_HEALER_CONFIRM",
            Self::SMSG_GOSSIP_POI(c) => "SMSG_GOSSIP_POI",
            Self::SMSG_LOGIN_VERIFY_WORLD(c) => "SMSG_LOGIN_VERIFY_WORLD",
            Self::SMSG_SEND_MAIL_RESULT(c) => "SMSG_SEND_MAIL_RESULT",
            Self::SMSG_MAIL_LIST_RESULT(c) => "SMSG_MAIL_LIST_RESULT",
            Self::SMSG_BATTLEFIELD_LIST(c) => "SMSG_BATTLEFIELD_LIST",
            Self::SMSG_ITEM_TEXT_QUERY_RESPONSE(c) => "SMSG_ITEM_TEXT_QUERY_RESPONSE",
            Self::SMSG_SPELLLOGMISS(c) => "SMSG_SPELLLOGMISS",
            Self::SMSG_SPELLLOGEXECUTE(c) => "SMSG_SPELLLOGEXECUTE",
            Self::SMSG_PERIODICAURALOG(c) => "SMSG_PERIODICAURALOG",
            Self::SMSG_SPELLDAMAGESHIELD(c) => "SMSG_SPELLDAMAGESHIELD",
            Self::SMSG_SPELLNONMELEEDAMAGELOG(c) => "SMSG_SPELLNONMELEEDAMAGELOG",
            Self::SMSG_ZONE_UNDER_ATTACK(c) => "SMSG_ZONE_UNDER_ATTACK",
            Self::MSG_AUCTION_HELLO(c) => "MSG_AUCTION_HELLO_Server",
            Self::SMSG_AUCTION_COMMAND_RESULT(c) => "SMSG_AUCTION_COMMAND_RESULT",
            Self::SMSG_AUCTION_LIST_RESULT(c) => "SMSG_AUCTION_LIST_RESULT",
            Self::SMSG_AUCTION_OWNER_LIST_RESULT(c) => "SMSG_AUCTION_OWNER_LIST_RESULT",
            Self::SMSG_AUCTION_BIDDER_NOTIFICATION(c) => "SMSG_AUCTION_BIDDER_NOTIFICATION",
            Self::SMSG_AUCTION_OWNER_NOTIFICATION(c) => "SMSG_AUCTION_OWNER_NOTIFICATION",
            Self::SMSG_PROCRESIST(c) => "SMSG_PROCRESIST",
            Self::SMSG_DISPEL_FAILED(c) => "SMSG_DISPEL_FAILED",
            Self::SMSG_SPELLORDAMAGE_IMMUNE(c) => "SMSG_SPELLORDAMAGE_IMMUNE",
            Self::SMSG_AUCTION_BIDDER_LIST_RESULT(c) => "SMSG_AUCTION_BIDDER_LIST_RESULT",
            Self::SMSG_SET_FLAT_SPELL_MODIFIER(c) => "SMSG_SET_FLAT_SPELL_MODIFIER",
            Self::SMSG_SET_PCT_SPELL_MODIFIER(c) => "SMSG_SET_PCT_SPELL_MODIFIER",
            Self::SMSG_CORPSE_RECLAIM_DELAY(c) => "SMSG_CORPSE_RECLAIM_DELAY",
            Self::MSG_LIST_STABLED_PETS(c) => "MSG_LIST_STABLED_PETS_Server",
            Self::SMSG_STABLE_RESULT(c) => "SMSG_STABLE_RESULT",
            Self::SMSG_PLAY_MUSIC(c) => "SMSG_PLAY_MUSIC",
            Self::SMSG_PLAY_OBJECT_SOUND(c) => "SMSG_PLAY_OBJECT_SOUND",
            Self::SMSG_SPELLDISPELLOG(c) => "SMSG_SPELLDISPELLOG",
            Self::MSG_QUERY_NEXT_MAIL_TIME(c) => "MSG_QUERY_NEXT_MAIL_TIME_Server",
            Self::SMSG_RECEIVED_MAIL(c) => "SMSG_RECEIVED_MAIL",
            Self::SMSG_RAID_GROUP_ONLY(c) => "SMSG_RAID_GROUP_ONLY",
            Self::SMSG_PVP_CREDIT(c) => "SMSG_PVP_CREDIT",
            Self::SMSG_AUCTION_REMOVED_NOTIFICATION(c) => "SMSG_AUCTION_REMOVED_NOTIFICATION",
            Self::SMSG_SERVER_MESSAGE(c) => "SMSG_SERVER_MESSAGE",
            Self::SMSG_MEETINGSTONE_SETQUEUE(c) => "SMSG_MEETINGSTONE_SETQUEUE",
            Self::SMSG_MEETINGSTONE_COMPLETE => "SMSG_MEETINGSTONE_COMPLETE",
            Self::SMSG_MEETINGSTONE_IN_PROGRESS => "SMSG_MEETINGSTONE_IN_PROGRESS",
            Self::SMSG_MEETINGSTONE_MEMBER_ADDED(c) => "SMSG_MEETINGSTONE_MEMBER_ADDED",
            Self::SMSG_CANCEL_AUTO_REPEAT => "SMSG_CANCEL_AUTO_REPEAT",
            Self::SMSG_STANDSTATE_UPDATE(c) => "SMSG_STANDSTATE_UPDATE",
            Self::SMSG_LOOT_ALL_PASSED(c) => "SMSG_LOOT_ALL_PASSED",
            Self::SMSG_LOOT_ROLL_WON(c) => "SMSG_LOOT_ROLL_WON",
            Self::SMSG_LOOT_START_ROLL(c) => "SMSG_LOOT_START_ROLL",
            Self::SMSG_LOOT_ROLL(c) => "SMSG_LOOT_ROLL",
            Self::SMSG_LOOT_MASTER_LIST(c) => "SMSG_LOOT_MASTER_LIST",
            Self::SMSG_SET_FORCED_REACTIONS(c) => "SMSG_SET_FORCED_REACTIONS",
            Self::SMSG_SPELL_FAILED_OTHER(c) => "SMSG_SPELL_FAILED_OTHER",
            Self::SMSG_GAMEOBJECT_RESET_STATE(c) => "SMSG_GAMEOBJECT_RESET_STATE",
            Self::SMSG_CHAT_PLAYER_NOT_FOUND(c) => "SMSG_CHAT_PLAYER_NOT_FOUND",
            Self::MSG_TALENT_WIPE_CONFIRM(c) => "MSG_TALENT_WIPE_CONFIRM_Server",
            Self::SMSG_SUMMON_REQUEST(c) => "SMSG_SUMMON_REQUEST",
            Self::SMSG_MONSTER_MOVE_TRANSPORT(c) => "SMSG_MONSTER_MOVE_TRANSPORT",
            Self::SMSG_PET_BROKEN => "SMSG_PET_BROKEN",
            Self::MSG_MOVE_FEATHER_FALL(c) => "MSG_MOVE_FEATHER_FALL_Server",
            Self::SMSG_FEIGN_DEATH_RESISTED => "SMSG_FEIGN_DEATH_RESISTED",
            Self::SMSG_DUEL_COUNTDOWN(c) => "SMSG_DUEL_COUNTDOWN",
            Self::SMSG_AREA_TRIGGER_MESSAGE(c) => "SMSG_AREA_TRIGGER_MESSAGE",
            Self::SMSG_MEETINGSTONE_JOINFAILED(c) => "SMSG_MEETINGSTONE_JOINFAILED",
            Self::SMSG_PLAYER_SKINNED(c) => "SMSG_PLAYER_SKINNED",
            Self::SMSG_DURABILITY_DAMAGE_DEATH => "SMSG_DURABILITY_DAMAGE_DEATH",
            Self::SMSG_INIT_WORLD_STATES(c) => "SMSG_INIT_WORLD_STATES",
            Self::SMSG_UPDATE_WORLD_STATE(c) => "SMSG_UPDATE_WORLD_STATE",
            Self::SMSG_ITEM_NAME_QUERY_RESPONSE(c) => "SMSG_ITEM_NAME_QUERY_RESPONSE",
            Self::SMSG_PET_ACTION_FEEDBACK(c) => "SMSG_PET_ACTION_FEEDBACK",
            Self::SMSG_CHAR_RENAME(c) => "SMSG_CHAR_RENAME",
            Self::SMSG_INSTANCE_SAVE_CREATED(c) => "SMSG_INSTANCE_SAVE_CREATED",
            Self::SMSG_RAID_INSTANCE_INFO(c) => "SMSG_RAID_INSTANCE_INFO",
            Self::SMSG_PLAY_SOUND(c) => "SMSG_PLAY_SOUND",
            Self::SMSG_BATTLEFIELD_STATUS(c) => "SMSG_BATTLEFIELD_STATUS",
            Self::MSG_INSPECT_HONOR_STATS(c) => "MSG_INSPECT_HONOR_STATS_Server",
            Self::SMSG_FORCE_WALK_SPEED_CHANGE(c) => "SMSG_FORCE_WALK_SPEED_CHANGE",
            Self::SMSG_FORCE_SWIM_BACK_SPEED_CHANGE(c) => "SMSG_FORCE_SWIM_BACK_SPEED_CHANGE",
            Self::SMSG_FORCE_TURN_RATE_CHANGE(c) => "SMSG_FORCE_TURN_RATE_CHANGE",
            Self::MSG_PVP_LOG_DATA(c) => "MSG_PVP_LOG_DATA_Server",
            Self::SMSG_AREA_SPIRIT_HEALER_TIME(c) => "SMSG_AREA_SPIRIT_HEALER_TIME",
            Self::SMSG_WARDEN_DATA(c) => "SMSG_WARDEN_DATA",
            Self::SMSG_GROUP_JOINED_BATTLEGROUND(c) => "SMSG_GROUP_JOINED_BATTLEGROUND",
            Self::MSG_BATTLEGROUND_PLAYER_POSITIONS(c) => "MSG_BATTLEGROUND_PLAYER_POSITIONS_Server",
            Self::SMSG_BINDER_CONFIRM(c) => "SMSG_BINDER_CONFIRM",
            Self::SMSG_BATTLEGROUND_PLAYER_JOINED(c) => "SMSG_BATTLEGROUND_PLAYER_JOINED",
            Self::SMSG_BATTLEGROUND_PLAYER_LEFT(c) => "SMSG_BATTLEGROUND_PLAYER_LEFT",
            Self::SMSG_ADDON_INFO(c) => "SMSG_ADDON_INFO",
            Self::SMSG_PET_UNLEARN_CONFIRM(c) => "SMSG_PET_UNLEARN_CONFIRM",
            Self::SMSG_PARTY_MEMBER_STATS_FULL(c) => "SMSG_PARTY_MEMBER_STATS_FULL",
            Self::SMSG_WEATHER(c) => "SMSG_WEATHER",
            Self::SMSG_RAID_INSTANCE_MESSAGE(c) => "SMSG_RAID_INSTANCE_MESSAGE",
            Self::SMSG_COMPRESSED_MOVES(c) => "SMSG_COMPRESSED_MOVES",
            Self::SMSG_CHAT_RESTRICTED => "SMSG_CHAT_RESTRICTED",
            Self::SMSG_SPLINE_SET_RUN_SPEED(c) => "SMSG_SPLINE_SET_RUN_SPEED",
            Self::SMSG_SPLINE_SET_RUN_BACK_SPEED(c) => "SMSG_SPLINE_SET_RUN_BACK_SPEED",
            Self::SMSG_SPLINE_SET_SWIM_SPEED(c) => "SMSG_SPLINE_SET_SWIM_SPEED",
            Self::SMSG_SPLINE_SET_WALK_SPEED(c) => "SMSG_SPLINE_SET_WALK_SPEED",
            Self::SMSG_SPLINE_SET_SWIM_BACK_SPEED(c) => "SMSG_SPLINE_SET_SWIM_BACK_SPEED",
            Self::SMSG_SPLINE_SET_TURN_RATE(c) => "SMSG_SPLINE_SET_TURN_RATE",
            Self::SMSG_SPLINE_MOVE_UNROOT(c) => "SMSG_SPLINE_MOVE_UNROOT",
            Self::SMSG_SPLINE_MOVE_FEATHER_FALL(c) => "SMSG_SPLINE_MOVE_FEATHER_FALL",
            Self::SMSG_SPLINE_MOVE_NORMAL_FALL(c) => "SMSG_SPLINE_MOVE_NORMAL_FALL",
            Self::SMSG_SPLINE_MOVE_SET_HOVER(c) => "SMSG_SPLINE_MOVE_SET_HOVER",
            Self::SMSG_SPLINE_MOVE_UNSET_HOVER(c) => "SMSG_SPLINE_MOVE_UNSET_HOVER",
            Self::SMSG_SPLINE_MOVE_WATER_WALK(c) => "SMSG_SPLINE_MOVE_WATER_WALK",
            Self::SMSG_SPLINE_MOVE_LAND_WALK(c) => "SMSG_SPLINE_MOVE_LAND_WALK",
            Self::SMSG_SPLINE_MOVE_START_SWIM(c) => "SMSG_SPLINE_MOVE_START_SWIM",
            Self::SMSG_SPLINE_MOVE_STOP_SWIM(c) => "SMSG_SPLINE_MOVE_STOP_SWIM",
            Self::SMSG_SPLINE_MOVE_SET_RUN_MODE(c) => "SMSG_SPLINE_MOVE_SET_RUN_MODE",
            Self::SMSG_SPLINE_MOVE_SET_WALK_MODE(c) => "SMSG_SPLINE_MOVE_SET_WALK_MODE",
            Self::MSG_MOVE_TIME_SKIPPED(c) => "MSG_MOVE_TIME_SKIPPED_Server",
            Self::SMSG_SPLINE_MOVE_ROOT(c) => "SMSG_SPLINE_MOVE_ROOT",
            Self::SMSG_INVALIDATE_PLAYER(c) => "SMSG_INVALIDATE_PLAYER",
            Self::SMSG_INSTANCE_RESET(c) => "SMSG_INSTANCE_RESET",
            Self::SMSG_INSTANCE_RESET_FAILED(c) => "SMSG_INSTANCE_RESET_FAILED",
            Self::SMSG_UPDATE_LAST_INSTANCE(c) => "SMSG_UPDATE_LAST_INSTANCE",
            Self::MSG_RAID_TARGET_UPDATE(c) => "MSG_RAID_TARGET_UPDATE_Server",
            Self::MSG_RAID_READY_CHECK(c) => "MSG_RAID_READY_CHECK_Server",
            Self::SMSG_PET_ACTION_SOUND(c) => "SMSG_PET_ACTION_SOUND",
            Self::SMSG_PET_DISMISS_SOUND(c) => "SMSG_PET_DISMISS_SOUND",
            Self::SMSG_GM_TICKET_STATUS_UPDATE(c) => "SMSG_GM_TICKET_STATUS_UPDATE",
            Self::SMSG_UPDATE_INSTANCE_OWNERSHIP(c) => "SMSG_UPDATE_INSTANCE_OWNERSHIP",
            Self::SMSG_SPELLINSTAKILLLOG(c) => "SMSG_SPELLINSTAKILLLOG",
            Self::SMSG_SPELL_UPDATE_CHAIN_TARGETS(c) => "SMSG_SPELL_UPDATE_CHAIN_TARGETS",
            Self::SMSG_EXPECTED_SPAM_RECORDS(c) => "SMSG_EXPECTED_SPAM_RECORDS",
            Self::SMSG_DEFENSE_MESSAGE(c) => "SMSG_DEFENSE_MESSAGE",
        }
    }
