...
pub enum ClientOpcodeMessage {
    ...
    CMSG_ITEM_QUERY_SINGLE(Box<CMSG_ITEM_QUERY_SINGLE>),
...
impl ClientOpcodeMessage {
    fn read_opcodes(opcode: u32, body_size: u32, mut r: &[u8]) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x0056 => Ok(Self::CMSG_ITEM_QUERY_SINGLE(Box::new(<CMSG_ITEM_QUERY_SINGLE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
    ...
    pub fn to_test_case_string(&self) -> Option<String> {
        match self {
            ...
            Self::CMSG_ITEM_QUERY_SINGLE(c) => crate::Message::to_test_case_string(c.as_ref()),
...
impl From<CMSG_ITEM_QUERY_SINGLE> for ClientOpcodeMessage {
    fn from(c: CMSG_ITEM_QUERY_SINGLE) -> Self {
        Self::CMSG_ITEM_QUERY_SINGLE(Box::new(c))
    }
}
...
pub enum ServerOpcodeMessage {
    ...
    SMSG_FRIEND_LIST(Box<SMSG_FRIEND_LIST>),
    SMSG_FRIEND_STATUS(Box<SMSG_FRIEND_STATUS>),
    SMSG_IGNORE_LIST(Box<SMSG_IGNORE_LIST>),
    ...
    SMSG_CAST_RESULT(Box<SMSG_CAST_RESULT>),
    ...
    SMSG_RESISTLOG(Box<SMSG_RESISTLOG>),
    ...
    MSG_PVP_LOG_DATA(Box<MSG_PVP_LOG_DATA_Server>),
    ...
    SMSG_EXPECTED_SPAM_RECORDS(Box<SMSG_EXPECTED_SPAM_RECORDS>),
...
impl ServerOpcodeMessage {
    fn read_opcodes(opcode: u16, body_size: u32, mut r: &[u8]) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x0067 => Ok(Self::SMSG_FRIEND_LIST(Box::new(<SMSG_FRIEND_LIST as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x006B => Ok(Self::SMSG_IGNORE_LIST(Box::new(<SMSG_IGNORE_LIST as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x0130 => Ok(Self::SMSG_CAST_RESULT(Box::new(<SMSG_CAST_RESULT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x01D6 => Ok(Self::SMSG_RESISTLOG(Box::new(<SMSG_RESISTLOG as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x02E0 => Ok(Self::MSG_PVP_LOG_DATA(Box::new(<MSG_PVP_LOG_DATA_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x0332 => Ok(Self::SMSG_EXPECTED_SPAM_RECORDS(Box::new(<SMSG_EXPECTED_SPAM_RECORDS as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x033B => Ok(Self::SMSG_DEFENSE_MESSAGE(Box::new(<SMSG_DEFENSE_MESSAGE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
    ...
    pub fn to_test_case_string(&self) -> Option<String> {
        match self {
            ...
            Self::SMSG_FRIEND_LIST(c) => crate::Message::to_test_case_string(c.as_ref()),
            ...
            Self::SMSG_CAST_RESULT(c) => crate::Message::to_test_case_string(c.as_ref()),
            ...
            Self::SMSG_RESISTLOG(c) => crate::Message::to_test_case_string(c.as_ref()),
            ...
            Self::MSG_PVP_LOG_DATA(c) => crate::Message::to_test_case_string(c.as_ref()),
            ...
            Self::SMSG_EXPECTED_SPAM_RECORDS(c) => crate::Message::to_test_case_string(c.as_ref()),
...
impl From<SMSG_FRIEND_LIST> for ServerOpcodeMessage {
    fn from(c: SMSG_FRIEND_LIST) -> Self {
        Self::SMSG_FRIEND_LIST(Box::new(c))
    }
}
...
impl From<SMSG_IGNORE_LIST> for ServerOpcodeMessage {
    fn from(c: SMSG_IGNORE_LIST) -> Self {
        Self::SMSG_IGNORE_LIST(Box::new(c))
    }
}
...
impl From<SMSG_CAST_RESULT> for ServerOpcodeMessage {
    fn from(c: SMSG_CAST_RESULT) -> Self {
        Self::SMSG_CAST_RESULT(Box::new(c))
    }
}
...
impl From<MSG_PVP_LOG_DATA_Server> for ServerOpcodeMessage {
    fn from(c: MSG_PVP_LOG_DATA_Server) -> Self {
        Self::MSG_PVP_LOG_DATA(Box::new(c))
    }
}
...
impl From<SMSG_EXPECTED_SPAM_RECORDS> for ServerOpcodeMessage {
    fn from(c: SMSG_EXPECTED_SPAM_RECORDS) -> Self {
        Self::SMSG_EXPECTED_SPAM_RECORDS(Box::new(c))
    }
}
