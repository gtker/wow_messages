...
use crate::world::vanilla::MSG_MOVE_WORLDPORT_ACK;
use crate::world::vanilla::MSG_PETITION_DECLINE;
...
use crate::world::vanilla::CMSG_CHAR_DELETE;
use crate::world::vanilla::CMSG_PLAYER_LOGIN;
use crate::world::vanilla::CMSG_PLAYER_LOGOUT;
use crate::world::vanilla::CMSG_LOGOUT_REQUEST;
use crate::world::vanilla::CMSG_LOGOUT_CANCEL;
use crate::world::vanilla::CMSG_NAME_QUERY;
use crate::world::vanilla::CMSG_PET_NAME_QUERY;
use crate::world::vanilla::CMSG_GUILD_QUERY;
use crate::world::vanilla::CMSG_ITEM_QUERY_SINGLE;
use crate::world::vanilla::CMSG_PAGE_TEXT_QUERY;
use crate::world::vanilla::CMSG_QUEST_QUERY;
use crate::world::vanilla::CMSG_GAMEOBJECT_QUERY;
use crate::world::vanilla::CMSG_CREATURE_QUERY;
use crate::world::vanilla::CMSG_WHO;
use crate::world::vanilla::CMSG_WHOIS;
use crate::world::vanilla::CMSG_FRIEND_LIST;
use crate::world::vanilla::CMSG_ADD_FRIEND;
use crate::world::vanilla::CMSG_DEL_FRIEND;
use crate::world::vanilla::CMSG_ADD_IGNORE;
use crate::world::vanilla::CMSG_DEL_IGNORE;
use crate::world::vanilla::CMSG_GROUP_INVITE;
use crate::world::vanilla::CMSG_GROUP_ACCEPT;
use crate::world::vanilla::CMSG_GROUP_DECLINE;
use crate::world::vanilla::CMSG_GROUP_UNINVITE;
use crate::world::vanilla::CMSG_GROUP_UNINVITE_GUID;
use crate::world::vanilla::CMSG_GROUP_SET_LEADER;
use crate::world::vanilla::CMSG_LOOT_METHOD;
use crate::world::vanilla::CMSG_GROUP_DISBAND;
use crate::world::vanilla::CMSG_GUILD_CREATE;
use crate::world::vanilla::CMSG_GUILD_INVITE;
use crate::world::vanilla::CMSG_GUILD_ACCEPT;
use crate::world::vanilla::CMSG_GUILD_DECLINE;
use crate::world::vanilla::CMSG_GUILD_INFO;
use crate::world::vanilla::CMSG_GUILD_ROSTER;
use crate::world::vanilla::CMSG_GUILD_PROMOTE;
use crate::world::vanilla::CMSG_GUILD_DEMOTE;
use crate::world::vanilla::CMSG_GUILD_LEAVE;
use crate::world::vanilla::CMSG_GUILD_REMOVE;
use crate::world::vanilla::CMSG_GUILD_DISBAND;
use crate::world::vanilla::CMSG_GUILD_LEADER;
use crate::world::vanilla::CMSG_GUILD_MOTD;
use crate::world::vanilla::CMSG_MESSAGECHAT;
use crate::world::vanilla::CMSG_JOIN_CHANNEL;
use crate::world::vanilla::CMSG_LEAVE_CHANNEL;
use crate::world::vanilla::CMSG_CHANNEL_LIST;
use crate::world::vanilla::CMSG_CHANNEL_PASSWORD;
use crate::world::vanilla::CMSG_CHANNEL_SET_OWNER;
use crate::world::vanilla::CMSG_CHANNEL_OWNER;
use crate::world::vanilla::CMSG_CHANNEL_MODERATOR;
use crate::world::vanilla::CMSG_CHANNEL_UNMODERATOR;
use crate::world::vanilla::CMSG_CHANNEL_MUTE;
use crate::world::vanilla::CMSG_CHANNEL_UNMUTE;
use crate::world::vanilla::CMSG_CHANNEL_INVITE;
use crate::world::vanilla::CMSG_CHANNEL_KICK;
use crate::world::vanilla::CMSG_CHANNEL_BAN;
use crate::world::vanilla::CMSG_CHANNEL_UNBAN;
use crate::world::vanilla::CMSG_CHANNEL_ANNOUNCEMENTS;
use crate::world::vanilla::CMSG_CHANNEL_MODERATE;
use crate::world::vanilla::CMSG_USE_ITEM;
use crate::world::vanilla::CMSG_OPEN_ITEM;
use crate::world::vanilla::CMSG_READ_ITEM;
use crate::world::vanilla::CMSG_GAMEOBJ_USE;
use crate::world::vanilla::CMSG_AREATRIGGER;
use crate::world::vanilla::MSG_MOVE_START_FORWARD_Client;
use crate::world::vanilla::MSG_MOVE_START_BACKWARD_Client;
use crate::world::vanilla::MSG_MOVE_STOP_Client;
use crate::world::vanilla::MSG_MOVE_START_STRAFE_LEFT_Client;
use crate::world::vanilla::MSG_MOVE_START_STRAFE_RIGHT_Client;
use crate::world::vanilla::MSG_MOVE_STOP_STRAFE_Client;
use crate::world::vanilla::MSG_MOVE_JUMP_Client;
use crate::world::vanilla::MSG_MOVE_START_TURN_LEFT_Client;
use crate::world::vanilla::MSG_MOVE_START_TURN_RIGHT_Client;
use crate::world::vanilla::MSG_MOVE_STOP_TURN_Client;
use crate::world::vanilla::MSG_MOVE_START_PITCH_UP_Client;
use crate::world::vanilla::MSG_MOVE_START_PITCH_DOWN_Client;
use crate::world::vanilla::MSG_MOVE_STOP_PITCH_Client;
use crate::world::vanilla::MSG_MOVE_SET_RUN_MODE_Client;
use crate::world::vanilla::MSG_MOVE_SET_WALK_MODE_Client;
use crate::world::vanilla::MSG_MOVE_TELEPORT_ACK_Client;
use crate::world::vanilla::MSG_MOVE_FALL_LAND_Client;
use crate::world::vanilla::MSG_MOVE_START_SWIM_Client;
use crate::world::vanilla::MSG_MOVE_STOP_SWIM_Client;
use crate::world::vanilla::MSG_MOVE_SET_FACING_Client;
use crate::world::vanilla::MSG_MOVE_SET_PITCH_Client;
use crate::world::vanilla::CMSG_MOVE_SET_RAW_POSITION;
use crate::world::vanilla::CMSG_FORCE_RUN_SPEED_CHANGE_ACK;
use crate::world::vanilla::CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK;
use crate::world::vanilla::CMSG_FORCE_SWIM_SPEED_CHANGE_ACK;
use crate::world::vanilla::CMSG_FORCE_MOVE_ROOT_ACK;
use crate::world::vanilla::CMSG_FORCE_MOVE_UNROOT_ACK;
use crate::world::vanilla::MSG_MOVE_HEARTBEAT_Client;
use crate::world::vanilla::CMSG_MOVE_KNOCK_BACK_ACK;
use crate::world::vanilla::CMSG_MOVE_HOVER_ACK;
use crate::world::vanilla::CMSG_NEXT_CINEMATIC_CAMERA;
use crate::world::vanilla::CMSG_COMPLETE_CINEMATIC;
use crate::world::vanilla::CMSG_TUTORIAL_FLAG;
use crate::world::vanilla::CMSG_TUTORIAL_CLEAR;
use crate::world::vanilla::CMSG_TUTORIAL_RESET;
use crate::world::vanilla::CMSG_STANDSTATECHANGE;
use crate::world::vanilla::CMSG_EMOTE;
use crate::world::vanilla::CMSG_TEXT_EMOTE;
use crate::world::vanilla::CMSG_AUTOSTORE_LOOT_ITEM;
use crate::world::vanilla::CMSG_AUTOEQUIP_ITEM;
use crate::world::vanilla::CMSG_AUTOSTORE_BAG_ITEM;
use crate::world::vanilla::CMSG_SWAP_ITEM;
use crate::world::vanilla::CMSG_SWAP_INV_ITEM;
use crate::world::vanilla::CMSG_SPLIT_ITEM;
use crate::world::vanilla::CMSG_AUTOEQUIP_ITEM_SLOT;
use crate::world::vanilla::CMSG_DESTROYITEM;
use crate::world::vanilla::CMSG_INSPECT;
use crate::world::vanilla::CMSG_INITIATE_TRADE;
use crate::world::vanilla::CMSG_BEGIN_TRADE;
use crate::world::vanilla::CMSG_BUSY_TRADE;
use crate::world::vanilla::CMSG_IGNORE_TRADE;
use crate::world::vanilla::CMSG_ACCEPT_TRADE;
use crate::world::vanilla::CMSG_UNACCEPT_TRADE;
use crate::world::vanilla::CMSG_CANCEL_TRADE;
use crate::world::vanilla::CMSG_SET_TRADE_ITEM;
use crate::world::vanilla::CMSG_CLEAR_TRADE_ITEM;
use crate::world::vanilla::CMSG_SET_TRADE_GOLD;
use crate::world::vanilla::CMSG_SET_FACTION_ATWAR;
use crate::world::vanilla::CMSG_SET_ACTION_BUTTON;
use crate::world::vanilla::CMSG_CAST_SPELL;
use crate::world::vanilla::CMSG_CANCEL_CAST;
use crate::world::vanilla::CMSG_CANCEL_AURA;
use crate::world::vanilla::CMSG_CANCEL_CHANNELLING;
use crate::world::vanilla::CMSG_SET_SELECTION;
use crate::world::vanilla::CMSG_SET_TARGET_OBSOLETE;
use crate::world::vanilla::CMSG_ATTACKSWING;
use crate::world::vanilla::CMSG_ATTACKSTOP;
use crate::world::vanilla::CMSG_REPOP_REQUEST;
use crate::world::vanilla::CMSG_RESURRECT_RESPONSE;
use crate::world::vanilla::CMSG_LOOT;
use crate::world::vanilla::CMSG_LOOT_MONEY;
use crate::world::vanilla::CMSG_LOOT_RELEASE;
use crate::world::vanilla::CMSG_DUEL_ACCEPTED;
use crate::world::vanilla::CMSG_DUEL_CANCELLED;
use crate::world::vanilla::CMSG_MOUNTSPECIAL_ANIM;
use crate::world::vanilla::CMSG_PET_SET_ACTION;
use crate::world::vanilla::CMSG_PET_ACTION;
use crate::world::vanilla::CMSG_PET_ABANDON;
use crate::world::vanilla::CMSG_PET_RENAME;
use crate::world::vanilla::CMSG_GOSSIP_HELLO;
use crate::world::vanilla::CMSG_GOSSIP_SELECT_OPTION;
use crate::world::vanilla::CMSG_NPC_TEXT_QUERY;
use crate::world::vanilla::CMSG_QUESTGIVER_STATUS_QUERY;
use crate::world::vanilla::CMSG_QUESTGIVER_HELLO;
use crate::world::vanilla::CMSG_QUESTGIVER_QUERY_QUEST;
use crate::world::vanilla::CMSG_QUESTGIVER_QUEST_AUTOLAUNCH;
use crate::world::vanilla::CMSG_QUESTGIVER_ACCEPT_QUEST;
use crate::world::vanilla::CMSG_QUESTGIVER_COMPLETE_QUEST;
use crate::world::vanilla::CMSG_QUESTGIVER_REQUEST_REWARD;
use crate::world::vanilla::CMSG_QUESTGIVER_CHOOSE_REWARD;
use crate::world::vanilla::CMSG_QUESTGIVER_CANCEL;
use crate::world::vanilla::CMSG_QUESTLOG_SWAP_QUEST;
use crate::world::vanilla::CMSG_QUESTLOG_REMOVE_QUEST;
use crate::world::vanilla::CMSG_QUEST_CONFIRM_ACCEPT;
use crate::world::vanilla::CMSG_PUSHQUESTTOPARTY;
use crate::world::vanilla::CMSG_LIST_INVENTORY;
use crate::world::vanilla::CMSG_SELL_ITEM;
use crate::world::vanilla::CMSG_BUY_ITEM;
use crate::world::vanilla::CMSG_BUY_ITEM_IN_SLOT;
use crate::world::vanilla::CMSG_TAXINODE_STATUS_QUERY;
use crate::world::vanilla::CMSG_TAXIQUERYAVAILABLENODES;
use crate::world::vanilla::CMSG_ACTIVATETAXI;
use crate::world::vanilla::CMSG_TRAINER_LIST;
use crate::world::vanilla::CMSG_TRAINER_BUY_SPELL;
use crate::world::vanilla::CMSG_BINDER_ACTIVATE;
use crate::world::vanilla::CMSG_BANKER_ACTIVATE;
use crate::world::vanilla::CMSG_BUY_BANK_SLOT;
use crate::world::vanilla::CMSG_PETITION_SHOWLIST;
use crate::world::vanilla::CMSG_PETITION_BUY;
use crate::world::vanilla::CMSG_PETITION_SHOW_SIGNATURES;
use crate::world::vanilla::CMSG_PETITION_SIGN;
use crate::world::vanilla::CMSG_OFFER_PETITION;
use crate::world::vanilla::CMSG_TURN_IN_PETITION;
use crate::world::vanilla::CMSG_PETITION_QUERY;
use crate::world::vanilla::CMSG_BUG;
use crate::world::vanilla::CMSG_PLAYED_TIME;
use crate::world::vanilla::CMSG_QUERY_TIME;
use crate::world::vanilla::CMSG_RECLAIM_CORPSE;
use crate::world::vanilla::CMSG_WRAP_ITEM;
use crate::world::vanilla::MSG_MINIMAP_PING_Client;
use crate::world::vanilla::CMSG_PING;
use crate::world::vanilla::CMSG_SETSHEATHED;
use crate::world::vanilla::CMSG_AUTH_SESSION;
use crate::world::vanilla::CMSG_PET_CAST_SPELL;
use crate::world::vanilla::MSG_SAVE_GUILD_EMBLEM_Client;
use crate::world::vanilla::CMSG_ZONEUPDATE;
use crate::world::vanilla::MSG_RANDOM_ROLL_Client;
use crate::world::vanilla::MSG_LOOKING_FOR_GROUP_Client;
use crate::world::vanilla::CMSG_UNLEARN_SKILL;
use crate::world::vanilla::CMSG_GMTICKET_CREATE;
use crate::world::vanilla::CMSG_GMTICKET_UPDATETEXT;
use crate::world::vanilla::CMSG_REQUEST_ACCOUNT_DATA;
use crate::world::vanilla::CMSG_UPDATE_ACCOUNT_DATA;
use crate::world::vanilla::CMSG_GMTICKET_GETTICKET;
use crate::world::vanilla::MSG_CORPSE_QUERY_Client;
use crate::world::vanilla::CMSG_GMTICKET_DELETETICKET;
use crate::world::vanilla::CMSG_GMTICKET_SYSTEMSTATUS;
use crate::world::vanilla::CMSG_SPIRIT_HEALER_ACTIVATE;
use crate::world::vanilla::CMSG_CHAT_IGNORED;
use crate::world::vanilla::CMSG_GUILD_RANK;
use crate::world::vanilla::CMSG_GUILD_ADD_RANK;
use crate::world::vanilla::CMSG_GUILD_DEL_RANK;
use crate::world::vanilla::CMSG_GUILD_SET_PUBLIC_NOTE;
use crate::world::vanilla::CMSG_GUILD_SET_OFFICER_NOTE;
use crate::world::vanilla::CMSG_SEND_MAIL;
use crate::world::vanilla::CMSG_GET_MAIL_LIST;
use crate::world::vanilla::CMSG_BATTLEFIELD_LIST;
use crate::world::vanilla::CMSG_BATTLEFIELD_JOIN;
use crate::world::vanilla::CMSG_ITEM_TEXT_QUERY;
use crate::world::vanilla::CMSG_MAIL_TAKE_MONEY;
use crate::world::vanilla::CMSG_MAIL_TAKE_ITEM;
use crate::world::vanilla::CMSG_MAIL_MARK_AS_READ;
use crate::world::vanilla::CMSG_MAIL_RETURN_TO_SENDER;
use crate::world::vanilla::CMSG_MAIL_DELETE;
use crate::world::vanilla::CMSG_MAIL_CREATE_TEXT_ITEM;
use crate::world::vanilla::CMSG_LEARN_TALENT;
use crate::world::vanilla::CMSG_TOGGLE_PVP;
use crate::world::vanilla::MSG_AUCTION_HELLO_Client;
use crate::world::vanilla::CMSG_AUCTION_SELL_ITEM;
use crate::world::vanilla::CMSG_AUCTION_REMOVE_ITEM;
use crate::world::vanilla::CMSG_AUCTION_LIST_ITEMS;
use crate::world::vanilla::CMSG_AUCTION_LIST_OWNER_ITEMS;
use crate::world::vanilla::CMSG_AUCTION_PLACE_BID;
use crate::world::vanilla::CMSG_AUCTION_LIST_BIDDER_ITEMS;
use crate::world::vanilla::CMSG_SET_AMMO;
use crate::world::vanilla::CMSG_SET_ACTIVE_MOVER;
use crate::world::vanilla::CMSG_PET_CANCEL_AURA;
use crate::world::vanilla::CMSG_CANCEL_AUTO_REPEAT_SPELL;
use crate::world::vanilla::MSG_LIST_STABLED_PETS_Client;
use crate::world::vanilla::CMSG_STABLE_PET;
use crate::world::vanilla::CMSG_UNSTABLE_PET;
use crate::world::vanilla::CMSG_BUY_STABLE_SLOT;
use crate::world::vanilla::CMSG_STABLE_SWAP_PET;
use crate::world::vanilla::CMSG_REQUEST_PET_INFO;
use crate::world::vanilla::CMSG_FAR_SIGHT;
use crate::world::vanilla::CMSG_GROUP_CHANGE_SUB_GROUP;
use crate::world::vanilla::CMSG_REQUEST_PARTY_MEMBER_STATS;
use crate::world::vanilla::CMSG_GROUP_SWAP_SUB_GROUP;
use crate::world::vanilla::CMSG_AUTOSTORE_BANK_ITEM;
use crate::world::vanilla::CMSG_AUTOBANK_ITEM;
use crate::world::vanilla::MSG_QUERY_NEXT_MAIL_TIME_Client;
use crate::world::vanilla::CMSG_GROUP_RAID_CONVERT;
use crate::world::vanilla::CMSG_GROUP_ASSISTANT_LEADER;
use crate::world::vanilla::CMSG_BUYBACK_ITEM;
use crate::world::vanilla::CMSG_MEETINGSTONE_JOIN;
use crate::world::vanilla::CMSG_MEETINGSTONE_LEAVE;
use crate::world::vanilla::CMSG_MEETINGSTONE_INFO;
use crate::world::vanilla::CMSG_CANCEL_GROWTH_AURA;
use crate::world::vanilla::CMSG_LOOT_ROLL;
use crate::world::vanilla::CMSG_LOOT_MASTER_GIVE;
use crate::world::vanilla::CMSG_REPAIR_ITEM;
use crate::world::vanilla::MSG_TALENT_WIPE_CONFIRM_Client;
use crate::world::vanilla::CMSG_SUMMON_RESPONSE;
use crate::world::vanilla::CMSG_SELF_RES;
use crate::world::vanilla::CMSG_TOGGLE_HELM;
use crate::world::vanilla::CMSG_TOGGLE_CLOAK;
use crate::world::vanilla::CMSG_SET_ACTIONBAR_TOGGLES;
use crate::world::vanilla::CMSG_ITEM_NAME_QUERY;
use crate::world::vanilla::CMSG_CHAR_RENAME;
use crate::world::vanilla::CMSG_MOVE_SPLINE_DONE;
use crate::world::vanilla::CMSG_MOVE_FALL_RESET;
use crate::world::vanilla::CMSG_REQUEST_RAID_INFO;
use crate::world::vanilla::CMSG_MOVE_TIME_SKIPPED;
use crate::world::vanilla::CMSG_MOVE_FEATHER_FALL_ACK;
use crate::world::vanilla::CMSG_MOVE_WATER_WALK_ACK;
use crate::world::vanilla::CMSG_MOVE_NOT_ACTIVE_MOVER;
use crate::world::vanilla::CMSG_BATTLEFIELD_STATUS;
use crate::world::vanilla::CMSG_BATTLEFIELD_PORT;
use crate::world::vanilla::MSG_INSPECT_HONOR_STATS_Client;
use crate::world::vanilla::CMSG_BATTLEMASTER_HELLO;
use crate::world::vanilla::CMSG_FORCE_WALK_SPEED_CHANGE_ACK;
use crate::world::vanilla::CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK;
use crate::world::vanilla::CMSG_FORCE_TURN_RATE_CHANGE_ACK;
use crate::world::vanilla::MSG_PVP_LOG_DATA_Client;
...
use crate::world::vanilla::CMSG_PET_UNLEARN;
use crate::world::vanilla::CMSG_PET_SPELL_AUTOCAST;
use crate::world::vanilla::CMSG_GUILD_INFO_TEXT;
use crate::world::vanilla::CMSG_ACTIVATETAXIEXPRESS;
use crate::world::vanilla::CMSG_SET_FACTION_INACTIVE;
use crate::world::vanilla::CMSG_SET_WATCHED_FACTION;
use crate::world::vanilla::CMSG_RESET_INSTANCES;
...
use crate::world::vanilla::MSG_MOVE_START_ASCEND_Client;
...
impl ClientOpcodeMessage {
    fn read_opcodes(opcode: u32, body_size: u32, mut r: &[u8]) -> std::result::Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x01C2 => Ok(Self::MSG_PETITION_DECLINE(<MSG_PETITION_DECLINE as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0052 => Ok(Self::CMSG_PET_NAME_QUERY(<CMSG_PET_NAME_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0054 => Ok(Self::CMSG_GUILD_QUERY(<CMSG_GUILD_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0056 => Ok(Self::CMSG_ITEM_QUERY_SINGLE(<CMSG_ITEM_QUERY_SINGLE as crate::Message>::read_body(&mut r, body_size)?)),
            0x005A => Ok(Self::CMSG_PAGE_TEXT_QUERY(<CMSG_PAGE_TEXT_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x005C => Ok(Self::CMSG_QUEST_QUERY(<CMSG_QUEST_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x005E => Ok(Self::CMSG_GAMEOBJECT_QUERY(<CMSG_GAMEOBJECT_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0060 => Ok(Self::CMSG_CREATURE_QUERY(<CMSG_CREATURE_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0062 => Ok(Self::CMSG_WHO(<CMSG_WHO as crate::Message>::read_body(&mut r, body_size)?)),
            0x0064 => Ok(Self::CMSG_WHOIS(<CMSG_WHOIS as crate::Message>::read_body(&mut r, body_size)?)),
            0x0066 => Ok(Self::CMSG_FRIEND_LIST(<CMSG_FRIEND_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x0069 => Ok(Self::CMSG_ADD_FRIEND(<CMSG_ADD_FRIEND as crate::Message>::read_body(&mut r, body_size)?)),
            0x006A => Ok(Self::CMSG_DEL_FRIEND(<CMSG_DEL_FRIEND as crate::Message>::read_body(&mut r, body_size)?)),
            0x006C => Ok(Self::CMSG_ADD_IGNORE(<CMSG_ADD_IGNORE as crate::Message>::read_body(&mut r, body_size)?)),
            0x006D => Ok(Self::CMSG_DEL_IGNORE(<CMSG_DEL_IGNORE as crate::Message>::read_body(&mut r, body_size)?)),
            0x006E => Ok(Self::CMSG_GROUP_INVITE(<CMSG_GROUP_INVITE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0072 => Ok(Self::CMSG_GROUP_ACCEPT(<CMSG_GROUP_ACCEPT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0073 => Ok(Self::CMSG_GROUP_DECLINE(<CMSG_GROUP_DECLINE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0075 => Ok(Self::CMSG_GROUP_UNINVITE(<CMSG_GROUP_UNINVITE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0076 => Ok(Self::CMSG_GROUP_UNINVITE_GUID(<CMSG_GROUP_UNINVITE_GUID as crate::Message>::read_body(&mut r, body_size)?)),
            0x0078 => Ok(Self::CMSG_GROUP_SET_LEADER(<CMSG_GROUP_SET_LEADER as crate::Message>::read_body(&mut r, body_size)?)),
            0x007A => Ok(Self::CMSG_LOOT_METHOD(<CMSG_LOOT_METHOD as crate::Message>::read_body(&mut r, body_size)?)),
            0x007B => Ok(Self::CMSG_GROUP_DISBAND(<CMSG_GROUP_DISBAND as crate::Message>::read_body(&mut r, body_size)?)),
            0x0081 => Ok(Self::CMSG_GUILD_CREATE(<CMSG_GUILD_CREATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0082 => Ok(Self::CMSG_GUILD_INVITE(<CMSG_GUILD_INVITE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0084 => Ok(Self::CMSG_GUILD_ACCEPT(<CMSG_GUILD_ACCEPT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0085 => Ok(Self::CMSG_GUILD_DECLINE(<CMSG_GUILD_DECLINE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0087 => Ok(Self::CMSG_GUILD_INFO(<CMSG_GUILD_INFO as crate::Message>::read_body(&mut r, body_size)?)),
            0x0089 => Ok(Self::CMSG_GUILD_ROSTER(<CMSG_GUILD_ROSTER as crate::Message>::read_body(&mut r, body_size)?)),
            0x008B => Ok(Self::CMSG_GUILD_PROMOTE(<CMSG_GUILD_PROMOTE as crate::Message>::read_body(&mut r, body_size)?)),
            0x008C => Ok(Self::CMSG_GUILD_DEMOTE(<CMSG_GUILD_DEMOTE as crate::Message>::read_body(&mut r, body_size)?)),
            0x008D => Ok(Self::CMSG_GUILD_LEAVE(<CMSG_GUILD_LEAVE as crate::Message>::read_body(&mut r, body_size)?)),
            0x008E => Ok(Self::CMSG_GUILD_REMOVE(<CMSG_GUILD_REMOVE as crate::Message>::read_body(&mut r, body_size)?)),
            0x008F => Ok(Self::CMSG_GUILD_DISBAND(<CMSG_GUILD_DISBAND as crate::Message>::read_body(&mut r, body_size)?)),
            0x0090 => Ok(Self::CMSG_GUILD_LEADER(<CMSG_GUILD_LEADER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0091 => Ok(Self::CMSG_GUILD_MOTD(<CMSG_GUILD_MOTD as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x00AB => Ok(Self::CMSG_USE_ITEM(<CMSG_USE_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x00AC => Ok(Self::CMSG_OPEN_ITEM(<CMSG_OPEN_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x00AD => Ok(Self::CMSG_READ_ITEM(<CMSG_READ_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x00B1 => Ok(Self::CMSG_GAMEOBJ_USE(<CMSG_GAMEOBJ_USE as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x00E1 => Ok(Self::CMSG_MOVE_SET_RAW_POSITION(<CMSG_MOVE_SET_RAW_POSITION as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x00F0 => Ok(Self::CMSG_MOVE_KNOCK_BACK_ACK(<CMSG_MOVE_KNOCK_BACK_ACK as crate::Message>::read_body(&mut r, body_size)?)),
            0x00F6 => Ok(Self::CMSG_MOVE_HOVER_ACK(<CMSG_MOVE_HOVER_ACK as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0101 => Ok(Self::CMSG_STANDSTATECHANGE(<CMSG_STANDSTATECHANGE as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0108 => Ok(Self::CMSG_AUTOSTORE_LOOT_ITEM(<CMSG_AUTOSTORE_LOOT_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x010A => Ok(Self::CMSG_AUTOEQUIP_ITEM(<CMSG_AUTOEQUIP_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x010B => Ok(Self::CMSG_AUTOSTORE_BAG_ITEM(<CMSG_AUTOSTORE_BAG_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x010C => Ok(Self::CMSG_SWAP_ITEM(<CMSG_SWAP_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x010D => Ok(Self::CMSG_SWAP_INV_ITEM(<CMSG_SWAP_INV_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x010E => Ok(Self::CMSG_SPLIT_ITEM(<CMSG_SPLIT_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x010F => Ok(Self::CMSG_AUTOEQUIP_ITEM_SLOT(<CMSG_AUTOEQUIP_ITEM_SLOT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0111 => Ok(Self::CMSG_DESTROYITEM(<CMSG_DESTROYITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0114 => Ok(Self::CMSG_INSPECT(<CMSG_INSPECT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0116 => Ok(Self::CMSG_INITIATE_TRADE(<CMSG_INITIATE_TRADE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0117 => Ok(Self::CMSG_BEGIN_TRADE(<CMSG_BEGIN_TRADE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0118 => Ok(Self::CMSG_BUSY_TRADE(<CMSG_BUSY_TRADE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0119 => Ok(Self::CMSG_IGNORE_TRADE(<CMSG_IGNORE_TRADE as crate::Message>::read_body(&mut r, body_size)?)),
            0x011A => Ok(Self::CMSG_ACCEPT_TRADE(<CMSG_ACCEPT_TRADE as crate::Message>::read_body(&mut r, body_size)?)),
            0x011B => Ok(Self::CMSG_UNACCEPT_TRADE(<CMSG_UNACCEPT_TRADE as crate::Message>::read_body(&mut r, body_size)?)),
            0x011C => Ok(Self::CMSG_CANCEL_TRADE(<CMSG_CANCEL_TRADE as crate::Message>::read_body(&mut r, body_size)?)),
            0x011D => Ok(Self::CMSG_SET_TRADE_ITEM(<CMSG_SET_TRADE_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x011E => Ok(Self::CMSG_CLEAR_TRADE_ITEM(<CMSG_CLEAR_TRADE_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x011F => Ok(Self::CMSG_SET_TRADE_GOLD(<CMSG_SET_TRADE_GOLD as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x012E => Ok(Self::CMSG_CAST_SPELL(<CMSG_CAST_SPELL as crate::Message>::read_body(&mut r, body_size)?)),
            0x012F => Ok(Self::CMSG_CANCEL_CAST(<CMSG_CANCEL_CAST as crate::Message>::read_body(&mut r, body_size)?)),
            0x0136 => Ok(Self::CMSG_CANCEL_AURA(<CMSG_CANCEL_AURA as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x015C => Ok(Self::CMSG_RESURRECT_RESPONSE(<CMSG_RESURRECT_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x015D => Ok(Self::CMSG_LOOT(<CMSG_LOOT as crate::Message>::read_body(&mut r, body_size)?)),
            0x015E => Ok(Self::CMSG_LOOT_MONEY(<CMSG_LOOT_MONEY as crate::Message>::read_body(&mut r, body_size)?)),
            0x015F => Ok(Self::CMSG_LOOT_RELEASE(<CMSG_LOOT_RELEASE as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0171 => Ok(Self::CMSG_MOUNTSPECIAL_ANIM(<CMSG_MOUNTSPECIAL_ANIM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0174 => Ok(Self::CMSG_PET_SET_ACTION(<CMSG_PET_SET_ACTION as crate::Message>::read_body(&mut r, body_size)?)),
            0x0175 => Ok(Self::CMSG_PET_ACTION(<CMSG_PET_ACTION as crate::Message>::read_body(&mut r, body_size)?)),
            0x0176 => Ok(Self::CMSG_PET_ABANDON(<CMSG_PET_ABANDON as crate::Message>::read_body(&mut r, body_size)?)),
            0x0177 => Ok(Self::CMSG_PET_RENAME(<CMSG_PET_RENAME as crate::Message>::read_body(&mut r, body_size)?)),
            0x017B => Ok(Self::CMSG_GOSSIP_HELLO(<CMSG_GOSSIP_HELLO as crate::Message>::read_body(&mut r, body_size)?)),
            0x017C => Ok(Self::CMSG_GOSSIP_SELECT_OPTION(<CMSG_GOSSIP_SELECT_OPTION as crate::Message>::read_body(&mut r, body_size)?)),
            0x017F => Ok(Self::CMSG_NPC_TEXT_QUERY(<CMSG_NPC_TEXT_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0182 => Ok(Self::CMSG_QUESTGIVER_STATUS_QUERY(<CMSG_QUESTGIVER_STATUS_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0184 => Ok(Self::CMSG_QUESTGIVER_HELLO(<CMSG_QUESTGIVER_HELLO as crate::Message>::read_body(&mut r, body_size)?)),
            0x0186 => Ok(Self::CMSG_QUESTGIVER_QUERY_QUEST(<CMSG_QUESTGIVER_QUERY_QUEST as crate::Message>::read_body(&mut r, body_size)?)),
            0x0187 => Ok(Self::CMSG_QUESTGIVER_QUEST_AUTOLAUNCH(<CMSG_QUESTGIVER_QUEST_AUTOLAUNCH as crate::Message>::read_body(&mut r, body_size)?)),
            0x0189 => Ok(Self::CMSG_QUESTGIVER_ACCEPT_QUEST(<CMSG_QUESTGIVER_ACCEPT_QUEST as crate::Message>::read_body(&mut r, body_size)?)),
            0x018A => Ok(Self::CMSG_QUESTGIVER_COMPLETE_QUEST(<CMSG_QUESTGIVER_COMPLETE_QUEST as crate::Message>::read_body(&mut r, body_size)?)),
            0x018C => Ok(Self::CMSG_QUESTGIVER_REQUEST_REWARD(<CMSG_QUESTGIVER_REQUEST_REWARD as crate::Message>::read_body(&mut r, body_size)?)),
            0x018E => Ok(Self::CMSG_QUESTGIVER_CHOOSE_REWARD(<CMSG_QUESTGIVER_CHOOSE_REWARD as crate::Message>::read_body(&mut r, body_size)?)),
            0x0190 => Ok(Self::CMSG_QUESTGIVER_CANCEL(<CMSG_QUESTGIVER_CANCEL as crate::Message>::read_body(&mut r, body_size)?)),
            0x0193 => Ok(Self::CMSG_QUESTLOG_SWAP_QUEST(<CMSG_QUESTLOG_SWAP_QUEST as crate::Message>::read_body(&mut r, body_size)?)),
            0x0194 => Ok(Self::CMSG_QUESTLOG_REMOVE_QUEST(<CMSG_QUESTLOG_REMOVE_QUEST as crate::Message>::read_body(&mut r, body_size)?)),
            0x019B => Ok(Self::CMSG_QUEST_CONFIRM_ACCEPT(<CMSG_QUEST_CONFIRM_ACCEPT as crate::Message>::read_body(&mut r, body_size)?)),
            0x019D => Ok(Self::CMSG_PUSHQUESTTOPARTY(<CMSG_PUSHQUESTTOPARTY as crate::Message>::read_body(&mut r, body_size)?)),
            0x019E => Ok(Self::CMSG_LIST_INVENTORY(<CMSG_LIST_INVENTORY as crate::Message>::read_body(&mut r, body_size)?)),
            0x01A0 => Ok(Self::CMSG_SELL_ITEM(<CMSG_SELL_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x01A2 => Ok(Self::CMSG_BUY_ITEM(<CMSG_BUY_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x01A3 => Ok(Self::CMSG_BUY_ITEM_IN_SLOT(<CMSG_BUY_ITEM_IN_SLOT as crate::Message>::read_body(&mut r, body_size)?)),
            0x01AA => Ok(Self::CMSG_TAXINODE_STATUS_QUERY(<CMSG_TAXINODE_STATUS_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x01AC => Ok(Self::CMSG_TAXIQUERYAVAILABLENODES(<CMSG_TAXIQUERYAVAILABLENODES as crate::Message>::read_body(&mut r, body_size)?)),
            0x01AD => Ok(Self::CMSG_ACTIVATETAXI(<CMSG_ACTIVATETAXI as crate::Message>::read_body(&mut r, body_size)?)),
            0x01B0 => Ok(Self::CMSG_TRAINER_LIST(<CMSG_TRAINER_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x01B2 => Ok(Self::CMSG_TRAINER_BUY_SPELL(<CMSG_TRAINER_BUY_SPELL as crate::Message>::read_body(&mut r, body_size)?)),
            0x01B5 => Ok(Self::CMSG_BINDER_ACTIVATE(<CMSG_BINDER_ACTIVATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x01B7 => Ok(Self::CMSG_BANKER_ACTIVATE(<CMSG_BANKER_ACTIVATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x01B9 => Ok(Self::CMSG_BUY_BANK_SLOT(<CMSG_BUY_BANK_SLOT as crate::Message>::read_body(&mut r, body_size)?)),
            0x01BB => Ok(Self::CMSG_PETITION_SHOWLIST(<CMSG_PETITION_SHOWLIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x01BD => Ok(Self::CMSG_PETITION_BUY(<CMSG_PETITION_BUY as crate::Message>::read_body(&mut r, body_size)?)),
            0x01BE => Ok(Self::CMSG_PETITION_SHOW_SIGNATURES(<CMSG_PETITION_SHOW_SIGNATURES as crate::Message>::read_body(&mut r, body_size)?)),
            0x01C0 => Ok(Self::CMSG_PETITION_SIGN(<CMSG_PETITION_SIGN as crate::Message>::read_body(&mut r, body_size)?)),
            0x01C3 => Ok(Self::CMSG_OFFER_PETITION(<CMSG_OFFER_PETITION as crate::Message>::read_body(&mut r, body_size)?)),
            0x01C4 => Ok(Self::CMSG_TURN_IN_PETITION(<CMSG_TURN_IN_PETITION as crate::Message>::read_body(&mut r, body_size)?)),
            0x01C6 => Ok(Self::CMSG_PETITION_QUERY(<CMSG_PETITION_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x01D2 => Ok(Self::CMSG_RECLAIM_CORPSE(<CMSG_RECLAIM_CORPSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x01D3 => Ok(Self::CMSG_WRAP_ITEM(<CMSG_WRAP_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x01D5 => Ok(Self::MSG_MINIMAP_PING(<MSG_MINIMAP_PING_Client as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x01F0 => Ok(Self::CMSG_PET_CAST_SPELL(<CMSG_PET_CAST_SPELL as crate::Message>::read_body(&mut r, body_size)?)),
            0x01F1 => Ok(Self::MSG_SAVE_GUILD_EMBLEM(<MSG_SAVE_GUILD_EMBLEM_Client as crate::Message>::read_body(&mut r, body_size)?)),
            0x01F4 => Ok(Self::CMSG_ZONEUPDATE(<CMSG_ZONEUPDATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x01FB => Ok(Self::MSG_RANDOM_ROLL(<MSG_RANDOM_ROLL_Client as crate::Message>::read_body(&mut r, body_size)?)),
            0x01FF => Ok(Self::MSG_LOOKING_FOR_GROUP(<MSG_LOOKING_FOR_GROUP_Client as crate::Message>::read_body(&mut r, body_size)?)),
            0x0202 => Ok(Self::CMSG_UNLEARN_SKILL(<CMSG_UNLEARN_SKILL as crate::Message>::read_body(&mut r, body_size)?)),
            0x0205 => Ok(Self::CMSG_GMTICKET_CREATE(<CMSG_GMTICKET_CREATE as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0216 => Ok(Self::MSG_CORPSE_QUERY(<MSG_CORPSE_QUERY_Client as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x021C => Ok(Self::CMSG_SPIRIT_HEALER_ACTIVATE(<CMSG_SPIRIT_HEALER_ACTIVATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0225 => Ok(Self::CMSG_CHAT_IGNORED(<CMSG_CHAT_IGNORED as crate::Message>::read_body(&mut r, body_size)?)),
            0x0231 => Ok(Self::CMSG_GUILD_RANK(<CMSG_GUILD_RANK as crate::Message>::read_body(&mut r, body_size)?)),
            0x0232 => Ok(Self::CMSG_GUILD_ADD_RANK(<CMSG_GUILD_ADD_RANK as crate::Message>::read_body(&mut r, body_size)?)),
            0x0233 => Ok(Self::CMSG_GUILD_DEL_RANK(<CMSG_GUILD_DEL_RANK as crate::Message>::read_body(&mut r, body_size)?)),
            0x0234 => Ok(Self::CMSG_GUILD_SET_PUBLIC_NOTE(<CMSG_GUILD_SET_PUBLIC_NOTE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0235 => Ok(Self::CMSG_GUILD_SET_OFFICER_NOTE(<CMSG_GUILD_SET_OFFICER_NOTE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0238 => Ok(Self::CMSG_SEND_MAIL(<CMSG_SEND_MAIL as crate::Message>::read_body(&mut r, body_size)?)),
            0x023A => Ok(Self::CMSG_GET_MAIL_LIST(<CMSG_GET_MAIL_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x023C => Ok(Self::CMSG_BATTLEFIELD_LIST(<CMSG_BATTLEFIELD_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x023E => Ok(Self::CMSG_BATTLEFIELD_JOIN(<CMSG_BATTLEFIELD_JOIN as crate::Message>::read_body(&mut r, body_size)?)),
            0x0243 => Ok(Self::CMSG_ITEM_TEXT_QUERY(<CMSG_ITEM_TEXT_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0245 => Ok(Self::CMSG_MAIL_TAKE_MONEY(<CMSG_MAIL_TAKE_MONEY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0246 => Ok(Self::CMSG_MAIL_TAKE_ITEM(<CMSG_MAIL_TAKE_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0247 => Ok(Self::CMSG_MAIL_MARK_AS_READ(<CMSG_MAIL_MARK_AS_READ as crate::Message>::read_body(&mut r, body_size)?)),
            0x0248 => Ok(Self::CMSG_MAIL_RETURN_TO_SENDER(<CMSG_MAIL_RETURN_TO_SENDER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0249 => Ok(Self::CMSG_MAIL_DELETE(<CMSG_MAIL_DELETE as crate::Message>::read_body(&mut r, body_size)?)),
            0x024A => Ok(Self::CMSG_MAIL_CREATE_TEXT_ITEM(<CMSG_MAIL_CREATE_TEXT_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0251 => Ok(Self::CMSG_LEARN_TALENT(<CMSG_LEARN_TALENT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0253 => Ok(Self::CMSG_TOGGLE_PVP(<CMSG_TOGGLE_PVP as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0268 => Ok(Self::CMSG_SET_AMMO(<CMSG_SET_AMMO as crate::Message>::read_body(&mut r, body_size)?)),
            0x026A => Ok(Self::CMSG_SET_ACTIVE_MOVER(<CMSG_SET_ACTIVE_MOVER as crate::Message>::read_body(&mut r, body_size)?)),
            0x026B => Ok(Self::CMSG_PET_CANCEL_AURA(<CMSG_PET_CANCEL_AURA as crate::Message>::read_body(&mut r, body_size)?)),
            0x026D => Ok(Self::CMSG_CANCEL_AUTO_REPEAT_SPELL(<CMSG_CANCEL_AUTO_REPEAT_SPELL as crate::Message>::read_body(&mut r, body_size)?)),
            0x026F => Ok(Self::MSG_LIST_STABLED_PETS(<MSG_LIST_STABLED_PETS_Client as crate::Message>::read_body(&mut r, body_size)?)),
            0x0270 => Ok(Self::CMSG_STABLE_PET(<CMSG_STABLE_PET as crate::Message>::read_body(&mut r, body_size)?)),
            0x0271 => Ok(Self::CMSG_UNSTABLE_PET(<CMSG_UNSTABLE_PET as crate::Message>::read_body(&mut r, body_size)?)),
            0x0272 => Ok(Self::CMSG_BUY_STABLE_SLOT(<CMSG_BUY_STABLE_SLOT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0275 => Ok(Self::CMSG_STABLE_SWAP_PET(<CMSG_STABLE_SWAP_PET as crate::Message>::read_body(&mut r, body_size)?)),
            0x0279 => Ok(Self::CMSG_REQUEST_PET_INFO(<CMSG_REQUEST_PET_INFO as crate::Message>::read_body(&mut r, body_size)?)),
            0x027A => Ok(Self::CMSG_FAR_SIGHT(<CMSG_FAR_SIGHT as crate::Message>::read_body(&mut r, body_size)?)),
            0x027E => Ok(Self::CMSG_GROUP_CHANGE_SUB_GROUP(<CMSG_GROUP_CHANGE_SUB_GROUP as crate::Message>::read_body(&mut r, body_size)?)),
            0x027F => Ok(Self::CMSG_REQUEST_PARTY_MEMBER_STATS(<CMSG_REQUEST_PARTY_MEMBER_STATS as crate::Message>::read_body(&mut r, body_size)?)),
            0x0280 => Ok(Self::CMSG_GROUP_SWAP_SUB_GROUP(<CMSG_GROUP_SWAP_SUB_GROUP as crate::Message>::read_body(&mut r, body_size)?)),
            0x0282 => Ok(Self::CMSG_AUTOSTORE_BANK_ITEM(<CMSG_AUTOSTORE_BANK_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0283 => Ok(Self::CMSG_AUTOBANK_ITEM(<CMSG_AUTOBANK_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0284 => Ok(Self::MSG_QUERY_NEXT_MAIL_TIME(<MSG_QUERY_NEXT_MAIL_TIME_Client as crate::Message>::read_body(&mut r, body_size)?)),
            0x028E => Ok(Self::CMSG_GROUP_RAID_CONVERT(<CMSG_GROUP_RAID_CONVERT as crate::Message>::read_body(&mut r, body_size)?)),
            0x028F => Ok(Self::CMSG_GROUP_ASSISTANT_LEADER(<CMSG_GROUP_ASSISTANT_LEADER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0290 => Ok(Self::CMSG_BUYBACK_ITEM(<CMSG_BUYBACK_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0292 => Ok(Self::CMSG_MEETINGSTONE_JOIN(<CMSG_MEETINGSTONE_JOIN as crate::Message>::read_body(&mut r, body_size)?)),
            0x0293 => Ok(Self::CMSG_MEETINGSTONE_LEAVE(<CMSG_MEETINGSTONE_LEAVE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0296 => Ok(Self::CMSG_MEETINGSTONE_INFO(<CMSG_MEETINGSTONE_INFO as crate::Message>::read_body(&mut r, body_size)?)),
            0x029B => Ok(Self::CMSG_CANCEL_GROWTH_AURA(<CMSG_CANCEL_GROWTH_AURA as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A0 => Ok(Self::CMSG_LOOT_ROLL(<CMSG_LOOT_ROLL as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A3 => Ok(Self::CMSG_LOOT_MASTER_GIVE(<CMSG_LOOT_MASTER_GIVE as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A8 => Ok(Self::CMSG_REPAIR_ITEM(<CMSG_REPAIR_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x02AA => Ok(Self::MSG_TALENT_WIPE_CONFIRM(<MSG_TALENT_WIPE_CONFIRM_Client as crate::Message>::read_body(&mut r, body_size)?)),
            0x02AC => Ok(Self::CMSG_SUMMON_RESPONSE(<CMSG_SUMMON_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x02B3 => Ok(Self::CMSG_SELF_RES(<CMSG_SELF_RES as crate::Message>::read_body(&mut r, body_size)?)),
            0x02B9 => Ok(Self::CMSG_TOGGLE_HELM(<CMSG_TOGGLE_HELM as crate::Message>::read_body(&mut r, body_size)?)),
            0x02BA => Ok(Self::CMSG_TOGGLE_CLOAK(<CMSG_TOGGLE_CLOAK as crate::Message>::read_body(&mut r, body_size)?)),
            0x02BF => Ok(Self::CMSG_SET_ACTIONBAR_TOGGLES(<CMSG_SET_ACTIONBAR_TOGGLES as crate::Message>::read_body(&mut r, body_size)?)),
            0x02C4 => Ok(Self::CMSG_ITEM_NAME_QUERY(<CMSG_ITEM_NAME_QUERY as crate::Message>::read_body(&mut r, body_size)?)),
            0x02C7 => Ok(Self::CMSG_CHAR_RENAME(<CMSG_CHAR_RENAME as crate::Message>::read_body(&mut r, body_size)?)),
            0x02C9 => Ok(Self::CMSG_MOVE_SPLINE_DONE(<CMSG_MOVE_SPLINE_DONE as crate::Message>::read_body(&mut r, body_size)?)),
            0x02CA => Ok(Self::CMSG_MOVE_FALL_RESET(<CMSG_MOVE_FALL_RESET as crate::Message>::read_body(&mut r, body_size)?)),
            0x02CD => Ok(Self::CMSG_REQUEST_RAID_INFO(<CMSG_REQUEST_RAID_INFO as crate::Message>::read_body(&mut r, body_size)?)),
            0x02CE => Ok(Self::CMSG_MOVE_TIME_SKIPPED(<CMSG_MOVE_TIME_SKIPPED as crate::Message>::read_body(&mut r, body_size)?)),
            0x02CF => Ok(Self::CMSG_MOVE_FEATHER_FALL_ACK(<CMSG_MOVE_FEATHER_FALL_ACK as crate::Message>::read_body(&mut r, body_size)?)),
            0x02D0 => Ok(Self::CMSG_MOVE_WATER_WALK_ACK(<CMSG_MOVE_WATER_WALK_ACK as crate::Message>::read_body(&mut r, body_size)?)),
            0x02D1 => Ok(Self::CMSG_MOVE_NOT_ACTIVE_MOVER(<CMSG_MOVE_NOT_ACTIVE_MOVER as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x02D6 => Ok(Self::MSG_INSPECT_HONOR_STATS(<MSG_INSPECT_HONOR_STATS_Client as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x02E0 => Ok(Self::MSG_PVP_LOG_DATA(<MSG_PVP_LOG_DATA_Client as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x02F0 => Ok(Self::CMSG_PET_UNLEARN(<CMSG_PET_UNLEARN as crate::Message>::read_body(&mut r, body_size)?)),
            0x02F3 => Ok(Self::CMSG_PET_SPELL_AUTOCAST(<CMSG_PET_SPELL_AUTOCAST as crate::Message>::read_body(&mut r, body_size)?)),
            0x02FC => Ok(Self::CMSG_GUILD_INFO_TEXT(<CMSG_GUILD_INFO_TEXT as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x031D => Ok(Self::CMSG_RESET_INSTANCES(<CMSG_RESET_INSTANCES as crate::Message>::read_body(&mut r, body_size)?)),
    ...
    pub fn write_encrypted_client<W: std::io::Write>(&self, w: &mut W, e: &mut EncrypterHalf) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::CMSG_FRIEND_LIST(c) => c.write_encrypted_client(w, e),
            ...
            Self::CMSG_MEETINGSTONE_LEAVE(c) => c.write_encrypted_client(w, e),
    ...
    pub fn write_unencrypted_client<W: std::io::Write>(&self, w: &mut W) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::CMSG_FRIEND_LIST(c) => c.write_unencrypted_client(w),
            ...
            Self::CMSG_MEETINGSTONE_LEAVE(c) => c.write_unencrypted_client(w),
    ...
    pub async fn tokio_write_encrypted_client<W: tokio::io::AsyncWriteExt + Unpin + Send>(&self, w: &mut W, e: &mut EncrypterHalf) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::CMSG_FRIEND_LIST(c) => c.tokio_write_encrypted_client(w, e).await,
            ...
            Self::CMSG_MEETINGSTONE_LEAVE(c) => c.tokio_write_encrypted_client(w, e).await,
    ...
    pub async fn tokio_write_unencrypted_client<W: tokio::io::AsyncWriteExt + Unpin + Send>(&self, w: &mut W) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::CMSG_FRIEND_LIST(c) => c.tokio_write_unencrypted_client(w).await,
            ...
            Self::CMSG_MEETINGSTONE_LEAVE(c) => c.tokio_write_unencrypted_client(w).await,
    ...
    pub async fn astd_write_encrypted_client<W: async_std::io::WriteExt + Unpin + Send>(&self, w: &mut W, e: &mut EncrypterHalf) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::CMSG_FRIEND_LIST(c) => c.astd_write_encrypted_client(w, e).await,
            ...
            Self::CMSG_MEETINGSTONE_LEAVE(c) => c.astd_write_encrypted_client(w, e).await,
    ...
    pub async fn astd_write_unencrypted_client<W: async_std::io::WriteExt + Unpin + Send>(&self, w: &mut W) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::CMSG_FRIEND_LIST(c) => c.astd_write_unencrypted_client(w).await,
            ...
            Self::CMSG_MEETINGSTONE_LEAVE(c) => c.astd_write_unencrypted_client(w).await,
...
impl std::fmt::Display for ClientOpcodeMessage {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            ClientOpcodeMessage::CMSG_FRIEND_LIST(_) => "CMSG_FRIEND_LIST",
            ...
            ClientOpcodeMessage::CMSG_MEETINGSTONE_LEAVE(_) => "CMSG_MEETINGSTONE_LEAVE",
...
use crate::world::vanilla::SMSG_NEW_WORLD;
use crate::world::vanilla::SMSG_TRANSFER_PENDING;
use crate::world::vanilla::SMSG_TRANSFER_ABORTED;
use crate::world::vanilla::SMSG_CHARACTER_LOGIN_FAILED;
use crate::world::vanilla::SMSG_LOGIN_SETTIMESPEED;
use crate::world::vanilla::SMSG_LOGOUT_RESPONSE;
use crate::world::vanilla::SMSG_LOGOUT_COMPLETE;
use crate::world::vanilla::SMSG_LOGOUT_CANCEL_ACK;
use crate::world::vanilla::SMSG_NAME_QUERY_RESPONSE;
use crate::world::vanilla::SMSG_PET_NAME_QUERY_RESPONSE;
use crate::world::vanilla::SMSG_GUILD_QUERY_RESPONSE;
use crate::world::vanilla::SMSG_ITEM_QUERY_SINGLE_RESPONSE;
use crate::world::vanilla::SMSG_PAGE_TEXT_QUERY_RESPONSE;
use crate::world::vanilla::SMSG_QUEST_QUERY_RESPONSE;
use crate::world::vanilla::SMSG_GAMEOBJECT_QUERY_RESPONSE;
use crate::world::vanilla::SMSG_CREATURE_QUERY_RESPONSE;
use crate::world::vanilla::SMSG_WHO;
use crate::world::vanilla::SMSG_WHOIS;
use crate::world::vanilla::SMSG_FRIEND_LIST;
use crate::world::vanilla::SMSG_FRIEND_STATUS;
use crate::world::vanilla::SMSG_IGNORE_LIST;
use crate::world::vanilla::SMSG_GROUP_INVITE;
use crate::world::vanilla::SMSG_GROUP_DECLINE;
use crate::world::vanilla::SMSG_GROUP_UNINVITE;
use crate::world::vanilla::SMSG_GROUP_SET_LEADER;
use crate::world::vanilla::SMSG_GROUP_DESTROYED;
use crate::world::vanilla::SMSG_GROUP_LIST;
use crate::world::vanilla::SMSG_PARTY_MEMBER_STATS;
use crate::world::vanilla::SMSG_PARTY_COMMAND_RESULT;
use crate::world::vanilla::SMSG_GUILD_INVITE;
use crate::world::vanilla::SMSG_GUILD_INFO;
use crate::world::vanilla::SMSG_GUILD_ROSTER;
use crate::world::vanilla::SMSG_GUILD_EVENT;
use crate::world::vanilla::SMSG_GUILD_COMMAND_RESULT;
use crate::world::vanilla::SMSG_MESSAGECHAT;
use crate::world::vanilla::SMSG_CHANNEL_NOTIFY;
use crate::world::vanilla::SMSG_CHANNEL_LIST;
use crate::world::vanilla::SMSG_UPDATE_OBJECT;
use crate::world::vanilla::SMSG_DESTROY_OBJECT;
use crate::world::vanilla::SMSG_READ_ITEM_OK;
use crate::world::vanilla::SMSG_READ_ITEM_FAILED;
use crate::world::vanilla::SMSG_ITEM_COOLDOWN;
use crate::world::vanilla::SMSG_GAMEOBJECT_CUSTOM_ANIM;
use crate::world::vanilla::MSG_MOVE_START_FORWARD_Server;
use crate::world::vanilla::MSG_MOVE_START_BACKWARD_Server;
use crate::world::vanilla::MSG_MOVE_STOP_Server;
use crate::world::vanilla::MSG_MOVE_START_STRAFE_LEFT_Server;
use crate::world::vanilla::MSG_MOVE_START_STRAFE_RIGHT_Server;
use crate::world::vanilla::MSG_MOVE_STOP_STRAFE_Server;
use crate::world::vanilla::MSG_MOVE_JUMP_Server;
use crate::world::vanilla::MSG_MOVE_START_TURN_LEFT_Server;
use crate::world::vanilla::MSG_MOVE_START_TURN_RIGHT_Server;
use crate::world::vanilla::MSG_MOVE_STOP_TURN_Server;
use crate::world::vanilla::MSG_MOVE_START_PITCH_UP_Server;
use crate::world::vanilla::MSG_MOVE_START_PITCH_DOWN_Server;
use crate::world::vanilla::MSG_MOVE_STOP_PITCH_Server;
use crate::world::vanilla::MSG_MOVE_SET_RUN_MODE_Server;
use crate::world::vanilla::MSG_MOVE_SET_WALK_MODE_Server;
use crate::world::vanilla::MSG_MOVE_TELEPORT_ACK_Server;
use crate::world::vanilla::MSG_MOVE_FALL_LAND_Server;
use crate::world::vanilla::MSG_MOVE_START_SWIM_Server;
use crate::world::vanilla::MSG_MOVE_STOP_SWIM_Server;
use crate::world::vanilla::MSG_MOVE_SET_FACING_Server;
use crate::world::vanilla::MSG_MOVE_SET_PITCH_Server;
use crate::world::vanilla::SMSG_MONSTER_MOVE;
use crate::world::vanilla::SMSG_MOVE_WATER_WALK;
use crate::world::vanilla::SMSG_MOVE_LAND_WALK;
use crate::world::vanilla::SMSG_FORCE_RUN_SPEED_CHANGE;
use crate::world::vanilla::SMSG_FORCE_RUN_BACK_SPEED_CHANGE;
use crate::world::vanilla::SMSG_FORCE_SWIM_SPEED_CHANGE;
use crate::world::vanilla::SMSG_FORCE_MOVE_ROOT;
use crate::world::vanilla::SMSG_FORCE_MOVE_UNROOT;
use crate::world::vanilla::MSG_MOVE_HEARTBEAT_Server;
use crate::world::vanilla::SMSG_MOVE_KNOCK_BACK;
use crate::world::vanilla::SMSG_MOVE_FEATHER_FALL;
use crate::world::vanilla::SMSG_MOVE_NORMAL_FALL;
use crate::world::vanilla::SMSG_MOVE_SET_HOVER;
use crate::world::vanilla::SMSG_MOVE_UNSET_HOVER;
use crate::world::vanilla::SMSG_TRIGGER_CINEMATIC;
use crate::world::vanilla::SMSG_TUTORIAL_FLAGS;
use crate::world::vanilla::SMSG_EMOTE;
use crate::world::vanilla::SMSG_TEXT_EMOTE;
use crate::world::vanilla::SMSG_INVENTORY_CHANGE_FAILURE;
use crate::world::vanilla::SMSG_OPEN_CONTAINER;
use crate::world::vanilla::SMSG_INSPECT;
use crate::world::vanilla::SMSG_TRADE_STATUS;
use crate::world::vanilla::SMSG_TRADE_STATUS_EXTENDED;
use crate::world::vanilla::SMSG_INITIALIZE_FACTIONS;
use crate::world::vanilla::SMSG_SET_FACTION_VISIBLE;
use crate::world::vanilla::SMSG_SET_FACTION_STANDING;
use crate::world::vanilla::SMSG_SET_PROFICIENCY;
use crate::world::vanilla::SMSG_ACTION_BUTTONS;
use crate::world::vanilla::SMSG_INITIAL_SPELLS;
use crate::world::vanilla::SMSG_LEARNED_SPELL;
use crate::world::vanilla::SMSG_SUPERCEDED_SPELL;
use crate::world::vanilla::SMSG_CAST_RESULT;
use crate::world::vanilla::SMSG_SPELL_START;
use crate::world::vanilla::SMSG_SPELL_GO;
use crate::world::vanilla::SMSG_SPELL_FAILURE;
use crate::world::vanilla::SMSG_SPELL_COOLDOWN;
use crate::world::vanilla::SMSG_COOLDOWN_EVENT;
use crate::world::vanilla::SMSG_UPDATE_AURA_DURATION;
use crate::world::vanilla::SMSG_PET_CAST_FAILED;
use crate::world::vanilla::SMSG_AI_REACTION;
use crate::world::vanilla::SMSG_ATTACKSTART;
use crate::world::vanilla::SMSG_ATTACKSTOP;
use crate::world::vanilla::SMSG_ATTACKSWING_NOTINRANGE;
use crate::world::vanilla::SMSG_ATTACKSWING_BADFACING;
use crate::world::vanilla::SMSG_ATTACKSWING_NOTSTANDING;
use crate::world::vanilla::SMSG_ATTACKSWING_DEADTARGET;
use crate::world::vanilla::SMSG_ATTACKSWING_CANT_ATTACK;
use crate::world::vanilla::SMSG_ATTACKERSTATEUPDATE;
use crate::world::vanilla::SMSG_CANCEL_COMBAT;
use crate::world::vanilla::SMSG_SPELLHEALLOG;
use crate::world::vanilla::SMSG_SPELLENERGIZELOG;
use crate::world::vanilla::SMSG_BINDPOINTUPDATE;
use crate::world::vanilla::SMSG_PLAYERBOUND;
use crate::world::vanilla::SMSG_CLIENT_CONTROL_UPDATE;
use crate::world::vanilla::SMSG_RESURRECT_REQUEST;
use crate::world::vanilla::SMSG_LOOT_RESPONSE;
use crate::world::vanilla::SMSG_LOOT_RELEASE_RESPONSE;
use crate::world::vanilla::SMSG_LOOT_REMOVED;
use crate::world::vanilla::SMSG_LOOT_MONEY_NOTIFY;
use crate::world::vanilla::SMSG_LOOT_CLEAR_MONEY;
use crate::world::vanilla::SMSG_ITEM_PUSH_RESULT;
use crate::world::vanilla::SMSG_DUEL_REQUESTED;
use crate::world::vanilla::SMSG_DUEL_OUTOFBOUNDS;
use crate::world::vanilla::SMSG_DUEL_INBOUNDS;
use crate::world::vanilla::SMSG_DUEL_COMPLETE;
use crate::world::vanilla::SMSG_DUEL_WINNER;
use crate::world::vanilla::SMSG_MOUNTRESULT;
use crate::world::vanilla::SMSG_DISMOUNTRESULT;
use crate::world::vanilla::SMSG_MOUNTSPECIAL_ANIM;
use crate::world::vanilla::SMSG_PET_TAME_FAILURE;
use crate::world::vanilla::SMSG_PET_NAME_INVALID;
use crate::world::vanilla::SMSG_PET_SPELLS;
use crate::world::vanilla::SMSG_PET_MODE;
use crate::world::vanilla::SMSG_GOSSIP_MESSAGE;
use crate::world::vanilla::SMSG_GOSSIP_COMPLETE;
use crate::world::vanilla::SMSG_NPC_TEXT_UPDATE;
use crate::world::vanilla::SMSG_QUESTGIVER_STATUS;
use crate::world::vanilla::SMSG_QUESTGIVER_QUEST_LIST;
use crate::world::vanilla::SMSG_QUESTGIVER_QUEST_DETAILS;
use crate::world::vanilla::SMSG_QUESTGIVER_REQUEST_ITEMS;
use crate::world::vanilla::SMSG_QUESTGIVER_OFFER_REWARD;
use crate::world::vanilla::SMSG_QUESTGIVER_QUEST_INVALID;
use crate::world::vanilla::SMSG_QUESTGIVER_QUEST_COMPLETE;
use crate::world::vanilla::SMSG_QUESTGIVER_QUEST_FAILED;
use crate::world::vanilla::SMSG_QUESTLOG_FULL;
use crate::world::vanilla::SMSG_QUESTUPDATE_FAILED;
use crate::world::vanilla::SMSG_QUESTUPDATE_FAILEDTIMER;
use crate::world::vanilla::SMSG_QUESTUPDATE_COMPLETE;
use crate::world::vanilla::SMSG_QUESTUPDATE_ADD_KILL;
use crate::world::vanilla::SMSG_QUESTUPDATE_ADD_ITEM;
use crate::world::vanilla::SMSG_QUEST_CONFIRM_ACCEPT;
use crate::world::vanilla::SMSG_LIST_INVENTORY;
use crate::world::vanilla::SMSG_SELL_ITEM;
use crate::world::vanilla::SMSG_BUY_ITEM;
use crate::world::vanilla::SMSG_BUY_FAILED;
use crate::world::vanilla::SMSG_SHOWTAXINODES;
use crate::world::vanilla::SMSG_TAXINODE_STATUS;
use crate::world::vanilla::SMSG_ACTIVATETAXIREPLY;
use crate::world::vanilla::SMSG_NEW_TAXI_PATH;
use crate::world::vanilla::SMSG_TRAINER_LIST;
use crate::world::vanilla::SMSG_TRAINER_BUY_SUCCEEDED;
use crate::world::vanilla::SMSG_TRAINER_BUY_FAILED;
use crate::world::vanilla::SMSG_SHOW_BANK;
use crate::world::vanilla::SMSG_BUY_BANK_SLOT_RESULT;
use crate::world::vanilla::SMSG_PETITION_SHOWLIST;
use crate::world::vanilla::SMSG_PETITION_SHOW_SIGNATURES;
use crate::world::vanilla::SMSG_PETITION_SIGN_RESULTS;
use crate::world::vanilla::SMSG_TURN_IN_PETITION_RESULTS;
use crate::world::vanilla::SMSG_PETITION_QUERY_RESPONSE;
use crate::world::vanilla::SMSG_FISH_NOT_HOOKED;
use crate::world::vanilla::SMSG_FISH_ESCAPED;
use crate::world::vanilla::SMSG_NOTIFICATION;
use crate::world::vanilla::SMSG_PLAYED_TIME;
use crate::world::vanilla::SMSG_QUERY_TIME_RESPONSE;
use crate::world::vanilla::SMSG_LOG_XPGAIN;
use crate::world::vanilla::SMSG_LEVELUP_INFO;
use crate::world::vanilla::MSG_MINIMAP_PING_Server;
use crate::world::vanilla::SMSG_RESISTLOG;
use crate::world::vanilla::SMSG_ENCHANTMENTLOG;
use crate::world::vanilla::SMSG_START_MIRROR_TIMER;
use crate::world::vanilla::SMSG_PAUSE_MIRROR_TIMER;
use crate::world::vanilla::SMSG_STOP_MIRROR_TIMER;
use crate::world::vanilla::SMSG_PONG;
use crate::world::vanilla::SMSG_CLEAR_COOLDOWN;
use crate::world::vanilla::SMSG_GAMEOBJECT_PAGETEXT;
use crate::world::vanilla::SMSG_SPELL_DELAYED;
use crate::world::vanilla::SMSG_ITEM_TIME_UPDATE;
use crate::world::vanilla::SMSG_ITEM_ENCHANT_TIME_UPDATE;
use crate::world::vanilla::SMSG_AUTH_CHALLENGE;
use crate::world::vanilla::SMSG_AUTH_RESPONSE;
...
use crate::world::vanilla::SMSG_GMTICKET_UPDATETEXT;
use crate::world::vanilla::SMSG_ACCOUNT_DATA_TIMES;
use crate::world::vanilla::SMSG_GMTICKET_GETTICKET;
use crate::world::vanilla::SMSG_GAMEOBJECT_SPAWN_ANIM;
use crate::world::vanilla::SMSG_GAMEOBJECT_DESPAWN_ANIM;
use crate::world::vanilla::MSG_CORPSE_QUERY_Server;
use crate::world::vanilla::SMSG_GMTICKET_DELETETICKET;
use crate::world::vanilla::SMSG_CHAT_WRONG_FACTION;
use crate::world::vanilla::SMSG_GMTICKET_SYSTEMSTATUS;
use crate::world::vanilla::SMSG_SET_REST_START;
...
use crate::world::vanilla::SMSG_SPELLLOGMISS;
use crate::world::vanilla::SMSG_SPELLLOGEXECUTE;
use crate::world::vanilla::SMSG_PERIODICAURALOG;
use crate::world::vanilla::SMSG_SPELLDAMAGESHIELD;
...
use crate::world::vanilla::SMSG_AUCTION_OWNER_NOTIFICATION;
use crate::world::vanilla::SMSG_PROCRESIST;
use crate::world::vanilla::SMSG_DISPEL_FAILED;
use crate::world::vanilla::SMSG_SPELLORDAMAGE_IMMUNE;
use crate::world::vanilla::SMSG_AUCTION_BIDDER_LIST_RESULT;
use crate::world::vanilla::SMSG_SET_FLAT_SPELL_MODIFIER;
use crate::world::vanilla::SMSG_SET_PCT_SPELL_MODIFIER;
use crate::world::vanilla::SMSG_CORPSE_RECLAIM_DELAY;
use crate::world::vanilla::MSG_LIST_STABLED_PETS_Server;
use crate::world::vanilla::SMSG_STABLE_RESULT;
use crate::world::vanilla::SMSG_PLAY_MUSIC;
use crate::world::vanilla::SMSG_PLAY_OBJECT_SOUND;
use crate::world::vanilla::SMSG_SPELLDISPELLOG;
use crate::world::vanilla::MSG_QUERY_NEXT_MAIL_TIME_Server;
use crate::world::vanilla::SMSG_RECEIVED_MAIL;
use crate::world::vanilla::SMSG_RAID_GROUP_ONLY;
use crate::world::vanilla::SMSG_PVP_CREDIT;
use crate::world::vanilla::SMSG_AUCTION_REMOVED_NOTIFICATION;
use crate::world::vanilla::SMSG_SERVER_MESSAGE;
use crate::world::vanilla::SMSG_MEETINGSTONE_SETQUEUE;
use crate::world::vanilla::SMSG_MEETINGSTONE_COMPLETE;
use crate::world::vanilla::SMSG_MEETINGSTONE_IN_PROGRESS;
use crate::world::vanilla::SMSG_MEETINGSTONE_MEMBER_ADDED;
use crate::world::vanilla::SMSG_CANCEL_AUTO_REPEAT;
use crate::world::vanilla::SMSG_STANDSTATE_UPDATE;
use crate::world::vanilla::SMSG_LOOT_ALL_PASSED;
use crate::world::vanilla::SMSG_LOOT_ROLL_WON;
use crate::world::vanilla::SMSG_LOOT_START_ROLL;
use crate::world::vanilla::SMSG_LOOT_ROLL;
use crate::world::vanilla::SMSG_LOOT_MASTER_LIST;
use crate::world::vanilla::SMSG_SET_FORCED_REACTIONS;
use crate::world::vanilla::SMSG_SPELL_FAILED_OTHER;
use crate::world::vanilla::SMSG_GAMEOBJECT_RESET_STATE;
use crate::world::vanilla::SMSG_CHAT_PLAYER_NOT_FOUND;
use crate::world::vanilla::MSG_TALENT_WIPE_CONFIRM_Server;
...
use crate::world::vanilla::SMSG_MEETINGSTONE_JOINFAILED;
...
use crate::world::vanilla::SMSG_INSTANCE_SAVE_CREATED;
use crate::world::vanilla::SMSG_RAID_INSTANCE_INFO;
use crate::world::vanilla::SMSG_PLAY_SOUND;
use crate::world::vanilla::SMSG_BATTLEFIELD_STATUS;
use crate::world::vanilla::MSG_INSPECT_HONOR_STATS_Server;
use crate::world::vanilla::SMSG_FORCE_WALK_SPEED_CHANGE;
use crate::world::vanilla::SMSG_FORCE_SWIM_BACK_SPEED_CHANGE;
...
use crate::world::vanilla::SMSG_SPLINE_SET_SWIM_SPEED;
use crate::world::vanilla::SMSG_SPLINE_SET_WALK_SPEED;
use crate::world::vanilla::SMSG_SPLINE_SET_SWIM_BACK_SPEED;
use crate::world::vanilla::SMSG_SPLINE_SET_TURN_RATE;
use crate::world::vanilla::SMSG_SPLINE_MOVE_UNROOT;
use crate::world::vanilla::SMSG_SPLINE_MOVE_FEATHER_FALL;
use crate::world::vanilla::SMSG_SPLINE_MOVE_NORMAL_FALL;
use crate::world::vanilla::SMSG_SPLINE_MOVE_SET_HOVER;
use crate::world::vanilla::SMSG_SPLINE_MOVE_UNSET_HOVER;
use crate::world::vanilla::SMSG_SPLINE_MOVE_WATER_WALK;
use crate::world::vanilla::SMSG_SPLINE_MOVE_LAND_WALK;
use crate::world::vanilla::SMSG_SPLINE_MOVE_START_SWIM;
use crate::world::vanilla::SMSG_SPLINE_MOVE_STOP_SWIM;
use crate::world::vanilla::SMSG_SPLINE_MOVE_SET_RUN_MODE;
use crate::world::vanilla::SMSG_SPLINE_MOVE_SET_WALK_MODE;
use crate::world::vanilla::SMSG_SPLINE_MOVE_ROOT;
use crate::world::vanilla::SMSG_INVALIDATE_PLAYER;
use crate::world::vanilla::SMSG_INSTANCE_RESET;
use crate::world::vanilla::SMSG_INSTANCE_RESET_FAILED;
use crate::world::vanilla::SMSG_UPDATE_LAST_INSTANCE;
use crate::world::vanilla::MSG_RAID_TARGET_UPDATE_Server;
use crate::world::vanilla::MSG_RAID_READY_CHECK_Server;
use crate::world::vanilla::SMSG_PET_ACTION_SOUND;
use crate::world::vanilla::SMSG_PET_DISMISS_SOUND;
use crate::world::vanilla::SMSG_GM_TICKET_STATUS_UPDATE;
use crate::world::vanilla::SMSG_UPDATE_INSTANCE_OWNERSHIP;
use crate::world::vanilla::SMSG_SPELLINSTAKILLLOG;
...
use crate::world::vanilla::MSG_MOVE_START_ASCEND_Server;
...
impl ServerOpcodeMessage {
    fn read_opcodes(opcode: u16, body_size: u32, mut r: &[u8]) -> std::result::Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x0040 => Ok(Self::SMSG_TRANSFER_ABORTED(<SMSG_TRANSFER_ABORTED as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0053 => Ok(Self::SMSG_PET_NAME_QUERY_RESPONSE(<SMSG_PET_NAME_QUERY_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0055 => Ok(Self::SMSG_GUILD_QUERY_RESPONSE(<SMSG_GUILD_QUERY_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0058 => Ok(Self::SMSG_ITEM_QUERY_SINGLE_RESPONSE(<SMSG_ITEM_QUERY_SINGLE_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x005B => Ok(Self::SMSG_PAGE_TEXT_QUERY_RESPONSE(<SMSG_PAGE_TEXT_QUERY_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x005D => Ok(Self::SMSG_QUEST_QUERY_RESPONSE(<SMSG_QUEST_QUERY_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x005F => Ok(Self::SMSG_GAMEOBJECT_QUERY_RESPONSE(<SMSG_GAMEOBJECT_QUERY_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0061 => Ok(Self::SMSG_CREATURE_QUERY_RESPONSE(<SMSG_CREATURE_QUERY_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0063 => Ok(Self::SMSG_WHO(<SMSG_WHO as crate::Message>::read_body(&mut r, body_size)?)),
            0x0065 => Ok(Self::SMSG_WHOIS(<SMSG_WHOIS as crate::Message>::read_body(&mut r, body_size)?)),
            0x0067 => Ok(Self::SMSG_FRIEND_LIST(<SMSG_FRIEND_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x0068 => Ok(Self::SMSG_FRIEND_STATUS(<SMSG_FRIEND_STATUS as crate::Message>::read_body(&mut r, body_size)?)),
            0x006B => Ok(Self::SMSG_IGNORE_LIST(<SMSG_IGNORE_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x006F => Ok(Self::SMSG_GROUP_INVITE(<SMSG_GROUP_INVITE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0074 => Ok(Self::SMSG_GROUP_DECLINE(<SMSG_GROUP_DECLINE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0077 => Ok(Self::SMSG_GROUP_UNINVITE(<SMSG_GROUP_UNINVITE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0079 => Ok(Self::SMSG_GROUP_SET_LEADER(<SMSG_GROUP_SET_LEADER as crate::Message>::read_body(&mut r, body_size)?)),
            0x007C => Ok(Self::SMSG_GROUP_DESTROYED(<SMSG_GROUP_DESTROYED as crate::Message>::read_body(&mut r, body_size)?)),
            0x007D => Ok(Self::SMSG_GROUP_LIST(<SMSG_GROUP_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x007E => Ok(Self::SMSG_PARTY_MEMBER_STATS(<SMSG_PARTY_MEMBER_STATS as crate::Message>::read_body(&mut r, body_size)?)),
            0x007F => Ok(Self::SMSG_PARTY_COMMAND_RESULT(<SMSG_PARTY_COMMAND_RESULT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0083 => Ok(Self::SMSG_GUILD_INVITE(<SMSG_GUILD_INVITE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0088 => Ok(Self::SMSG_GUILD_INFO(<SMSG_GUILD_INFO as crate::Message>::read_body(&mut r, body_size)?)),
            0x008A => Ok(Self::SMSG_GUILD_ROSTER(<SMSG_GUILD_ROSTER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0092 => Ok(Self::SMSG_GUILD_EVENT(<SMSG_GUILD_EVENT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0093 => Ok(Self::SMSG_GUILD_COMMAND_RESULT(<SMSG_GUILD_COMMAND_RESULT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0096 => Ok(Self::SMSG_MESSAGECHAT(<SMSG_MESSAGECHAT as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x00AE => Ok(Self::SMSG_READ_ITEM_OK(<SMSG_READ_ITEM_OK as crate::Message>::read_body(&mut r, body_size)?)),
            0x00AF => Ok(Self::SMSG_READ_ITEM_FAILED(<SMSG_READ_ITEM_FAILED as crate::Message>::read_body(&mut r, body_size)?)),
            0x00B0 => Ok(Self::SMSG_ITEM_COOLDOWN(<SMSG_ITEM_COOLDOWN as crate::Message>::read_body(&mut r, body_size)?)),
            0x00B3 => Ok(Self::SMSG_GAMEOBJECT_CUSTOM_ANIM(<SMSG_GAMEOBJECT_CUSTOM_ANIM as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x00DD => Ok(Self::SMSG_MONSTER_MOVE(<SMSG_MONSTER_MOVE as crate::Message>::read_body(&mut r, body_size)?)),
            0x00DE => Ok(Self::SMSG_MOVE_WATER_WALK(<SMSG_MOVE_WATER_WALK as crate::Message>::read_body(&mut r, body_size)?)),
            0x00DF => Ok(Self::SMSG_MOVE_LAND_WALK(<SMSG_MOVE_LAND_WALK as crate::Message>::read_body(&mut r, body_size)?)),
            0x00E2 => Ok(Self::SMSG_FORCE_RUN_SPEED_CHANGE(<SMSG_FORCE_RUN_SPEED_CHANGE as crate::Message>::read_body(&mut r, body_size)?)),
            0x00E4 => Ok(Self::SMSG_FORCE_RUN_BACK_SPEED_CHANGE(<SMSG_FORCE_RUN_BACK_SPEED_CHANGE as crate::Message>::read_body(&mut r, body_size)?)),
            0x00E6 => Ok(Self::SMSG_FORCE_SWIM_SPEED_CHANGE(<SMSG_FORCE_SWIM_SPEED_CHANGE as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x00EF => Ok(Self::SMSG_MOVE_KNOCK_BACK(<SMSG_MOVE_KNOCK_BACK as crate::Message>::read_body(&mut r, body_size)?)),
            0x00F2 => Ok(Self::SMSG_MOVE_FEATHER_FALL(<SMSG_MOVE_FEATHER_FALL as crate::Message>::read_body(&mut r, body_size)?)),
            0x00F3 => Ok(Self::SMSG_MOVE_NORMAL_FALL(<SMSG_MOVE_NORMAL_FALL as crate::Message>::read_body(&mut r, body_size)?)),
            0x00F4 => Ok(Self::SMSG_MOVE_SET_HOVER(<SMSG_MOVE_SET_HOVER as crate::Message>::read_body(&mut r, body_size)?)),
            0x00F5 => Ok(Self::SMSG_MOVE_UNSET_HOVER(<SMSG_MOVE_UNSET_HOVER as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0112 => Ok(Self::SMSG_INVENTORY_CHANGE_FAILURE(<SMSG_INVENTORY_CHANGE_FAILURE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0113 => Ok(Self::SMSG_OPEN_CONTAINER(<SMSG_OPEN_CONTAINER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0115 => Ok(Self::SMSG_INSPECT(<SMSG_INSPECT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0120 => Ok(Self::SMSG_TRADE_STATUS(<SMSG_TRADE_STATUS as crate::Message>::read_body(&mut r, body_size)?)),
            0x0121 => Ok(Self::SMSG_TRADE_STATUS_EXTENDED(<SMSG_TRADE_STATUS_EXTENDED as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0127 => Ok(Self::SMSG_SET_PROFICIENCY(<SMSG_SET_PROFICIENCY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0129 => Ok(Self::SMSG_ACTION_BUTTONS(<SMSG_ACTION_BUTTONS as crate::Message>::read_body(&mut r, body_size)?)),
            0x012A => Ok(Self::SMSG_INITIAL_SPELLS(<SMSG_INITIAL_SPELLS as crate::Message>::read_body(&mut r, body_size)?)),
            0x012B => Ok(Self::SMSG_LEARNED_SPELL(<SMSG_LEARNED_SPELL as crate::Message>::read_body(&mut r, body_size)?)),
            0x012C => Ok(Self::SMSG_SUPERCEDED_SPELL(<SMSG_SUPERCEDED_SPELL as crate::Message>::read_body(&mut r, body_size)?)),
            0x0130 => Ok(Self::SMSG_CAST_RESULT(<SMSG_CAST_RESULT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0131 => Ok(Self::SMSG_SPELL_START(<SMSG_SPELL_START as crate::Message>::read_body(&mut r, body_size)?)),
            0x0132 => Ok(Self::SMSG_SPELL_GO(<SMSG_SPELL_GO as crate::Message>::read_body(&mut r, body_size)?)),
            0x0133 => Ok(Self::SMSG_SPELL_FAILURE(<SMSG_SPELL_FAILURE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0134 => Ok(Self::SMSG_SPELL_COOLDOWN(<SMSG_SPELL_COOLDOWN as crate::Message>::read_body(&mut r, body_size)?)),
            0x0135 => Ok(Self::SMSG_COOLDOWN_EVENT(<SMSG_COOLDOWN_EVENT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0137 => Ok(Self::SMSG_UPDATE_AURA_DURATION(<SMSG_UPDATE_AURA_DURATION as crate::Message>::read_body(&mut r, body_size)?)),
            0x0138 => Ok(Self::SMSG_PET_CAST_FAILED(<SMSG_PET_CAST_FAILED as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0150 => Ok(Self::SMSG_SPELLHEALLOG(<SMSG_SPELLHEALLOG as crate::Message>::read_body(&mut r, body_size)?)),
            0x0151 => Ok(Self::SMSG_SPELLENERGIZELOG(<SMSG_SPELLENERGIZELOG as crate::Message>::read_body(&mut r, body_size)?)),
            0x0155 => Ok(Self::SMSG_BINDPOINTUPDATE(<SMSG_BINDPOINTUPDATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0158 => Ok(Self::SMSG_PLAYERBOUND(<SMSG_PLAYERBOUND as crate::Message>::read_body(&mut r, body_size)?)),
            0x0159 => Ok(Self::SMSG_CLIENT_CONTROL_UPDATE(<SMSG_CLIENT_CONTROL_UPDATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x015B => Ok(Self::SMSG_RESURRECT_REQUEST(<SMSG_RESURRECT_REQUEST as crate::Message>::read_body(&mut r, body_size)?)),
            0x0160 => Ok(Self::SMSG_LOOT_RESPONSE(<SMSG_LOOT_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0161 => Ok(Self::SMSG_LOOT_RELEASE_RESPONSE(<SMSG_LOOT_RELEASE_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0162 => Ok(Self::SMSG_LOOT_REMOVED(<SMSG_LOOT_REMOVED as crate::Message>::read_body(&mut r, body_size)?)),
            0x0163 => Ok(Self::SMSG_LOOT_MONEY_NOTIFY(<SMSG_LOOT_MONEY_NOTIFY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0165 => Ok(Self::SMSG_LOOT_CLEAR_MONEY(<SMSG_LOOT_CLEAR_MONEY as crate::Message>::read_body(&mut r, body_size)?)),
            0x0166 => Ok(Self::SMSG_ITEM_PUSH_RESULT(<SMSG_ITEM_PUSH_RESULT as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x016E => Ok(Self::SMSG_MOUNTRESULT(<SMSG_MOUNTRESULT as crate::Message>::read_body(&mut r, body_size)?)),
            0x016F => Ok(Self::SMSG_DISMOUNTRESULT(<SMSG_DISMOUNTRESULT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0172 => Ok(Self::SMSG_MOUNTSPECIAL_ANIM(<SMSG_MOUNTSPECIAL_ANIM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0173 => Ok(Self::SMSG_PET_TAME_FAILURE(<SMSG_PET_TAME_FAILURE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0178 => Ok(Self::SMSG_PET_NAME_INVALID(<SMSG_PET_NAME_INVALID as crate::Message>::read_body(&mut r, body_size)?)),
            0x0179 => Ok(Self::SMSG_PET_SPELLS(<SMSG_PET_SPELLS as crate::Message>::read_body(&mut r, body_size)?)),
            0x017A => Ok(Self::SMSG_PET_MODE(<SMSG_PET_MODE as crate::Message>::read_body(&mut r, body_size)?)),
            0x017D => Ok(Self::SMSG_GOSSIP_MESSAGE(<SMSG_GOSSIP_MESSAGE as crate::Message>::read_body(&mut r, body_size)?)),
            0x017E => Ok(Self::SMSG_GOSSIP_COMPLETE(<SMSG_GOSSIP_COMPLETE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0180 => Ok(Self::SMSG_NPC_TEXT_UPDATE(<SMSG_NPC_TEXT_UPDATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0183 => Ok(Self::SMSG_QUESTGIVER_STATUS(<SMSG_QUESTGIVER_STATUS as crate::Message>::read_body(&mut r, body_size)?)),
            0x0185 => Ok(Self::SMSG_QUESTGIVER_QUEST_LIST(<SMSG_QUESTGIVER_QUEST_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x0188 => Ok(Self::SMSG_QUESTGIVER_QUEST_DETAILS(<SMSG_QUESTGIVER_QUEST_DETAILS as crate::Message>::read_body(&mut r, body_size)?)),
            0x018B => Ok(Self::SMSG_QUESTGIVER_REQUEST_ITEMS(<SMSG_QUESTGIVER_REQUEST_ITEMS as crate::Message>::read_body(&mut r, body_size)?)),
            0x018D => Ok(Self::SMSG_QUESTGIVER_OFFER_REWARD(<SMSG_QUESTGIVER_OFFER_REWARD as crate::Message>::read_body(&mut r, body_size)?)),
            0x018F => Ok(Self::SMSG_QUESTGIVER_QUEST_INVALID(<SMSG_QUESTGIVER_QUEST_INVALID as crate::Message>::read_body(&mut r, body_size)?)),
            0x0191 => Ok(Self::SMSG_QUESTGIVER_QUEST_COMPLETE(<SMSG_QUESTGIVER_QUEST_COMPLETE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0192 => Ok(Self::SMSG_QUESTGIVER_QUEST_FAILED(<SMSG_QUESTGIVER_QUEST_FAILED as crate::Message>::read_body(&mut r, body_size)?)),
            0x0195 => Ok(Self::SMSG_QUESTLOG_FULL(<SMSG_QUESTLOG_FULL as crate::Message>::read_body(&mut r, body_size)?)),
            0x0196 => Ok(Self::SMSG_QUESTUPDATE_FAILED(<SMSG_QUESTUPDATE_FAILED as crate::Message>::read_body(&mut r, body_size)?)),
            0x0197 => Ok(Self::SMSG_QUESTUPDATE_FAILEDTIMER(<SMSG_QUESTUPDATE_FAILEDTIMER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0198 => Ok(Self::SMSG_QUESTUPDATE_COMPLETE(<SMSG_QUESTUPDATE_COMPLETE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0199 => Ok(Self::SMSG_QUESTUPDATE_ADD_KILL(<SMSG_QUESTUPDATE_ADD_KILL as crate::Message>::read_body(&mut r, body_size)?)),
            0x019A => Ok(Self::SMSG_QUESTUPDATE_ADD_ITEM(<SMSG_QUESTUPDATE_ADD_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x019C => Ok(Self::SMSG_QUEST_CONFIRM_ACCEPT(<SMSG_QUEST_CONFIRM_ACCEPT as crate::Message>::read_body(&mut r, body_size)?)),
            0x019F => Ok(Self::SMSG_LIST_INVENTORY(<SMSG_LIST_INVENTORY as crate::Message>::read_body(&mut r, body_size)?)),
            0x01A1 => Ok(Self::SMSG_SELL_ITEM(<SMSG_SELL_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x01A4 => Ok(Self::SMSG_BUY_ITEM(<SMSG_BUY_ITEM as crate::Message>::read_body(&mut r, body_size)?)),
            0x01A5 => Ok(Self::SMSG_BUY_FAILED(<SMSG_BUY_FAILED as crate::Message>::read_body(&mut r, body_size)?)),
            0x01A9 => Ok(Self::SMSG_SHOWTAXINODES(<SMSG_SHOWTAXINODES as crate::Message>::read_body(&mut r, body_size)?)),
            0x01AB => Ok(Self::SMSG_TAXINODE_STATUS(<SMSG_TAXINODE_STATUS as crate::Message>::read_body(&mut r, body_size)?)),
            0x01AE => Ok(Self::SMSG_ACTIVATETAXIREPLY(<SMSG_ACTIVATETAXIREPLY as crate::Message>::read_body(&mut r, body_size)?)),
            0x01AF => Ok(Self::SMSG_NEW_TAXI_PATH(<SMSG_NEW_TAXI_PATH as crate::Message>::read_body(&mut r, body_size)?)),
            0x01B1 => Ok(Self::SMSG_TRAINER_LIST(<SMSG_TRAINER_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x01B3 => Ok(Self::SMSG_TRAINER_BUY_SUCCEEDED(<SMSG_TRAINER_BUY_SUCCEEDED as crate::Message>::read_body(&mut r, body_size)?)),
            0x01B4 => Ok(Self::SMSG_TRAINER_BUY_FAILED(<SMSG_TRAINER_BUY_FAILED as crate::Message>::read_body(&mut r, body_size)?)),
            0x01B8 => Ok(Self::SMSG_SHOW_BANK(<SMSG_SHOW_BANK as crate::Message>::read_body(&mut r, body_size)?)),
            0x01BA => Ok(Self::SMSG_BUY_BANK_SLOT_RESULT(<SMSG_BUY_BANK_SLOT_RESULT as crate::Message>::read_body(&mut r, body_size)?)),
            0x01BC => Ok(Self::SMSG_PETITION_SHOWLIST(<SMSG_PETITION_SHOWLIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x01BF => Ok(Self::SMSG_PETITION_SHOW_SIGNATURES(<SMSG_PETITION_SHOW_SIGNATURES as crate::Message>::read_body(&mut r, body_size)?)),
            0x01C1 => Ok(Self::SMSG_PETITION_SIGN_RESULTS(<SMSG_PETITION_SIGN_RESULTS as crate::Message>::read_body(&mut r, body_size)?)),
            0x01C5 => Ok(Self::SMSG_TURN_IN_PETITION_RESULTS(<SMSG_TURN_IN_PETITION_RESULTS as crate::Message>::read_body(&mut r, body_size)?)),
            0x01C7 => Ok(Self::SMSG_PETITION_QUERY_RESPONSE(<SMSG_PETITION_QUERY_RESPONSE as crate::Message>::read_body(&mut r, body_size)?)),
            0x01C8 => Ok(Self::SMSG_FISH_NOT_HOOKED(<SMSG_FISH_NOT_HOOKED as crate::Message>::read_body(&mut r, body_size)?)),
            0x01C9 => Ok(Self::SMSG_FISH_ESCAPED(<SMSG_FISH_ESCAPED as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x01D5 => Ok(Self::MSG_MINIMAP_PING(<MSG_MINIMAP_PING_Server as crate::Message>::read_body(&mut r, body_size)?)),
            0x01D6 => Ok(Self::SMSG_RESISTLOG(<SMSG_RESISTLOG as crate::Message>::read_body(&mut r, body_size)?)),
            0x01D7 => Ok(Self::SMSG_ENCHANTMENTLOG(<SMSG_ENCHANTMENTLOG as crate::Message>::read_body(&mut r, body_size)?)),
            0x01D9 => Ok(Self::SMSG_START_MIRROR_TIMER(<SMSG_START_MIRROR_TIMER as crate::Message>::read_body(&mut r, body_size)?)),
            0x01DA => Ok(Self::SMSG_PAUSE_MIRROR_TIMER(<SMSG_PAUSE_MIRROR_TIMER as crate::Message>::read_body(&mut r, body_size)?)),
            0x01DB => Ok(Self::SMSG_STOP_MIRROR_TIMER(<SMSG_STOP_MIRROR_TIMER as crate::Message>::read_body(&mut r, body_size)?)),
            0x01DD => Ok(Self::SMSG_PONG(<SMSG_PONG as crate::Message>::read_body(&mut r, body_size)?)),
            0x01DE => Ok(Self::SMSG_CLEAR_COOLDOWN(<SMSG_CLEAR_COOLDOWN as crate::Message>::read_body(&mut r, body_size)?)),
            0x01DF => Ok(Self::SMSG_GAMEOBJECT_PAGETEXT(<SMSG_GAMEOBJECT_PAGETEXT as crate::Message>::read_body(&mut r, body_size)?)),
            0x01E2 => Ok(Self::SMSG_SPELL_DELAYED(<SMSG_SPELL_DELAYED as crate::Message>::read_body(&mut r, body_size)?)),
            0x01EA => Ok(Self::SMSG_ITEM_TIME_UPDATE(<SMSG_ITEM_TIME_UPDATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x01EB => Ok(Self::SMSG_ITEM_ENCHANT_TIME_UPDATE(<SMSG_ITEM_ENCHANT_TIME_UPDATE as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x01FF => Ok(Self::MSG_LOOKING_FOR_GROUP(<MSG_LOOKING_FOR_GROUP_Server as crate::Message>::read_body(&mut r, body_size)?)),
            0x0203 => Ok(Self::SMSG_REMOVED_SPELL(<SMSG_REMOVED_SPELL as crate::Message>::read_body(&mut r, body_size)?)),
            0x0206 => Ok(Self::SMSG_GMTICKET_CREATE(<SMSG_GMTICKET_CREATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0208 => Ok(Self::SMSG_GMTICKET_UPDATETEXT(<SMSG_GMTICKET_UPDATETEXT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0209 => Ok(Self::SMSG_ACCOUNT_DATA_TIMES(<SMSG_ACCOUNT_DATA_TIMES as crate::Message>::read_body(&mut r, body_size)?)),
            0x0212 => Ok(Self::SMSG_GMTICKET_GETTICKET(<SMSG_GMTICKET_GETTICKET as crate::Message>::read_body(&mut r, body_size)?)),
            0x0214 => Ok(Self::SMSG_GAMEOBJECT_SPAWN_ANIM(<SMSG_GAMEOBJECT_SPAWN_ANIM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0215 => Ok(Self::SMSG_GAMEOBJECT_DESPAWN_ANIM(<SMSG_GAMEOBJECT_DESPAWN_ANIM as crate::Message>::read_body(&mut r, body_size)?)),
            0x0216 => Ok(Self::MSG_CORPSE_QUERY(<MSG_CORPSE_QUERY_Server as crate::Message>::read_body(&mut r, body_size)?)),
            0x0218 => Ok(Self::SMSG_GMTICKET_DELETETICKET(<SMSG_GMTICKET_DELETETICKET as crate::Message>::read_body(&mut r, body_size)?)),
            0x0219 => Ok(Self::SMSG_CHAT_WRONG_FACTION(<SMSG_CHAT_WRONG_FACTION as crate::Message>::read_body(&mut r, body_size)?)),
            0x021B => Ok(Self::SMSG_GMTICKET_SYSTEMSTATUS(<SMSG_GMTICKET_SYSTEMSTATUS as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x024B => Ok(Self::SMSG_SPELLLOGMISS(<SMSG_SPELLLOGMISS as crate::Message>::read_body(&mut r, body_size)?)),
            0x024C => Ok(Self::SMSG_SPELLLOGEXECUTE(<SMSG_SPELLLOGEXECUTE as crate::Message>::read_body(&mut r, body_size)?)),
            0x024E => Ok(Self::SMSG_PERIODICAURALOG(<SMSG_PERIODICAURALOG as crate::Message>::read_body(&mut r, body_size)?)),
            0x024F => Ok(Self::SMSG_SPELLDAMAGESHIELD(<SMSG_SPELLDAMAGESHIELD as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0262 => Ok(Self::SMSG_DISPEL_FAILED(<SMSG_DISPEL_FAILED as crate::Message>::read_body(&mut r, body_size)?)),
            0x0263 => Ok(Self::SMSG_SPELLORDAMAGE_IMMUNE(<SMSG_SPELLORDAMAGE_IMMUNE as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0266 => Ok(Self::SMSG_SET_FLAT_SPELL_MODIFIER(<SMSG_SET_FLAT_SPELL_MODIFIER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0267 => Ok(Self::SMSG_SET_PCT_SPELL_MODIFIER(<SMSG_SET_PCT_SPELL_MODIFIER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0269 => Ok(Self::SMSG_CORPSE_RECLAIM_DELAY(<SMSG_CORPSE_RECLAIM_DELAY as crate::Message>::read_body(&mut r, body_size)?)),
            0x026F => Ok(Self::MSG_LIST_STABLED_PETS(<MSG_LIST_STABLED_PETS_Server as crate::Message>::read_body(&mut r, body_size)?)),
            0x0273 => Ok(Self::SMSG_STABLE_RESULT(<SMSG_STABLE_RESULT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0277 => Ok(Self::SMSG_PLAY_MUSIC(<SMSG_PLAY_MUSIC as crate::Message>::read_body(&mut r, body_size)?)),
            0x0278 => Ok(Self::SMSG_PLAY_OBJECT_SOUND(<SMSG_PLAY_OBJECT_SOUND as crate::Message>::read_body(&mut r, body_size)?)),
            0x027B => Ok(Self::SMSG_SPELLDISPELLOG(<SMSG_SPELLDISPELLOG as crate::Message>::read_body(&mut r, body_size)?)),
            0x0284 => Ok(Self::MSG_QUERY_NEXT_MAIL_TIME(<MSG_QUERY_NEXT_MAIL_TIME_Server as crate::Message>::read_body(&mut r, body_size)?)),
            0x0285 => Ok(Self::SMSG_RECEIVED_MAIL(<SMSG_RECEIVED_MAIL as crate::Message>::read_body(&mut r, body_size)?)),
            0x0286 => Ok(Self::SMSG_RAID_GROUP_ONLY(<SMSG_RAID_GROUP_ONLY as crate::Message>::read_body(&mut r, body_size)?)),
            0x028C => Ok(Self::SMSG_PVP_CREDIT(<SMSG_PVP_CREDIT as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0295 => Ok(Self::SMSG_MEETINGSTONE_SETQUEUE(<SMSG_MEETINGSTONE_SETQUEUE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0297 => Ok(Self::SMSG_MEETINGSTONE_COMPLETE(<SMSG_MEETINGSTONE_COMPLETE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0298 => Ok(Self::SMSG_MEETINGSTONE_IN_PROGRESS(<SMSG_MEETINGSTONE_IN_PROGRESS as crate::Message>::read_body(&mut r, body_size)?)),
            0x0299 => Ok(Self::SMSG_MEETINGSTONE_MEMBER_ADDED(<SMSG_MEETINGSTONE_MEMBER_ADDED as crate::Message>::read_body(&mut r, body_size)?)),
            0x029C => Ok(Self::SMSG_CANCEL_AUTO_REPEAT(<SMSG_CANCEL_AUTO_REPEAT as crate::Message>::read_body(&mut r, body_size)?)),
            0x029D => Ok(Self::SMSG_STANDSTATE_UPDATE(<SMSG_STANDSTATE_UPDATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x029E => Ok(Self::SMSG_LOOT_ALL_PASSED(<SMSG_LOOT_ALL_PASSED as crate::Message>::read_body(&mut r, body_size)?)),
            0x029F => Ok(Self::SMSG_LOOT_ROLL_WON(<SMSG_LOOT_ROLL_WON as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A1 => Ok(Self::SMSG_LOOT_START_ROLL(<SMSG_LOOT_START_ROLL as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A2 => Ok(Self::SMSG_LOOT_ROLL(<SMSG_LOOT_ROLL as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A4 => Ok(Self::SMSG_LOOT_MASTER_LIST(<SMSG_LOOT_MASTER_LIST as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A5 => Ok(Self::SMSG_SET_FORCED_REACTIONS(<SMSG_SET_FORCED_REACTIONS as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A6 => Ok(Self::SMSG_SPELL_FAILED_OTHER(<SMSG_SPELL_FAILED_OTHER as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A7 => Ok(Self::SMSG_GAMEOBJECT_RESET_STATE(<SMSG_GAMEOBJECT_RESET_STATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x02A9 => Ok(Self::SMSG_CHAT_PLAYER_NOT_FOUND(<SMSG_CHAT_PLAYER_NOT_FOUND as crate::Message>::read_body(&mut r, body_size)?)),
            0x02AA => Ok(Self::MSG_TALENT_WIPE_CONFIRM(<MSG_TALENT_WIPE_CONFIRM_Server as crate::Message>::read_body(&mut r, body_size)?)),
            0x02AB => Ok(Self::SMSG_SUMMON_REQUEST(<SMSG_SUMMON_REQUEST as crate::Message>::read_body(&mut r, body_size)?)),
            0x02AE => Ok(Self::SMSG_MONSTER_MOVE_TRANSPORT(<SMSG_MONSTER_MOVE_TRANSPORT as crate::Message>::read_body(&mut r, body_size)?)),
            0x02AF => Ok(Self::SMSG_PET_BROKEN(<SMSG_PET_BROKEN as crate::Message>::read_body(&mut r, body_size)?)),
            0x02B4 => Ok(Self::SMSG_FEIGN_DEATH_RESISTED(<SMSG_FEIGN_DEATH_RESISTED as crate::Message>::read_body(&mut r, body_size)?)),
            0x02B7 => Ok(Self::SMSG_DUEL_COUNTDOWN(<SMSG_DUEL_COUNTDOWN as crate::Message>::read_body(&mut r, body_size)?)),
            0x02B8 => Ok(Self::SMSG_AREA_TRIGGER_MESSAGE(<SMSG_AREA_TRIGGER_MESSAGE as crate::Message>::read_body(&mut r, body_size)?)),
            0x02BB => Ok(Self::SMSG_MEETINGSTONE_JOINFAILED(<SMSG_MEETINGSTONE_JOINFAILED as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x02CB => Ok(Self::SMSG_INSTANCE_SAVE_CREATED(<SMSG_INSTANCE_SAVE_CREATED as crate::Message>::read_body(&mut r, body_size)?)),
            0x02CC => Ok(Self::SMSG_RAID_INSTANCE_INFO(<SMSG_RAID_INSTANCE_INFO as crate::Message>::read_body(&mut r, body_size)?)),
            0x02D2 => Ok(Self::SMSG_PLAY_SOUND(<SMSG_PLAY_SOUND as crate::Message>::read_body(&mut r, body_size)?)),
            0x02D4 => Ok(Self::SMSG_BATTLEFIELD_STATUS(<SMSG_BATTLEFIELD_STATUS as crate::Message>::read_body(&mut r, body_size)?)),
            0x02D6 => Ok(Self::MSG_INSPECT_HONOR_STATS(<MSG_INSPECT_HONOR_STATS_Server as crate::Message>::read_body(&mut r, body_size)?)),
            0x02DA => Ok(Self::SMSG_FORCE_WALK_SPEED_CHANGE(<SMSG_FORCE_WALK_SPEED_CHANGE as crate::Message>::read_body(&mut r, body_size)?)),
            0x02DC => Ok(Self::SMSG_FORCE_SWIM_BACK_SPEED_CHANGE(<SMSG_FORCE_SWIM_BACK_SPEED_CHANGE as crate::Message>::read_body(&mut r, body_size)?)),
            ...
            0x0300 => Ok(Self::SMSG_SPLINE_SET_SWIM_SPEED(<SMSG_SPLINE_SET_SWIM_SPEED as crate::Message>::read_body(&mut r, body_size)?)),
            0x0301 => Ok(Self::SMSG_SPLINE_SET_WALK_SPEED(<SMSG_SPLINE_SET_WALK_SPEED as crate::Message>::read_body(&mut r, body_size)?)),
            0x0302 => Ok(Self::SMSG_SPLINE_SET_SWIM_BACK_SPEED(<SMSG_SPLINE_SET_SWIM_BACK_SPEED as crate::Message>::read_body(&mut r, body_size)?)),
            0x0303 => Ok(Self::SMSG_SPLINE_SET_TURN_RATE(<SMSG_SPLINE_SET_TURN_RATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0304 => Ok(Self::SMSG_SPLINE_MOVE_UNROOT(<SMSG_SPLINE_MOVE_UNROOT as crate::Message>::read_body(&mut r, body_size)?)),
            0x0305 => Ok(Self::SMSG_SPLINE_MOVE_FEATHER_FALL(<SMSG_SPLINE_MOVE_FEATHER_FALL as crate::Message>::read_body(&mut r, body_size)?)),
            0x0306 => Ok(Self::SMSG_SPLINE_MOVE_NORMAL_FALL(<SMSG_SPLINE_MOVE_NORMAL_FALL as crate::Message>::read_body(&mut r, body_size)?)),
            0x0307 => Ok(Self::SMSG_SPLINE_MOVE_SET_HOVER(<SMSG_SPLINE_MOVE_SET_HOVER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0308 => Ok(Self::SMSG_SPLINE_MOVE_UNSET_HOVER(<SMSG_SPLINE_MOVE_UNSET_HOVER as crate::Message>::read_body(&mut r, body_size)?)),
            0x0309 => Ok(Self::SMSG_SPLINE_MOVE_WATER_WALK(<SMSG_SPLINE_MOVE_WATER_WALK as crate::Message>::read_body(&mut r, body_size)?)),
            0x030A => Ok(Self::SMSG_SPLINE_MOVE_LAND_WALK(<SMSG_SPLINE_MOVE_LAND_WALK as crate::Message>::read_body(&mut r, body_size)?)),
            0x030B => Ok(Self::SMSG_SPLINE_MOVE_START_SWIM(<SMSG_SPLINE_MOVE_START_SWIM as crate::Message>::read_body(&mut r, body_size)?)),
            0x030C => Ok(Self::SMSG_SPLINE_MOVE_STOP_SWIM(<SMSG_SPLINE_MOVE_STOP_SWIM as crate::Message>::read_body(&mut r, body_size)?)),
            0x030D => Ok(Self::SMSG_SPLINE_MOVE_SET_RUN_MODE(<SMSG_SPLINE_MOVE_SET_RUN_MODE as crate::Message>::read_body(&mut r, body_size)?)),
            0x030E => Ok(Self::SMSG_SPLINE_MOVE_SET_WALK_MODE(<SMSG_SPLINE_MOVE_SET_WALK_MODE as crate::Message>::read_body(&mut r, body_size)?)),
            0x031A => Ok(Self::SMSG_SPLINE_MOVE_ROOT(<SMSG_SPLINE_MOVE_ROOT as crate::Message>::read_body(&mut r, body_size)?)),
            0x031C => Ok(Self::SMSG_INVALIDATE_PLAYER(<SMSG_INVALIDATE_PLAYER as crate::Message>::read_body(&mut r, body_size)?)),
            0x031E => Ok(Self::SMSG_INSTANCE_RESET(<SMSG_INSTANCE_RESET as crate::Message>::read_body(&mut r, body_size)?)),
            0x031F => Ok(Self::SMSG_INSTANCE_RESET_FAILED(<SMSG_INSTANCE_RESET_FAILED as crate::Message>::read_body(&mut r, body_size)?)),
            0x0320 => Ok(Self::SMSG_UPDATE_LAST_INSTANCE(<SMSG_UPDATE_LAST_INSTANCE as crate::Message>::read_body(&mut r, body_size)?)),
            0x0321 => Ok(Self::MSG_RAID_TARGET_UPDATE(<MSG_RAID_TARGET_UPDATE_Server as crate::Message>::read_body(&mut r, body_size)?)),
            0x0322 => Ok(Self::MSG_RAID_READY_CHECK(<MSG_RAID_READY_CHECK_Server as crate::Message>::read_body(&mut r, body_size)?)),
            0x0324 => Ok(Self::SMSG_PET_ACTION_SOUND(<SMSG_PET_ACTION_SOUND as crate::Message>::read_body(&mut r, body_size)?)),
            0x0325 => Ok(Self::SMSG_PET_DISMISS_SOUND(<SMSG_PET_DISMISS_SOUND as crate::Message>::read_body(&mut r, body_size)?)),
            0x0328 => Ok(Self::SMSG_GM_TICKET_STATUS_UPDATE(<SMSG_GM_TICKET_STATUS_UPDATE as crate::Message>::read_body(&mut r, body_size)?)),
            0x032B => Ok(Self::SMSG_UPDATE_INSTANCE_OWNERSHIP(<SMSG_UPDATE_INSTANCE_OWNERSHIP as crate::Message>::read_body(&mut r, body_size)?)),
            0x032F => Ok(Self::SMSG_SPELLINSTAKILLLOG(<SMSG_SPELLINSTAKILLLOG as crate::Message>::read_body(&mut r, body_size)?)),
    ...
    pub fn write_encrypted_server<W: std::io::Write>(&self, w: &mut W, e: &mut EncrypterHalf) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::SMSG_MEETINGSTONE_COMPLETE(c) => c.write_encrypted_server(w, e),
            Self::SMSG_MEETINGSTONE_IN_PROGRESS(c) => c.write_encrypted_server(w, e),
    ...
    pub fn write_unencrypted_server<W: std::io::Write>(&self, w: &mut W) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::SMSG_MEETINGSTONE_COMPLETE(c) => c.write_unencrypted_server(w),
            Self::SMSG_MEETINGSTONE_IN_PROGRESS(c) => c.write_unencrypted_server(w),
    ...
    pub async fn tokio_write_encrypted_server<W: tokio::io::AsyncWriteExt + Unpin + Send>(&self, w: &mut W, e: &mut EncrypterHalf) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::SMSG_MEETINGSTONE_COMPLETE(c) => c.tokio_write_encrypted_server(w, e).await,
            Self::SMSG_MEETINGSTONE_IN_PROGRESS(c) => c.tokio_write_encrypted_server(w, e).await,
    ...
    pub async fn tokio_write_unencrypted_server<W: tokio::io::AsyncWriteExt + Unpin + Send>(&self, w: &mut W) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::SMSG_MEETINGSTONE_COMPLETE(c) => c.tokio_write_unencrypted_server(w).await,
            Self::SMSG_MEETINGSTONE_IN_PROGRESS(c) => c.tokio_write_unencrypted_server(w).await,
    ...
    pub async fn astd_write_encrypted_server<W: async_std::io::WriteExt + Unpin + Send>(&self, w: &mut W, e: &mut EncrypterHalf) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::SMSG_MEETINGSTONE_COMPLETE(c) => c.astd_write_encrypted_server(w, e).await,
            Self::SMSG_MEETINGSTONE_IN_PROGRESS(c) => c.astd_write_encrypted_server(w, e).await,
    ...
    pub async fn astd_write_unencrypted_server<W: async_std::io::WriteExt + Unpin + Send>(&self, w: &mut W) -> Result<(), std::io::Error> {
        match self {
            ...
            Self::SMSG_MEETINGSTONE_COMPLETE(c) => c.astd_write_unencrypted_server(w).await,
            Self::SMSG_MEETINGSTONE_IN_PROGRESS(c) => c.astd_write_unencrypted_server(w).await,
...
impl std::fmt::Display for ServerOpcodeMessage {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            ServerOpcodeMessage::SMSG_MEETINGSTONE_COMPLETE(_) => "SMSG_MEETINGSTONE_COMPLETE",
            ServerOpcodeMessage::SMSG_MEETINGSTONE_IN_PROGRESS(_) => "SMSG_MEETINGSTONE_IN_PROGRESS",
