...
impl MSG_MOVE_START_FORWARD_Server {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_START_FORWARD_Server {{").unwrap();
        // Members
...
impl crate::Message for MSG_MOVE_START_FORWARD_Server {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_START_FORWARD_Server::to_test_case_string(self)
    }
...
mod test {
    ...
    fn assert(t: &MSG_MOVE_START_FORWARD_Server, expected: &MSG_MOVE_START_FORWARD_Server) {
