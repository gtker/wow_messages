...
impl SMSG_SEND_MAIL_RESULT {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        if !(12..=20).contains(&body_size) {
            return Err(crate::errors::ParseErrorKind::InvalidSize { opcode: 0x0239, size: body_size });
        }
...
impl crate::Message for SMSG_SEND_MAIL_RESULT {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        match &self.action {
            crate::vanilla::SMSG_SEND_MAIL_RESULT_MailAction::Send {
                result2,
            } => {
                writeln!(s, "    result2 = {};", MailResultTwo::try_from(result2.as_int()).unwrap().as_test_case_value()).unwrap();
                match &result2 {
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResultTwo::ErrEquipError {
                        equip_error2,
                    } => {
            ...
            crate::vanilla::SMSG_SEND_MAIL_RESULT_MailAction::MoneyTaken {
                result2,
            } => {
                writeln!(s, "    result2 = {};", MailResultTwo::try_from(result2.as_int()).unwrap().as_test_case_value()).unwrap();
                match &result2 {
            ...
            crate::vanilla::SMSG_SEND_MAIL_RESULT_MailAction::ItemTaken {
                result,
            } => {
                writeln!(s, "    result = {};", MailResult::try_from(result.as_int()).unwrap().as_test_case_value()).unwrap();
                match &result {
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::Ok {
                        item,
                        item_count,
                    } => {
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrEquipError {
                        equip_error,
                    } => {
                        writeln!(s, "    equip_error = {};", equip_error).unwrap();
                    }
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrCannotSendToSelf {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrNotEnoughMoney {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrRecipientNotFound {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrNotYourTeam {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrInternalError {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrDisabledForTrialAcc {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrRecipientCapReached {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrCantSendWrappedCod {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrMailAndChatSuspended {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrTooManyAttachments {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
                    ...
                    crate::vanilla::SMSG_SEND_MAIL_RESULT_MailResult::ErrMailAttachmentInvalid {
                        item,
                        item_count,
                    } => {
                        writeln!(s, "    item = {};", item).unwrap();
            ...
            crate::vanilla::SMSG_SEND_MAIL_RESULT_MailAction::ReturnedToSender {
                result2,
            } => {
                writeln!(s, "    result2 = {};", MailResultTwo::try_from(result2.as_int()).unwrap().as_test_case_value()).unwrap();
                match &result2 {
            ...
            crate::vanilla::SMSG_SEND_MAIL_RESULT_MailAction::Deleted {
                result2,
            } => {
                writeln!(s, "    result2 = {};", MailResultTwo::try_from(result2.as_int()).unwrap().as_test_case_value()).unwrap();
                match &result2 {
            ...
            crate::vanilla::SMSG_SEND_MAIL_RESULT_MailAction::MadePermanent {
                result2,
            } => {
                writeln!(s, "    result2 = {};", MailResultTwo::try_from(result2.as_int()).unwrap().as_test_case_value()).unwrap();
                match &result2 {
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ServerMessage for SMSG_SEND_MAIL_RESULT {}
