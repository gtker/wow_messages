...
impl crate::helper::shared::vanilla_tbc::ClientMessage for MSG_MOVE_START_BACKWARD_Client {}
...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/world/movement/msg/msg_move_start_backward.wowm` line 7.
    #[cfg(feature = "sync")]
