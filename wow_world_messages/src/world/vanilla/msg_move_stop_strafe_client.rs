...
impl crate::helper::shared::vanilla_tbc::ClientMessage for MSG_MOVE_STOP_STRAFE_Client {}
...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/world/movement/msg/msg_move_stop_strafe.wowm` line 7.
    #[cfg(feature = "sync")]
