...
mod test {
    ...
    fn assert(t: &MSG_MOVE_SET_FACING_Server, expected: &MSG_MOVE_SET_FACING_Server) {
    ...
    pub(crate) fn expected0() -> MSG_MOVE_SET_FACING_Server {
    ...
    fn msg_move_set_facing_server0() {
        ...
        let t = match t {
            ...
            opcode => panic!("incorrect opcode. Expected MSG_MOVE_SET_FACING, got {opcode:#?}"),
        };
