...
impl crate::Message for CMSG_MOVE_FALL_RESET {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_MOVE_FALL_RESET {{").unwrap();
        // Members
        // info: MovementInfo
        ...
        let [a, b, c, d] = 714_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(714, "CMSG_MOVE_FALL_RESET", body_size, a))
    }
