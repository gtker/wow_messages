...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/social/smsg_party_member_stats.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/social/smsg_party_member_stats.wowm#L1):
/// ```text
...
impl SMSG_PARTY_MEMBER_STATS {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        let mask_auras_2 = if mask.is_auras_2() {
            ...
            Some(SMSG_PARTY_MEMBER_STATS_GroupUpdateFlags_Auras2 {
                negative_auras,
            })
        }
        else {
...
impl crate::Message for SMSG_PARTY_MEMBER_STATS {
    ...
    fn write_into_vec(&self, mut w: impl Write) -> Result<(), std::io::Error> {
        ...
        if let Some(if_statement) = &self.mask.auras_2 {
            // negative_auras: AuraMask
            if_statement.negative_auras.write_into_vec(&mut w)?;
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(126, "SMSG_PARTY_MEMBER_STATS", body_size, a))
    }
...
pub struct SMSG_PARTY_MEMBER_STATS_GroupUpdateFlags {
    ...
    auras_2: Option<SMSG_PARTY_MEMBER_STATS_GroupUpdateFlags_Auras2>,
...
impl SMSG_PARTY_MEMBER_STATS_GroupUpdateFlags {
    ...
    pub const fn new_auras_2(auras_2: SMSG_PARTY_MEMBER_STATS_GroupUpdateFlags_Auras2) -> Self {
        Self {
    ...
    pub const fn get_auras_2(&self) -> Option<&SMSG_PARTY_MEMBER_STATS_GroupUpdateFlags_Auras2> {
        self.auras_2.as_ref()
    }
...
impl SMSG_PARTY_MEMBER_STATS_GroupUpdateFlags_Auras2 {
    pub(crate) const fn size(&self) -> usize {
        self.negative_auras.size() // negative_auras: AuraMask
    }
}
