...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_stop.wowm:31`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_stop.wowm#L31):
/// ```text
...
impl crate::helper::shared::vanilla_tbc::ServerMessage for MSG_MOVE_STOP_Server {}
...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/world/movement/msg/msg_move_stop.wowm` line 37.
    #[cfg(feature = "sync")]
    #[cfg_attr(feature = "sync", test)]
    fn MSG_MOVE_STOP_Server0() {
        let expected = MSG_MOVE_STOP_Server {
            guid: Guid::new(0x5),
            info: MovementInfo {
