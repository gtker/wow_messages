...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_set_run_mode.wowm:46`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_set_run_mode.wowm#L46):
/// ```text
...
impl MSG_MOVE_SET_RUN_MODE_Server {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_SET_RUN_MODE_Server {{").unwrap();
        // Members
...
impl crate::private::Sealed for MSG_MOVE_SET_RUN_MODE_Server {}
impl crate::Message for MSG_MOVE_SET_RUN_MODE_Server {
    const OPCODE: u32 = 0x00c2;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_SET_RUN_MODE_Server::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(30..=90).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00C2, size: body_size });
        }
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ServerMessage for MSG_MOVE_SET_RUN_MODE_Server {}
...
mod test {
    ...
    fn assert(t: &MSG_MOVE_SET_RUN_MODE_Server, expected: &MSG_MOVE_SET_RUN_MODE_Server) {
    ...
    fn msg_move_set_run_mode_server0() {
        ...
        let t = match t {
            ...
            opcode => panic!("incorrect opcode. Expected MSG_MOVE_SET_RUN_MODE, got {opcode:#?}"),
        };
