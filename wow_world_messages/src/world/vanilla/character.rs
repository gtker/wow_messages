...
impl Character {
    pub(crate) fn read<R: std::io::Read>(mut r: R) -> Result<Self, crate::errors::ParseErrorKind> {
        ...
        // flags: CharacterFlags
        let flags = CharacterFlags::new(crate::util::read_u32_le(&mut r)?);
        ...
        // first_bag_display_id: u32
        let _first_bag_display_id = crate::util::read_u32_le(&mut r)?;
        // first_bag_display_id is expected to always be 0 (0)

        // first_bag_inventory_id: u8
        let _first_bag_inventory_id = crate::util::read_u8_le(&mut r)?;
