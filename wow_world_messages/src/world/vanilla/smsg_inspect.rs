...
impl crate::private::Sealed for SMSG_INSPECT {}
impl SMSG_INSPECT {
...
impl crate::Message for SMSG_INSPECT {
    const OPCODE: u32 = 0x0115;
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test SMSG_INSPECT {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(277, "SMSG_INSPECT", body_size, a))
    }
