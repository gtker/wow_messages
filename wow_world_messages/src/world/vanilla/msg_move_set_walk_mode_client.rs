...
impl crate::private::Sealed for MSG_MOVE_SET_WALK_MODE_Client {}
...
impl crate::Message for MSG_MOVE_SET_WALK_MODE_Client {
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(195, "MSG_MOVE_SET_WALK_MODE_Client", body_size, a))
    }
...
mod test {
    ...
    fn assert(t: &MSG_MOVE_SET_WALK_MODE_Client, expected: &MSG_MOVE_SET_WALK_MODE_Client) {
    ...
    pub(crate) fn expected0() -> MSG_MOVE_SET_WALK_MODE_Client {
        MSG_MOVE_SET_WALK_MODE_Client {
            info: MovementInfo {
