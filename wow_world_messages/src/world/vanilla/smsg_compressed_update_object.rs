...
impl crate::Message for SMSG_COMPRESSED_UPDATE_OBJECT {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        let mut decompressed_size = [0_u8; 4];
        r.read_exact(&mut decompressed_size);
...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/world/gameobject/smsg_update_compressed_object.wowm` line 12.
    #[cfg(feature = "sync")]
