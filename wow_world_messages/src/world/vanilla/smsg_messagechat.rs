...
impl crate::Message for SMSG_MESSAGECHAT {
    ...
    fn read_body(r: &mut &[u8], body_size: u32) -> std::result::Result<Self, crate::errors::ParseError> {
        ...
        let chat_type_if = match chat_type {
            ChatType::Say => {
                // speech_bubble_credit: Guid
                let speech_bubble_credit = Guid::read(r)?;

                // chat_credit: Guid
                let chat_credit = Guid::read(r)?;
...
impl crate::helper::shared::vanilla_tbc::ServerMessage for SMSG_MESSAGECHAT {}
