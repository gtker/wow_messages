...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/auction/smsg/smsg_auction_command_result.wowm:35`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/auction/smsg/smsg_auction_command_result.wowm#L35):
/// ```text
...
impl crate::Message for SMSG_AUCTION_COMMAND_RESULT {
        ...
        match &self.action {
            crate::vanilla::SMSG_AUCTION_COMMAND_RESULT_AuctionCommandAction::Started {
                ...
                match &result2 {
                    ...
                    crate::vanilla::SMSG_AUCTION_COMMAND_RESULT_AuctionCommandResultTwo::ErrHigherBid {
                        auction_outbid3,
                        higher_bidder2,
                        new_bid2,
                    } => {
            ...
            crate::vanilla::SMSG_AUCTION_COMMAND_RESULT_AuctionCommandAction::BidPlaced {
                ...
                match &result {
                    ...
                    crate::vanilla::SMSG_AUCTION_COMMAND_RESULT_AuctionCommandResult::ErrInventory {
                        inventory_result,
                    } => {
                        writeln!(s, "    inventory_result = {};", inventory_result.as_test_case_value()).unwrap();
                    }
                    crate::vanilla::SMSG_AUCTION_COMMAND_RESULT_AuctionCommandResult::ErrHigherBid {
                        auction_outbid2,
                        higher_bidder,
                        new_bid,
                    } => {
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(603, "SMSG_AUCTION_COMMAND_RESULT", body_size, a))
    }
