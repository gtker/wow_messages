...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/cmsg/cmsg_force_move_unroot_ack.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/cmsg/cmsg_force_move_unroot_ack.wowm#L1):
/// ```text
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ClientMessage for CMSG_FORCE_MOVE_UNROOT_ACK {}
