...
impl SMSG_PARTY_MEMBER_STATS_FULL_GroupUpdateFlags {
    ...
    pub const fn get_PET_GUID(&self) -> bool {
        (self.inner & GroupUpdateFlags::PET_GUID) != 0
    }
