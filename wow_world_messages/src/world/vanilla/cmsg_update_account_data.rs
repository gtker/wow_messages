...
impl crate::helper::shared::vanilla_tbc::ClientMessage for CMSG_UPDATE_ACCOUNT_DATA {}
...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/world/login_logout/cmsg_update_account_data.wowm` line 15.
    #[cfg(feature = "sync")]
    ...
    // Generated from `wow_message_parser/wowm/world/login_logout/cmsg_update_account_data.wowm` line 26.
    #[cfg(feature = "sync")]
    #[cfg_attr(feature = "sync", test)]
