...
impl MSG_MOVE_FALL_LAND_Client {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_FALL_LAND_Client {{").unwrap();
        // Members
        // info: MovementInfo
...
impl crate::Message for MSG_MOVE_FALL_LAND_Client {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_FALL_LAND_Client::to_test_case_string(self)
    }
...
#[cfg(feature = "vanilla")]
impl crate::vanilla::ClientMessage for MSG_MOVE_FALL_LAND_Client {}
...
mod test {
    ...
    fn assert(t: &MSG_MOVE_FALL_LAND_Client, expected: &MSG_MOVE_FALL_LAND_Client) {
    ...
    pub(crate) fn expected0() -> MSG_MOVE_FALL_LAND_Client {
