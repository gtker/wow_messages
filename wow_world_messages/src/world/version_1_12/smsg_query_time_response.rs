...
/// [`CMSG_QUERY_TIME`](crate::world::version_1_12::CMSG_QUERY_TIME) and this reply does not actually appear to set the time. Instead [`SMSG_LOGIN_SETTIMESPEED`](crate::world::version_1_12::SMSG_LOGIN_SETTIMESPEED) seems to correctly set the time. Running the client with `-console` will print the date when [`SMSG_LOGIN_SETTIMESPEED`](crate::world::version_1_12::SMSG_LOGIN_SETTIMESPEED) is received, but not when this message is received.
///
