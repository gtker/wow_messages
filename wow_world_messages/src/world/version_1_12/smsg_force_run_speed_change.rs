...
/// Client replies with [`CMSG_FORCE_RUN_SPEED_CHANGE_ACK`](crate::world::version_1_12::CMSG_FORCE_RUN_SPEED_CHANGE_ACK).
/// vmangos sends this message to the client being changed and [`SMSG_SPLINE_SET_RUN_SPEED`](crate::world::version_1_12::SMSG_SPLINE_SET_RUN_SPEED) to others.
///
