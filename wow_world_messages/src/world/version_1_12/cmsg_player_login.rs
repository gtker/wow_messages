...
/// If the player receives a [`SMSG_CHARACTER_LOGIN_FAILED`](crate::world::version_1_12::SMSG_CHARACTER_LOGIN_FAILED) it will return to the character screen and send a [`CMSG_CHAR_ENUM`](crate::world::version_1_12::CMSG_CHAR_ENUM).
///
