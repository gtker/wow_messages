...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_teleport.wowm:2`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_teleport.wowm#L2):
/// ```text
...
impl crate::private::Sealed for MSG_MOVE_TELEPORT_Server {}
...
impl crate::Message for MSG_MOVE_TELEPORT_Server {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_TELEPORT_Server {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 197_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(197, "MSG_MOVE_TELEPORT_Server", body_size, a))
    }

}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for MSG_MOVE_TELEPORT_Server {}
