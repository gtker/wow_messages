...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/cmsg/cmsg_force_swim_back_speed_change_ack.wowm:10`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/cmsg/cmsg_force_swim_back_speed_change_ack.wowm#L10):
/// ```text
...
impl CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        if !(45..=98).contains(&body_size) {
            return Err(crate::errors::ParseErrorKind::InvalidSize { opcode: 0x02DD, size: body_size });
        }
...
#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK {}
