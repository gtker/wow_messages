...
use crate::world::tbc::SpellEffect;
...
impl SpellLog {
    pub(crate) fn write_into_vec(&self, w: &mut Vec<u8>) -> Result<(), std::io::Error> {
        ...
        match &self.effect {
            ...
            SpellLog_SpellEffect::Unknown41 => {}
            SpellLog_SpellEffect::Unknown42 => {}
            SpellLog_SpellEffect::TeleportUnitsFaceCaster => {}
            SpellLog_SpellEffect::SkillStep => {}
            SpellLog_SpellEffect::Undefined45 => {}
            ...
            SpellLog_SpellEffect::Unknown73 => {}
            SpellLog_SpellEffect::Unknown74 => {}
            ...
            SpellLog_SpellEffect::Unknown87 => {}
            SpellLog_SpellEffect::Unknown88 => {}
            SpellLog_SpellEffect::Unknown89 => {}
            SpellLog_SpellEffect::Unknown90 => {}
            SpellLog_SpellEffect::ThreatAll => {}
            SpellLog_SpellEffect::EnchantHeldItem => {}
            SpellLog_SpellEffect::Unknown93 => {}
            SpellLog_SpellEffect::SelfResurrect => {}
            SpellLog_SpellEffect::Skinning => {}
            SpellLog_SpellEffect::Charge => {}
            SpellLog_SpellEffect::Unknown97 => {}
            ...
            SpellLog_SpellEffect::Unknown141 => {}
