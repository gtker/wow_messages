...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_start_pitch_up.wowm:7`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_start_pitch_up.wowm#L7):
/// ```text
...
impl MSG_MOVE_START_PITCH_UP_Client {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_START_PITCH_UP_Client {{").unwrap();
        // Members
        // info: MovementInfo
        ...
        let [a, b, c, d] = 191_u32.to_le_bytes();
...
impl crate::private::Sealed for MSG_MOVE_START_PITCH_UP_Client {}
impl crate::Message for MSG_MOVE_START_PITCH_UP_Client {
    const OPCODE: u32 = 0x00bf;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_START_PITCH_UP_Client::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(29..=82).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00BF, size: body_size });
        }
...
#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for MSG_MOVE_START_PITCH_UP_Client {}
