...
impl crate::Message for CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 898_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(898, "CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK", body_size, a))
    }

}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK {}
