...
impl MSG_MOVE_SET_FLIGHT_SPEED_Server {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_SET_FLIGHT_SPEED_Server {{").unwrap();
        // Members
...
impl crate::private::Sealed for MSG_MOVE_SET_FLIGHT_SPEED_Server {}
impl crate::Message for MSG_MOVE_SET_FLIGHT_SPEED_Server {
    const OPCODE: u32 = 0x037e;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_SET_FLIGHT_SPEED_Server::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(35..=95).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x037E, size: body_size });
        }
