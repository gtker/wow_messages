...
impl crate::Message for CMSG_MOVE_SET_CAN_FLY_ACK {
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(45..=98).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x0345, size: body_size });
        }
...
#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_MOVE_SET_CAN_FLY_ACK {}
