...
impl crate::Message for CMSG_MOVE_SET_FLY {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_MOVE_SET_FLY {{").unwrap();
        // Members
        // info: MovementInfo
        ...
        let [a, b, c, d] = 838_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(838, "CMSG_MOVE_SET_FLY", body_size, a))
    }

}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_MOVE_SET_FLY {}
