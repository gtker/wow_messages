...
impl MSG_MOVE_START_DESCEND_Client {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_START_DESCEND_Client {{").unwrap();
        // Members
        // info: MovementInfo
        ...
        let [a, b, c, d] = 935_u32.to_le_bytes();
...
impl crate::private::Sealed for MSG_MOVE_START_DESCEND_Client {}
impl crate::Message for MSG_MOVE_START_DESCEND_Client {
    const OPCODE: u32 = 0x03a7;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_START_DESCEND_Client::to_test_case_string(self)
    }
