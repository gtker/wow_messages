...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_fall_land.wowm:81`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_fall_land.wowm#L81):
/// ```text
...
impl MSG_MOVE_FALL_LAND_Server {
    pub fn to_test_case_string(&self) -> String {
        ...
        writeln!(s, "test MSG_MOVE_FALL_LAND_Server {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 201_u32.to_le_bytes();
...
#[cfg(feature = "tbc")]
impl crate::tbc::ServerMessage for MSG_MOVE_FALL_LAND_Server {}
