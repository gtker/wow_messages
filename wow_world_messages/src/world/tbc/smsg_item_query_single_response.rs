...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/queries/smsg_item_query_single_response.wowm:694`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/queries/smsg_item_query_single_response.wowm#L694):
/// ```text
        ...
        let found = if current_size < body_size as usize {
            ...
            let stats = {
                ...
                for i in stats.iter_mut() {
                    *i = crate::util::tbc_wrath_itemstat_read(&mut r)?;
                }
                stats
            };
