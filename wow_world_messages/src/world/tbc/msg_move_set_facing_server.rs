...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_set_facing.wowm:81`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_set_facing.wowm#L81):
/// ```text
...
impl MSG_MOVE_SET_FACING_Server {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_SET_FACING_Server {{").unwrap();
        // Members
...
impl crate::private::Sealed for MSG_MOVE_SET_FACING_Server {}
impl crate::Message for MSG_MOVE_SET_FACING_Server {
    const OPCODE: u32 = 0x00da;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_SET_FACING_Server::to_test_case_string(self)
    }
...
#[cfg(feature = "tbc")]
impl crate::tbc::ServerMessage for MSG_MOVE_SET_FACING_Server {}
