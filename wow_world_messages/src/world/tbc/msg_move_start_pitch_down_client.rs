...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_start_pitch_down.wowm:7`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_start_pitch_down.wowm#L7):
/// ```text
...
impl crate::Message for MSG_MOVE_START_PITCH_DOWN_Client {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_START_PITCH_DOWN_Client {{").unwrap();
        // Members
        // info: MovementInfo
        ...
        let [a, b, c, d] = 192_u32.to_le_bytes();
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(192, "MSG_MOVE_START_PITCH_DOWN_Client", body_size, a))
    }

}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for MSG_MOVE_START_PITCH_DOWN_Client {}
