...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/cmsg/cmsg_force_turn_rate_change_ack.wowm:10`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/cmsg/cmsg_force_turn_rate_change_ack.wowm#L10):
/// ```text
...
#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_FORCE_TURN_RATE_CHANGE_ACK {}
