...
impl crate::Message for CMSG_MOVE_HOVER_ACK {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        let [a, b, c, d] = 246_u32.to_le_bytes();
        ...
        crate::util::write_bytes(&mut s, &mut bytes, 4, "is_applied", "    ");
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(246, "CMSG_MOVE_HOVER_ACK", body_size, a))
    }

}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_MOVE_HOVER_ACK {}
