use crate::Guid;
use crate::tbc::UpdateMask;
use crate::tbc::MovementBlock;
use crate::tbc::ObjectType;
use crate::tbc::UpdateType;
use std::io::{Write, Read};

#[derive(Debug, Clone, PartialEq, PartialOrd, Default)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/gameobject/smsg_update_object_2_4_3.wowm:94`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/gameobject/smsg_update_object_2_4_3.wowm#L94):
/// ```text
/// struct Object {
