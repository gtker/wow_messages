...
impl crate::Message for SMSG_TRADE_STATUS {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        match &self.status {
            crate::tbc::SMSG_TRADE_STATUS_TradeStatus::BeginTrade {
                unknown1,
            } => {
                writeln!(s, "    unknown1 = {};", unknown1.guid()).unwrap();
            }
            crate::tbc::SMSG_TRADE_STATUS_TradeStatus::CloseWindow {
                inventory_result,
                item_limit_category_id,
                target_error,
            } => {
            ...
            crate::tbc::SMSG_TRADE_STATUS_TradeStatus::OnlyConjured {
                slot,
            } => {
                writeln!(s, "    slot = {};", slot).unwrap();
            }
            crate::tbc::SMSG_TRADE_STATUS_TradeStatus::NotOnTaplist {
                slot,
            } => {
                writeln!(s, "    slot = {};", slot).unwrap();
            }
