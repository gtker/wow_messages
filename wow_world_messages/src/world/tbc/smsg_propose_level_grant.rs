...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/_need_sorting/smsg_propose_level_grant.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/_need_sorting/smsg_propose_level_grant.wowm#L1):
/// ```text
...
#[cfg(feature = "tbc")]
impl crate::world::tbc::ServerMessage for SMSG_PROPOSE_LEVEL_GRANT {}
