...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/cmsg/cmsg_force_walk_speed_change_ack.wowm:10`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/cmsg/cmsg_force_walk_speed_change_ack.wowm#L10):
/// ```text
...
impl CMSG_FORCE_WALK_SPEED_CHANGE_ACK {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_FORCE_WALK_SPEED_CHANGE_ACK {{").unwrap();
        // Members
        ...
        let [a, b, c, d] = 731_u32.to_le_bytes();
...
impl crate::Message for CMSG_FORCE_WALK_SPEED_CHANGE_ACK {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_FORCE_WALK_SPEED_CHANGE_ACK::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(45..=98).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x02DB, size: body_size });
        }
...
#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for CMSG_FORCE_WALK_SPEED_CHANGE_ACK {}
