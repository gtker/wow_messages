...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_stop_ascend.wowm:14`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_stop_ascend.wowm#L14):
/// ```text
...
impl crate::Message for MSG_MOVE_STOP_ASCEND_Server {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_STOP_ASCEND_Server {{").unwrap();
        // Members
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(858, "MSG_MOVE_STOP_ASCEND_Server", body_size, a))
    }

}

#[cfg(feature = "tbc")]
impl crate::tbc::ServerMessage for MSG_MOVE_STOP_ASCEND_Server {}
