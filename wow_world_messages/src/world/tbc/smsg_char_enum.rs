    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        if !self.characters.is_empty() {
            ...
            for (i, v) in self.characters.iter().enumerate() {
                ...
                writeln!(s, "    /* equipment: CharacterGear[20] start */").unwrap();
                for (i, v) in v.equipment.iter().enumerate() {
                    writeln!(s, "    /* equipment: CharacterGear[20] {i} start */").unwrap();
                    ...
                    writeln!(s, "    /* equipment: CharacterGear[20] {i} end */").unwrap();
                }
                writeln!(s, "    /* equipment: CharacterGear[20] end */").unwrap();
