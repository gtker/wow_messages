...
impl CMSG_LFM_CLEAR_AUTOFILL {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test CMSG_LFM_CLEAR_AUTOFILL {{").unwrap();
        // Members
...
impl crate::private::Sealed for CMSG_LFM_CLEAR_AUTOFILL {}
impl crate::Message for CMSG_LFM_CLEAR_AUTOFILL {
    const OPCODE: u32 = 0x035f;

    #[cfg(feature = "print-testcase")]
    fn to_test_case_string(&self) -> Option<String> {
        CMSG_LFM_CLEAR_AUTOFILL::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if body_size != 0 {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x035F, size: body_size });
        }
