...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_start_strafe_left.wowm:33`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_start_strafe_left.wowm#L33):
/// ```text
...
impl crate::private::Sealed for MSG_MOVE_START_STRAFE_LEFT_Client {}
...
impl crate::Message for MSG_MOVE_START_STRAFE_LEFT_Client {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_START_STRAFE_LEFT_Client {{").unwrap();
        // Members
        // info: MovementInfo
    ...
    fn read_body<S: crate::private::Sealed>(r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r, body_size).map_err(|a| crate::errors::ParseError::new(184, "MSG_MOVE_START_STRAFE_LEFT_Client", body_size, a))
    }

}

#[cfg(feature = "tbc")]
impl crate::tbc::ClientMessage for MSG_MOVE_START_STRAFE_LEFT_Client {}
