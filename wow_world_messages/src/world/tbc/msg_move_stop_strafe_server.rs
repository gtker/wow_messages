...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/msg/msg_move_stop_strafe.wowm:53`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_stop_strafe.wowm#L53):
/// ```text
...
impl MSG_MOVE_STOP_STRAFE_Server {
    fn read_inner(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseErrorKind> {
        if !(31..=91).contains(&body_size) {
            return Err(crate::errors::ParseErrorKind::InvalidSize { opcode: 0x00BA, size: body_size });
        }
...
impl crate::Message for MSG_MOVE_STOP_STRAFE_Server {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_STOP_STRAFE_Server {{").unwrap();
        // Members
...
#[cfg(feature = "tbc")]
impl crate::tbc::ServerMessage for MSG_MOVE_STOP_STRAFE_Server {}
