...
impl MSG_MOVE_STOP_TURN_Client {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "test MSG_MOVE_STOP_TURN_Client {{").unwrap();
        // Members
        // info: MovementInfo
        ...
        let [a, b, c, d] = 190_u32.to_le_bytes();
...
impl crate::Message for MSG_MOVE_STOP_TURN_Client {
    ...
    fn to_test_case_string(&self) -> Option<String> {
        MSG_MOVE_STOP_TURN_Client::to_test_case_string(self)
    }
    ...
    fn read_body<S: crate::private::Sealed>(mut r: &mut &[u8], body_size: u32) -> Result<Self, crate::errors::ParseError> {
        if !(29..=82).contains(&body_size) {
            return Err(crate::errors::ParseError::InvalidSize { opcode: 0x00BE, size: body_size });
        }
