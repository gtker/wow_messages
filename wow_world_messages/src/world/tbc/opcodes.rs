...
impl ClientOpcodeMessage {
    fn read_opcodes(opcode: u32, body_size: u32, mut r: &[u8]) -> std::result::Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x006B => Ok(Self::CMSG_SET_CONTACT_NOTES(<CMSG_SET_CONTACT_NOTES as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x006B, size: body_size, io, } } else { a } })?)),
            ...
            0x00C5 => Ok(Self::MSG_MOVE_TELEPORT(<MSG_MOVE_TELEPORT_Server as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x00C5, size: body_size, io, } } else { a } })?)),
            ...
            0x0200 => Ok(Self::CMSG_SET_LOOKING_FOR_GROUP(<CMSG_SET_LOOKING_FOR_GROUP as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0200, size: body_size, io, } } else { a } })?)),
            ...
            0x0409 => Ok(Self::MSG_QUERY_GUILD_BANK_TEXT(<MSG_QUERY_GUILD_BANK_TEXT_Client as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0409, size: body_size, io, } } else { a } })?)),
...
impl ServerOpcodeMessage {
    fn read_opcodes(opcode: u16, body_size: u32, mut r: &[u8]) -> std::result::Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x0086 => Ok(Self::SMSG_GUILD_DECLINE(<SMSG_GUILD_DECLINE as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0086, size: body_size, io, } } else { a } })?)),
            ...
            0x00F1 => Ok(Self::MSG_MOVE_KNOCK_BACK(<MSG_MOVE_KNOCK_BACK_Server as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x00F1, size: body_size, io, } } else { a } })?)),
            ...
            0x0130 => Ok(Self::SMSG_CAST_FAILED(<SMSG_CAST_FAILED as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0130, size: body_size, io, } } else { a } })?)),
            ...
            0x0252 => Ok(Self::SMSG_RESURRECT_FAILED(<SMSG_RESURRECT_FAILED as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0252, size: body_size, io, } } else { a } })?)),
            ...
            0x033E => Ok(Self::SMSG_MOVE_SET_FLIGHT(<SMSG_MOVE_SET_FLIGHT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x033E, size: body_size, io, } } else { a } })?)),
            0x033F => Ok(Self::SMSG_MOVE_UNSET_FLIGHT(<SMSG_MOVE_UNSET_FLIGHT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x033F, size: body_size, io, } } else { a } })?)),
            ...
            0x0349 => Ok(Self::SMSG_ARENA_TEAM_COMMAND_RESULT(<SMSG_ARENA_TEAM_COMMAND_RESULT as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x0349, size: body_size, io, } } else { a } })?)),
            ...
            0x036E => Ok(Self::SMSG_LFG_UPDATE_LFG(<SMSG_LFG_UPDATE_LFG as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x036E, size: body_size, io, } } else { a } })?)),
            0x036F => Ok(Self::SMSG_LFG_UPDATE_QUEUED(<SMSG_LFG_UPDATE_QUEUED as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x036F, size: body_size, io, } } else { a } })?)),
            ...
            0x03E7 => Ok(Self::SMSG_GUILD_BANK_LIST(<SMSG_GUILD_BANK_LIST as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03E7, size: body_size, io, } } else { a } })?)),
            ...
            0x03F0 => Ok(Self::SMSG_USERLIST_REMOVE(<SMSG_USERLIST_REMOVE as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03F0, size: body_size, io, } } else { a } })?)),
            0x03F1 => Ok(Self::SMSG_USERLIST_UPDATE(<SMSG_USERLIST_UPDATE as crate::Message>::read_body(&mut r, body_size).map_err(|a| { if let ParseError::Io(io) = a { ParseError::BufferSizeTooSmall { opcode: 0x03F1, size: body_size, io, } } else { a } })?)),
