...
pub enum ClientOpcodeMessage {
    ...
    MSG_MOVE_START_FORWARD(Box<MSG_MOVE_START_FORWARD_Client>),
    MSG_MOVE_START_BACKWARD(Box<MSG_MOVE_START_BACKWARD_Client>),
    MSG_MOVE_STOP(Box<MSG_MOVE_STOP_Client>),
    MSG_MOVE_START_STRAFE_LEFT(Box<MSG_MOVE_START_STRAFE_LEFT_Client>),
    MSG_MOVE_START_STRAFE_RIGHT(Box<MSG_MOVE_START_STRAFE_RIGHT_Client>),
    MSG_MOVE_STOP_STRAFE(Box<MSG_MOVE_STOP_STRAFE_Client>),
    MSG_MOVE_JUMP(Box<MSG_MOVE_JUMP_Client>),
    MSG_MOVE_START_TURN_LEFT(Box<MSG_MOVE_START_TURN_LEFT_Client>),
    MSG_MOVE_START_TURN_RIGHT(Box<MSG_MOVE_START_TURN_RIGHT_Client>),
    MSG_MOVE_STOP_TURN(Box<MSG_MOVE_STOP_TURN_Client>),
    MSG_MOVE_START_PITCH_UP(Box<MSG_MOVE_START_PITCH_UP_Client>),
    MSG_MOVE_START_PITCH_DOWN(Box<MSG_MOVE_START_PITCH_DOWN_Client>),
    MSG_MOVE_STOP_PITCH(Box<MSG_MOVE_STOP_PITCH_Client>),
    MSG_MOVE_SET_RUN_MODE(Box<MSG_MOVE_SET_RUN_MODE_Client>),
    MSG_MOVE_SET_WALK_MODE(Box<MSG_MOVE_SET_WALK_MODE_Client>),
    MSG_MOVE_TELEPORT(Box<MSG_MOVE_TELEPORT_Server>),
    MSG_MOVE_TELEPORT_ACK(Box<MSG_MOVE_TELEPORT_ACK_Client>),
    MSG_MOVE_FALL_LAND(Box<MSG_MOVE_FALL_LAND_Client>),
    MSG_MOVE_START_SWIM(Box<MSG_MOVE_START_SWIM_Client>),
    MSG_MOVE_STOP_SWIM(Box<MSG_MOVE_STOP_SWIM_Client>),
    MSG_MOVE_SET_FACING(Box<MSG_MOVE_SET_FACING_Client>),
    MSG_MOVE_SET_PITCH(Box<MSG_MOVE_SET_PITCH_Client>),
    ...
    MSG_MOVE_HEARTBEAT(Box<MSG_MOVE_HEARTBEAT_Client>),
    ...
    MSG_LOOKING_FOR_GROUP(Box<MSG_LOOKING_FOR_GROUP_Client>),
    ...
    CMSG_ITEM_TEXT_QUERY(Box<CMSG_ITEM_TEXT_QUERY>),
    ...
    MSG_MOVE_START_ASCEND(Box<MSG_MOVE_START_ASCEND_Client>),
    MSG_MOVE_STOP_ASCEND(Box<MSG_MOVE_STOP_ASCEND_Client>),
    ...
    MSG_MOVE_START_DESCEND(Box<MSG_MOVE_START_DESCEND_Client>),
...
impl ClientOpcodeMessage {
    fn read_opcodes(opcode: u32, body_size: u32, mut r: &[u8]) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x00B5 => Ok(Self::MSG_MOVE_START_FORWARD(Box::new(<MSG_MOVE_START_FORWARD_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00B6 => Ok(Self::MSG_MOVE_START_BACKWARD(Box::new(<MSG_MOVE_START_BACKWARD_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00B7 => Ok(Self::MSG_MOVE_STOP(Box::new(<MSG_MOVE_STOP_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00B8 => Ok(Self::MSG_MOVE_START_STRAFE_LEFT(Box::new(<MSG_MOVE_START_STRAFE_LEFT_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00B9 => Ok(Self::MSG_MOVE_START_STRAFE_RIGHT(Box::new(<MSG_MOVE_START_STRAFE_RIGHT_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BA => Ok(Self::MSG_MOVE_STOP_STRAFE(Box::new(<MSG_MOVE_STOP_STRAFE_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BB => Ok(Self::MSG_MOVE_JUMP(Box::new(<MSG_MOVE_JUMP_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BC => Ok(Self::MSG_MOVE_START_TURN_LEFT(Box::new(<MSG_MOVE_START_TURN_LEFT_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BD => Ok(Self::MSG_MOVE_START_TURN_RIGHT(Box::new(<MSG_MOVE_START_TURN_RIGHT_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BE => Ok(Self::MSG_MOVE_STOP_TURN(Box::new(<MSG_MOVE_STOP_TURN_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BF => Ok(Self::MSG_MOVE_START_PITCH_UP(Box::new(<MSG_MOVE_START_PITCH_UP_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00C0 => Ok(Self::MSG_MOVE_START_PITCH_DOWN(Box::new(<MSG_MOVE_START_PITCH_DOWN_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00C1 => Ok(Self::MSG_MOVE_STOP_PITCH(Box::new(<MSG_MOVE_STOP_PITCH_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00C2 => Ok(Self::MSG_MOVE_SET_RUN_MODE(Box::new(<MSG_MOVE_SET_RUN_MODE_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00C3 => Ok(Self::MSG_MOVE_SET_WALK_MODE(Box::new(<MSG_MOVE_SET_WALK_MODE_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x00C9 => Ok(Self::MSG_MOVE_FALL_LAND(Box::new(<MSG_MOVE_FALL_LAND_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00CA => Ok(Self::MSG_MOVE_START_SWIM(Box::new(<MSG_MOVE_START_SWIM_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00CB => Ok(Self::MSG_MOVE_STOP_SWIM(Box::new(<MSG_MOVE_STOP_SWIM_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00DA => Ok(Self::MSG_MOVE_SET_FACING(Box::new(<MSG_MOVE_SET_FACING_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00DB => Ok(Self::MSG_MOVE_SET_PITCH(Box::new(<MSG_MOVE_SET_PITCH_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x00EE => Ok(Self::MSG_MOVE_HEARTBEAT(Box::new(<MSG_MOVE_HEARTBEAT_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x01FF => Ok(Self::MSG_LOOKING_FOR_GROUP(Box::new(<MSG_LOOKING_FOR_GROUP_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x0243 => Ok(Self::CMSG_ITEM_TEXT_QUERY(Box::new(<CMSG_ITEM_TEXT_QUERY as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x0359 => Ok(Self::MSG_MOVE_START_ASCEND(Box::new(<MSG_MOVE_START_ASCEND_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x035A => Ok(Self::MSG_MOVE_STOP_ASCEND(Box::new(<MSG_MOVE_STOP_ASCEND_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x03A7 => Ok(Self::MSG_MOVE_START_DESCEND(Box::new(<MSG_MOVE_START_DESCEND_Client as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x03C6 => Ok(Self::CMSG_COMPLAIN(Box::new(<CMSG_COMPLAIN as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03D1 => Ok(Self::CMSG_CHANNEL_DISPLAY_LIST(Box::new(<CMSG_CHANNEL_DISPLAY_LIST as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03D2 => Ok(Self::CMSG_SET_ACTIVE_VOICE_CHANNEL(Box::new(<CMSG_SET_ACTIVE_VOICE_CHANNEL as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03D3 => Ok(Self::CMSG_GET_CHANNEL_MEMBER_COUNT(Box::new(<CMSG_GET_CHANNEL_MEMBER_COUNT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x03E5 => Ok(Self::CMSG_GUILD_BANKER_ACTIVATE(Box::new(<CMSG_GUILD_BANKER_ACTIVATE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03E6 => Ok(Self::CMSG_GUILD_BANK_QUERY_TAB(Box::new(<CMSG_GUILD_BANK_QUERY_TAB as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03E8 => Ok(Self::CMSG_GUILD_BANK_SWAP_ITEMS(Box::new(<CMSG_GUILD_BANK_SWAP_ITEMS as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03E9 => Ok(Self::CMSG_GUILD_BANK_BUY_TAB(Box::new(<CMSG_GUILD_BANK_BUY_TAB as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03EA => Ok(Self::CMSG_GUILD_BANK_UPDATE_TAB(Box::new(<CMSG_GUILD_BANK_UPDATE_TAB as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03EB => Ok(Self::CMSG_GUILD_BANK_DEPOSIT_MONEY(Box::new(<CMSG_GUILD_BANK_DEPOSIT_MONEY as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03EC => Ok(Self::CMSG_GUILD_BANK_WITHDRAW_MONEY(Box::new(<CMSG_GUILD_BANK_WITHDRAW_MONEY as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x03EE => Ok(Self::CMSG_SET_CHANNEL_WATCH(Box::new(<CMSG_SET_CHANNEL_WATCH as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03F2 => Ok(Self::CMSG_CLEAR_CHANNEL_WATCH(Box::new(<CMSG_CLEAR_CHANNEL_WATCH as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x040A => Ok(Self::CMSG_SET_GUILD_BANK_TEXT(Box::new(<CMSG_SET_GUILD_BANK_TEXT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x0418 => Ok(Self::CMSG_SET_PLAYER_DECLINED_NAMES(Box::new(<CMSG_SET_PLAYER_DECLINED_NAMES as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
    ...
    pub fn to_test_case_string(&self) -> Option<String> {
        match self {
            ...
            Self::CMSG_WORLD_TELEPORT(c) => crate::Message::to_test_case_string(c.as_ref()),
            ...
            Self::MSG_LOOKING_FOR_GROUP(c) => crate::Message::to_test_case_string(c.as_ref()),
            ...
            Self::CMSG_ITEM_TEXT_QUERY(c) => crate::Message::to_test_case_string(c.as_ref()),
...
impl From<MSG_LOOKING_FOR_GROUP_Client> for ClientOpcodeMessage {
    fn from(c: MSG_LOOKING_FOR_GROUP_Client) -> Self {
        Self::MSG_LOOKING_FOR_GROUP(Box::new(c))
    }
}
...
impl From<CMSG_ITEM_TEXT_QUERY> for ClientOpcodeMessage {
    fn from(c: CMSG_ITEM_TEXT_QUERY) -> Self {
        Self::CMSG_ITEM_TEXT_QUERY(Box::new(c))
    }
}
...
pub enum ServerOpcodeMessage {
    ...
    MSG_MOVE_START_FORWARD(Box<MSG_MOVE_START_FORWARD_Server>),
    MSG_MOVE_START_BACKWARD(Box<MSG_MOVE_START_BACKWARD_Server>),
    MSG_MOVE_STOP(Box<MSG_MOVE_STOP_Server>),
    MSG_MOVE_START_STRAFE_LEFT(Box<MSG_MOVE_START_STRAFE_LEFT_Server>),
    MSG_MOVE_START_STRAFE_RIGHT(Box<MSG_MOVE_START_STRAFE_RIGHT_Server>),
    MSG_MOVE_STOP_STRAFE(Box<MSG_MOVE_STOP_STRAFE_Server>),
    MSG_MOVE_JUMP(Box<MSG_MOVE_JUMP_Server>),
    MSG_MOVE_START_TURN_LEFT(Box<MSG_MOVE_START_TURN_LEFT_Server>),
    MSG_MOVE_START_TURN_RIGHT(Box<MSG_MOVE_START_TURN_RIGHT_Server>),
    MSG_MOVE_STOP_TURN(Box<MSG_MOVE_STOP_TURN_Server>),
    MSG_MOVE_START_PITCH_UP(Box<MSG_MOVE_START_PITCH_UP_Server>),
    MSG_MOVE_START_PITCH_DOWN(Box<MSG_MOVE_START_PITCH_DOWN_Server>),
    MSG_MOVE_STOP_PITCH(Box<MSG_MOVE_STOP_PITCH_Server>),
    MSG_MOVE_SET_RUN_MODE(Box<MSG_MOVE_SET_RUN_MODE_Server>),
    MSG_MOVE_SET_WALK_MODE(Box<MSG_MOVE_SET_WALK_MODE_Server>),
    MSG_MOVE_TELEPORT_CHEAT(Box<MSG_MOVE_TELEPORT_CHEAT_Server>),
    MSG_MOVE_TELEPORT_ACK(Box<MSG_MOVE_TELEPORT_ACK_Server>),
    MSG_MOVE_FALL_LAND(Box<MSG_MOVE_FALL_LAND_Server>),
    MSG_MOVE_START_SWIM(Box<MSG_MOVE_START_SWIM_Server>),
    MSG_MOVE_STOP_SWIM(Box<MSG_MOVE_STOP_SWIM_Server>),
    MSG_MOVE_SET_FACING(Box<MSG_MOVE_SET_FACING_Server>),
    MSG_MOVE_SET_PITCH(Box<MSG_MOVE_SET_PITCH_Server>),
    ...
    MSG_MOVE_HEARTBEAT(Box<MSG_MOVE_HEARTBEAT_Server>),
    ...
    MSG_LOOKING_FOR_GROUP(Box<MSG_LOOKING_FOR_GROUP_Server>),
    ...
    SMSG_MOVE_SET_FLIGHT(Box<SMSG_MOVE_SET_FLIGHT>),
    SMSG_MOVE_UNSET_FLIGHT(Box<SMSG_MOVE_UNSET_FLIGHT>),
    ...
    MSG_MOVE_START_ASCEND(Box<MSG_MOVE_START_ASCEND_Server>),
    MSG_MOVE_STOP_ASCEND(Box<MSG_MOVE_STOP_ASCEND_Server>),
    ...
    SMSG_LFG_UPDATE_LFG(Box<SMSG_LFG_UPDATE_LFG>),
    ...
    SMSG_SET_EXTRA_AURA_INFO(Box<SMSG_SET_EXTRA_AURA_INFO>),
    SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE(Box<SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE>),
    SMSG_CLEAR_EXTRA_AURA_INFO(Box<SMSG_CLEAR_EXTRA_AURA_INFO>),
    MSG_MOVE_START_DESCEND(Box<MSG_MOVE_START_DESCEND_Server>),
...
impl ServerOpcodeMessage {
    fn read_opcodes(opcode: u16, body_size: u32, mut r: &[u8]) -> Result<Self, crate::errors::ExpectedOpcodeError> {
        match opcode {
            ...
            0x00B5 => Ok(Self::MSG_MOVE_START_FORWARD(Box::new(<MSG_MOVE_START_FORWARD_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00B6 => Ok(Self::MSG_MOVE_START_BACKWARD(Box::new(<MSG_MOVE_START_BACKWARD_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00B7 => Ok(Self::MSG_MOVE_STOP(Box::new(<MSG_MOVE_STOP_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00B8 => Ok(Self::MSG_MOVE_START_STRAFE_LEFT(Box::new(<MSG_MOVE_START_STRAFE_LEFT_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00B9 => Ok(Self::MSG_MOVE_START_STRAFE_RIGHT(Box::new(<MSG_MOVE_START_STRAFE_RIGHT_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BA => Ok(Self::MSG_MOVE_STOP_STRAFE(Box::new(<MSG_MOVE_STOP_STRAFE_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BB => Ok(Self::MSG_MOVE_JUMP(Box::new(<MSG_MOVE_JUMP_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BC => Ok(Self::MSG_MOVE_START_TURN_LEFT(Box::new(<MSG_MOVE_START_TURN_LEFT_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BD => Ok(Self::MSG_MOVE_START_TURN_RIGHT(Box::new(<MSG_MOVE_START_TURN_RIGHT_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BE => Ok(Self::MSG_MOVE_STOP_TURN(Box::new(<MSG_MOVE_STOP_TURN_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00BF => Ok(Self::MSG_MOVE_START_PITCH_UP(Box::new(<MSG_MOVE_START_PITCH_UP_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00C0 => Ok(Self::MSG_MOVE_START_PITCH_DOWN(Box::new(<MSG_MOVE_START_PITCH_DOWN_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00C1 => Ok(Self::MSG_MOVE_STOP_PITCH(Box::new(<MSG_MOVE_STOP_PITCH_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00C2 => Ok(Self::MSG_MOVE_SET_RUN_MODE(Box::new(<MSG_MOVE_SET_RUN_MODE_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00C3 => Ok(Self::MSG_MOVE_SET_WALK_MODE(Box::new(<MSG_MOVE_SET_WALK_MODE_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x00C9 => Ok(Self::MSG_MOVE_FALL_LAND(Box::new(<MSG_MOVE_FALL_LAND_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00CA => Ok(Self::MSG_MOVE_START_SWIM(Box::new(<MSG_MOVE_START_SWIM_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00CB => Ok(Self::MSG_MOVE_STOP_SWIM(Box::new(<MSG_MOVE_STOP_SWIM_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00DA => Ok(Self::MSG_MOVE_SET_FACING(Box::new(<MSG_MOVE_SET_FACING_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x00DB => Ok(Self::MSG_MOVE_SET_PITCH(Box::new(<MSG_MOVE_SET_PITCH_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x00EE => Ok(Self::MSG_MOVE_HEARTBEAT(Box::new(<MSG_MOVE_HEARTBEAT_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x01FF => Ok(Self::MSG_LOOKING_FOR_GROUP(Box::new(<MSG_LOOKING_FOR_GROUP_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x033E => Ok(Self::SMSG_MOVE_SET_FLIGHT(Box::new(<SMSG_MOVE_SET_FLIGHT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x033F => Ok(Self::SMSG_MOVE_UNSET_FLIGHT(Box::new(<SMSG_MOVE_UNSET_FLIGHT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x0359 => Ok(Self::MSG_MOVE_START_ASCEND(Box::new(<MSG_MOVE_START_ASCEND_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x035A => Ok(Self::MSG_MOVE_STOP_ASCEND(Box::new(<MSG_MOVE_STOP_ASCEND_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x036E => Ok(Self::SMSG_LFG_UPDATE_LFG(Box::new(<SMSG_LFG_UPDATE_LFG as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x03A4 => Ok(Self::SMSG_SET_EXTRA_AURA_INFO(Box::new(<SMSG_SET_EXTRA_AURA_INFO as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03A5 => Ok(Self::SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE(Box::new(<SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03A6 => Ok(Self::SMSG_CLEAR_EXTRA_AURA_INFO(Box::new(<SMSG_CLEAR_EXTRA_AURA_INFO as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03A7 => Ok(Self::MSG_MOVE_START_DESCEND(Box::new(<MSG_MOVE_START_DESCEND_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x03B2 => Ok(Self::SMSG_GM_MESSAGECHAT(Box::new(<SMSG_GM_MESSAGECHAT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x03C0 => Ok(Self::SMSG_CROSSED_INEBRIATION_THRESHOLD(Box::new(<SMSG_CROSSED_INEBRIATION_THRESHOLD as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03C4 => Ok(Self::SMSG_KICK_REASON(Box::new(<SMSG_KICK_REASON as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x03D4 => Ok(Self::SMSG_CHANNEL_MEMBER_COUNT(Box::new(<SMSG_CHANNEL_MEMBER_COUNT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03E7 => Ok(Self::SMSG_GUILD_BANK_LIST(Box::new(<SMSG_GUILD_BANK_LIST as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03ED => Ok(Self::MSG_GUILD_BANK_LOG_QUERY(Box::new(<MSG_GUILD_BANK_LOG_QUERY_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03EF => Ok(Self::SMSG_USERLIST_ADD(Box::new(<SMSG_USERLIST_ADD as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03F0 => Ok(Self::SMSG_USERLIST_REMOVE(Box::new(<SMSG_USERLIST_REMOVE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03F1 => Ok(Self::SMSG_USERLIST_UPDATE(Box::new(<SMSG_USERLIST_UPDATE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03F3 => Ok(Self::SMSG_INSPECT_TALENT(Box::new(<SMSG_INSPECT_TALENT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03F8 => Ok(Self::SMSG_LOOT_LIST(Box::new(<SMSG_LOOT_LIST as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x03FC => Ok(Self::MSG_GUILD_PERMISSIONS(Box::new(<MSG_GUILD_PERMISSIONS_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x03FE => Ok(Self::MSG_GUILD_EVENT_LOG_QUERY(Box::new(<MSG_GUILD_EVENT_LOG_QUERY_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x0401 => Ok(Self::SMSG_MIRRORIMAGE_DATA(Box::new(<SMSG_MIRRORIMAGE_DATA as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x0409 => Ok(Self::MSG_QUERY_GUILD_BANK_TEXT(Box::new(<MSG_QUERY_GUILD_BANK_TEXT_Server as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x0411 => Ok(Self::SMSG_OVERRIDE_LIGHT(Box::new(<SMSG_OVERRIDE_LIGHT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x0412 => Ok(Self::SMSG_TOTEM_CREATED(Box::new(<SMSG_TOTEM_CREATED as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x0417 => Ok(Self::SMSG_QUESTGIVER_STATUS_MULTIPLE(Box::new(<SMSG_QUESTGIVER_STATUS_MULTIPLE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x0419 => Ok(Self::SMSG_SET_PLAYER_DECLINED_NAMES_RESULT(Box::new(<SMSG_SET_PLAYER_DECLINED_NAMES_RESULT as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            0x041D => Ok(Self::SMSG_SEND_UNLEARN_SPELLS(Box::new(<SMSG_SEND_UNLEARN_SPELLS as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
            ...
            0x0420 => Ok(Self::SMSG_REFER_A_FRIEND_FAILURE(Box::new(<SMSG_REFER_A_FRIEND_FAILURE as crate::Message>::read_body::<crate::traits::private::Internal>(&mut r, body_size).map_err(|a| a.opcode_convert())?))),
    ...
    pub fn to_test_case_string(&self) -> Option<String> {
        match self {
            ...
            Self::SMSG_MOVE_SET_FLIGHT(c) => crate::Message::to_test_case_string(c.as_ref()),
            Self::SMSG_MOVE_UNSET_FLIGHT(c) => crate::Message::to_test_case_string(c.as_ref()),
            ...
            Self::SMSG_LFG_UPDATE_LFG(c) => crate::Message::to_test_case_string(c.as_ref()),
            ...
            Self::SMSG_SET_EXTRA_AURA_INFO(c) => crate::Message::to_test_case_string(c.as_ref()),
            Self::SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE(c) => crate::Message::to_test_case_string(c.as_ref()),
            Self::SMSG_CLEAR_EXTRA_AURA_INFO(c) => crate::Message::to_test_case_string(c.as_ref()),
            Self::MSG_MOVE_START_DESCEND(c) => crate::Message::to_test_case_string(c.as_ref()),
...
impl From<SMSG_LFG_UPDATE_LFG> for ServerOpcodeMessage {
    fn from(c: SMSG_LFG_UPDATE_LFG) -> Self {
        Self::SMSG_LFG_UPDATE_LFG(Box::new(c))
    }
}
...
impl From<SMSG_SET_EXTRA_AURA_INFO> for ServerOpcodeMessage {
    fn from(c: SMSG_SET_EXTRA_AURA_INFO) -> Self {
        Self::SMSG_SET_EXTRA_AURA_INFO(Box::new(c))
    }
}
