...
use crate::world::tbc::CMSG_PET_NAME_QUERY;
use crate::world::tbc::CMSG_GUILD_QUERY;
use crate::world::tbc::CMSG_ITEM_QUERY_SINGLE;
use crate::world::tbc::CMSG_PAGE_TEXT_QUERY;
use crate::world::tbc::CMSG_QUEST_QUERY;
use crate::world::tbc::CMSG_GAMEOBJECT_QUERY;
use crate::world::tbc::CMSG_CREATURE_QUERY;
use crate::world::tbc::CMSG_WHO;
use crate::world::tbc::CMSG_WHOIS;
use crate::world::tbc::CMSG_CONTACT_LIST;
use crate::world::tbc::CMSG_ADD_FRIEND;
use crate::world::tbc::CMSG_DEL_FRIEND;
use crate::world::tbc::CMSG_SET_CONTACT_NOTES;
use crate::world::tbc::CMSG_ADD_IGNORE;
use crate::world::tbc::CMSG_DEL_IGNORE;
use crate::world::tbc::CMSG_GROUP_INVITE;
use crate::world::tbc::CMSG_GROUP_CANCEL;
use crate::world::tbc::CMSG_GROUP_ACCEPT;
use crate::world::tbc::CMSG_GROUP_DECLINE;
use crate::world::tbc::CMSG_GROUP_UNINVITE;
...
use crate::world::tbc::CMSG_GUILD_DECLINE;
use crate::world::tbc::CMSG_GUILD_INFO;
use crate::world::tbc::CMSG_GUILD_ROSTER;
use crate::world::tbc::CMSG_GUILD_PROMOTE;
use crate::world::tbc::CMSG_GUILD_DEMOTE;
use crate::world::tbc::CMSG_GUILD_LEAVE;
use crate::world::tbc::CMSG_GUILD_REMOVE;
use crate::world::tbc::CMSG_GUILD_DISBAND;
use crate::world::tbc::CMSG_GUILD_LEADER;
use crate::world::tbc::CMSG_GUILD_MOTD;
...
use crate::world::tbc::CMSG_USE_ITEM;
use crate::world::tbc::CMSG_OPEN_ITEM;
use crate::world::tbc::CMSG_READ_ITEM;
use crate::world::tbc::CMSG_GAMEOBJ_USE;
...
use crate::world::tbc::MSG_MOVE_TELEPORT_Server;
...
use crate::world::tbc::CMSG_MOVE_KNOCK_BACK_ACK;
use crate::world::tbc::CMSG_MOVE_HOVER_ACK;
...
use crate::world::tbc::CMSG_STANDSTATECHANGE;
use crate::world::tbc::CMSG_EMOTE;
use crate::world::tbc::CMSG_TEXT_EMOTE;
use crate::world::tbc::CMSG_AUTOSTORE_LOOT_ITEM;
use crate::world::tbc::CMSG_AUTOEQUIP_ITEM;
use crate::world::tbc::CMSG_AUTOSTORE_BAG_ITEM;
use crate::world::tbc::CMSG_SWAP_ITEM;
use crate::world::tbc::CMSG_SWAP_INV_ITEM;
use crate::world::tbc::CMSG_SPLIT_ITEM;
use crate::world::tbc::CMSG_AUTOEQUIP_ITEM_SLOT;
use crate::world::tbc::CMSG_DESTROYITEM;
use crate::world::tbc::CMSG_INSPECT;
use crate::world::tbc::CMSG_INITIATE_TRADE;
use crate::world::tbc::CMSG_BEGIN_TRADE;
use crate::world::tbc::CMSG_BUSY_TRADE;
use crate::world::tbc::CMSG_IGNORE_TRADE;
use crate::world::tbc::CMSG_ACCEPT_TRADE;
use crate::world::tbc::CMSG_UNACCEPT_TRADE;
use crate::world::tbc::CMSG_CANCEL_TRADE;
use crate::world::tbc::CMSG_SET_TRADE_ITEM;
use crate::world::tbc::CMSG_CLEAR_TRADE_ITEM;
use crate::world::tbc::CMSG_SET_TRADE_GOLD;
use crate::world::tbc::CMSG_SET_FACTION_ATWAR;
use crate::world::tbc::CMSG_SET_ACTION_BUTTON;
use crate::world::tbc::CMSG_CAST_SPELL;
use crate::world::tbc::CMSG_CANCEL_CAST;
use crate::world::tbc::CMSG_CANCEL_AURA;
...
use crate::world::tbc::CMSG_RESURRECT_RESPONSE;
use crate::world::tbc::CMSG_LOOT;
use crate::world::tbc::CMSG_LOOT_MONEY;
use crate::world::tbc::CMSG_LOOT_RELEASE;
use crate::world::tbc::CMSG_DUEL_ACCEPTED;
use crate::world::tbc::CMSG_DUEL_CANCELLED;
use crate::world::tbc::CMSG_MOUNTSPECIAL_ANIM;
use crate::world::tbc::CMSG_PET_SET_ACTION;
use crate::world::tbc::CMSG_PET_ACTION;
use crate::world::tbc::CMSG_PET_ABANDON;
use crate::world::tbc::CMSG_PET_RENAME;
use crate::world::tbc::CMSG_GOSSIP_HELLO;
use crate::world::tbc::CMSG_GOSSIP_SELECT_OPTION;
use crate::world::tbc::CMSG_NPC_TEXT_QUERY;
use crate::world::tbc::CMSG_QUESTGIVER_STATUS_QUERY;
use crate::world::tbc::CMSG_QUESTGIVER_HELLO;
use crate::world::tbc::CMSG_QUESTGIVER_QUERY_QUEST;
...
use crate::world::tbc::CMSG_QUESTLOG_SWAP_QUEST;
use crate::world::tbc::CMSG_QUESTLOG_REMOVE_QUEST;
use crate::world::tbc::CMSG_QUEST_CONFIRM_ACCEPT;
use crate::world::tbc::CMSG_PUSHQUESTTOPARTY;
use crate::world::tbc::CMSG_LIST_INVENTORY;
use crate::world::tbc::CMSG_SELL_ITEM;
use crate::world::tbc::CMSG_BUY_ITEM;
use crate::world::tbc::CMSG_BUY_ITEM_IN_SLOT;
use crate::world::tbc::CMSG_TAXINODE_STATUS_QUERY;
...
use crate::world::tbc::CMSG_RECLAIM_CORPSE;
use crate::world::tbc::CMSG_WRAP_ITEM;
use crate::world::tbc::MSG_MINIMAP_PING_Client;
use crate::world::tbc::CMSG_PING;
use crate::world::tbc::CMSG_SETSHEATHED;
use crate::world::tbc::CMSG_AUTH_SESSION;
use crate::world::tbc::CMSG_PET_CAST_SPELL;
use crate::world::tbc::MSG_SAVE_GUILD_EMBLEM_Client;
use crate::world::tbc::CMSG_ZONEUPDATE;
use crate::world::tbc::MSG_RANDOM_ROLL_Client;
use crate::world::tbc::CMSG_UNLEARN_SKILL;
...
use crate::world::tbc::CMSG_UNLEARN_TALENTS;
...
use crate::world::tbc::CMSG_ITEM_TEXT_QUERY;
use crate::world::tbc::CMSG_MAIL_TAKE_MONEY;
use crate::world::tbc::CMSG_MAIL_TAKE_ITEM;
use crate::world::tbc::CMSG_MAIL_MARK_AS_READ;
...
use crate::world::tbc::CMSG_CANCEL_AUTO_REPEAT_SPELL;
use crate::world::tbc::MSG_LIST_STABLED_PETS_Client;
...
use crate::world::tbc::CMSG_REQUEST_PARTY_MEMBER_STATS;
use crate::world::tbc::CMSG_GROUP_SWAP_SUB_GROUP;
...
use crate::world::tbc::CMSG_GMTICKETSYSTEM_TOGGLE;
...
use crate::world::tbc::MSG_TALENT_WIPE_CONFIRM_Client;
use crate::world::tbc::CMSG_SUMMON_RESPONSE;
use crate::world::tbc::CMSG_SELF_RES;
use crate::world::tbc::CMSG_TOGGLE_HELM;
use crate::world::tbc::CMSG_TOGGLE_CLOAK;
use crate::world::tbc::CMSG_SET_ACTIONBAR_TOGGLES;
use crate::world::tbc::CMSG_ITEM_NAME_QUERY;
use crate::world::tbc::CMSG_CHAR_RENAME;
use crate::world::tbc::CMSG_MOVE_SPLINE_DONE;
use crate::world::tbc::CMSG_MOVE_FALL_RESET;
use crate::world::tbc::CMSG_REQUEST_RAID_INFO;
use crate::world::tbc::CMSG_MOVE_TIME_SKIPPED;
use crate::world::tbc::CMSG_MOVE_FEATHER_FALL_ACK;
use crate::world::tbc::CMSG_MOVE_WATER_WALK_ACK;
use crate::world::tbc::CMSG_MOVE_NOT_ACTIVE_MOVER;
use crate::world::tbc::CMSG_BATTLEFIELD_STATUS;
use crate::world::tbc::CMSG_BATTLEFIELD_PORT;
use crate::world::tbc::MSG_INSPECT_HONOR_STATS_Client;
...
use crate::world::tbc::MSG_PVP_LOG_DATA_Client;
use crate::world::tbc::CMSG_LEAVE_BATTLEFIELD;
use crate::world::tbc::CMSG_AREA_SPIRIT_HEALER_QUERY;
use crate::world::tbc::CMSG_AREA_SPIRIT_HEALER_QUEUE;
use crate::world::tbc::CMSG_WARDEN_DATA;
use crate::world::tbc::MSG_BATTLEGROUND_PLAYER_POSITIONS_Client;
use crate::world::tbc::CMSG_PET_STOP_ATTACK;
use crate::world::tbc::CMSG_BATTLEMASTER_JOIN;
use crate::world::tbc::CMSG_PET_UNLEARN;
use crate::world::tbc::CMSG_PET_SPELL_AUTOCAST;
use crate::world::tbc::CMSG_GUILD_INFO_TEXT;
...
use crate::world::tbc::CMSG_ARENA_TEAM_LEADER;
...
use crate::world::tbc::CMSG_SET_TAXI_BENCHMARK_MODE;
use crate::world::tbc::CMSG_REALM_SPLIT;
use crate::world::tbc::CMSG_MOVE_CHNG_TRANSPORT;
use crate::world::tbc::MSG_PARTY_ASSIGNMENT_Client;
...
use crate::world::tbc::SMSG_PAGE_TEXT_QUERY_RESPONSE;
use crate::world::tbc::SMSG_QUEST_QUERY_RESPONSE;
use crate::world::tbc::SMSG_GAMEOBJECT_QUERY_RESPONSE;
use crate::world::tbc::SMSG_CREATURE_QUERY_RESPONSE;
use crate::world::tbc::SMSG_WHO;
...
use crate::world::tbc::SMSG_GROUP_UNINVITE;
use crate::world::tbc::SMSG_GROUP_SET_LEADER;
use crate::world::tbc::SMSG_GROUP_DESTROYED;
use crate::world::tbc::SMSG_GROUP_LIST;
use crate::world::tbc::SMSG_PARTY_COMMAND_RESULT;
use crate::world::tbc::SMSG_GUILD_INVITE;
use crate::world::tbc::SMSG_GUILD_DECLINE;
use crate::world::tbc::SMSG_GUILD_INFO;
use crate::world::tbc::SMSG_GUILD_ROSTER;
use crate::world::tbc::SMSG_GUILD_EVENT;
use crate::world::tbc::SMSG_GUILD_COMMAND_RESULT;
use crate::world::tbc::SMSG_MESSAGECHAT;
...
use crate::world::tbc::SMSG_READ_ITEM_OK;
use crate::world::tbc::SMSG_READ_ITEM_FAILED;
use crate::world::tbc::SMSG_ITEM_COOLDOWN;
use crate::world::tbc::SMSG_GAMEOBJECT_CUSTOM_ANIM;
...
use crate::world::tbc::MSG_MOVE_TELEPORT_CHEAT_Server;
...
use crate::world::tbc::SMSG_FORCE_MOVE_ROOT;
use crate::world::tbc::SMSG_FORCE_MOVE_UNROOT;
use crate::world::tbc::MSG_MOVE_ROOT_Server;
use crate::world::tbc::MSG_MOVE_UNROOT_Server;
use crate::world::tbc::MSG_MOVE_HEARTBEAT_Server;
use crate::world::tbc::SMSG_MOVE_KNOCK_BACK;
use crate::world::tbc::MSG_MOVE_KNOCK_BACK_Server;
use crate::world::tbc::SMSG_MOVE_FEATHER_FALL;
use crate::world::tbc::SMSG_MOVE_NORMAL_FALL;
use crate::world::tbc::SMSG_MOVE_SET_HOVER;
use crate::world::tbc::SMSG_MOVE_UNSET_HOVER;
...
use crate::world::tbc::SMSG_SET_PROFICIENCY;
use crate::world::tbc::SMSG_ACTION_BUTTONS;
use crate::world::tbc::SMSG_INITIAL_SPELLS;
use crate::world::tbc::SMSG_LEARNED_SPELL;
use crate::world::tbc::SMSG_SUPERCEDED_SPELL;
use crate::world::tbc::SMSG_CAST_FAILED;
...
use crate::world::tbc::SMSG_SPELLHEALLOG;
use crate::world::tbc::SMSG_SPELLENERGIZELOG;
...
use crate::world::tbc::SMSG_LOOT_RESPONSE;
...
use crate::world::tbc::SMSG_LOOT_CLEAR_MONEY;
use crate::world::tbc::SMSG_ITEM_PUSH_RESULT;
...
use crate::world::tbc::SMSG_MOUNTRESULT;
use crate::world::tbc::SMSG_MOUNTSPECIAL_ANIM;
use crate::world::tbc::SMSG_PET_TAME_FAILURE;
use crate::world::tbc::SMSG_PET_NAME_INVALID;
use crate::world::tbc::SMSG_PET_SPELLS;
use crate::world::tbc::SMSG_PET_MODE;
...
use crate::world::tbc::SMSG_QUESTGIVER_QUEST_LIST;
use crate::world::tbc::SMSG_QUESTGIVER_QUEST_DETAILS;
use crate::world::tbc::SMSG_QUESTGIVER_REQUEST_ITEMS;
use crate::world::tbc::SMSG_QUESTGIVER_OFFER_REWARD;
use crate::world::tbc::SMSG_QUESTGIVER_QUEST_INVALID;
use crate::world::tbc::SMSG_QUESTGIVER_QUEST_COMPLETE;
use crate::world::tbc::SMSG_QUESTGIVER_QUEST_FAILED;
use crate::world::tbc::SMSG_QUESTLOG_FULL;
use crate::world::tbc::SMSG_QUESTUPDATE_FAILED;
use crate::world::tbc::SMSG_QUESTUPDATE_FAILEDTIMER;
use crate::world::tbc::SMSG_QUESTUPDATE_COMPLETE;
use crate::world::tbc::SMSG_QUESTUPDATE_ADD_KILL;
use crate::world::tbc::SMSG_QUESTUPDATE_ADD_ITEM;
...
use crate::world::tbc::SMSG_TAXINODE_STATUS;
use crate::world::tbc::SMSG_ACTIVATETAXIREPLY;
use crate::world::tbc::SMSG_NEW_TAXI_PATH;
use crate::world::tbc::SMSG_TRAINER_LIST;
use crate::world::tbc::SMSG_TRAINER_BUY_SUCCEEDED;
use crate::world::tbc::SMSG_TRAINER_BUY_FAILED;
use crate::world::tbc::SMSG_SHOW_BANK;
use crate::world::tbc::SMSG_BUY_BANK_SLOT_RESULT;
...
use crate::world::tbc::SMSG_TURN_IN_PETITION_RESULTS;
use crate::world::tbc::SMSG_PETITION_QUERY_RESPONSE;
...
use crate::world::tbc::SMSG_ENCHANTMENTLOG;
use crate::world::tbc::SMSG_START_MIRROR_TIMER;
use crate::world::tbc::SMSG_PAUSE_MIRROR_TIMER;
use crate::world::tbc::SMSG_STOP_MIRROR_TIMER;
use crate::world::tbc::SMSG_PONG;
use crate::world::tbc::SMSG_CLEAR_COOLDOWN;
use crate::world::tbc::SMSG_GAMEOBJECT_PAGETEXT;
use crate::world::tbc::SMSG_SPELL_DELAYED;
use crate::world::tbc::SMSG_ITEM_TIME_UPDATE;
use crate::world::tbc::SMSG_ITEM_ENCHANT_TIME_UPDATE;
use crate::world::tbc::SMSG_AUTH_CHALLENGE;
use crate::world::tbc::SMSG_AUTH_RESPONSE;
use crate::world::tbc::MSG_SAVE_GUILD_EMBLEM_Server;
use crate::world::tbc::SMSG_PLAY_SPELL_VISUAL;
use crate::world::tbc::SMSG_PARTYKILLLOG;
use crate::world::tbc::SMSG_PLAY_SPELL_IMPACT;
use crate::world::tbc::SMSG_EXPLORATION_EXPERIENCE;
use crate::world::tbc::MSG_RANDOM_ROLL_Server;
use crate::world::tbc::SMSG_ENVIRONMENTAL_DAMAGE_LOG;
use crate::world::tbc::SMSG_REMOVED_SPELL;
use crate::world::tbc::SMSG_GMTICKET_CREATE;
use crate::world::tbc::SMSG_GMTICKET_UPDATETEXT;
use crate::world::tbc::SMSG_ACCOUNT_DATA_TIMES;
use crate::world::tbc::SMSG_GMTICKET_GETTICKET;
use crate::world::tbc::SMSG_GAMEOBJECT_SPAWN_ANIM;
use crate::world::tbc::SMSG_GAMEOBJECT_DESPAWN_ANIM;
use crate::world::tbc::MSG_CORPSE_QUERY_Server;
...
use crate::world::tbc::SMSG_SPELLNONMELEEDAMAGELOG;
use crate::world::tbc::SMSG_RESURRECT_FAILED;
...
use crate::world::tbc::SMSG_SET_FLAT_SPELL_MODIFIER;
use crate::world::tbc::SMSG_SET_PCT_SPELL_MODIFIER;
use crate::world::tbc::SMSG_CORPSE_RECLAIM_DELAY;
...
use crate::world::tbc::SMSG_FORCE_TURN_RATE_CHANGE;
use crate::world::tbc::SMSG_AREA_SPIRIT_HEALER_TIME;
use crate::world::tbc::SMSG_WARDEN_DATA;
use crate::world::tbc::SMSG_GROUP_JOINED_BATTLEGROUND;
...
use crate::world::tbc::SMSG_ARENA_TEAM_COMMAND_RESULT;
...
use crate::world::tbc::SMSG_DEATH_RELEASE_LOC;
use crate::world::tbc::SMSG_FORCED_DEATH_UPDATE;
use crate::world::tbc::MSG_MOVE_SET_FLIGHT_SPEED_Server;
use crate::world::tbc::SMSG_FORCE_FLIGHT_SPEED_CHANGE;
use crate::world::tbc::SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE;
use crate::world::tbc::SMSG_SPLINE_SET_FLIGHT_SPEED;
use crate::world::tbc::SMSG_SPLINE_SET_FLIGHT_BACK_SPEED;
use crate::world::tbc::SMSG_FLIGHT_SPLINE_SYNC;
use crate::world::tbc::SMSG_REALM_SPLIT;
use crate::world::tbc::SMSG_TIME_SYNC_REQ;
use crate::world::tbc::SMSG_RESET_FAILED_NOTIFY;
use crate::world::tbc::SMSG_LFG_DISABLED;
