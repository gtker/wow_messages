...
use crate::tbc::MSG_MOVE_WORLDPORT_ACK;
use crate::tbc::MSG_MOVE_HOVER;
use crate::tbc::MSG_PETITION_DECLINE;
use crate::tbc::MSG_TABARDVENDOR_ACTIVATE;
use crate::tbc::MSG_QUEST_PUSH_RESULT;
use crate::tbc::MSG_MOVE_WATER_WALK;
use crate::tbc::MSG_PETITION_RENAME;
use crate::tbc::MSG_MOVE_SET_FLIGHT_BACK_SPEED;
use crate::tbc::CMSG_BOOTME;
use crate::tbc::CMSG_DBLOOKUP;
use crate::tbc::CMSG_WORLD_TELEPORT;
use crate::tbc::CMSG_TELEPORT_TO_UNIT;
use crate::tbc::CMSG_CHAR_CREATE;
use crate::tbc::CMSG_CHAR_ENUM;
use crate::tbc::CMSG_CHAR_DELETE;
use crate::tbc::CMSG_PLAYER_LOGIN;
use crate::tbc::CMSG_PLAYER_LOGOUT;
use crate::tbc::CMSG_LOGOUT_REQUEST;
use crate::tbc::CMSG_LOGOUT_CANCEL;
use crate::tbc::CMSG_NAME_QUERY;
use crate::tbc::CMSG_PET_NAME_QUERY;
use crate::tbc::CMSG_GUILD_QUERY;
use crate::tbc::CMSG_ITEM_QUERY_SINGLE;
use crate::tbc::CMSG_PAGE_TEXT_QUERY;
use crate::tbc::CMSG_QUEST_QUERY;
use crate::tbc::CMSG_GAMEOBJECT_QUERY;
use crate::tbc::CMSG_CREATURE_QUERY;
use crate::tbc::CMSG_WHO;
use crate::tbc::CMSG_WHOIS;
use crate::tbc::CMSG_CONTACT_LIST;
use crate::tbc::CMSG_ADD_FRIEND;
use crate::tbc::CMSG_DEL_FRIEND;
use crate::tbc::CMSG_SET_CONTACT_NOTES;
use crate::tbc::CMSG_ADD_IGNORE;
use crate::tbc::CMSG_DEL_IGNORE;
use crate::tbc::CMSG_GROUP_INVITE;
use crate::tbc::CMSG_GROUP_CANCEL;
use crate::tbc::CMSG_GROUP_ACCEPT;
use crate::tbc::CMSG_GROUP_DECLINE;
use crate::tbc::CMSG_GROUP_UNINVITE;
use crate::tbc::CMSG_GROUP_UNINVITE_GUID;
use crate::tbc::CMSG_GROUP_SET_LEADER;
use crate::tbc::CMSG_LOOT_METHOD;
use crate::tbc::CMSG_GROUP_DISBAND;
use crate::tbc::CMSG_GUILD_CREATE;
use crate::tbc::CMSG_GUILD_INVITE;
use crate::tbc::CMSG_GUILD_ACCEPT;
use crate::tbc::CMSG_GUILD_DECLINE;
use crate::tbc::CMSG_GUILD_INFO;
use crate::tbc::CMSG_GUILD_ROSTER;
use crate::tbc::CMSG_GUILD_PROMOTE;
use crate::tbc::CMSG_GUILD_DEMOTE;
use crate::tbc::CMSG_GUILD_LEAVE;
use crate::tbc::CMSG_GUILD_REMOVE;
use crate::tbc::CMSG_GUILD_DISBAND;
use crate::tbc::CMSG_GUILD_LEADER;
use crate::tbc::CMSG_GUILD_MOTD;
use crate::tbc::CMSG_MESSAGECHAT;
use crate::tbc::CMSG_JOIN_CHANNEL;
use crate::tbc::CMSG_LEAVE_CHANNEL;
use crate::tbc::CMSG_CHANNEL_LIST;
use crate::tbc::CMSG_CHANNEL_PASSWORD;
use crate::tbc::CMSG_CHANNEL_SET_OWNER;
use crate::tbc::CMSG_CHANNEL_OWNER;
use crate::tbc::CMSG_CHANNEL_MODERATOR;
use crate::tbc::CMSG_CHANNEL_UNMODERATOR;
use crate::tbc::CMSG_CHANNEL_MUTE;
use crate::tbc::CMSG_CHANNEL_UNMUTE;
use crate::tbc::CMSG_CHANNEL_INVITE;
use crate::tbc::CMSG_CHANNEL_KICK;
use crate::tbc::CMSG_CHANNEL_BAN;
use crate::tbc::CMSG_CHANNEL_UNBAN;
use crate::tbc::CMSG_CHANNEL_ANNOUNCEMENTS;
use crate::tbc::CMSG_CHANNEL_MODERATE;
use crate::tbc::CMSG_USE_ITEM;
use crate::tbc::CMSG_OPEN_ITEM;
use crate::tbc::CMSG_READ_ITEM;
use crate::tbc::CMSG_GAMEOBJ_USE;
use crate::tbc::CMSG_AREATRIGGER;
use crate::tbc::MSG_MOVE_START_FORWARD_Client;
use crate::tbc::MSG_MOVE_START_BACKWARD_Client;
use crate::tbc::MSG_MOVE_STOP_Client;
use crate::tbc::MSG_MOVE_START_STRAFE_LEFT_Client;
use crate::tbc::MSG_MOVE_START_STRAFE_RIGHT_Client;
use crate::tbc::MSG_MOVE_STOP_STRAFE_Client;
use crate::tbc::MSG_MOVE_JUMP_Client;
use crate::tbc::MSG_MOVE_START_TURN_LEFT_Client;
use crate::tbc::MSG_MOVE_START_TURN_RIGHT_Client;
use crate::tbc::MSG_MOVE_STOP_TURN_Client;
use crate::tbc::MSG_MOVE_START_PITCH_UP_Client;
use crate::tbc::MSG_MOVE_START_PITCH_DOWN_Client;
use crate::tbc::MSG_MOVE_STOP_PITCH_Client;
use crate::tbc::MSG_MOVE_SET_RUN_MODE_Client;
use crate::tbc::MSG_MOVE_SET_WALK_MODE_Client;
use crate::tbc::MSG_MOVE_TELEPORT_Server;
use crate::tbc::MSG_MOVE_TELEPORT_ACK_Client;
use crate::tbc::MSG_MOVE_FALL_LAND_Client;
use crate::tbc::MSG_MOVE_START_SWIM_Client;
use crate::tbc::MSG_MOVE_STOP_SWIM_Client;
use crate::tbc::MSG_MOVE_SET_FACING_Client;
use crate::tbc::MSG_MOVE_SET_PITCH_Client;
use crate::tbc::CMSG_MOVE_SET_RAW_POSITION;
use crate::tbc::CMSG_FORCE_RUN_SPEED_CHANGE_ACK;
use crate::tbc::CMSG_FORCE_RUN_BACK_SPEED_CHANGE_ACK;
use crate::tbc::CMSG_FORCE_SWIM_SPEED_CHANGE_ACK;
use crate::tbc::CMSG_FORCE_MOVE_ROOT_ACK;
use crate::tbc::CMSG_FORCE_MOVE_UNROOT_ACK;
use crate::tbc::MSG_MOVE_HEARTBEAT_Client;
use crate::tbc::CMSG_MOVE_KNOCK_BACK_ACK;
use crate::tbc::CMSG_MOVE_HOVER_ACK;
use crate::tbc::CMSG_NEXT_CINEMATIC_CAMERA;
use crate::tbc::CMSG_COMPLETE_CINEMATIC;
use crate::tbc::CMSG_TUTORIAL_FLAG;
use crate::tbc::CMSG_TUTORIAL_CLEAR;
use crate::tbc::CMSG_TUTORIAL_RESET;
use crate::tbc::CMSG_STANDSTATECHANGE;
use crate::tbc::CMSG_EMOTE;
use crate::tbc::CMSG_TEXT_EMOTE;
use crate::tbc::CMSG_AUTOSTORE_LOOT_ITEM;
use crate::tbc::CMSG_AUTOEQUIP_ITEM;
use crate::tbc::CMSG_AUTOSTORE_BAG_ITEM;
use crate::tbc::CMSG_SWAP_ITEM;
use crate::tbc::CMSG_SWAP_INV_ITEM;
use crate::tbc::CMSG_SPLIT_ITEM;
use crate::tbc::CMSG_AUTOEQUIP_ITEM_SLOT;
use crate::tbc::CMSG_DESTROYITEM;
use crate::tbc::CMSG_INSPECT;
use crate::tbc::CMSG_INITIATE_TRADE;
use crate::tbc::CMSG_BEGIN_TRADE;
use crate::tbc::CMSG_BUSY_TRADE;
use crate::tbc::CMSG_IGNORE_TRADE;
use crate::tbc::CMSG_ACCEPT_TRADE;
use crate::tbc::CMSG_UNACCEPT_TRADE;
use crate::tbc::CMSG_CANCEL_TRADE;
use crate::tbc::CMSG_SET_TRADE_ITEM;
use crate::tbc::CMSG_CLEAR_TRADE_ITEM;
use crate::tbc::CMSG_SET_TRADE_GOLD;
use crate::tbc::CMSG_SET_FACTION_ATWAR;
use crate::tbc::CMSG_SET_ACTION_BUTTON;
use crate::tbc::CMSG_CAST_SPELL;
use crate::tbc::CMSG_CANCEL_CAST;
use crate::tbc::CMSG_CANCEL_AURA;
use crate::tbc::CMSG_CANCEL_CHANNELLING;
use crate::tbc::CMSG_SET_SELECTION;
use crate::tbc::CMSG_SET_TARGET_OBSOLETE;
use crate::tbc::CMSG_ATTACKSWING;
use crate::tbc::CMSG_ATTACKSTOP;
use crate::tbc::CMSG_REPOP_REQUEST;
use crate::tbc::CMSG_RESURRECT_RESPONSE;
use crate::tbc::CMSG_LOOT;
use crate::tbc::CMSG_LOOT_MONEY;
use crate::tbc::CMSG_LOOT_RELEASE;
use crate::tbc::CMSG_DUEL_ACCEPTED;
use crate::tbc::CMSG_DUEL_CANCELLED;
use crate::tbc::CMSG_MOUNTSPECIAL_ANIM;
use crate::tbc::CMSG_PET_SET_ACTION;
use crate::tbc::CMSG_PET_ACTION;
use crate::tbc::CMSG_PET_ABANDON;
use crate::tbc::CMSG_PET_RENAME;
use crate::tbc::CMSG_GOSSIP_HELLO;
use crate::tbc::CMSG_GOSSIP_SELECT_OPTION;
use crate::tbc::CMSG_NPC_TEXT_QUERY;
use crate::tbc::CMSG_QUESTGIVER_STATUS_QUERY;
use crate::tbc::CMSG_QUESTGIVER_HELLO;
use crate::tbc::CMSG_QUESTGIVER_QUERY_QUEST;
use crate::tbc::CMSG_QUESTGIVER_QUEST_AUTOLAUNCH;
use crate::tbc::CMSG_QUESTGIVER_ACCEPT_QUEST;
use crate::tbc::CMSG_QUESTGIVER_COMPLETE_QUEST;
use crate::tbc::CMSG_QUESTGIVER_REQUEST_REWARD;
use crate::tbc::CMSG_QUESTGIVER_CHOOSE_REWARD;
use crate::tbc::CMSG_QUESTGIVER_CANCEL;
use crate::tbc::CMSG_QUESTLOG_SWAP_QUEST;
use crate::tbc::CMSG_QUESTLOG_REMOVE_QUEST;
use crate::tbc::CMSG_QUEST_CONFIRM_ACCEPT;
use crate::tbc::CMSG_PUSHQUESTTOPARTY;
use crate::tbc::CMSG_LIST_INVENTORY;
use crate::tbc::CMSG_SELL_ITEM;
use crate::tbc::CMSG_BUY_ITEM;
use crate::tbc::CMSG_BUY_ITEM_IN_SLOT;
use crate::tbc::CMSG_TAXINODE_STATUS_QUERY;
use crate::tbc::CMSG_TAXIQUERYAVAILABLENODES;
use crate::tbc::CMSG_ACTIVATETAXI;
use crate::tbc::CMSG_TRAINER_LIST;
use crate::tbc::CMSG_TRAINER_BUY_SPELL;
use crate::tbc::CMSG_BINDER_ACTIVATE;
use crate::tbc::CMSG_BANKER_ACTIVATE;
use crate::tbc::CMSG_BUY_BANK_SLOT;
use crate::tbc::CMSG_PETITION_SHOWLIST;
use crate::tbc::CMSG_PETITION_BUY;
use crate::tbc::CMSG_PETITION_SHOW_SIGNATURES;
use crate::tbc::CMSG_PETITION_SIGN;
use crate::tbc::CMSG_OFFER_PETITION;
use crate::tbc::CMSG_TURN_IN_PETITION;
use crate::tbc::CMSG_PETITION_QUERY;
use crate::tbc::CMSG_BUG;
use crate::tbc::CMSG_PLAYED_TIME;
use crate::tbc::CMSG_QUERY_TIME;
use crate::tbc::CMSG_RECLAIM_CORPSE;
use crate::tbc::CMSG_WRAP_ITEM;
use crate::tbc::MSG_MINIMAP_PING_Client;
use crate::tbc::CMSG_PING;
use crate::tbc::CMSG_SETSHEATHED;
use crate::tbc::CMSG_AUTH_SESSION;
use crate::tbc::CMSG_PET_CAST_SPELL;
use crate::tbc::MSG_SAVE_GUILD_EMBLEM_Client;
use crate::tbc::CMSG_ZONEUPDATE;
use crate::tbc::MSG_RANDOM_ROLL_Client;
use crate::tbc::MSG_LOOKING_FOR_GROUP_Client;
use crate::tbc::CMSG_SET_LOOKING_FOR_GROUP;
use crate::tbc::CMSG_UNLEARN_SKILL;
use crate::tbc::CMSG_GMTICKET_CREATE;
use crate::tbc::CMSG_GMTICKET_UPDATETEXT;
use crate::tbc::CMSG_REQUEST_ACCOUNT_DATA;
use crate::tbc::CMSG_UPDATE_ACCOUNT_DATA;
use crate::tbc::CMSG_GMTICKET_GETTICKET;
use crate::tbc::CMSG_UNLEARN_TALENTS;
use crate::tbc::MSG_CORPSE_QUERY_Client;
use crate::tbc::CMSG_GMTICKET_DELETETICKET;
use crate::tbc::CMSG_GMTICKET_SYSTEMSTATUS;
use crate::tbc::CMSG_SPIRIT_HEALER_ACTIVATE;
use crate::tbc::CMSG_CHAT_IGNORED;
use crate::tbc::CMSG_GUILD_RANK;
use crate::tbc::CMSG_GUILD_ADD_RANK;
use crate::tbc::CMSG_GUILD_DEL_RANK;
use crate::tbc::CMSG_GUILD_SET_PUBLIC_NOTE;
use crate::tbc::CMSG_GUILD_SET_OFFICER_NOTE;
use crate::tbc::CMSG_SEND_MAIL;
use crate::tbc::CMSG_GET_MAIL_LIST;
use crate::tbc::CMSG_BATTLEFIELD_LIST;
use crate::tbc::CMSG_ITEM_TEXT_QUERY;
use crate::tbc::CMSG_MAIL_TAKE_MONEY;
use crate::tbc::CMSG_MAIL_TAKE_ITEM;
use crate::tbc::CMSG_MAIL_MARK_AS_READ;
use crate::tbc::CMSG_MAIL_RETURN_TO_SENDER;
use crate::tbc::CMSG_MAIL_DELETE;
use crate::tbc::CMSG_MAIL_CREATE_TEXT_ITEM;
use crate::tbc::CMSG_LEARN_TALENT;
use crate::tbc::CMSG_TOGGLE_PVP;
use crate::tbc::MSG_AUCTION_HELLO_Client;
use crate::tbc::CMSG_AUCTION_SELL_ITEM;
use crate::tbc::CMSG_AUCTION_REMOVE_ITEM;
use crate::tbc::CMSG_AUCTION_LIST_ITEMS;
use crate::tbc::CMSG_AUCTION_LIST_OWNER_ITEMS;
use crate::tbc::CMSG_AUCTION_PLACE_BID;
use crate::tbc::CMSG_AUCTION_LIST_BIDDER_ITEMS;
use crate::tbc::CMSG_SET_AMMO;
use crate::tbc::CMSG_SET_ACTIVE_MOVER;
use crate::tbc::CMSG_PET_CANCEL_AURA;
use crate::tbc::CMSG_CANCEL_AUTO_REPEAT_SPELL;
use crate::tbc::MSG_LIST_STABLED_PETS_Client;
use crate::tbc::CMSG_STABLE_PET;
use crate::tbc::CMSG_UNSTABLE_PET;
use crate::tbc::CMSG_BUY_STABLE_SLOT;
use crate::tbc::CMSG_STABLE_SWAP_PET;
use crate::tbc::CMSG_REQUEST_PET_INFO;
use crate::tbc::CMSG_FAR_SIGHT;
use crate::tbc::CMSG_GROUP_CHANGE_SUB_GROUP;
use crate::tbc::CMSG_REQUEST_PARTY_MEMBER_STATS;
use crate::tbc::CMSG_GROUP_SWAP_SUB_GROUP;
use crate::tbc::CMSG_AUTOSTORE_BANK_ITEM;
use crate::tbc::CMSG_AUTOBANK_ITEM;
use crate::tbc::MSG_QUERY_NEXT_MAIL_TIME_Client;
use crate::tbc::CMSG_GROUP_RAID_CONVERT;
use crate::tbc::CMSG_GROUP_ASSISTANT_LEADER;
use crate::tbc::CMSG_BUYBACK_ITEM;
use crate::tbc::CMSG_MEETINGSTONE_INFO;
use crate::tbc::CMSG_GMTICKETSYSTEM_TOGGLE;
use crate::tbc::CMSG_CANCEL_GROWTH_AURA;
use crate::tbc::CMSG_LOOT_ROLL;
use crate::tbc::CMSG_LOOT_MASTER_GIVE;
use crate::tbc::CMSG_REPAIR_ITEM;
use crate::tbc::MSG_TALENT_WIPE_CONFIRM_Client;
use crate::tbc::CMSG_SUMMON_RESPONSE;
use crate::tbc::CMSG_SELF_RES;
use crate::tbc::CMSG_TOGGLE_HELM;
use crate::tbc::CMSG_TOGGLE_CLOAK;
use crate::tbc::CMSG_SET_ACTIONBAR_TOGGLES;
use crate::tbc::CMSG_ITEM_NAME_QUERY;
use crate::tbc::CMSG_CHAR_RENAME;
use crate::tbc::CMSG_MOVE_SPLINE_DONE;
use crate::tbc::CMSG_MOVE_FALL_RESET;
use crate::tbc::CMSG_REQUEST_RAID_INFO;
use crate::tbc::CMSG_MOVE_TIME_SKIPPED;
use crate::tbc::CMSG_MOVE_FEATHER_FALL_ACK;
use crate::tbc::CMSG_MOVE_WATER_WALK_ACK;
use crate::tbc::CMSG_MOVE_NOT_ACTIVE_MOVER;
use crate::tbc::CMSG_BATTLEFIELD_STATUS;
use crate::tbc::CMSG_BATTLEFIELD_PORT;
use crate::tbc::MSG_INSPECT_HONOR_STATS_Client;
use crate::tbc::CMSG_BATTLEMASTER_HELLO;
use crate::tbc::CMSG_FORCE_WALK_SPEED_CHANGE_ACK;
use crate::tbc::CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK;
use crate::tbc::CMSG_FORCE_TURN_RATE_CHANGE_ACK;
use crate::tbc::MSG_PVP_LOG_DATA_Client;
use crate::tbc::CMSG_LEAVE_BATTLEFIELD;
use crate::tbc::CMSG_AREA_SPIRIT_HEALER_QUERY;
use crate::tbc::CMSG_AREA_SPIRIT_HEALER_QUEUE;
use crate::tbc::CMSG_WARDEN_DATA;
use crate::tbc::MSG_BATTLEGROUND_PLAYER_POSITIONS_Client;
use crate::tbc::CMSG_PET_STOP_ATTACK;
use crate::tbc::CMSG_BATTLEMASTER_JOIN;
use crate::tbc::CMSG_PET_UNLEARN;
use crate::tbc::CMSG_PET_SPELL_AUTOCAST;
use crate::tbc::CMSG_GUILD_INFO_TEXT;
use crate::tbc::CMSG_ACTIVATETAXIEXPRESS;
use crate::tbc::CMSG_SET_FACTION_INACTIVE;
use crate::tbc::CMSG_SET_WATCHED_FACTION;
use crate::tbc::CMSG_RESET_INSTANCES;
use crate::tbc::MSG_RAID_TARGET_UPDATE_Client;
use crate::tbc::MSG_RAID_READY_CHECK_Client;
use crate::tbc::MSG_SET_DUNGEON_DIFFICULTY_Client;
use crate::tbc::CMSG_GMSURVEY_SUBMIT;
use crate::tbc::CMSG_MOVE_SET_CAN_FLY_ACK;
use crate::tbc::CMSG_MOVE_SET_FLY;
use crate::tbc::CMSG_SOCKET_GEMS;
use crate::tbc::CMSG_ARENA_TEAM_ROSTER;
use crate::tbc::CMSG_ARENA_TEAM_INVITE;
use crate::tbc::CMSG_ARENA_TEAM_ACCEPT;
use crate::tbc::CMSG_ARENA_TEAM_DECLINE;
use crate::tbc::CMSG_ARENA_TEAM_LEAVE;
use crate::tbc::CMSG_ARENA_TEAM_REMOVE;
use crate::tbc::CMSG_ARENA_TEAM_DISBAND;
use crate::tbc::CMSG_ARENA_TEAM_LEADER;
use crate::tbc::CMSG_BATTLEMASTER_JOIN_ARENA;
use crate::tbc::MSG_MOVE_START_ASCEND_Client;
use crate::tbc::MSG_MOVE_STOP_ASCEND_Client;
use crate::tbc::CMSG_LFG_SET_AUTOJOIN;
use crate::tbc::CMSG_LFG_CLEAR_AUTOJOIN;
use crate::tbc::CMSG_LFM_SET_AUTOFILL;
use crate::tbc::CMSG_LFM_CLEAR_AUTOFILL;
use crate::tbc::CMSG_CLEAR_LOOKING_FOR_GROUP;
use crate::tbc::CMSG_CLEAR_LOOKING_FOR_MORE;
use crate::tbc::CMSG_SET_LOOKING_FOR_MORE;
use crate::tbc::CMSG_SET_LFG_COMMENT;
use crate::tbc::CMSG_SET_TITLE;
use crate::tbc::CMSG_CANCEL_MOUNT_AURA;
use crate::tbc::MSG_INSPECT_ARENA_TEAMS_Client;
use crate::tbc::CMSG_CANCEL_TEMP_ENCHANTMENT;
use crate::tbc::CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK;
use crate::tbc::CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK;
use crate::tbc::CMSG_SET_TAXI_BENCHMARK_MODE;
use crate::tbc::CMSG_REALM_SPLIT;
use crate::tbc::CMSG_MOVE_CHNG_TRANSPORT;
use crate::tbc::MSG_PARTY_ASSIGNMENT_Client;
use crate::tbc::CMSG_TIME_SYNC_RESP;
use crate::tbc::MSG_MOVE_START_DESCEND_Client;
use crate::tbc::MSG_RAID_READY_CHECK_CONFIRM_Client;
use crate::tbc::CMSG_VOICE_SESSION_ENABLE;
use crate::tbc::CMSG_COMMENTATOR_ENABLE;
use crate::tbc::MSG_RAID_READY_CHECK_FINISHED_Client;
use crate::tbc::CMSG_COMPLAIN;
use crate::tbc::CMSG_CHANNEL_DISPLAY_LIST;
use crate::tbc::CMSG_SET_ACTIVE_VOICE_CHANNEL;
use crate::tbc::CMSG_GET_CHANNEL_MEMBER_COUNT;
use crate::tbc::CMSG_CHANNEL_VOICE_ON;
use crate::tbc::CMSG_REPORT_PVP_AFK;
use crate::tbc::CMSG_GUILD_BANKER_ACTIVATE;
use crate::tbc::CMSG_GUILD_BANK_QUERY_TAB;
use crate::tbc::CMSG_GUILD_BANK_SWAP_ITEMS;
use crate::tbc::CMSG_GUILD_BANK_BUY_TAB;
use crate::tbc::CMSG_GUILD_BANK_UPDATE_TAB;
use crate::tbc::CMSG_GUILD_BANK_DEPOSIT_MONEY;
use crate::tbc::CMSG_GUILD_BANK_WITHDRAW_MONEY;
use crate::tbc::MSG_GUILD_BANK_LOG_QUERY_Client;
use crate::tbc::CMSG_SET_CHANNEL_WATCH;
use crate::tbc::CMSG_CLEAR_CHANNEL_WATCH;
use crate::tbc::CMSG_SPELLCLICK;
use crate::tbc::MSG_GUILD_PERMISSIONS_Client;
use crate::tbc::MSG_GUILD_BANK_MONEY_WITHDRAWN_Client;
use crate::tbc::MSG_GUILD_EVENT_LOG_QUERY_Client;
use crate::tbc::CMSG_GET_MIRRORIMAGE_DATA;
use crate::tbc::CMSG_KEEP_ALIVE;
use crate::tbc::CMSG_OPT_OUT_OF_LOOT;
use crate::tbc::MSG_QUERY_GUILD_BANK_TEXT_Client;
use crate::tbc::CMSG_SET_GUILD_BANK_TEXT;
use crate::tbc::CMSG_GRANT_LEVEL;
use crate::tbc::CMSG_TOTEM_DESTROYED;
use crate::tbc::CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY;
use crate::tbc::CMSG_SET_PLAYER_DECLINED_NAMES;
use crate::tbc::CMSG_ACCEPT_LEVEL_GRANT;
...
use crate::tbc::SMSG_CHAR_CREATE;
use crate::tbc::SMSG_CHAR_ENUM;
use crate::tbc::SMSG_CHAR_DELETE;
use crate::tbc::SMSG_NEW_WORLD;
use crate::tbc::SMSG_TRANSFER_PENDING;
use crate::tbc::SMSG_TRANSFER_ABORTED;
use crate::tbc::SMSG_CHARACTER_LOGIN_FAILED;
use crate::tbc::SMSG_LOGIN_SETTIMESPEED;
use crate::tbc::SMSG_LOGOUT_RESPONSE;
use crate::tbc::SMSG_LOGOUT_COMPLETE;
use crate::tbc::SMSG_LOGOUT_CANCEL_ACK;
use crate::tbc::SMSG_NAME_QUERY_RESPONSE;
use crate::tbc::SMSG_PET_NAME_QUERY_RESPONSE;
use crate::tbc::SMSG_GUILD_QUERY_RESPONSE;
use crate::tbc::SMSG_ITEM_QUERY_SINGLE_RESPONSE;
use crate::tbc::SMSG_PAGE_TEXT_QUERY_RESPONSE;
use crate::tbc::SMSG_QUEST_QUERY_RESPONSE;
use crate::tbc::SMSG_GAMEOBJECT_QUERY_RESPONSE;
use crate::tbc::SMSG_CREATURE_QUERY_RESPONSE;
use crate::tbc::SMSG_WHO;
use crate::tbc::SMSG_WHOIS;
use crate::tbc::SMSG_CONTACT_LIST;
use crate::tbc::SMSG_FRIEND_STATUS;
use crate::tbc::SMSG_GROUP_INVITE;
use crate::tbc::SMSG_GROUP_DECLINE;
use crate::tbc::SMSG_GROUP_UNINVITE;
use crate::tbc::SMSG_GROUP_SET_LEADER;
use crate::tbc::SMSG_GROUP_DESTROYED;
use crate::tbc::SMSG_GROUP_LIST;
use crate::tbc::SMSG_PARTY_MEMBER_STATS;
use crate::tbc::SMSG_PARTY_COMMAND_RESULT;
use crate::tbc::SMSG_GUILD_INVITE;
use crate::tbc::SMSG_GUILD_DECLINE;
use crate::tbc::SMSG_GUILD_INFO;
use crate::tbc::SMSG_GUILD_ROSTER;
use crate::tbc::SMSG_GUILD_EVENT;
use crate::tbc::SMSG_GUILD_COMMAND_RESULT;
use crate::tbc::SMSG_MESSAGECHAT;
use crate::tbc::SMSG_CHANNEL_NOTIFY;
use crate::tbc::SMSG_CHANNEL_LIST;
use crate::tbc::SMSG_UPDATE_OBJECT;
use crate::tbc::SMSG_DESTROY_OBJECT;
use crate::tbc::SMSG_READ_ITEM_OK;
use crate::tbc::SMSG_READ_ITEM_FAILED;
use crate::tbc::SMSG_ITEM_COOLDOWN;
use crate::tbc::SMSG_GAMEOBJECT_CUSTOM_ANIM;
use crate::tbc::MSG_MOVE_START_FORWARD_Server;
use crate::tbc::MSG_MOVE_START_BACKWARD_Server;
use crate::tbc::MSG_MOVE_STOP_Server;
use crate::tbc::MSG_MOVE_START_STRAFE_LEFT_Server;
use crate::tbc::MSG_MOVE_START_STRAFE_RIGHT_Server;
use crate::tbc::MSG_MOVE_STOP_STRAFE_Server;
use crate::tbc::MSG_MOVE_JUMP_Server;
use crate::tbc::MSG_MOVE_START_TURN_LEFT_Server;
use crate::tbc::MSG_MOVE_START_TURN_RIGHT_Server;
use crate::tbc::MSG_MOVE_STOP_TURN_Server;
use crate::tbc::MSG_MOVE_START_PITCH_UP_Server;
use crate::tbc::MSG_MOVE_START_PITCH_DOWN_Server;
use crate::tbc::MSG_MOVE_STOP_PITCH_Server;
use crate::tbc::MSG_MOVE_SET_RUN_MODE_Server;
use crate::tbc::MSG_MOVE_SET_WALK_MODE_Server;
use crate::tbc::MSG_MOVE_TELEPORT_CHEAT_Server;
use crate::tbc::MSG_MOVE_TELEPORT_ACK_Server;
use crate::tbc::MSG_MOVE_FALL_LAND_Server;
use crate::tbc::MSG_MOVE_START_SWIM_Server;
use crate::tbc::MSG_MOVE_STOP_SWIM_Server;
use crate::tbc::MSG_MOVE_SET_FACING_Server;
use crate::tbc::MSG_MOVE_SET_PITCH_Server;
use crate::tbc::SMSG_MONSTER_MOVE;
use crate::tbc::SMSG_MOVE_WATER_WALK;
use crate::tbc::SMSG_MOVE_LAND_WALK;
use crate::tbc::SMSG_FORCE_RUN_SPEED_CHANGE;
use crate::tbc::SMSG_FORCE_RUN_BACK_SPEED_CHANGE;
use crate::tbc::SMSG_FORCE_SWIM_SPEED_CHANGE;
use crate::tbc::SMSG_FORCE_MOVE_ROOT;
use crate::tbc::SMSG_FORCE_MOVE_UNROOT;
use crate::tbc::MSG_MOVE_ROOT_Server;
use crate::tbc::MSG_MOVE_UNROOT_Server;
use crate::tbc::MSG_MOVE_HEARTBEAT_Server;
use crate::tbc::SMSG_MOVE_KNOCK_BACK;
use crate::tbc::MSG_MOVE_KNOCK_BACK_Server;
use crate::tbc::SMSG_MOVE_FEATHER_FALL;
use crate::tbc::SMSG_MOVE_NORMAL_FALL;
use crate::tbc::SMSG_MOVE_SET_HOVER;
use crate::tbc::SMSG_MOVE_UNSET_HOVER;
use crate::tbc::SMSG_TRIGGER_CINEMATIC;
use crate::tbc::SMSG_TUTORIAL_FLAGS;
use crate::tbc::SMSG_EMOTE;
use crate::tbc::SMSG_TEXT_EMOTE;
use crate::tbc::SMSG_INVENTORY_CHANGE_FAILURE;
use crate::tbc::SMSG_TRADE_STATUS;
use crate::tbc::SMSG_TRADE_STATUS_EXTENDED;
use crate::tbc::SMSG_INITIALIZE_FACTIONS;
use crate::tbc::SMSG_SET_FACTION_VISIBLE;
use crate::tbc::SMSG_SET_FACTION_STANDING;
use crate::tbc::SMSG_SET_PROFICIENCY;
use crate::tbc::SMSG_ACTION_BUTTONS;
use crate::tbc::SMSG_INITIAL_SPELLS;
use crate::tbc::SMSG_LEARNED_SPELL;
use crate::tbc::SMSG_SUPERCEDED_SPELL;
use crate::tbc::SMSG_CAST_FAILED;
use crate::tbc::SMSG_SPELL_START;
use crate::tbc::SMSG_SPELL_GO;
use crate::tbc::SMSG_SPELL_FAILURE;
use crate::tbc::SMSG_SPELL_COOLDOWN;
use crate::tbc::SMSG_COOLDOWN_EVENT;
use crate::tbc::SMSG_UPDATE_AURA_DURATION;
use crate::tbc::SMSG_PET_CAST_FAILED;
use crate::tbc::MSG_CHANNEL_START_Server;
use crate::tbc::MSG_CHANNEL_UPDATE_Server;
use crate::tbc::SMSG_AI_REACTION;
use crate::tbc::SMSG_ATTACKSTART;
use crate::tbc::SMSG_ATTACKSTOP;
use crate::tbc::SMSG_ATTACKSWING_NOTINRANGE;
use crate::tbc::SMSG_ATTACKSWING_BADFACING;
use crate::tbc::SMSG_ATTACKSWING_NOTSTANDING;
use crate::tbc::SMSG_ATTACKSWING_DEADTARGET;
use crate::tbc::SMSG_ATTACKSWING_CANT_ATTACK;
use crate::tbc::SMSG_ATTACKERSTATEUPDATE;
use crate::tbc::SMSG_CANCEL_COMBAT;
use crate::tbc::SMSG_SPELLHEALLOG;
use crate::tbc::SMSG_SPELLENERGIZELOG;
use crate::tbc::SMSG_BINDPOINTUPDATE;
use crate::tbc::SMSG_PLAYERBOUND;
use crate::tbc::SMSG_CLIENT_CONTROL_UPDATE;
use crate::tbc::SMSG_RESURRECT_REQUEST;
use crate::tbc::SMSG_LOOT_RESPONSE;
use crate::tbc::SMSG_LOOT_RELEASE_RESPONSE;
use crate::tbc::SMSG_LOOT_REMOVED;
use crate::tbc::SMSG_LOOT_MONEY_NOTIFY;
use crate::tbc::SMSG_LOOT_CLEAR_MONEY;
use crate::tbc::SMSG_ITEM_PUSH_RESULT;
use crate::tbc::SMSG_DUEL_REQUESTED;
use crate::tbc::SMSG_DUEL_OUTOFBOUNDS;
use crate::tbc::SMSG_DUEL_INBOUNDS;
use crate::tbc::SMSG_DUEL_COMPLETE;
use crate::tbc::SMSG_DUEL_WINNER;
use crate::tbc::SMSG_MOUNTRESULT;
use crate::tbc::SMSG_MOUNTSPECIAL_ANIM;
use crate::tbc::SMSG_PET_TAME_FAILURE;
use crate::tbc::SMSG_PET_NAME_INVALID;
use crate::tbc::SMSG_PET_SPELLS;
use crate::tbc::SMSG_PET_MODE;
use crate::tbc::SMSG_GOSSIP_MESSAGE;
use crate::tbc::SMSG_GOSSIP_COMPLETE;
use crate::tbc::SMSG_NPC_TEXT_UPDATE;
use crate::tbc::SMSG_QUESTGIVER_STATUS;
use crate::tbc::SMSG_QUESTGIVER_QUEST_LIST;
use crate::tbc::SMSG_QUESTGIVER_QUEST_DETAILS;
use crate::tbc::SMSG_QUESTGIVER_REQUEST_ITEMS;
use crate::tbc::SMSG_QUESTGIVER_OFFER_REWARD;
use crate::tbc::SMSG_QUESTGIVER_QUEST_INVALID;
use crate::tbc::SMSG_QUESTGIVER_QUEST_COMPLETE;
use crate::tbc::SMSG_QUESTGIVER_QUEST_FAILED;
use crate::tbc::SMSG_QUESTLOG_FULL;
use crate::tbc::SMSG_QUESTUPDATE_FAILED;
use crate::tbc::SMSG_QUESTUPDATE_FAILEDTIMER;
use crate::tbc::SMSG_QUESTUPDATE_COMPLETE;
use crate::tbc::SMSG_QUESTUPDATE_ADD_KILL;
use crate::tbc::SMSG_QUESTUPDATE_ADD_ITEM;
use crate::tbc::SMSG_QUEST_CONFIRM_ACCEPT;
use crate::tbc::SMSG_LIST_INVENTORY;
use crate::tbc::SMSG_SELL_ITEM;
use crate::tbc::SMSG_BUY_ITEM;
use crate::tbc::SMSG_BUY_FAILED;
use crate::tbc::SMSG_SHOWTAXINODES;
use crate::tbc::SMSG_TAXINODE_STATUS;
use crate::tbc::SMSG_ACTIVATETAXIREPLY;
use crate::tbc::SMSG_NEW_TAXI_PATH;
use crate::tbc::SMSG_TRAINER_LIST;
use crate::tbc::SMSG_TRAINER_BUY_SUCCEEDED;
use crate::tbc::SMSG_TRAINER_BUY_FAILED;
use crate::tbc::SMSG_SHOW_BANK;
use crate::tbc::SMSG_BUY_BANK_SLOT_RESULT;
use crate::tbc::SMSG_PETITION_SHOWLIST;
use crate::tbc::SMSG_PETITION_SHOW_SIGNATURES;
use crate::tbc::SMSG_PETITION_SIGN_RESULTS;
use crate::tbc::SMSG_TURN_IN_PETITION_RESULTS;
use crate::tbc::SMSG_PETITION_QUERY_RESPONSE;
use crate::tbc::SMSG_FISH_NOT_HOOKED;
use crate::tbc::SMSG_FISH_ESCAPED;
use crate::tbc::SMSG_NOTIFICATION;
use crate::tbc::SMSG_PLAYED_TIME;
use crate::tbc::SMSG_QUERY_TIME_RESPONSE;
use crate::tbc::SMSG_LOG_XPGAIN;
use crate::tbc::SMSG_LEVELUP_INFO;
use crate::tbc::MSG_MINIMAP_PING_Server;
use crate::tbc::SMSG_ENCHANTMENTLOG;
use crate::tbc::SMSG_START_MIRROR_TIMER;
use crate::tbc::SMSG_PAUSE_MIRROR_TIMER;
use crate::tbc::SMSG_STOP_MIRROR_TIMER;
use crate::tbc::SMSG_PONG;
use crate::tbc::SMSG_CLEAR_COOLDOWN;
use crate::tbc::SMSG_GAMEOBJECT_PAGETEXT;
use crate::tbc::SMSG_SPELL_DELAYED;
use crate::tbc::SMSG_ITEM_TIME_UPDATE;
use crate::tbc::SMSG_ITEM_ENCHANT_TIME_UPDATE;
use crate::tbc::SMSG_AUTH_CHALLENGE;
use crate::tbc::SMSG_AUTH_RESPONSE;
use crate::tbc::MSG_SAVE_GUILD_EMBLEM_Server;
use crate::tbc::SMSG_PLAY_SPELL_VISUAL;
use crate::tbc::SMSG_PARTYKILLLOG;
use crate::tbc::SMSG_COMPRESSED_UPDATE_OBJECT;
use crate::tbc::SMSG_PLAY_SPELL_IMPACT;
use crate::tbc::SMSG_EXPLORATION_EXPERIENCE;
use crate::tbc::MSG_RANDOM_ROLL_Server;
use crate::tbc::SMSG_ENVIRONMENTAL_DAMAGE_LOG;
use crate::tbc::MSG_LOOKING_FOR_GROUP_Server;
use crate::tbc::SMSG_REMOVED_SPELL;
use crate::tbc::SMSG_GMTICKET_CREATE;
use crate::tbc::SMSG_GMTICKET_UPDATETEXT;
use crate::tbc::SMSG_ACCOUNT_DATA_TIMES;
use crate::tbc::SMSG_UPDATE_ACCOUNT_DATA;
use crate::tbc::SMSG_GMTICKET_GETTICKET;
use crate::tbc::SMSG_GAMEOBJECT_SPAWN_ANIM;
use crate::tbc::SMSG_GAMEOBJECT_DESPAWN_ANIM;
use crate::tbc::MSG_CORPSE_QUERY_Server;
use crate::tbc::SMSG_GMTICKET_DELETETICKET;
use crate::tbc::SMSG_CHAT_WRONG_FACTION;
use crate::tbc::SMSG_GMTICKET_SYSTEMSTATUS;
use crate::tbc::SMSG_SET_REST_START;
use crate::tbc::SMSG_SPIRIT_HEALER_CONFIRM;
use crate::tbc::SMSG_GOSSIP_POI;
use crate::tbc::SMSG_LOGIN_VERIFY_WORLD;
use crate::tbc::SMSG_SEND_MAIL_RESULT;
use crate::tbc::SMSG_MAIL_LIST_RESULT;
use crate::tbc::SMSG_BATTLEFIELD_LIST;
use crate::tbc::SMSG_ITEM_TEXT_QUERY_RESPONSE;
use crate::tbc::SMSG_SPELLLOGMISS;
use crate::tbc::SMSG_SPELLLOGEXECUTE;
use crate::tbc::SMSG_PERIODICAURALOG;
use crate::tbc::SMSG_SPELLDAMAGESHIELD;
use crate::tbc::SMSG_SPELLNONMELEEDAMAGELOG;
use crate::tbc::SMSG_RESURRECT_FAILED;
use crate::tbc::SMSG_ZONE_UNDER_ATTACK;
use crate::tbc::MSG_AUCTION_HELLO_Server;
use crate::tbc::SMSG_AUCTION_COMMAND_RESULT;
use crate::tbc::SMSG_AUCTION_LIST_RESULT;
use crate::tbc::SMSG_AUCTION_OWNER_LIST_RESULT;
use crate::tbc::SMSG_AUCTION_BIDDER_NOTIFICATION;
use crate::tbc::SMSG_AUCTION_OWNER_NOTIFICATION;
use crate::tbc::SMSG_PROCRESIST;
use crate::tbc::SMSG_DISPEL_FAILED;
use crate::tbc::SMSG_SPELLORDAMAGE_IMMUNE;
use crate::tbc::SMSG_AUCTION_BIDDER_LIST_RESULT;
use crate::tbc::SMSG_SET_FLAT_SPELL_MODIFIER;
use crate::tbc::SMSG_SET_PCT_SPELL_MODIFIER;
use crate::tbc::SMSG_CORPSE_RECLAIM_DELAY;
use crate::tbc::MSG_LIST_STABLED_PETS_Server;
use crate::tbc::SMSG_STABLE_RESULT;
use crate::tbc::SMSG_PLAY_MUSIC;
use crate::tbc::SMSG_PLAY_OBJECT_SOUND;
use crate::tbc::SMSG_SPELLDISPELLOG;
use crate::tbc::MSG_QUERY_NEXT_MAIL_TIME_Server;
use crate::tbc::SMSG_RECEIVED_MAIL;
use crate::tbc::SMSG_RAID_GROUP_ONLY;
use crate::tbc::SMSG_PVP_CREDIT;
use crate::tbc::SMSG_AUCTION_REMOVED_NOTIFICATION;
use crate::tbc::SMSG_SERVER_MESSAGE;
use crate::tbc::SMSG_MEETINGSTONE_SETQUEUE;
use crate::tbc::SMSG_CANCEL_AUTO_REPEAT;
use crate::tbc::SMSG_STANDSTATE_UPDATE;
use crate::tbc::SMSG_LOOT_ALL_PASSED;
use crate::tbc::SMSG_LOOT_ROLL_WON;
use crate::tbc::SMSG_LOOT_START_ROLL;
use crate::tbc::SMSG_LOOT_ROLL;
use crate::tbc::SMSG_LOOT_MASTER_LIST;
use crate::tbc::SMSG_SET_FORCED_REACTIONS;
use crate::tbc::SMSG_SPELL_FAILED_OTHER;
use crate::tbc::SMSG_CHAT_PLAYER_NOT_FOUND;
use crate::tbc::MSG_TALENT_WIPE_CONFIRM_Server;
use crate::tbc::SMSG_SUMMON_REQUEST;
use crate::tbc::SMSG_MONSTER_MOVE_TRANSPORT;
use crate::tbc::SMSG_PET_BROKEN;
use crate::tbc::MSG_MOVE_FEATHER_FALL_Server;
use crate::tbc::SMSG_FEIGN_DEATH_RESISTED;
use crate::tbc::SMSG_DUEL_COUNTDOWN;
use crate::tbc::SMSG_AREA_TRIGGER_MESSAGE;
use crate::tbc::SMSG_PLAYER_SKINNED;
use crate::tbc::SMSG_DURABILITY_DAMAGE_DEATH;
use crate::tbc::SMSG_INIT_WORLD_STATES;
use crate::tbc::SMSG_UPDATE_WORLD_STATE;
use crate::tbc::SMSG_ITEM_NAME_QUERY_RESPONSE;
use crate::tbc::SMSG_PET_ACTION_FEEDBACK;
use crate::tbc::SMSG_CHAR_RENAME;
use crate::tbc::SMSG_INSTANCE_SAVE_CREATED;
use crate::tbc::SMSG_RAID_INSTANCE_INFO;
use crate::tbc::SMSG_PLAY_SOUND;
use crate::tbc::SMSG_BATTLEFIELD_STATUS;
use crate::tbc::MSG_INSPECT_HONOR_STATS_Server;
use crate::tbc::SMSG_FORCE_WALK_SPEED_CHANGE;
use crate::tbc::SMSG_FORCE_SWIM_BACK_SPEED_CHANGE;
use crate::tbc::SMSG_FORCE_TURN_RATE_CHANGE;
use crate::tbc::SMSG_AREA_SPIRIT_HEALER_TIME;
use crate::tbc::SMSG_WARDEN_DATA;
use crate::tbc::SMSG_GROUP_JOINED_BATTLEGROUND;
use crate::tbc::MSG_BATTLEGROUND_PLAYER_POSITIONS_Server;
use crate::tbc::SMSG_BINDER_CONFIRM;
use crate::tbc::SMSG_BATTLEGROUND_PLAYER_JOINED;
use crate::tbc::SMSG_BATTLEGROUND_PLAYER_LEFT;
use crate::tbc::SMSG_ADDON_INFO;
use crate::tbc::SMSG_PET_UNLEARN_CONFIRM;
use crate::tbc::SMSG_PARTY_MEMBER_STATS_FULL;
use crate::tbc::SMSG_WEATHER;
use crate::tbc::SMSG_RAID_INSTANCE_MESSAGE;
use crate::tbc::SMSG_CHAT_RESTRICTED;
use crate::tbc::SMSG_SPLINE_SET_RUN_SPEED;
use crate::tbc::SMSG_SPLINE_SET_RUN_BACK_SPEED;
use crate::tbc::SMSG_SPLINE_SET_SWIM_SPEED;
use crate::tbc::SMSG_SPLINE_SET_WALK_SPEED;
use crate::tbc::SMSG_SPLINE_SET_SWIM_BACK_SPEED;
use crate::tbc::SMSG_SPLINE_SET_TURN_RATE;
use crate::tbc::SMSG_SPLINE_MOVE_UNROOT;
use crate::tbc::SMSG_SPLINE_MOVE_FEATHER_FALL;
use crate::tbc::SMSG_SPLINE_MOVE_NORMAL_FALL;
use crate::tbc::SMSG_SPLINE_MOVE_SET_HOVER;
use crate::tbc::SMSG_SPLINE_MOVE_UNSET_HOVER;
use crate::tbc::SMSG_SPLINE_MOVE_WATER_WALK;
use crate::tbc::SMSG_SPLINE_MOVE_LAND_WALK;
use crate::tbc::SMSG_SPLINE_MOVE_START_SWIM;
use crate::tbc::SMSG_SPLINE_MOVE_STOP_SWIM;
use crate::tbc::SMSG_SPLINE_MOVE_SET_RUN_MODE;
use crate::tbc::SMSG_SPLINE_MOVE_SET_WALK_MODE;
use crate::tbc::MSG_MOVE_TIME_SKIPPED_Server;
use crate::tbc::SMSG_SPLINE_MOVE_ROOT;
use crate::tbc::SMSG_INVALIDATE_PLAYER;
use crate::tbc::SMSG_INSTANCE_RESET;
use crate::tbc::SMSG_INSTANCE_RESET_FAILED;
use crate::tbc::SMSG_UPDATE_LAST_INSTANCE;
use crate::tbc::MSG_RAID_TARGET_UPDATE_Server;
use crate::tbc::MSG_RAID_READY_CHECK_Server;
use crate::tbc::SMSG_PET_ACTION_SOUND;
use crate::tbc::SMSG_PET_DISMISS_SOUND;
use crate::tbc::SMSG_GM_TICKET_STATUS_UPDATE;
use crate::tbc::MSG_SET_DUNGEON_DIFFICULTY_Server;
use crate::tbc::SMSG_UPDATE_INSTANCE_OWNERSHIP;
use crate::tbc::SMSG_CHAT_PLAYER_AMBIGUOUS;
use crate::tbc::SMSG_SPELLINSTAKILLLOG;
use crate::tbc::SMSG_SPELL_UPDATE_CHAIN_TARGETS;
use crate::tbc::SMSG_SPELLSTEALLOG;
use crate::tbc::SMSG_DEFENSE_MESSAGE;
use crate::tbc::SMSG_INSTANCE_DIFFICULTY;
use crate::tbc::SMSG_MOTD;
use crate::tbc::SMSG_MOVE_SET_FLIGHT;
use crate::tbc::SMSG_MOVE_UNSET_FLIGHT;
use crate::tbc::SMSG_MOVE_SET_CAN_FLY;
use crate::tbc::SMSG_MOVE_UNSET_CAN_FLY;
use crate::tbc::SMSG_ARENA_TEAM_COMMAND_RESULT;
use crate::tbc::SMSG_ARENA_TEAM_QUERY_RESPONSE;
use crate::tbc::SMSG_ARENA_TEAM_ROSTER;
use crate::tbc::SMSG_ARENA_TEAM_INVITE;
use crate::tbc::SMSG_ARENA_TEAM_EVENT;
use crate::tbc::MSG_MOVE_START_ASCEND_Server;
use crate::tbc::MSG_MOVE_STOP_ASCEND_Server;
use crate::tbc::SMSG_ARENA_TEAM_STATS;
use crate::tbc::SMSG_LFG_LEADER_IS_LFM;
use crate::tbc::SMSG_LFG_UPDATE;
use crate::tbc::SMSG_LFG_UPDATE_LFM;
use crate::tbc::SMSG_LFG_UPDATE_LFG;
use crate::tbc::SMSG_LFG_UPDATE_QUEUED;
use crate::tbc::SMSG_TITLE_EARNED;
use crate::tbc::SMSG_ARENA_ERROR;
use crate::tbc::MSG_INSPECT_ARENA_TEAMS_Server;
use crate::tbc::SMSG_DEATH_RELEASE_LOC;
use crate::tbc::SMSG_FORCED_DEATH_UPDATE;
use crate::tbc::MSG_MOVE_SET_FLIGHT_SPEED_Server;
use crate::tbc::SMSG_FORCE_FLIGHT_SPEED_CHANGE;
use crate::tbc::SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE;
use crate::tbc::SMSG_SPLINE_SET_FLIGHT_SPEED;
use crate::tbc::SMSG_SPLINE_SET_FLIGHT_BACK_SPEED;
use crate::tbc::SMSG_FLIGHT_SPLINE_SYNC;
use crate::tbc::SMSG_REALM_SPLIT;
use crate::tbc::SMSG_TIME_SYNC_REQ;
use crate::tbc::SMSG_RESET_FAILED_NOTIFY;
use crate::tbc::SMSG_LFG_DISABLED;
use crate::tbc::SMSG_UPDATE_COMBO_POINTS;
use crate::tbc::SMSG_SET_EXTRA_AURA_INFO;
use crate::tbc::SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE;
use crate::tbc::SMSG_CLEAR_EXTRA_AURA_INFO;
use crate::tbc::MSG_MOVE_START_DESCEND_Server;
use crate::tbc::SMSG_DISMOUNT;
use crate::tbc::MSG_MOVE_UPDATE_CAN_FLY_Server;
use crate::tbc::MSG_RAID_READY_CHECK_CONFIRM_Server;
use crate::tbc::SMSG_GM_MESSAGECHAT;
use crate::tbc::SMSG_CLEAR_TARGET;
use crate::tbc::SMSG_CROSSED_INEBRIATION_THRESHOLD;
use crate::tbc::SMSG_KICK_REASON;
use crate::tbc::SMSG_COMPLAIN_RESULT;
use crate::tbc::SMSG_FEATURE_SYSTEM_STATUS;
use crate::tbc::SMSG_CHANNEL_MEMBER_COUNT;
use crate::tbc::SMSG_GUILD_BANK_LIST;
use crate::tbc::MSG_GUILD_BANK_LOG_QUERY_Server;
use crate::tbc::SMSG_USERLIST_ADD;
use crate::tbc::SMSG_USERLIST_REMOVE;
use crate::tbc::SMSG_USERLIST_UPDATE;
use crate::tbc::SMSG_INSPECT_TALENT;
use crate::tbc::SMSG_LOOT_LIST;
use crate::tbc::MSG_GUILD_PERMISSIONS_Server;
use crate::tbc::MSG_GUILD_BANK_MONEY_WITHDRAWN_Server;
use crate::tbc::MSG_GUILD_EVENT_LOG_QUERY_Server;
use crate::tbc::SMSG_MIRRORIMAGE_DATA;
use crate::tbc::MSG_QUERY_GUILD_BANK_TEXT_Server;
use crate::tbc::SMSG_OVERRIDE_LIGHT;
use crate::tbc::SMSG_TOTEM_CREATED;
use crate::tbc::SMSG_QUESTGIVER_STATUS_MULTIPLE;
use crate::tbc::SMSG_SET_PLAYER_DECLINED_NAMES_RESULT;
use crate::tbc::SMSG_SEND_UNLEARN_SPELLS;
use crate::tbc::SMSG_PROPOSE_LEVEL_GRANT;
use crate::tbc::SMSG_REFER_A_FRIEND_FAILURE;
use crate::tbc::SMSG_SPLINE_MOVE_SET_FLYING;
use crate::tbc::SMSG_SPLINE_MOVE_UNSET_FLYING;
