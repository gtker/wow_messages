...
// AUTOGENERATED_START
#[cfg(feature = "tbc")]
pub(crate) fn tbc_aura_read<R: std::io::Read>(mut r: R) -> Result<wow_world_base::tbc::Aura, std::io::Error> {
    // aura: u16
...
#[cfg(feature = "tbc")]
pub(crate) fn tbc_aura_write_into_vec(s: &wow_world_base::tbc::Aura, mut w: impl std::io::Write) -> Result<(), std::io::Error> {
    // aura: u16
    w.write_all(&s.aura.to_le_bytes())?;

    // unknown: u8
    w.write_all(&s.unknown.to_le_bytes())?;

    Ok(())
}

#[cfg(feature = "wrath")]
pub(crate) fn wrath_aura_read<R: std::io::Read>(mut r: R) -> Result<wow_world_base::wrath::Aura, std::io::Error> {
    // aura: u32
    let aura = crate::util::read_u32_le(&mut r)?;

    // unknown: u8
    let unknown = crate::util::read_u8_le(&mut r)?;

    Ok(wow_world_base::wrath::Aura {
        aura,
        unknown,
    })
}
...
#[cfg(feature = "wrath")]
pub(crate) fn wrath_aura_write_into_vec(s: &wow_world_base::wrath::Aura, mut w: impl std::io::Write) -> Result<(), std::io::Error> {
    // aura: u32
    w.write_all(&s.aura.to_le_bytes())?;
...
#[cfg(any(feature = "vanilla", feature = "tbc", feature = "wrath"))]
pub(crate) fn vanilla_tbc_wrath_vector4d_read<R: std::io::Read>(mut r: R) -> Result<wow_world_base::shared::vector4d_vanilla_tbc_wrath::Vector4d, std::io::Error> {
    // x: f32
    let x = crate::util::read_f32_le(&mut r)?;
    ...
    Ok(wow_world_base::shared::vector4d_vanilla_tbc_wrath::Vector4d {
        x,
        y,
        z,
        orientation,
...
#[cfg(any(feature = "vanilla", feature = "tbc", feature = "wrath"))]
pub(crate) fn vanilla_tbc_wrath_vector4d_write_into_vec(s: &wow_world_base::shared::vector4d_vanilla_tbc_wrath::Vector4d, mut w: impl std::io::Write) -> Result<(), std::io::Error> {
    // x: f32
    w.write_all(&s.x.to_le_bytes())?;
    ...
    // orientation: f32
    w.write_all(&s.orientation.to_le_bytes())?;
