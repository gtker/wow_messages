...
// AUTOGENERATED_START
#[cfg(any(feature = "vanilla", feature = "tbc", feature = "wrath"))]
pub(crate) fn vanilla_tbc_wrath_itemdamagetype_read<R: std::io::Read>(
    mut r: R,
) -> Result<
    wow_world_base::shared::item_damage_type_vanilla_tbc_wrath::ItemDamageType,
    crate::errors::ParseErrorKind,
> {
    // damage_minimum: f32
...
#[cfg(any(feature = "vanilla", feature = "tbc", feature = "wrath"))]
pub(crate) fn vanilla_tbc_wrath_itemdamagetype_write_into_vec(
    s: &wow_world_base::shared::item_damage_type_vanilla_tbc_wrath::ItemDamageType,
...
pub(crate) fn tbc_wrath_itemsocket_read<R: std::io::Read>(
    mut r: R,
) -> Result<wow_world_base::shared::item_socket_tbc_wrath::ItemSocket, std::io::Error> {
    // color: u32
    ...
    Ok(wow_world_base::shared::item_socket_tbc_wrath::ItemSocket { color, content })
}

#[cfg(any(feature = "tbc", feature = "wrath"))]
pub(crate) fn tbc_wrath_itemsocket_write_into_vec(
    s: &wow_world_base::shared::item_socket_tbc_wrath::ItemSocket,
    mut w: impl std::io::Write,
) -> Result<(), std::io::Error> {
    // color: u32
...
#[cfg(feature = "vanilla")]
pub(crate) fn vanilla_itemspells_read<R: std::io::Read>(
    mut r: R,
) -> Result<wow_world_base::vanilla::ItemSpells, crate::errors::ParseErrorKind> {
    // spell: Spell
...
#[cfg(feature = "vanilla")]
pub(crate) fn vanilla_itemspells_write_into_vec(
    s: &wow_world_base::vanilla::ItemSpells,
    mut w: impl std::io::Write,
) -> Result<(), std::io::Error> {
    // spell: Spell
...
#[cfg(any(feature = "tbc", feature = "wrath"))]
pub(crate) fn tbc_wrath_itemspells_read<R: std::io::Read>(
    mut r: R,
) -> Result<wow_world_base::shared::item_spells_tbc_wrath::ItemSpells, crate::errors::ParseErrorKind>
{
    // spell: Spell
    let spell = crate::util::read_u32_le(&mut r)?;
...
#[cfg(any(feature = "tbc", feature = "wrath"))]
pub(crate) fn tbc_wrath_itemspells_write_into_vec(
    s: &wow_world_base::shared::item_spells_tbc_wrath::ItemSpells,
    mut w: impl std::io::Write,
) -> Result<(), std::io::Error> {
    // spell: Spell
    w.write_all(&s.spell.to_le_bytes())?;
...
#[cfg(feature = "vanilla")]
pub(crate) fn vanilla_itemstat_read<R: std::io::Read>(
    mut r: R,
) -> Result<wow_world_base::vanilla::ItemStat, crate::errors::ParseErrorKind> {
    ...
    Ok(wow_world_base::vanilla::ItemStat { stat_type, value })
}

#[cfg(feature = "vanilla")]
pub(crate) fn vanilla_itemstat_write_into_vec(
    s: &wow_world_base::vanilla::ItemStat,
    mut w: impl std::io::Write,
) -> Result<(), std::io::Error> {
    // stat_type: ItemStatType
...
#[cfg(any(feature = "tbc", feature = "wrath"))]
pub(crate) fn tbc_wrath_itemstat_read<R: std::io::Read>(
    mut r: R,
) -> Result<wow_world_base::shared::item_stat_tbc_wrath::ItemStat, std::io::Error> {
    // stat_type: u32
    ...
    Ok(wow_world_base::shared::item_stat_tbc_wrath::ItemStat { stat_type, value })
}

#[cfg(any(feature = "tbc", feature = "wrath"))]
pub(crate) fn tbc_wrath_itemstat_write_into_vec(
    s: &wow_world_base::shared::item_stat_tbc_wrath::ItemStat,
    mut w: impl std::io::Write,
) -> Result<(), std::io::Error> {
    // stat_type: u32
...
#[cfg(any(feature = "vanilla", feature = "tbc", feature = "wrath"))]
pub(crate) fn vanilla_tbc_wrath_vector2d_read<R: std::io::Read>(
    mut r: R,
) -> Result<wow_world_base::shared::vector2d_vanilla_tbc_wrath::Vector2d, std::io::Error> {
    // x: f32
    ...
    Ok(wow_world_base::shared::vector2d_vanilla_tbc_wrath::Vector2d { x, y })
}

#[cfg(any(feature = "vanilla", feature = "tbc", feature = "wrath"))]
pub(crate) fn vanilla_tbc_wrath_vector2d_write_into_vec(
    s: &wow_world_base::shared::vector2d_vanilla_tbc_wrath::Vector2d,
    mut w: impl std::io::Write,
) -> Result<(), std::io::Error> {
    // x: f32
...
#[cfg(any(feature = "vanilla", feature = "tbc", feature = "wrath"))]
pub(crate) fn vanilla_tbc_wrath_vector3d_read<R: std::io::Read>(
    mut r: R,
) -> Result<wow_world_base::shared::vector3d_vanilla_tbc_wrath::Vector3d, std::io::Error> {
    // x: f32
    let x = crate::util::read_f32_le(&mut r)?;
    ...
    Ok(wow_world_base::shared::vector3d_vanilla_tbc_wrath::Vector3d { x, y, z })
}

#[cfg(any(feature = "vanilla", feature = "tbc", feature = "wrath"))]
pub(crate) fn vanilla_tbc_wrath_vector3d_write_into_vec(
    s: &wow_world_base::shared::vector3d_vanilla_tbc_wrath::Vector3d,
    mut w: impl std::io::Write,
) -> Result<(), std::io::Error> {
    // x: f32
    w.write_all(&s.x.to_le_bytes())?;
