...
impl MessageBody for CMSG_SET_WATCHED_FACTION {
    ...
    >> where
        ...
        Self: 'async_trait,
     {
        Box::pin(async move {
            // reputation_id: u32
            let reputation_id = crate::util::tokio_read_u32_le(r).await?;
    ...
    >> where
        ...
        Self: 'async_trait,
     {
        Box::pin(async move {
            // reputation_id: u32
            w.write_all(&self.reputation_id.to_le_bytes()).await?;
    ...
    >> where
        ...
        Self: 'async_trait,
     {
        Box::pin(async move {
            // reputation_id: u32
            let reputation_id = crate::util::astd_read_u32_le(r).await?;
