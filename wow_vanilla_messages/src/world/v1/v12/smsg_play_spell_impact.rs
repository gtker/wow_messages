...
impl MessageBody for SMSG_PLAY_SPELL_IMPACT {
    ...
    async fn tokio_read_body<R: AsyncReadExt + Unpin + Send>(r: &mut R, body_size: u32) -> std::result::Result<Self, Self::Error> {
        ...
        // spell_visual_kit: u32
        let spell_visual_kit = crate::util::tokio_read_u32_le(r).await?;
    ...
    async fn tokio_write_body<W: AsyncWriteExt + Unpin + Send>(&self, w: &mut W) -> std::result::Result<(), std::io::Error> {
        ...
        // spell_visual_kit: u32
        w.write_all(&self.spell_visual_kit.to_le_bytes()).await?;
    ...
    async fn astd_read_body<R: ReadExt + Unpin + Send>(r: &mut R, body_size: u32) -> std::result::Result<Self, Self::Error> {
        ...
        // spell_visual_kit: u32
        let spell_visual_kit = crate::util::astd_read_u32_le(r).await?;
