...
/// Mangos sends this to third parties that aren't having their speed changed and [`SMSG_FORCE_RUN_SPEED_CHANGE`](crate::world::version_1_12::SMSG_FORCE_RUN_SPEED_CHANGE) to the client that has their run speed changed.
///
