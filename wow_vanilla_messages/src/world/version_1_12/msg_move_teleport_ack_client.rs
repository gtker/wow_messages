...
#[derive(Copy)]
/// Response to [`MSG_MOVE_TELEPORT_ACK_Server`](crate::world::version_1_12::MSG_MOVE_TELEPORT_ACK_Server), at which point [`MSG_MOVE_TELEPORT_ACK_Server`](crate::world::version_1_12::MSG_MOVE_TELEPORT_ACK_Server) should be sent to observing players.
///
