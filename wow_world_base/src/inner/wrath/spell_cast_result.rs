/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/common.wowm:610`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/common.wowm#L610):
/// ```text
...
impl SpellCastResult {
    ...
    pub const fn variants() -> [Self; 188] {
        [
            Self::Success,
...
impl std::fmt::Display for SpellCastResult {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            Self::Success => "Success",
            Self::AffectingCombat => "AffectingCombat",
            Self::AlreadyAtFullHealth => "AlreadyAtFullHealth",
            Self::AlreadyAtFullMana => "AlreadyAtFullMana",
            Self::AlreadyAtFullPower => "AlreadyAtFullPower",
            Self::AlreadyBeingTamed => "AlreadyBeingTamed",
            Self::AlreadyHaveCharm => "AlreadyHaveCharm",
            Self::AlreadyHaveSummon => "AlreadyHaveSummon",
            Self::AlreadyOpen => "AlreadyOpen",
            Self::AuraBounced => "AuraBounced",
            Self::AutotrackInterrupted => "AutotrackInterrupted",
            Self::BadImplicitTargets => "BadImplicitTargets",
            Self::BadTargets => "BadTargets",
            Self::CantBeCharmed => "CantBeCharmed",
            Self::CantBeDisenchanted => "CantBeDisenchanted",
            Self::CantBeDisenchantedSkill => "CantBeDisenchantedSkill",
            Self::CantBeMilled => "CantBeMilled",
            Self::CantBeProspected => "CantBeProspected",
            Self::CantCastOnTapped => "CantCastOnTapped",
            Self::CantDuelWhileInvisible => "CantDuelWhileInvisible",
            Self::CantDuelWhileStealthed => "CantDuelWhileStealthed",
            Self::CantStealth => "CantStealth",
            Self::CasterAurastate => "CasterAurastate",
            Self::CasterDead => "CasterDead",
            Self::Charmed => "Charmed",
            Self::ChestInUse => "ChestInUse",
            Self::Confused => "Confused",
            Self::DontReport => "DontReport",
            Self::EquippedItem => "EquippedItem",
            Self::EquippedItemClass => "EquippedItemClass",
            Self::EquippedItemClassMainhand => "EquippedItemClassMainhand",
            Self::EquippedItemClassOffhand => "EquippedItemClassOffhand",
            Self::ErrorX => "ErrorX",
            Self::Fizzle => "Fizzle",
            Self::Fleeing => "Fleeing",
            Self::FoodLowlevel => "FoodLowlevel",
            Self::Highlevel => "Highlevel",
            Self::HungerSatiated => "HungerSatiated",
            Self::Immune => "Immune",
            Self::IncorrectArea => "IncorrectArea",
            Self::Interrupted => "Interrupted",
            Self::InterruptedCombat => "InterruptedCombat",
            Self::ItemAlreadyEnchanted => "ItemAlreadyEnchanted",
            Self::ItemGone => "ItemGone",
            Self::ItemNotFound => "ItemNotFound",
            Self::ItemNotReady => "ItemNotReady",
            Self::LevelRequirement => "LevelRequirement",
            Self::LineOfSight => "LineOfSight",
            Self::Lowlevel => "Lowlevel",
            Self::LowCastlevel => "LowCastlevel",
            Self::MainhandEmpty => "MainhandEmpty",
            Self::Moving => "Moving",
            Self::NeedAmmo => "NeedAmmo",
            Self::NeedAmmoPouch => "NeedAmmoPouch",
            Self::NeedExoticAmmo => "NeedExoticAmmo",
            Self::NeedMoreItems => "NeedMoreItems",
            Self::Nopath => "Nopath",
            Self::NotBehind => "NotBehind",
            Self::NotFishable => "NotFishable",
            Self::NotFlying => "NotFlying",
            Self::NotHere => "NotHere",
            Self::NotInfront => "NotInfront",
            Self::NotInControl => "NotInControl",
            Self::NotKnown => "NotKnown",
            Self::NotMounted => "NotMounted",
            Self::NotOnTaxi => "NotOnTaxi",
            Self::NotOnTransport => "NotOnTransport",
            Self::NotReady => "NotReady",
            Self::NotShapeshift => "NotShapeshift",
            Self::NotStanding => "NotStanding",
            Self::NotTradeable => "NotTradeable",
            Self::NotTrading => "NotTrading",
            Self::NotUnsheathed => "NotUnsheathed",
            Self::NotWhileGhost => "NotWhileGhost",
            Self::NotWhileLooting => "NotWhileLooting",
            Self::NoAmmo => "NoAmmo",
            Self::NoChargesRemain => "NoChargesRemain",
            Self::NoChampion => "NoChampion",
            Self::NoComboPoints => "NoComboPoints",
            Self::NoDueling => "NoDueling",
            Self::NoEndurance => "NoEndurance",
            Self::NoFish => "NoFish",
            Self::NoItemsWhileShapeshifted => "NoItemsWhileShapeshifted",
            Self::NoMountsAllowed => "NoMountsAllowed",
            Self::NoPet => "NoPet",
            Self::NoPower => "NoPower",
            Self::NothingToDispel => "NothingToDispel",
            Self::NothingToSteal => "NothingToSteal",
            Self::OnlyAbovewater => "OnlyAbovewater",
            Self::OnlyDaytime => "OnlyDaytime",
            Self::OnlyIndoors => "OnlyIndoors",
            Self::OnlyMounted => "OnlyMounted",
            Self::OnlyNighttime => "OnlyNighttime",
            Self::OnlyOutdoors => "OnlyOutdoors",
            Self::OnlyShapeshift => "OnlyShapeshift",
            Self::OnlyStealthed => "OnlyStealthed",
            Self::OnlyUnderwater => "OnlyUnderwater",
            Self::OutOfRange => "OutOfRange",
            Self::Pacified => "Pacified",
            Self::Possessed => "Possessed",
            Self::Reagents => "Reagents",
            Self::RequiresArea => "RequiresArea",
            Self::RequiresSpellFocus => "RequiresSpellFocus",
            Self::Rooted => "Rooted",
            Self::Silenced => "Silenced",
            Self::SpellInProgress => "SpellInProgress",
            Self::SpellLearned => "SpellLearned",
            Self::SpellUnavailable => "SpellUnavailable",
            Self::Stunned => "Stunned",
            Self::TargetsDead => "TargetsDead",
            Self::TargetAffectingCombat => "TargetAffectingCombat",
            Self::TargetAurastate => "TargetAurastate",
            Self::TargetDueling => "TargetDueling",
            Self::TargetEnemy => "TargetEnemy",
            Self::TargetEnraged => "TargetEnraged",
            Self::TargetFriendly => "TargetFriendly",
            Self::TargetInCombat => "TargetInCombat",
            Self::TargetIsPlayer => "TargetIsPlayer",
            Self::TargetIsPlayerControlled => "TargetIsPlayerControlled",
            Self::TargetNotDead => "TargetNotDead",
            Self::TargetNotInParty => "TargetNotInParty",
            Self::TargetNotLooted => "TargetNotLooted",
            Self::TargetNotPlayer => "TargetNotPlayer",
            Self::TargetNoPockets => "TargetNoPockets",
            Self::TargetNoWeapons => "TargetNoWeapons",
            Self::TargetNoRangedWeapons => "TargetNoRangedWeapons",
            Self::TargetUnskinnable => "TargetUnskinnable",
            Self::ThirstSatiated => "ThirstSatiated",
            Self::TooClose => "TooClose",
            Self::TooManyOfItem => "TooManyOfItem",
            Self::TotemCategory => "TotemCategory",
            Self::Totems => "Totems",
            Self::TryAgain => "TryAgain",
            Self::UnitNotBehind => "UnitNotBehind",
            Self::UnitNotInfront => "UnitNotInfront",
            Self::WrongPetFood => "WrongPetFood",
            Self::NotWhileFatigued => "NotWhileFatigued",
            Self::TargetNotInInstance => "TargetNotInInstance",
            Self::NotWhileTrading => "NotWhileTrading",
            Self::TargetNotInRaid => "TargetNotInRaid",
            Self::TargetFreeforall => "TargetFreeforall",
            Self::NoEdibleCorpses => "NoEdibleCorpses",
            Self::OnlyBattlegrounds => "OnlyBattlegrounds",
            Self::TargetNotGhost => "TargetNotGhost",
            Self::TransformUnusable => "TransformUnusable",
            Self::WrongWeather => "WrongWeather",
            Self::DamageImmune => "DamageImmune",
            Self::PreventedByMechanic => "PreventedByMechanic",
            Self::PlayTime => "PlayTime",
            Self::Reputation => "Reputation",
            Self::MinSkill => "MinSkill",
            Self::NotInArena => "NotInArena",
            Self::NotOnShapeshift => "NotOnShapeshift",
            Self::NotOnStealthed => "NotOnStealthed",
            Self::NotOnDamageImmune => "NotOnDamageImmune",
            Self::NotOnMounted => "NotOnMounted",
            Self::TooShallow => "TooShallow",
            Self::TargetNotInSanctuary => "TargetNotInSanctuary",
            Self::TargetIsTrivial => "TargetIsTrivial",
            Self::BmOrInvisgod => "BmOrInvisgod",
            Self::ExpertRidingRequirement => "ExpertRidingRequirement",
            Self::ArtisanRidingRequirement => "ArtisanRidingRequirement",
            Self::NotIdle => "NotIdle",
            Self::NotInactive => "NotInactive",
            Self::PartialPlaytime => "PartialPlaytime",
            Self::NoPlaytime => "NoPlaytime",
            Self::NotInBattleground => "NotInBattleground",
            Self::NotInRaidInstance => "NotInRaidInstance",
            Self::OnlyInArena => "OnlyInArena",
            Self::TargetLockedToRaidInstance => "TargetLockedToRaidInstance",
            Self::OnUseEnchant => "OnUseEnchant",
            Self::NotOnGround => "NotOnGround",
            Self::CustomError => "CustomError",
            Self::CantDoThatRightNow => "CantDoThatRightNow",
            Self::TooManySockets => "TooManySockets",
            Self::InvalidGlyph => "InvalidGlyph",
            Self::UniqueGlyph => "UniqueGlyph",
            Self::GlyphSocketLocked => "GlyphSocketLocked",
            Self::NoValidTargets => "NoValidTargets",
            Self::ItemAtMaxCharges => "ItemAtMaxCharges",
            Self::NotInBarbershop => "NotInBarbershop",
            Self::FishingTooLow => "FishingTooLow",
            Self::ItemEnchantTradeWindow => "ItemEnchantTradeWindow",
            Self::SummonPending => "SummonPending",
            Self::MaxSockets => "MaxSockets",
            Self::PetCanRename => "PetCanRename",
            Self::TargetCannotBeResurrected => "TargetCannotBeResurrected",
            Self::Unknown => "Unknown",
        })
    }
}
