/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/enums/skill.wowm:273`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/enums/skill.wowm#L273):
/// ```text
/// enum Skill : u16 {
///     NONE = 0;
///     FROST = 6;
...
impl Skill {
    ...
    pub const fn variants() -> [Self; 151] {
        [
            Self::None,
            Self::Frost,
            Self::Fire,
            ...
            Self::Mounts,
            Self::Companions,
            Self::PetExoticChimaera,
            Self::PetExoticDevilsaur,
            Self::PetGhoul,
            Self::PetExoticSilithid,
            Self::PetExoticWorm,
            Self::PetWasp,
            Self::PetExoticRhino,
            Self::PetExoticCoreHound,
            Self::PetExoticSpiritBeast,
        ]
    }
...
impl Skill {
    pub const fn as_test_case_value(&self) -> &'static str {
        match self {
            ...
            Self::PetBirdOfPrey => "PET_BIRD_OF_PREY",
            ...
            Self::RacialBloodelf => "RACIAL_BLOODELF",
            Self::PetEventRc => "PET_EVENT_RC",
            Self::LanguageDraenei => "LANGUAGE_DRAENEI",
            Self::RacialDraenei => "RACIAL_DRAENEI",
            Self::PetFelguard => "PET_FELGUARD",
            Self::Riding => "RIDING",
            Self::PetDragonhawk => "PET_DRAGONHAWK",
            Self::PetNetherRay => "PET_NETHER_RAY",
            Self::PetSporebat => "PET_SPOREBAT",
            Self::PetWarpStalker => "PET_WARP_STALKER",
            Self::PetRavager => "PET_RAVAGER",
            Self::PetSerpent => "PET_SERPENT",
            Self::Internal => "INTERNAL",
            Self::DkBlood => "DK_BLOOD",
            Self::DkFrost => "DK_FROST",
            Self::DkUnholy => "DK_UNHOLY",
            Self::Inscription => "INSCRIPTION",
            Self::PetMoth => "PET_MOTH",
            Self::Runeforging => "RUNEFORGING",
            Self::Mounts => "MOUNTS",
            Self::Companions => "COMPANIONS",
            Self::PetExoticChimaera => "PET_EXOTIC_CHIMAERA",
            Self::PetExoticDevilsaur => "PET_EXOTIC_DEVILSAUR",
            Self::PetGhoul => "PET_GHOUL",
            Self::PetExoticSilithid => "PET_EXOTIC_SILITHID",
            Self::PetExoticWorm => "PET_EXOTIC_WORM",
            Self::PetWasp => "PET_WASP",
            Self::PetExoticRhino => "PET_EXOTIC_RHINO",
            Self::PetExoticCoreHound => "PET_EXOTIC_CORE_HOUND",
            Self::PetExoticSpiritBeast => "PET_EXOTIC_SPIRIT_BEAST",
        }
    }
...
impl std::fmt::Display for Skill {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::Survival => "Survival",
            Self::Maces => "Maces",
            Self::TwoHandedSwords => "TwoHandedSwords",
            Self::Holy => "Holy",
            Self::Shadow => "Shadow",
            Self::Defense => "Defense",
            Self::LanguageCommon => "LanguageCommon",
            Self::RacialDwarven => "RacialDwarven",
            Self::LanguageOrcish => "LanguageOrcish",
            Self::LanguageDwarven => "LanguageDwarven",
            Self::LanguageDarnassian => "LanguageDarnassian",
            Self::LanguageTaurahe => "LanguageTaurahe",
            Self::DualWield => "DualWield",
            Self::RacialTauren => "RacialTauren",
            Self::OrcRacial => "OrcRacial",
            Self::RacialNightElf => "RacialNightElf",
            Self::FirstAid => "FirstAid",
            Self::FeralCombat => "FeralCombat",
            Self::Staves => "Staves",
            Self::LanguageThalassian => "LanguageThalassian",
            Self::LanguageDraconic => "LanguageDraconic",
            Self::LanguageDemonTongue => "LanguageDemonTongue",
            Self::LanguageTitan => "LanguageTitan",
            Self::LanguageOldTongue => "LanguageOldTongue",
            Self::Survival2 => "Survival2",
            Self::RidingHorse => "RidingHorse",
            Self::RidingWolf => "RidingWolf",
            Self::RidingTiger => "RidingTiger",
            Self::RidingRam => "RidingRam",
            Self::Swimming => "Swimming",
            Self::TwoHandedMaces => "TwoHandedMaces",
            Self::Unarmed => "Unarmed",
            Self::Marksmanship => "Marksmanship",
            Self::Blacksmithing => "Blacksmithing",
            Self::Leatherworking => "Leatherworking",
            Self::Alchemy => "Alchemy",
            Self::TwoHandedAxes => "TwoHandedAxes",
            Self::Daggers => "Daggers",
            Self::Thrown => "Thrown",
            Self::Herbalism => "Herbalism",
            Self::GenericDnd => "GenericDnd",
            Self::Retribution => "Retribution",
            Self::Cooking => "Cooking",
            Self::Mining => "Mining",
            Self::PetImp => "PetImp",
            Self::PetFelhunter => "PetFelhunter",
            Self::Tailoring => "Tailoring",
            Self::Engineering => "Engineering",
            Self::PetSpider => "PetSpider",
            Self::PetVoidwalker => "PetVoidwalker",
            Self::PetSuccubus => "PetSuccubus",
            Self::PetInfernal => "PetInfernal",
            Self::PetDoomguard => "PetDoomguard",
            Self::PetWolf => "PetWolf",
            Self::PetCat => "PetCat",
            Self::PetBear => "PetBear",
            Self::PetBoar => "PetBoar",
            Self::PetCrocilisk => "PetCrocilisk",
            Self::PetCarrionBird => "PetCarrionBird",
            Self::PetCrab => "PetCrab",
            Self::PetGorilla => "PetGorilla",
            Self::PetRaptor => "PetRaptor",
            Self::PetTallstrider => "PetTallstrider",
            Self::RacialUnded => "RacialUnded",
            Self::Crossbows => "Crossbows",
            Self::Wands => "Wands",
            Self::Polearms => "Polearms",
            Self::PetScorpid => "PetScorpid",
            Self::Arcane => "Arcane",
            Self::PetTurtle => "PetTurtle",
            Self::Assassination => "Assassination",
            Self::Fury => "Fury",
            Self::Protection => "Protection",
            Self::Protection2 => "Protection2",
            Self::PetTalents => "PetTalents",
            Self::PlateMail => "PlateMail",
            Self::LanguageGnomish => "LanguageGnomish",
            Self::LanguageTroll => "LanguageTroll",
            Self::Enchanting => "Enchanting",
            Self::Demonology => "Demonology",
            Self::Affliction => "Affliction",
            Self::Fishing => "Fishing",
            Self::Enhancement => "Enhancement",
            Self::Restoration => "Restoration",
            Self::ElementalCombat => "ElementalCombat",
            Self::Skinning => "Skinning",
            Self::Mail => "Mail",
            Self::Leather => "Leather",
            Self::Cloth => "Cloth",
            Self::Shield => "Shield",
            Self::FistWeapons => "FistWeapons",
            Self::RidingRaptor => "RidingRaptor",
            Self::RidingMechanostrider => "RidingMechanostrider",
            Self::RidingUndeadHorse => "RidingUndeadHorse",
            Self::Restoration2 => "Restoration2",
            Self::Balance => "Balance",
            Self::Destruction => "Destruction",
            Self::Holy2 => "Holy2",
            ...
            Self::Lockpicking => "Lockpicking",
            Self::PetBat => "PetBat",
            Self::PetHyena => "PetHyena",
            Self::PetBirdOfPrey => "PetBirdOfPrey",
            Self::PetWindSerpent => "PetWindSerpent",
            Self::LanguageGutterspeak => "LanguageGutterspeak",
            Self::RidingKodo => "RidingKodo",
            Self::RacialTroll => "RacialTroll",
            Self::RacialGnome => "RacialGnome",
            Self::RacialHuman => "RacialHuman",
            Self::Jewelcrafting => "Jewelcrafting",
            Self::RacialBloodelf => "RacialBloodelf",
            Self::PetEventRc => "PetEventRc",
            Self::LanguageDraenei => "LanguageDraenei",
            Self::RacialDraenei => "RacialDraenei",
            Self::PetFelguard => "PetFelguard",
            Self::Riding => "Riding",
            Self::PetDragonhawk => "PetDragonhawk",
            Self::PetNetherRay => "PetNetherRay",
            Self::PetSporebat => "PetSporebat",
            Self::PetWarpStalker => "PetWarpStalker",
            Self::PetRavager => "PetRavager",
            Self::PetSerpent => "PetSerpent",
            Self::Internal => "Internal",
            Self::DkBlood => "DkBlood",
            Self::DkFrost => "DkFrost",
            Self::DkUnholy => "DkUnholy",
            Self::Inscription => "Inscription",
            Self::PetMoth => "PetMoth",
            Self::Runeforging => "Runeforging",
            Self::Mounts => "Mounts",
            Self::Companions => "Companions",
            Self::PetExoticChimaera => "PetExoticChimaera",
            Self::PetExoticDevilsaur => "PetExoticDevilsaur",
            Self::PetGhoul => "PetGhoul",
            Self::PetExoticSilithid => "PetExoticSilithid",
            Self::PetExoticWorm => "PetExoticWorm",
            Self::PetWasp => "PetWasp",
            Self::PetExoticRhino => "PetExoticRhino",
            Self::PetExoticCoreHound => "PetExoticCoreHound",
            Self::PetExoticSpiritBeast => "PetExoticSpiritBeast",
        })
    }
}
