/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/queries/smsg_item_query_single_response.wowm:797`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/queries/smsg_item_query_single_response.wowm#L797):
/// ```text
/// flag ItemFlag2 : u32 {
...
impl From<u32> for ItemFlag2 {
    fn from(value: u32) -> Self {
        Self::new(value)
    }
}

impl From<u8> for ItemFlag2 {
    fn from(value: u8) -> Self {
        Self::new(value.into())
    }
}

impl From<u16> for ItemFlag2 {
    fn from(value: u16) -> Self {
        Self::new(value.into())
    }
}

impl TryFrom<u64> for ItemFlag2 {
    type Error = u64;
...
impl TryFrom<i16> for ItemFlag2 {
    type Error = i16;
...
impl From<i32> for ItemFlag2 {
    fn from(value: i32) -> Self {
        Self::new(u32::from_le_bytes(value.to_le_bytes()))
    }
}

impl TryFrom<i64> for ItemFlag2 {
    type Error = i64;
...
impl TryFrom<usize> for ItemFlag2 {
    type Error = usize;
