...
impl std::fmt::Display for CreatureFamily {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::Bat => "Bat",
            Self::Hyena => "Hyena",
            Self::BirdOfPrey => "BirdOfPrey",
            Self::WindSerpent => "WindSerpent",
            Self::RemoteControl => "RemoteControl",
            Self::Felguard => "Felguard",
            Self::Dragonhawk => "Dragonhawk",
            Self::Ravager => "Ravager",
            Self::WarpStalker => "WarpStalker",
            Self::Sporebat => "Sporebat",
            Self::NetherRay => "NetherRay",
            Self::Serpent => "Serpent",
            Self::Moth => "Moth",
            Self::Chimaera => "Chimaera",
            Self::Devilsaur => "Devilsaur",
            ...
            Self::Rhino => "Rhino",
            Self::Wasp => "Wasp",
            Self::CoreHound => "CoreHound",
            Self::SpiritBeast => "SpiritBeast",
        })
    }
}
