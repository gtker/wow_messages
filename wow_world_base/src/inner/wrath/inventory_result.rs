...
impl InventoryResult {
    pub const fn as_test_case_value(&self) -> &'static str {
        match self {
            ...
            Self::ItemUniqueEquipable => "ITEM_UNIQUE_EQUIPABLE",
            Self::VendorMissingTurnins => "VENDOR_MISSING_TURNINS",
            Self::NotEnoughHonorPoints => "NOT_ENOUGH_HONOR_POINTS",
            Self::NotEnoughArenaPoints => "NOT_ENOUGH_ARENA_POINTS",
            Self::ItemMaxCountSocketed => "ITEM_MAX_COUNT_SOCKETED",
            Self::MailBoundItem => "MAIL_BOUND_ITEM",
            Self::NoSplitWhileProspecting => "NO_SPLIT_WHILE_PROSPECTING",
            Self::ItemMaxCountEquippedSocketed => "ITEM_MAX_COUNT_EQUIPPED_SOCKETED",
            Self::ItemUniqueEquippableSocketed => "ITEM_UNIQUE_EQUIPPABLE_SOCKETED",
            Self::TooMuchGold => "TOO_MUCH_GOLD",
            Self::NotDuringArenaMatch => "NOT_DURING_ARENA_MATCH",
            Self::CannotTradeThat => "CANNOT_TRADE_THAT",
            Self::PersonalArenaRatingTooLow => "PERSONAL_ARENA_RATING_TOO_LOW",
            Self::EventAutoequipBindConfirm => "EVENT_AUTOEQUIP_BIND_CONFIRM",
            Self::ArtefactsOnlyForOwnCharacters => "ARTEFACTS_ONLY_FOR_OWN_CHARACTERS",
            Self::ItemMaxLimitCategoryCountExceeded => "ITEM_MAX_LIMIT_CATEGORY_COUNT_EXCEEDED",
            Self::ItemMaxLimitCategorySocketedExceeded => "ITEM_MAX_LIMIT_CATEGORY_SOCKETED_EXCEEDED",
            Self::ScalingStatItemLevelExceeded => "SCALING_STAT_ITEM_LEVEL_EXCEEDED",
            Self::PurchaseLevelTooLow => "PURCHASE_LEVEL_TOO_LOW",
            Self::CantEquipNeedTalent => "CANT_EQUIP_NEED_TALENT",
            Self::ItemMaxLimitCategoryEquippedExceeded => "ITEM_MAX_LIMIT_CATEGORY_EQUIPPED_EXCEEDED",
        }
    }
...
impl std::fmt::Display for InventoryResult {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            Self::Ok => "Ok",
            Self::CantEquipLevelI => "CantEquipLevelI",
            Self::CantEquipSkill => "CantEquipSkill",
            Self::ItemDoesntGoToSlot => "ItemDoesntGoToSlot",
            Self::BagFull => "BagFull",
            Self::NonemptyBagOverOtherBag => "NonemptyBagOverOtherBag",
            Self::CantTradeEquipBags => "CantTradeEquipBags",
            Self::OnlyAmmoCanGoHere => "OnlyAmmoCanGoHere",
            Self::NoRequiredProficiency => "NoRequiredProficiency",
            Self::NoEquipmentSlotAvailable => "NoEquipmentSlotAvailable",
            Self::YouCanNeverUseThatItem => "YouCanNeverUseThatItem",
            Self::YouCanNeverUseThatItem2 => "YouCanNeverUseThatItem2",
            Self::NoEquipmentSlotAvailable2 => "NoEquipmentSlotAvailable2",
            Self::CantEquipWithTwohanded => "CantEquipWithTwohanded",
            Self::CantDualWield => "CantDualWield",
            Self::ItemDoesntGoIntoBag => "ItemDoesntGoIntoBag",
            Self::ItemDoesntGoIntoBag2 => "ItemDoesntGoIntoBag2",
            Self::CantCarryMoreOfThis => "CantCarryMoreOfThis",
            Self::NoEquipmentSlotAvailable3 => "NoEquipmentSlotAvailable3",
            Self::ItemCantStack => "ItemCantStack",
            Self::ItemCantBeEquipped => "ItemCantBeEquipped",
            Self::ItemsCantBeSwapped => "ItemsCantBeSwapped",
            Self::SlotIsEmpty => "SlotIsEmpty",
            Self::ItemNotFound => "ItemNotFound",
            Self::CantDropSoulbound => "CantDropSoulbound",
            Self::OutOfRange => "OutOfRange",
            Self::TriedToSplitMoreThanCount => "TriedToSplitMoreThanCount",
            Self::CouldntSplitItems => "CouldntSplitItems",
            Self::MissingReagent => "MissingReagent",
            Self::NotEnoughMoney => "NotEnoughMoney",
            Self::NotABag => "NotABag",
            Self::CanOnlyDoWithEmptyBags => "CanOnlyDoWithEmptyBags",
            Self::DontOwnThatItem => "DontOwnThatItem",
            Self::CanEquipOnly1Quiver => "CanEquipOnly1Quiver",
            Self::MustPurchaseThatBagSlot => "MustPurchaseThatBagSlot",
            Self::TooFarAwayFromBank => "TooFarAwayFromBank",
            Self::ItemLocked => "ItemLocked",
            Self::YouAreStunned => "YouAreStunned",
            Self::YouAreDead => "YouAreDead",
            Self::CantDoRightNow => "CantDoRightNow",
            Self::IntBagError => "IntBagError",
            Self::CanEquipOnly1Bolt => "CanEquipOnly1Bolt",
            Self::CanEquipOnly1Ammopouch => "CanEquipOnly1Ammopouch",
            Self::StackableCantBeWrapped => "StackableCantBeWrapped",
            Self::EquippedCantBeWrapped => "EquippedCantBeWrapped",
            Self::WrappedCantBeWrapped => "WrappedCantBeWrapped",
            Self::BoundCantBeWrapped => "BoundCantBeWrapped",
            Self::UniqueCantBeWrapped => "UniqueCantBeWrapped",
            Self::BagsCantBeWrapped => "BagsCantBeWrapped",
            Self::AlreadyLooted => "AlreadyLooted",
            Self::InventoryFull => "InventoryFull",
            Self::BankFull => "BankFull",
            Self::ItemIsCurrentlySoldOut => "ItemIsCurrentlySoldOut",
            Self::BagFull3 => "BagFull3",
            Self::ItemNotFound2 => "ItemNotFound2",
            Self::ItemCantStack2 => "ItemCantStack2",
            Self::BagFull4 => "BagFull4",
            Self::ItemSoldOut => "ItemSoldOut",
            Self::ObjectIsBusy => "ObjectIsBusy",
            Self::None => "None",
            Self::NotInCombat => "NotInCombat",
            Self::NotWhileDisarmed => "NotWhileDisarmed",
            Self::BagFull6 => "BagFull6",
            Self::CantEquipRank => "CantEquipRank",
            Self::CantEquipReputation => "CantEquipReputation",
            Self::TooManySpecialBags => "TooManySpecialBags",
            Self::LootCantLootThatNow => "LootCantLootThatNow",
            Self::ItemUniqueEquipable => "ItemUniqueEquipable",
            Self::VendorMissingTurnins => "VendorMissingTurnins",
            Self::NotEnoughHonorPoints => "NotEnoughHonorPoints",
            Self::NotEnoughArenaPoints => "NotEnoughArenaPoints",
            Self::ItemMaxCountSocketed => "ItemMaxCountSocketed",
            Self::MailBoundItem => "MailBoundItem",
            Self::NoSplitWhileProspecting => "NoSplitWhileProspecting",
            Self::ItemMaxCountEquippedSocketed => "ItemMaxCountEquippedSocketed",
            Self::ItemUniqueEquippableSocketed => "ItemUniqueEquippableSocketed",
            Self::TooMuchGold => "TooMuchGold",
            Self::NotDuringArenaMatch => "NotDuringArenaMatch",
            Self::CannotTradeThat => "CannotTradeThat",
            Self::PersonalArenaRatingTooLow => "PersonalArenaRatingTooLow",
            Self::EventAutoequipBindConfirm => "EventAutoequipBindConfirm",
            Self::ArtefactsOnlyForOwnCharacters => "ArtefactsOnlyForOwnCharacters",
            Self::ItemMaxLimitCategoryCountExceeded => "ItemMaxLimitCategoryCountExceeded",
            Self::ItemMaxLimitCategorySocketedExceeded => "ItemMaxLimitCategorySocketedExceeded",
            Self::ScalingStatItemLevelExceeded => "ScalingStatItemLevelExceeded",
            Self::PurchaseLevelTooLow => "PurchaseLevelTooLow",
            Self::CantEquipNeedTalent => "CantEquipNeedTalent",
            Self::ItemMaxLimitCategoryEquippedExceeded => "ItemMaxLimitCategoryEquippedExceeded",
        })
    }
}
