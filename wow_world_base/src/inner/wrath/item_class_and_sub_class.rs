...
impl std::fmt::Display for ItemClassAndSubClass {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::Flask => "Flask",
            Self::Bandage => "Bandage",
            Self::ItemEnhancement => "ItemEnhancement",
            Self::Scroll => "Scroll",
            Self::OtherConsumable => "OtherConsumable",
            Self::Bag => "Bag",
            Self::SoulBag => "SoulBag",
            Self::HerbBag => "HerbBag",
            Self::EnchantingBag => "EnchantingBag",
            Self::EngineeringBag => "EngineeringBag",
            Self::GemBag => "GemBag",
            Self::MiningBag => "MiningBag",
            Self::LeatherworkingBag => "LeatherworkingBag",
            Self::InscriptionBag => "InscriptionBag",
            Self::OneHandedAxe => "OneHandedAxe",
            Self::TwoHandedAxe => "TwoHandedAxe",
            Self::Bow => "Bow",
            Self::Gun => "Gun",
            Self::OneHandedMace => "OneHandedMace",
            Self::TwoHandedMace => "TwoHandedMace",
            Self::Polearm => "Polearm",
            Self::OneHandedSword => "OneHandedSword",
            Self::TwoHandedSword => "TwoHandedSword",
            Self::ObsoleteWeapon => "ObsoleteWeapon",
            Self::Staff => "Staff",
            Self::OneHandedExotic => "OneHandedExotic",
            Self::TwoHandedExotic => "TwoHandedExotic",
            Self::FistWeapon => "FistWeapon",
            Self::MiscellaneousWeapon => "MiscellaneousWeapon",
            Self::Dagger => "Dagger",
            Self::Thrown => "Thrown",
            Self::Spear => "Spear",
            Self::Crossbow => "Crossbow",
            ...
            Self::GemRed => "GemRed",
            Self::GemBlue => "GemBlue",
            Self::GemYellow => "GemYellow",
            Self::GemPurple => "GemPurple",
            Self::GemGreen => "GemGreen",
            Self::GemOrange => "GemOrange",
            Self::GemMeta => "GemMeta",
            Self::GemSimple => "GemSimple",
            Self::GemPrismatic => "GemPrismatic",
            Self::MiscellaneousArmor => "MiscellaneousArmor",
            Self::ClothArmor => "ClothArmor",
            Self::LeatherArmor => "LeatherArmor",
            Self::MailArmor => "MailArmor",
            Self::PlateArmor => "PlateArmor",
            Self::BucklerObsolete => "BucklerObsolete",
            Self::Shield => "Shield",
            Self::Libram => "Libram",
            Self::Idol => "Idol",
            Self::Totem => "Totem",
            Self::Sigil => "Sigil",
            Self::Reagent => "Reagent",
            Self::WandObsolete => "WandObsolete",
            Self::BoltObsolete => "BoltObsolete",
            Self::Arrow => "Arrow",
            Self::Bullet => "Bullet",
            Self::ThrownObsolete => "ThrownObsolete",
            Self::TradeGood => "TradeGood",
            Self::ElementalTradeGood => "ElementalTradeGood",
            Self::ClothTradeGood => "ClothTradeGood",
            Self::LeatherTradeGood => "LeatherTradeGood",
            Self::MetalAndStoneTradeGood => "MetalAndStoneTradeGood",
            Self::MeatTradeGood => "MeatTradeGood",
            Self::HerbTradeGood => "HerbTradeGood",
            Self::EnchantingTradeGood => "EnchantingTradeGood",
            Self::JewelcraftingTradeGood => "JewelcraftingTradeGood",
            Self::PartTradeGood => "PartTradeGood",
            Self::DeviceTradeGood => "DeviceTradeGood",
            Self::ExplosiveTradeGood => "ExplosiveTradeGood",
            Self::MaterialTradeGood => "MaterialTradeGood",
            Self::OtherTradeGood => "OtherTradeGood",
            Self::ArmorEnchantmentTradeGood => "ArmorEnchantmentTradeGood",
            Self::WeaponEnchantmentTradeGood => "WeaponEnchantmentTradeGood",
            Self::GenericObsolete => "GenericObsolete",
            Self::Book => "Book",
            Self::LeatherworkingRecipe => "LeatherworkingRecipe",
            Self::TailoringRecipe => "TailoringRecipe",
            Self::EngineeringRecipe => "EngineeringRecipe",
            Self::BlacksmithingRecipe => "BlacksmithingRecipe",
            Self::CookingRecipe => "CookingRecipe",
            Self::AlchemyRecipe => "AlchemyRecipe",
            Self::FirstAidRecipe => "FirstAidRecipe",
            Self::EnchantingRecipe => "EnchantingRecipe",
            Self::FishingRecipe => "FishingRecipe",
            Self::JewelcraftingRecipe => "JewelcraftingRecipe",
            Self::InscriptionRecipe => "InscriptionRecipe",
            Self::MoneyObsolete => "MoneyObsolete",
            Self::QuiverObsolete => "QuiverObsolete",
            Self::QuiverObsolete1 => "QuiverObsolete1",
            Self::Quiver => "Quiver",
            Self::AmmoPouch => "AmmoPouch",
            Self::Quest => "Quest",
            Self::Key => "Key",
            Self::Lockpick => "Lockpick",
            Self::PermanentObsolete => "PermanentObsolete",
            Self::MiscellaneousJunk => "MiscellaneousJunk",
            Self::MiscellaneousReagent => "MiscellaneousReagent",
            Self::MiscellaneousPet => "MiscellaneousPet",
            Self::MiscellaneousHoliday => "MiscellaneousHoliday",
            Self::MiscellaneousOther => "MiscellaneousOther",
            Self::MiscellaneousMount => "MiscellaneousMount",
            Self::WarriorGlyph => "WarriorGlyph",
            Self::PaladinGlyph => "PaladinGlyph",
            Self::HunterGlyph => "HunterGlyph",
            Self::RogueGlyph => "RogueGlyph",
            Self::PriestGlyph => "PriestGlyph",
            Self::DeathKnightGlyph => "DeathKnightGlyph",
            Self::ShamanGlyph => "ShamanGlyph",
            Self::MageGlyph => "MageGlyph",
            Self::WarlockGlyph => "WarlockGlyph",
            Self::DruidGlyph => "DruidGlyph",
        })
    }
}
