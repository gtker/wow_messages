/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/enums/map.wowm:397`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/enums/map.wowm#L397):
/// ```text
/// enum Map : u32 {
///     EASTERN_KINGDOMS = 0;
///     KALIMDOR = 1;
...
impl std::fmt::Display for Map {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::Exteriortest => "ExteriorTest",
            Self::UtgardeKeep => "Utgarde Keep",
            Self::UtgardePinnacle => "Utgarde Pinnacle",
            Self::TheNexus => "The Nexus",
            Self::TheOculus => "The Oculus",
            ...
            Self::TransportBoreanTundraTest => "Transport: Borean Tundra Test",
            Self::TransportBootyBayToRatchet => "Transport: Booty Bay to Ratchet",
            Self::TransportHowlingFjordSisterMercyQuest => "Transport: Howling Fjord Sister Mercy (Quest)",
            Self::TheCullingOfStratholme => "The Culling of Stratholme",
            Self::TransportNaglfar => "Transport: Naglfar",
            Self::CraigTest => "Craig Test",
            Self::SunwellFixUnused => "Sunwell Fix (Unused)",
            Self::HallsOfStone => "Halls of Stone",
            Self::DrakTharonKeep => "Drak'Tharon Keep",
            Self::AzjolNerub => "Azjol-Nerub",
            Self::HallsOfLightning => "Halls of Lightning",
            Self::Ulduar => "Ulduar",
            Self::Gundrak => "Gundrak",
            Self::DevelopmentLandNonWeightedTextures => "Development Land (non-weighted textures)",
            Self::QaAndDvd => "QA and DVD",
            Self::StrandOfTheAncients => "Strand of the Ancients",
            Self::VioletHold => "Violet Hold",
            Self::EbonHold => "Ebon Hold",
            Self::TransportTirisfalToVengeanceLanding => "Transport: Tirisfal to Vengeance Landing",
            Self::TransportMenethilToValgarde => "Transport: Menethil to Valgarde",
            Self::TransportOrgrimmarToWarsongHold => "Transport: Orgrimmar to Warsong Hold",
            Self::TransportStormwindToValianceKeep => "Transport: Stormwind to Valiance Keep",
            Self::TheObsidianSanctum => "The Obsidian Sanctum",
            Self::TheEyeOfEternity => "The Eye of Eternity",
            Self::DalaranSewers => "Dalaran Sewers",
            Self::TheRingOfValor => "The Ring of Valor",
            Self::AhnKahetTheOldKingdom => "Ahn'kahet: The Old Kingdom",
            Self::TransportMoaKiToUnuPe => "Transport: Moa'ki to Unu'pe",
            Self::TransportMoaKiToKamagua => "Transport: Moa'ki to Kamagua",
            Self::TransportOrgrimsHammer => "Transport: Orgrim's Hammer",
            Self::TransportTheSkybreaker => "Transport: The Skybreaker",
            Self::VaultOfArchavon => "Vault of Archavon",
            Self::IsleOfConquest => "Isle of Conquest",
            Self::IcecrownCitadel => "Icecrown Citadel",
            Self::TheForgeOfSouls => "The Forge of Souls",
            Self::TransportAllianceAirshipBg => "Transport: Alliance Airship BG",
            Self::TransportHordeairshipbg => "Transport: HordeAirshipBG",
            Self::TransportOrgrimmarToThunderBluff => "Transport: Orgrimmar to Thunder Bluff",
            Self::TrialOfTheCrusader => "Trial of the Crusader",
            Self::TrialOfTheChampion => "Trial of the Champion",
            Self::PitOfSaron => "Pit of Saron",
            Self::HallsOfReflection => "Halls of Reflection",
            Self::TransportTheSkybreakerIcecrownCitadelRaid => "Transport: The Skybreaker (Icecrown Citadel Raid)",
            Self::TransportOrgrimsHammerIcecrownCitadelRaid => "Transport: Orgrim's Hammer (Icecrown Citadel Raid)",
            Self::TransportTheSkybreakerIcDungeon => "Transport: The Skybreaker (IC Dungeon)",
            Self::TransportOrgrimsHammerIcDungeon => "Transport: Orgrim's Hammer (IC Dungeon)",
            Self::TransportTheMightyWindIcecrownCitadelRaid => "Transport: The Mighty Wind (Icecrown Citadel Raid)",
            Self::Stormwind => "Stormwind",
            Self::TheRubySanctum => "The Ruby Sanctum",
        })
    }
}
