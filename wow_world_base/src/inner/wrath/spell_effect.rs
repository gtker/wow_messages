/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/spell/smsg_spelllogexecute.wowm:431`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/spell/smsg_spelllogexecute.wowm#L431):
/// ```text
...
impl SpellEffect {
    ...
    pub const fn variants() -> [Self; 165] {
        [
            Self::None,
            Self::Instakill,
            Self::SchoolDamage,
...
impl SpellEffect {
    pub const fn as_test_case_value(&self) -> &'static str {
        match self {
            ...
            Self::ApplyAreaAuraRaid => "APPLY_AREA_AURA_RAID",
            Self::RestoreItemCharges => "RESTORE_ITEM_CHARGES",
            ...
            Self::UntrainTalents => "UNTRAIN_TALENTS",
            Self::ApplyGlyph => "APPLY_GLYPH",
            ...
            Self::WmoDamage => "WMO_DAMAGE",
            Self::WmoRepair => "WMO_REPAIR",
            Self::WmoChange => "WMO_CHANGE",
            Self::KillCreditPersonal => "KILL_CREDIT_PERSONAL",
            Self::ThreatAll => "THREAT_ALL",
            Self::EnchantHeldItem => "ENCHANT_HELD_ITEM",
            Self::BreakPlayerTargeting => "BREAK_PLAYER_TARGETING",
            Self::SelfResurrect => "SELF_RESURRECT",
            Self::Skinning => "SKINNING",
            Self::Charge => "CHARGE",
            Self::SummonAllTotems => "SUMMON_ALL_TOTEMS",
            ...
            Self::ForceCastWithValue => "FORCE_CAST_WITH_VALUE",
            ...
            Self::TalentSpecCount => "TALENT_SPEC_COUNT",
            Self::TalentSpecSelect => "TALENT_SPEC_SELECT",
            Self::Unknown163 => "UNKNOWN163",
            Self::CancelAura => "CANCEL_AURA",
        }
    }
...
impl std::fmt::Display for SpellEffect {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            Self::None => "None",
            Self::Instakill => "Instakill",
            Self::SchoolDamage => "SchoolDamage",
            Self::Dummy => "Dummy",
            Self::PortalTeleport => "PortalTeleport",
            Self::TeleportUnits => "TeleportUnits",
            Self::ApplyAura => "ApplyAura",
            Self::EnvironmentalDamage => "EnvironmentalDamage",
            Self::PowerDrain => "PowerDrain",
            Self::HealthLeech => "HealthLeech",
            Self::Heal => "Heal",
            Self::Bind => "Bind",
            Self::Portal => "Portal",
            Self::RitualBase => "RitualBase",
            Self::RitualSpecialize => "RitualSpecialize",
            Self::RitualActivatePortal => "RitualActivatePortal",
            Self::QuestComplete => "QuestComplete",
            Self::WeaponDamageNoschool => "WeaponDamageNoschool",
            Self::Resurrect => "Resurrect",
            Self::AddExtraAttacks => "AddExtraAttacks",
            Self::Dodge => "Dodge",
            Self::Evade => "Evade",
            Self::Parry => "Parry",
            Self::Block => "Block",
            ...
            Self::Weapon => "Weapon",
            Self::Defense => "Defense",
            Self::PersistentAreaAura => "PersistentAreaAura",
            Self::Summon => "Summon",
            Self::Leap => "Leap",
            Self::Energize => "Energize",
            Self::WeaponPercentDamage => "WeaponPercentDamage",
            Self::TriggerMissile => "TriggerMissile",
            Self::OpenLock => "OpenLock",
            Self::SummonChangeItem => "SummonChangeItem",
            Self::ApplyAreaAuraParty => "ApplyAreaAuraParty",
            Self::LearnSpell => "LearnSpell",
            Self::SpellDefense => "SpellDefense",
            Self::Dispel => "Dispel",
            Self::Language => "Language",
            Self::DualWield => "DualWield",
            Self::Jump => "Jump",
            Self::Jump2 => "Jump2",
            Self::TeleportUnitsFaceCaster => "TeleportUnitsFaceCaster",
            Self::SkillStep => "SkillStep",
            Self::AddHonor => "AddHonor",
            Self::Spawn => "Spawn",
            Self::TradeSkill => "TradeSkill",
            Self::Stealth => "Stealth",
            Self::Detect => "Detect",
            Self::TransDoor => "TransDoor",
            Self::ForceCriticalHit => "ForceCriticalHit",
            Self::GuaranteeHit => "GuaranteeHit",
            Self::EnchantItem => "EnchantItem",
            Self::EnchantItemTemporary => "EnchantItemTemporary",
            Self::Tamecreature => "Tamecreature",
            Self::SummonPet => "SummonPet",
            Self::LearnPetSpell => "LearnPetSpell",
            Self::WeaponDamage => "WeaponDamage",
            Self::OpenLockItem => "OpenLockItem",
            Self::Proficiency => "Proficiency",
            Self::SendEvent => "SendEvent",
            Self::PowerBurn => "PowerBurn",
            Self::Threat => "Threat",
            Self::TriggerSpell => "TriggerSpell",
            Self::ApplyAreaAuraRaid => "ApplyAreaAuraRaid",
            Self::RestoreItemCharges => "RestoreItemCharges",
            Self::HealMaxHealth => "HealMaxHealth",
            Self::InterruptCast => "InterruptCast",
            Self::Distract => "Distract",
            Self::Pull => "Pull",
            Self::Pickpocket => "Pickpocket",
            Self::AddFarsight => "AddFarsight",
            Self::UntrainTalents => "UntrainTalents",
            Self::ApplyGlyph => "ApplyGlyph",
            Self::HealMechanical => "HealMechanical",
            Self::SummonObjectWild => "SummonObjectWild",
            Self::ScriptEffect => "ScriptEffect",
            Self::Attack => "Attack",
            Self::Sanctuary => "Sanctuary",
            Self::AddComboPoints => "AddComboPoints",
            Self::CreateHouse => "CreateHouse",
            Self::BindSight => "BindSight",
            Self::Duel => "Duel",
            Self::Stuck => "Stuck",
            Self::SummonPlayer => "SummonPlayer",
            Self::ActivateObject => "ActivateObject",
            Self::WmoDamage => "WmoDamage",
            Self::WmoRepair => "WmoRepair",
            Self::WmoChange => "WmoChange",
            Self::KillCreditPersonal => "KillCreditPersonal",
            Self::ThreatAll => "ThreatAll",
            Self::EnchantHeldItem => "EnchantHeldItem",
            Self::BreakPlayerTargeting => "BreakPlayerTargeting",
            Self::SelfResurrect => "SelfResurrect",
            Self::Skinning => "Skinning",
            Self::Charge => "Charge",
            Self::SummonAllTotems => "SummonAllTotems",
            Self::KnockBack => "KnockBack",
            Self::Disenchant => "Disenchant",
            Self::Inebriate => "Inebriate",
            Self::FeedPet => "FeedPet",
            Self::DismissPet => "DismissPet",
            Self::Reputation => "Reputation",
            Self::SummonObjectSlot1 => "SummonObjectSlot1",
            Self::SummonObjectSlot2 => "SummonObjectSlot2",
            Self::SummonObjectSlot3 => "SummonObjectSlot3",
            Self::SummonObjectSlot4 => "SummonObjectSlot4",
            Self::DispelMechanic => "DispelMechanic",
            Self::SummonDeadPet => "SummonDeadPet",
            Self::DestroyAllTotems => "DestroyAllTotems",
            Self::DurabilityDamage => "DurabilityDamage",
            Self::Unknown112 => "Unknown112",
            Self::ResurrectNew => "ResurrectNew",
            Self::AttackMe => "AttackMe",
            Self::DurabilityDamagePct => "DurabilityDamagePct",
            Self::SkinPlayerCorpse => "SkinPlayerCorpse",
            Self::SpiritHeal => "SpiritHeal",
            Self::Skill => "Skill",
            Self::ApplyAreaAuraPet => "ApplyAreaAuraPet",
            Self::TeleportGraveyard => "TeleportGraveyard",
            Self::NormalizedWeaponDmg => "NormalizedWeaponDmg",
            Self::Unknown122 => "Unknown122",
            Self::SendTaxi => "SendTaxi",
            Self::PlayerPull => "PlayerPull",
            Self::ModifyThreatPercent => "ModifyThreatPercent",
            Self::StealBeneficialBuff => "StealBeneficialBuff",
            Self::Prospecting => "Prospecting",
            Self::ApplyAreaAuraFriend => "ApplyAreaAuraFriend",
            Self::ApplyAreaAuraEnemy => "ApplyAreaAuraEnemy",
            Self::RedirectThreat => "RedirectThreat",
            Self::PlaySound => "PlaySound",
            Self::PlayMusic => "PlayMusic",
            Self::UnlearnSpecialization => "UnlearnSpecialization",
            Self::KillCreditGroup => "KillCreditGroup",
            Self::CallPet => "CallPet",
            Self::HealPct => "HealPct",
            Self::EnergizePct => "EnergizePct",
            Self::LeapBack => "LeapBack",
            Self::ClearQuest => "ClearQuest",
            Self::ForceCast => "ForceCast",
            Self::ForceCastWithValue => "ForceCastWithValue",
            Self::TriggerSpellWithValue => "TriggerSpellWithValue",
            Self::ApplyAreaAuraOwner => "ApplyAreaAuraOwner",
            Self::KnockbackFromPosition => "KnockbackFromPosition",
            Self::GravityPull => "GravityPull",
            Self::ActivateRune => "ActivateRune",
            Self::QuestFail => "QuestFail",
            Self::Unknown148 => "Unknown148",
            Self::Charge2 => "Charge2",
            Self::QuestOffer => "QuestOffer",
            Self::TriggerSpell2 => "TriggerSpell2",
            Self::Unknown152 => "Unknown152",
            Self::CreatePet => "CreatePet",
            Self::TeachTaxiNode => "TeachTaxiNode",
            Self::TitanGrip => "TitanGrip",
            Self::EnchantItemPrismatic => "EnchantItemPrismatic",
            Self::CreateItem2 => "CreateItem2",
            Self::Milling => "Milling",
            Self::AllowRenamePet => "AllowRenamePet",
            Self::Unknown160 => "Unknown160",
            Self::TalentSpecCount => "TalentSpecCount",
            Self::TalentSpecSelect => "TalentSpecSelect",
            Self::Unknown163 => "Unknown163",
            Self::CancelAura => "CancelAura",
        })
    }
}
