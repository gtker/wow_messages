...
impl std::ops::BitAnd for ExtraMovementFlags {
    type Output = Self;
...
impl std::ops::BitAndAssign for ExtraMovementFlags {
    fn bitand_assign(&mut self, rhs: Self) {
        self.inner.bitand_assign(rhs.inner)
    }
}

impl std::ops::BitOr for ExtraMovementFlags {
    type Output = Self;
...
impl std::ops::BitOrAssign for ExtraMovementFlags {
    fn bitor_assign(&mut self, rhs: Self) {
        self.inner.bitor_assign(rhs.inner)
    }
}

impl std::ops::BitXor for ExtraMovementFlags {
    type Output = Self;
...
impl std::ops::BitXorAssign for ExtraMovementFlags {
