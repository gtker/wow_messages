...
impl std::fmt::Display for ItemSet {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::WrathOfSpellfire => "WrathOfSpellfire",
            Self::ShadowsEmbrace => "Shadow's Embrace",
            Self::PrimalMooncloth => "PrimalMooncloth",
            Self::NetherweaveVestments => "NetherweaveVestments",
            Self::ImbuedNetherweave => "ImbuedNetherweave",
            Self::SoulclothEmbrace => "SoulclothEmbrace",
            Self::ArcanoweaveVestments => "ArcanoweaveVestments",
            Self::SpellstrikeInfusion => "SpellstrikeInfusion",
            Self::FelIronPlate => "FelIronPlate",
            Self::FelIronChain => "FelIronChain",
            Self::AdamantiteBattlegear => "AdamantiteBattlegear",
            Self::EnchantedAdamantiteArmor => "EnchantedAdamantiteArmor",
            Self::FlameGuard => "FlameGuard",
            Self::KhoriumWard => "KhoriumWard",
            Self::BurningRage => "BurningRage",
            Self::GladiatorsBattlegear => "Gladiator's Battlegear",
            Self::GladiatorsDreadgear => "Gladiator's Dreadgear",
            Self::FaithInFelsteel => "FaithInFelsteel",
            Self::TheUnyielding => "TheUnyielding",
            Self::WhitemendWisdom => "WhitemendWisdom",
            Self::BattlecastGarb => "BattlecastGarb",
            Self::FelSkin => "FelSkin",
            Self::StrengthOfTheClefthoof => "StrengthOfTheClefthoof",
            Self::FelstalkerArmor => "FelstalkerArmor",
            Self::FuryOfTheNether => "FuryOfTheNether",
            Self::GladiatorsVestments => "Gladiator's Vestments",
            Self::GladiatorsEarthshaker => "Gladiator's Earthshaker",
            Self::GladiatorsRegalia => "Gladiator's Regalia",
            Self::GladiatorsThunderfist => "Gladiator's Thunderfist",
            Self::GladiatorsRaiment => "Gladiator's Raiment",
            Self::GladiatorsAegis => "Gladiator's Aegis",
            Self::GladiatorsVindication => "Gladiator's Vindication",
            Self::GladiatorsSanctuary => "Gladiator's Sanctuary",
            Self::GladiatorsWildhide => "Gladiator's Wildhide",
            Self::GladiatorsPursuit => "Gladiator's Pursuit",
            Self::HighWarlordsAegis => "High Warlord's Aegis",
            Self::HighWarlordsBattlegear => "High Warlord's Battlegear",
            Self::GrandMarshalsAegis => "Grand Marshal's Aegis",
            Self::GrandMarshalsBattlegear => "Grand Marshal's Battlegear",
            Self::GrandMarshalsDreadgear => "Grand Marshal's Dreadgear",
            Self::HighWarlordsDreadgear => "High Warlord's Dreadgear",
            Self::GrandMarshalsEarthshaker => "Grand Marshal's Earthshaker",
            Self::HighWarlordsEarthshaker => "High Warlord's Earthshaker",
            Self::GrandMarshalsPursuit => "Grand Marshal's Pursuit",
            Self::HighWarlordsPursuit => "High Warlord's Pursuit",
            Self::GrandMarshalsRaiment => "Grand Marshal's Raiment",
            Self::HighWarlordsRaiment => "High Warlord's Raiment",
            Self::GrandMarshalsRegalia => "Grand Marshal's Regalia",
            Self::HighWarlordsRegalia => "High Warlord's Regalia",
            Self::GrandMarshalsSanctuary => "Grand Marshal's Sanctuary",
            Self::HighWarlordsSanctuary => "High Warlord's Sanctuary",
            Self::GrandMarshalsThunderfist => "Grand Marshal's Thunderfist",
            Self::HighWarlordsThunderfist => "High Warlord's Thunderfist",
            Self::GrandMarshalsVestments => "Grand Marshal's Vestments",
            Self::HighWarlordsVestments => "High Warlord's Vestments",
            Self::GrandMarshalsVindication => "Grand Marshal's Vindication",
            Self::HighWarlordsVindication => "High Warlord's Vindication",
            Self::GrandMarshalsWildhide => "Grand Marshal's Wildhide",
            Self::HighWarlordsWildhide => "High Warlord's Wildhide",
            Self::FelscaleArmor => "FelscaleArmor",
            Self::ScaledDraenicArmor => "ScaledDraenicArmor",
            Self::ThickDraenicArmor => "ThickDraenicArmor",
            Self::WildDraenishArmor => "WildDraenishArmor",
            Self::GladiatorsFelshroud => "Gladiator's Felshroud",
            Self::NetherscaleArmor => "NetherscaleArmor",
            Self::NetherstrikeArmor => "NetherstrikeArmor",
            Self::WindhawkArmor => "WindhawkArmor",
            Self::PrimalIntent => "PrimalIntent",
            Self::AssassinationArmor => "AssassinationArmor",
            Self::Netherblade => "Netherblade",
            Self::Deathmantle => "Deathmantle",
            Self::RighteousArmor => "RighteousArmor",
            Self::JusticarRaiment => "JusticarRaiment",
            Self::JusticarArmor => "JusticarArmor",
            Self::JusticarBattlegear => "JusticarBattlegear",
            Self::CrystalforgeRaiment => "CrystalforgeRaiment",
            Self::CrystalforgeArmor => "CrystalforgeArmor",
            Self::CrystalforgeBattlegear => "CrystalforgeBattlegear",
            Self::TidefuryRaiment => "TidefuryRaiment",
            Self::CycloneRaiment => "CycloneRaiment",
            Self::CycloneRegalia => "CycloneRegalia",
            Self::CycloneHarness => "CycloneHarness",
            Self::CataclysmRaiment => "CataclysmRaiment",
            Self::CataclysmRegalia => "CataclysmRegalia",
            Self::CataclysmHarness => "CataclysmHarness",
            Self::MoongladeRaiment => "MoongladeRaiment",
            Self::MalorneRaiment => "MalorneRaiment",
            Self::MalorneRegalia => "MalorneRegalia",
            Self::MalorneHarness => "MalorneHarness",
            Self::NordrassilHarness => "NordrassilHarness",
            Self::NordrassilRaiment => "NordrassilRaiment",
            Self::NordrassilRegalia => "NordrassilRegalia",
            Self::OblivionRaiment => "OblivionRaiment",
            Self::VoidheartRaiment => "VoidheartRaiment",
            Self::CorruptorRaiment => "CorruptorRaiment",
            Self::IncantersRegalia => "Incanter's Regalia",
            Self::AldorRegalia => "AldorRegalia",
            Self::TirisfalRegalia => "TirisfalRegalia",
            Self::BeastLordArmor => "BeastLordArmor",
            Self::DemonStalkerArmor => "DemonStalkerArmor",
            Self::RiftStalkerArmor => "RiftStalkerArmor",
            Self::BoldArmor => "BoldArmor",
            Self::WarbringerArmor => "WarbringerArmor",
            Self::WarbringerBattlegear => "WarbringerBattlegear",
            Self::DestroyerArmor => "DestroyerArmor",
            Self::DestroyerBattlegear => "DestroyerBattlegear",
            Self::ManaEtchedRegalia => "Mana-Etched Regalia",
            Self::WastewalkerArmor => "WastewalkerArmor",
            Self::DesolationBattlegear => "DesolationBattlegear",
            Self::DoomplateBattlegear => "DoomplateBattlegear",
            Self::HallowedRaiment => "HallowedRaiment",
            Self::IncarnateRaiment => "IncarnateRaiment",
            Self::IncarnateRegalia => "IncarnateRegalia",
            Self::AvatarRaiment => "AvatarRaiment",
            Self::AvatarRegalia => "AvatarRegalia",
            Self::TheTwinStars => "TheTwinStars",
            Self::SlayersArmor => "Slayer's Armor",
            Self::GronnstalkersArmor => "Gronnstalker's Armor",
            Self::MaleficRaiment => "MaleficRaiment",
            Self::TempestRegalia => "TempestRegalia",
            Self::OnslaughtBattlegear => "OnslaughtBattlegear",
            Self::OnslaughtArmor => "OnslaughtArmor",
            Self::AbsolutionRegalia => "AbsolutionRegalia",
            Self::VestmentsOfAbsolution => "VestmentsOfAbsolution",
            Self::ThunderheartHarness => "ThunderheartHarness",
            Self::ThunderheartRegalia => "ThunderheartRegalia",
            Self::ThunderheartRaiment => "ThunderheartRaiment",
            Self::LightbringerArmor => "LightbringerArmor",
            Self::LightbringerBattlegear => "LightbringerBattlegear",
            Self::LightbringerRaiment => "LightbringerRaiment",
            Self::SkyshatterHarness => "SkyshatterHarness",
            Self::SkyshatterRaiment => "SkyshatterRaiment",
            Self::SkyshatterRegalia => "SkyshatterRegalia",
            Self::GladiatorsRefuge => "Gladiator's Refuge",
            Self::GladiatorsWartide => "Gladiator's Wartide",
            Self::GladiatorsInvestiture => "Gladiator's Investiture",
            Self::GrandMarshalsRefuge => "Grand Marshal's Refuge",
            Self::HighWarlordsRefuge => "High Warlord's Refuge",
            Self::GladiatorsRedemption => "Gladiator's Redemption",
            Self::GrandMarshalsInvestiture => "Grand Marshal's Investiture",
            Self::HighWarlordsInvestiture => "High Warlord's Investiture",
            Self::GrandMarshalsRedemption => "Grand Marshal's Redemption",
            Self::HighWarlordsRedemption => "High Warlord's Redemption",
            Self::GrandMarshalsWartide => "Grand Marshal's Wartide",
            Self::HighWarlordsWartide => "High Warlord's Wartide",
            Self::ChampionsRedoubt => "Champion's Redoubt",
            Self::WarlordsAegis => "Warlord's Aegis",
            Self::TheTwinBladesOfAzzinoth => "TheTwinBladesOfAzzinoth",
            Self::MercilessGladiatorsAegis => "Merciless Gladiator's Aegis",
            Self::MercilessGladiatorsBattlegear => "Merciless Gladiator's Battlegear",
            Self::MercilessGladiatorsDreadgear => "Merciless Gladiator's Dreadgear",
            Self::MercilessGladiatorsEarthshaker => "Merciless Gladiator's Earthshaker",
            Self::MercilessGladiatorsFelshroud => "Merciless Gladiator's Felshroud",
            Self::MercilessGladiatorsInvestiture => "Merciless Gladiator's Investiture",
            Self::MercilessGladiatorsPursuit => "Merciless Gladiator's Pursuit",
            Self::MercilessGladiatorsRaiment => "Merciless Gladiator's Raiment",
            Self::MercilessGladiatorsRedemption => "Merciless Gladiator's Redemption",
            Self::MercilessGladiatorsRefuge => "Merciless Gladiator's Refuge",
            Self::MercilessGladiatorsRegalia => "Merciless Gladiator's Regalia",
            Self::MercilessGladiatorsSanctuary => "Merciless Gladiator's Sanctuary",
            Self::MercilessGladiatorsThunderfist => "Merciless Gladiator's Thunderfist",
            Self::MercilessGladiatorsVestments => "Merciless Gladiator's Vestments",
            Self::MercilessGladiatorsVindication => "Merciless Gladiator's Vindication",
            Self::MercilessGladiatorsWartide => "Merciless Gladiator's Wartide",
            Self::MercilessGladiatorsWildhide => "Merciless Gladiator's Wildhide",
            Self::FieldMarshalsEarthshaker => "Field Marshal's Earthshaker",
            Self::LieutenantCommandersEarthshaker => "Lieutenant Commander's Earthshaker",
            Self::TheFistsOfFury => "TheFistsOfFury",
            Self::VengefulGladiatorsRefuge => "Vengeful Gladiator's Refuge",
            Self::VengefulGladiatorsSanctuary => "Vengeful Gladiator's Sanctuary",
            Self::VengefulGladiatorsWildhide => "Vengeful Gladiator's Wildhide",
            Self::VengefulGladiatorsPursuit => "Vengeful Gladiator's Pursuit",
            Self::VengefulGladiatorsRegalia => "Vengeful Gladiator's Regalia",
            Self::VengefulGladiatorsRedemption => "Vengeful Gladiator's Redemption",
            Self::VengefulGladiatorsVindication => "Vengeful Gladiator's Vindication",
            Self::VengefulGladiatorsAegis => "Vengeful Gladiator's Aegis",
            Self::VengefulGladiatorsInvestiture => "Vengeful Gladiator's Investiture",
            Self::VengefulGladiatorsRaiment => "Vengeful Gladiator's Raiment",
            Self::VengefulGladiatorsVestments => "Vengeful Gladiator's Vestments",
            Self::VengefulGladiatorsWartide => "Vengeful Gladiator's Wartide",
            Self::VengefulGladiatorsEarthshaker => "Vengeful Gladiator's Earthshaker",
            Self::VengefulGladiatorsThunderfist => "Vengeful Gladiator's Thunderfist",
            Self::VengefulGladiatorsDreadgear => "Vengeful Gladiator's Dreadgear",
            Self::VengefulGladiatorsFelshroud => "Vengeful Gladiator's Felshroud",
            Self::VengefulGladiatorsBattlegear => "Vengeful Gladiator's Battlegear",
            Self::LatrosFlurry => "Latro's Flurry",
            Self::DreadweaveBattlegear => "DreadweaveBattlegear",
            Self::MoonclothBattlegear => "MoonclothBattlegear",
            Self::SatinBattlegear => "SatinBattlegear",
            Self::EvokersSilkBattlegear => "Evoker's Silk Battlegear",
            Self::DragonhideBattlegear => "DragonhideBattlegear",
            Self::WyrmhideBattlegear => "WyrmhideBattlegear",
            Self::KodohideBattlegear => "KodohideBattlegear",
            Self::OpportunistsBattlegear => "Opportunist's Battlegear",
            Self::SeersMailBattlegear => "Seer's Mail Battlegear",
            Self::SeersRingmailBattlegear => "Seer's Ringmail Battlegear",
            Self::SeersLinkedBattlegear => "Seer's Linked Battlegear",
            Self::StalkersChainBattlegear => "Stalker's Chain Battlegear",
            Self::SavagePlateBattlegear => "SavagePlateBattlegear",
            Self::CrusadersOrnamentedBattlegear => "Crusader's Ornamented Battlegear",
            Self::CrusadersScaledBattlegear => "Crusader's Scaled Battlegear",
            Self::BoreanEmbrace => "BoreanEmbrace",
            Self::NerubianHive => "NerubianHive",
            Self::FrostscaleBinding => "FrostscaleBinding",
            Self::IceborneEmbrace => "IceborneEmbrace",
            Self::RainesRevenge => "Raine's Revenge",
            Self::GladiatorsDreadplate => "Gladiator's Dreadplate",
            Self::WinterGarb => "WinterGarb",
            Self::BrewfestGarb => "BrewfestGarb",
            Self::FrostwovenPower => "FrostwovenPower",
            Self::Duskweaver => "Duskweaver",
            Self::GladiatorsBattlegear2 => "Gladiator's Battlegear",
            Self::GladiatorsVindication2 => "Gladiator's Vindication",
            Self::GladiatorsRedemption2 => "Gladiator's Redemption",
            Self::GladiatorsDesecration => "Gladiator's Desecration",
            Self::GladiatorsThunderfist2 => "Gladiator's Thunderfist",
            Self::GladiatorsEarthshaker2 => "Gladiator's Earthshaker",
            Self::GladiatorsWartide2 => "Gladiator's Wartide",
            Self::GladiatorsPursuit2 => "Gladiator's Pursuit",
            Self::GladiatorsRefuge2 => "Gladiator's Refuge",
            Self::GladiatorsWildhide2 => "Gladiator's Wildhide",
            Self::GladiatorsSanctuary2 => "Gladiator's Sanctuary",
            Self::GladiatorsVestments2 => "Gladiator's Vestments",
            Self::GladiatorsInvestiture2 => "Gladiator's Investiture",
            Self::GladiatorsRaiment2 => "Gladiator's Raiment",
            Self::GladiatorsRegalia2 => "Gladiator's Regalia",
            Self::GladiatorsFelshroud2 => "Gladiator's Felshroud",
            Self::BlessedRegaliaOfUndeadCleansing => "BlessedRegaliaOfUndeadCleansing",
            Self::UndeadSlayersBlessedArmor => "Undead Slayer's Blessed Armor",
            Self::BlessedGarbOfTheUndeadSlayer => "BlessedGarbOfTheUndeadSlayer",
            Self::BlessedBattlegearOfUndeadSlaying => "BlessedBattlegearOfUndeadSlaying",
            Self::MidsummerReveler => "MidsummerReveler",
            Self::DreadnaughtPlate => "DreadnaughtPlate",
            Self::DreadnaughtBattlegear => "DreadnaughtBattlegear",
            Self::RedemptionBattlegear => "RedemptionBattlegear",
            Self::RedemptionRegalia => "RedemptionRegalia",
            Self::RedemptionPlate => "RedemptionPlate",
            Self::ScourgeborneBattlegear => "ScourgeborneBattlegear",
            Self::ScourgebornePlate => "ScourgebornePlate",
            Self::CryptstalkerBattlegear => "CryptstalkerBattlegear",
            Self::EarthshatterBattlegear => "EarthshatterBattlegear",
            Self::EarthshatterGarb => "EarthshatterGarb",
            Self::EarthshatterRegalia => "EarthshatterRegalia",
            Self::DreamwalkerBattlegear => "DreamwalkerBattlegear",
            Self::DreamwalkerRegalia => "DreamwalkerRegalia",
            Self::DreamwalkerGarb => "DreamwalkerGarb",
            Self::BonescytheBattlegear => "BonescytheBattlegear",
            Self::PlagueheartGarb => "PlagueheartGarb",
            Self::FrostfireGarb => "FrostfireGarb",
            Self::RegaliaOfFaith => "RegaliaOfFaith",
            Self::GarbOfFaith => "GarbOfFaith",
            Self::SpringTuxedo => "SpringTuxedo",
            Self::EvisceratorsBattlegear => "Eviscerator's Battlegear",
            Self::OrnateSaroniteBattlegear => "OrnateSaroniteBattlegear",
            Self::OvercasterBattlegear => "OvercasterBattlegear",
            Self::SavageSaroniteBattlegear => "SavageSaroniteBattlegear",
            Self::StormhideBattlegear => "StormhideBattlegear",
            Self::SwiftarrowBattlegear => "SwiftarrowBattlegear",
            Self::FrostsavageBattlegear => "FrostsavageBattlegear",
            Self::AegisBattlegear => "AegisBattlegear",
            Self::AegisPlate => "AegisPlate",
            Self::AegisRegalia => "AegisRegalia",
            Self::WorldbreakerBattlegear => "WorldbreakerBattlegear",
            Self::WorldbreakerGarb => "WorldbreakerGarb",
            Self::WorldbreakerRegalia => "WorldbreakerRegalia",
            Self::TerrorbladeBattlegear => "TerrorbladeBattlegear",
            Self::NightsongBattlegear => "NightsongBattlegear",
            Self::NightsongGarb => "NightsongGarb",
            Self::NightsongRegalia => "NightsongRegalia",
            Self::SiegebreakerBattlegear => "SiegebreakerBattlegear",
            Self::SiegebreakerPlate => "SiegebreakerPlate",
            Self::SanctificationGarb => "SanctificationGarb",
            Self::SanctificationRegalia => "SanctificationRegalia",
            Self::DarkrunedBattlegear => "DarkrunedBattlegear",
            Self::DarkrunedPlate => "DarkrunedPlate",
            Self::KirinTorGarb => "KirinTorGarb",
            Self::DeathbringerGarb => "DeathbringerGarb",
            Self::ScourgestalkerBattlegear => "ScourgestalkerBattlegear",
            Self::KhadgarsRegalia => "Khadgar's Regalia",
            Self::SunstridersRegalia => "Sunstrider's Regalia",
            Self::GulDansRegalia => "Gul'dan's Regalia",
            Self::KelThuzadsRegalia => "Kel'Thuzad's Regalia",
            Self::VelensRaiment => "Velen's Raiment",
            Self::ZabrasRaiment => "Zabra's Raiment",
            Self::VelensRegalia => "Velen's Regalia",
            Self::ZabrasRegalia => "Zabra's Regalia",
            Self::MalfurionsGarb => "Malfurion's Garb",
            Self::RunetotemsGarb => "Runetotem's Garb",
            Self::MalfurionsRegalia => "Malfurion's Regalia",
            Self::RunetotemsRegalia => "Runetotem's Regalia",
            Self::MalfurionsBattlegear => "Malfurion's Battlegear",
            Self::RunetotemsBattlegear => "Runetotem's Battlegear",
            Self::VancleefsBattlegear => "VanCleef's Battlegear",
            Self::GaronasBattlegear => "Garona's Battlegear",
            Self::WindrunnersBattlegear => "Windrunner's Battlegear",
            Self::WindrunnersPursuit => "Windrunner's Pursuit",
            Self::NobundosGarb => "Nobundo's Garb",
            Self::ThrallsGarb => "Thrall's Garb",
            Self::ThrallsRegalia => "Thrall's Regalia",
            Self::NobundosRegalia => "Nobundo's Regalia",
            Self::NobundosBattlegear => "Nobundo's Battlegear",
            Self::ThrallsBattlegear => "Thrall's Battlegear",
            Self::WrynnsBattlegear => "Wrynn's Battlegear",
            Self::HellscreamsBattlegear => "Hellscream's Battlegear",
            Self::WrynnsPlate => "Wrynn's Plate",
            Self::HellscreamsPlate => "Hellscream's Plate",
            Self::ThassariansBattlegear => "Thassarian's Battlegear",
            Self::KoltirasBattlegear => "Koltira's Battlegear",
            Self::ThassariansPlate => "Thassarian's Plate",
            Self::KoltirasPlate => "Koltira's Plate",
            Self::TuralyonsGarb => "Turalyon's Garb",
            Self::LiadrinsGarb => "Liadrin's Garb",
            Self::TuralyonsBattlegear => "Turalyon's Battlegear",
            Self::LiadrinsBattlegear => "Liadrin's Battlegear",
            Self::TuralyonsPlate => "Turalyon's Plate",
            Self::LiadrinsPlate => "Liadrin's Plate",
            Self::PurifiedShardOfTheGods => "PurifiedShardOfTheGods",
            Self::ShinyShardOfTheGods => "ShinyShardOfTheGods",
            Self::BloodmagesRegalia => "Bloodmage's Regalia",
            Self::DarkCovensRegalia => "Dark Coven's Regalia",
            Self::CrimsonAcolytesRaiment => "Crimson Acolyte's Raiment",
            Self::CrimsonAcolytesRegalia => "Crimson Acolyte's Regalia",
            Self::LasherweaveGarb => "LasherweaveGarb",
            Self::LasherweaveRegalia => "LasherweaveRegalia",
            Self::LasherweaveBattlegear => "LasherweaveBattlegear",
            Self::ShadowbladesBattlegear => "Shadowblade's Battlegear",
            Self::AhnKaharBloodHuntersBattlegear => "Ahn'Kahar Blood Hunter's Battlegear",
            Self::FrostWitchsGarb => "Frost Witch's Garb",
            Self::FrostWitchsRegalia => "Frost Witch's Regalia",
            Self::FrostWitchsBattlegear => "Frost Witch's Battlegear",
            Self::YmirjarLordsBattlegear => "Ymirjar Lord's Battlegear",
            Self::YmirjarLordsPlate => "Ymirjar Lord's Plate",
            Self::ScourgelordsBattlegear => "Scourgelord's Battlegear",
            Self::ScourgelordsPlate => "Scourgelord's Plate",
            Self::LightswornGarb => "LightswornGarb",
            Self::LightswornBattlegear => "LightswornBattlegear",
            Self::LightswornPlate => "LightswornPlate",
        })
    }
}
