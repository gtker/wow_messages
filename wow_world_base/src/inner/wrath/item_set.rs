/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/item/item_sets.wowm:1102`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/item/item_sets.wowm#L1102):
/// ```text
/// enum ItemSet : u16 {
///     NONE = 0;
///     THE_GLADIATOR = 1;
