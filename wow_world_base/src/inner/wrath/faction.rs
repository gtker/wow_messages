...
impl std::fmt::Display for Faction {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::SilvermoonCity => "SilvermoonCity",
            Self::MightOfKalimdor => "MightOfKalimdor",
            Self::PlayerBloodElf => "PLAYER, Blood Elf",
            ...
            Self::Deprecated => "Deprecated",
            Self::Sunstriders => "Sunstriders",
            Self::MagistersGuild => "Magister's Guild",
            Self::PlayerDraenei => "PLAYER, Draenei",
            Self::ScourgeInvaders => "ScourgeInvaders",
            Self::BloodmaulClan => "BloodmaulClan",
            Self::Exodar => "Exodar",
            Self::TestFactionNotARealFaction => "Test Faction (not a real faction)",
            Self::TheAldor => "TheAldor",
            Self::TheConsortium => "TheConsortium",
            Self::TheScryers => "TheScryers",
            Self::TheShaTar => "The Sha'tar",
            Self::ShattrathCity => "ShattrathCity",
            Self::TrollForest => "Troll, Forest",
            Self::TheOmenai => "TheOmenai",
            Self::Deprecated1 => "Deprecated1",
            Self::TheSonsOfLothar => "TheSonsOfLothar",
            Self::TheMagHar => "The Mag'har",
            Self::CenarionExpedition => "CenarionExpedition",
            Self::FelOrc => "FelOrc",
            Self::FelOrcGhost => "FelOrcGhost",
            Self::SonsOfLotharGhosts => "SonsOfLotharGhosts",
            Self::HonorHold => "HonorHold",
            Self::Thrallmar => "Thrallmar",
            Self::TestFaction2 => "TestFaction2",
            Self::TestFaction1 => "TestFaction1",
            Self::TowowFlag => "ToWoW - Flag",
            Self::TowowFlagTriggerAllianceDnd => "ToWoW - Flag Trigger Alliance (DND)",
            Self::TestFaction3 => "TestFaction3",
            Self::TestFaction4 => "TestFaction4",
            Self::TowowFlagTriggerHordeDnd => "ToWoW - Flag Trigger Horde (DND)",
            Self::Broken => "Broken",
            Self::Ethereum => "Ethereum",
            Self::EarthElemental => "EarthElemental",
            Self::FightingRobots => "FightingRobots",
            Self::ActorGood => "ActorGood",
            Self::ActorEvil => "ActorEvil",
            Self::StillpineFurbolg => "StillpineFurbolg",
            Self::CrazedOwlkin => "CrazedOwlkin",
            Self::ChessAlliance => "ChessAlliance",
            Self::ChessHorde => "ChessHorde",
            Self::MonsterSpar => "MonsterSpar",
            Self::MonsterSparBuddy => "MonsterSparBuddy",
            Self::TheVioletEye => "TheVioletEye",
            Self::Sunhawks => "Sunhawks",
            Self::HandOfArgus => "HandOfArgus",
            Self::Sporeggar => "Sporeggar",
            Self::FungalGiant => "FungalGiant",
            Self::SporeBat => "SporeBat",
            Self::MonsterPredator => "Monster, Predator",
            Self::MonsterPrey => "Monster, Prey",
            Self::VoidAnomaly => "VoidAnomaly",
            Self::HyjalDefenders => "HyjalDefenders",
            Self::HyjalInvaders => "HyjalInvaders",
            Self::Kurenai => "Kurenai",
            Self::EarthenRing => "EarthenRing",
            Self::TheBurningCrusade => "TheBurningCrusade",
            Self::Arakkoa => "Arakkoa",
            Self::ZangarmarshBannerAlliance => "Zangarmarsh Banner (Alliance)",
            Self::ZangarmarshBannerHorde => "Zangarmarsh Banner (Horde)",
            Self::ZangarmarshBannerNeutral => "Zangarmarsh Banner (Neutral)",
            Self::CavernsOfTimeThrall => "Caverns of Time - Thrall",
            Self::CavernsOfTimeDurnholde => "Caverns of Time - Durnholde",
            Self::CavernsOfTimeSouthshoreGuards => "Caverns of Time - Southshore Guards",
            Self::ShadowCouncilCovert => "ShadowCouncilCovert",
            Self::KeepersOfTime => "KeepersOfTime",
            Self::TheScaleOfTheSands => "TheScaleOfTheSands",
            Self::DarkPortalDefenderAlliance => "Dark Portal Defender, Alliance",
            Self::DarkPortalDefenderHorde => "Dark Portal Defender, Horde",
            Self::DarkPortalAttackerLegion => "Dark Portal Attacker, Legion",
            Self::InciterTrigger => "InciterTrigger",
            Self::InciterTrigger2 => "InciterTrigger2",
            Self::InciterTrigger3 => "InciterTrigger3",
            Self::InciterTrigger4 => "InciterTrigger4",
            Self::InciterTrigger5 => "InciterTrigger5",
            Self::ManaCreature => "ManaCreature",
            Self::KhadgarsServant => "Khadgar's Servant",
            Self::BladespireClan => "BladespireClan",
            Self::EthereumSparbuddy => "EthereumSparbuddy",
            Self::Protectorate => "Protectorate",
            Self::ArcaneAnnihilatorDnr => "Arcane Annihilator (DNR)",
            Self::FriendlyHidden => "Friendly, Hidden",
            Self::KirinVarDathric => "Kirin'Var - Dathric",
            Self::KirinVarBelmara => "Kirin'Var - Belmara",
            Self::KirinVarLuminrath => "Kirin'Var - Luminrath",
            Self::KirinVarCohlien => "Kirin'Var - Cohlien",
            Self::ServantOfIllidan => "ServantOfIllidan",
            Self::LowerCity => "LowerCity",
            Self::AshtongueDeathsworn => "AshtongueDeathsworn",
            Self::SpiritsOfShadowmoon1 => "SpiritsOfShadowmoon1",
            Self::SpiritsOfShadowmoon2 => "SpiritsOfShadowmoon2",
            Self::Netherwing => "Netherwing",
            Self::Wyrmcult => "Wyrmcult",
            Self::Treant => "Treant",
            Self::LeotherasDemonI => "LeotherasDemonI",
            Self::LeotherasDemonIi => "LeotherasDemonIi",
            Self::LeotherasDemonIii => "LeotherasDemonIii",
            Self::LeotherasDemonIv => "LeotherasDemonIv",
            Self::LeotherasDemonV => "LeotherasDemonV",
            Self::Azaloth => "Azaloth",
            Self::RockFlayer => "RockFlayer",
            Self::FlayerHunter => "FlayerHunter",
            Self::ShadowmoonShade => "ShadowmoonShade",
            Self::LegionCommunicator => "LegionCommunicator",
            Self::RavenswoodAncients => "RavenswoodAncients",
            Self::ChessFriendlyToAllChess => "Chess, Friendly to All Chess",
            Self::BlackTempleGatesIllidari => "Black Temple Gates - Illidari",
            Self::ShaTariSkyguard => "Sha'tari Skyguard",
            Self::Area52 => "Area52",
            Self::Maiev => "Maiev",
            Self::SkettisShadowyArakkoa => "SkettisShadowyArakkoa",
            Self::SkettisArakkoa => "SkettisArakkoa",
            Self::DragonmawEnemy => "DragonmawEnemy",
            Self::AllianceVanguard => "AllianceVanguard",
            Self::OgriLa => "Ogri'la",
            Self::Ravager => "Ravager",
            Self::Reuse => "Reuse",
            Self::Frenzy => "Frenzy",
            Self::SkyguardEnemy => "SkyguardEnemy",
            Self::SkunkPetunia => "Skunk, Petunia",
            Self::TheramoreDeserter => "TheramoreDeserter",
            Self::Vrykul => "Vrykul",
            Self::NorthseaPirates => "NorthseaPirates",
            Self::Tuskarr => "Tuskarr",
            Self::Unused => "Unused",
            Self::TrollAmani => "Troll, Amani",
            Self::ValianceExpedition => "ValianceExpedition",
            Self::Unused1 => "Unused1",
            Self::HordeExpedition => "HordeExpedition",
            Self::Westguard => "Westguard",
            Self::SpottedGryphon => "SpottedGryphon",
            Self::TamedPlaguehound => "TamedPlaguehound",
            Self::VrykulAncientSpirit1 => "Vrykul (Ancient Spirit 1)",
            Self::VrykulAncientSiprit2 => "Vrykul (Ancient Siprit 2)",
            Self::VrykulAncientSiprit3 => "Vrykul (Ancient Siprit 3)",
            Self::CtfFlagAlliance => "CTF - Flag - Alliance",
            Self::Test => "Test",
            Self::Vrykul1 => "Vrykul1",
            Self::VrykulGladiator => "VrykulGladiator",
            Self::ValgardeCombatant => "ValgardeCombatant",
            Self::TheTaunka => "TheTaunka",
            Self::MonsterZoneForceReaction1 => "Monster, Zone Force Reaction 1",
            Self::MonsterZoneForceReaction2 => "Monster, Zone Force Reaction 2",
            Self::TheHandOfVengeance => "TheHandOfVengeance",
            Self::ExplorersLeague => "Explorers' League",
            Self::RamRacingPowerupDnd => "RamRacingPowerupDnd",
            Self::RamRacingTrapDnd => "RamRacingTrapDnd",
            Self::CraigsSquirrels => "Craig's Squirrels",
            Self::Reuse1 => "Reuse1",
            Self::TheKaluAk => "The Kalu'ak",
            Self::HolidayWaterBarrel => "Holiday - Water Barrel",
            Self::HolidayGeneric => "Holiday - Generic",
            Self::IronDwarves => "IronDwarves",
            Self::ShatteredSunOffensive => "ShatteredSunOffensive",
            Self::FightingVanityPet => "FightingVanityPet",
            Self::MurlocWinterfin => "Murloc, Winterfin",
            Self::FriendlyForceReaction => "Friendly, Force Reaction",
            Self::ObjectForceReaction => "Object, Force Reaction",
            Self::Reuse2 => "Reuse2",
            Self::Reuse4 => "Reuse4",
            Self::VrykulSea => "Vrykul, Sea",
            Self::WarsongOffensive => "WarsongOffensive",
            Self::Poacher => "Poacher",
            Self::HolidayMonster => "HolidayMonster",
            Self::FurbolgRedfang => "Furbolg, Redfang",
            Self::FurbolgFrostpaw => "Furbolg, Frostpaw",
            Self::KirinTor => "KirinTor",
            Self::TheWyrmrestAccord => "TheWyrmrestAccord",
            Self::AzjolNerub => "Azjol-Nerub",
            Self::Reuse8 => "Reuse8",
            Self::TheSilverCovenant => "TheSilverCovenant",
            Self::GrizzlyHillsTrapper => "GrizzlyHillsTrapper",
            Self::Reuse16 => "Reuse16",
            Self::WrathOfTheLichKing => "WrathOfTheLichKing",
            Self::KnightsOfTheEbonBlade => "KnightsOfTheEbonBlade",
            Self::WrathgateScourge => "WrathgateScourge",
            Self::WrathgateAlliance => "WrathgateAlliance",
            Self::WrathgateHorde => "WrathgateHorde",
            Self::CtfFlagHorde => "CTF - Flag - Horde",
            Self::CtfFlagNeutral => "CTF - Flag - Neutral",
            Self::FrenzyheartTribe => "FrenzyheartTribe",
            Self::TheOracles => "TheOracles",
            Self::ArgentCrusade => "ArgentCrusade",
            Self::TrollDrakkari => "Troll, Drakkari",
            Self::CotArthas => "CotArthas",
            Self::CotStratholmeCitizen => "CotStratholmeCitizen",
            Self::CotScourge => "CotScourge",
            Self::Freya => "Freya",
            Self::MountTaxiAlliance => "Mount - Taxi - Alliance",
            Self::MountTaxiHorde => "Mount - Taxi - Horde",
            Self::MountTaxiNeutral => "Mount - Taxi - Neutral",
            Self::ElementalWater => "Elemental, Water",
            Self::ElementalAir => "Elemental, Air",
            Self::SholazarBasin => "SholazarBasin",
            Self::Classic => "Classic",
            Self::TheSonsOfHodir => "TheSonsOfHodir",
            Self::IronGiants => "IronGiants",
            Self::FrostVrykul => "FrostVrykul",
            Self::Earthen => "Earthen",
            Self::MonsterReferee => "MonsterReferee",
            Self::TheSunreavers => "TheSunreavers",
            Self::Hyldsmeet => "Hyldsmeet",
            Self::TheFrostborn => "TheFrostborn",
            Self::OrgrimmarAlexTest => "Orgrimmar (Alex Test)",
            Self::TranquillienConversion => "TranquillienConversion",
            Self::WintersaberConversion => "WintersaberConversion",
            Self::HatesEverything => "HatesEverything",
            Self::SilverCovenantConversion => "SilverCovenantConversion",
            Self::SunreaversConversion => "SunreaversConversion",
            Self::TheAshenVerdict => "TheAshenVerdict",
            Self::CtfFlagAlliance2 => "CTF - Flag - Alliance 2",
            Self::CtfFlagHorde2 => "CTF - Flag - Horde 2",
        })
    }
}
