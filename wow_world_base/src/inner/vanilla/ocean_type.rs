...
///
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/external/ocean_type.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/external/ocean_type.wowm#L1):
/// ```text
/// enum OceanType : u8 {
///     FIRE = 0;
///     SLIME = 2;
