...
impl ItemSet {
    ...
    pub const fn variants() -> [Self; 173] {
        [
            Self::None,
            Self::TheGladiator,
            Self::DalRendsArms,
...
impl std::fmt::Display for ItemSet {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            Self::None => "None",
            Self::TheGladiator => "TheGladiator",
            Self::DalRendsArms => "Dal'Rend's Arms",
            Self::SpidersKiss => "Spider's Kiss",
            Self::ThePostmaster => "ThePostmaster",
            Self::CadaverousGarb => "CadaverousGarb",
            Self::NecropileRaiment => "NecropileRaiment",
            Self::BloodmailRegalia => "BloodmailRegalia",
            Self::DeathboneGuardian => "DeathboneGuardian",
            Self::VolcanicArmor => "VolcanicArmor",
            Self::StormshroudArmor => "StormshroudArmor",
            Self::DevilsaurArmor => "DevilsaurArmor",
            Self::IronfeatherArmor => "IronfeatherArmor",
            Self::DefiasLeather => "DefiasLeather",
            Self::EmbraceOfTheViper => "EmbraceOfTheViper",
            Self::ChainOfTheScarletCrusade => "ChainOfTheScarletCrusade",
            Self::MagistersRegalia => "Magister's Regalia",
            Self::VestmentsOfTheDevout => "VestmentsOfTheDevout",
            Self::DreadmistRaiment => "DreadmistRaiment",
            Self::ShadowcraftArmor => "ShadowcraftArmor",
            Self::WildheartRaiment => "WildheartRaiment",
            Self::BeaststalkerArmor => "BeaststalkerArmor",
            Self::TheElements => "TheElements",
            Self::LightforgeArmor => "LightforgeArmor",
            Self::BattlegearOfValor => "BattlegearOfValor",
            Self::ArcanistRegalia => "ArcanistRegalia",
            Self::VestmentsOfProphecy => "VestmentsOfProphecy",
            Self::FelheartRaiment => "FelheartRaiment",
            Self::NightslayerArmor => "NightslayerArmor",
            Self::CenarionRaiment => "CenarionRaiment",
            Self::GiantstalkerArmor => "GiantstalkerArmor",
            Self::TheEarthfury => "TheEarthfury",
            Self::LawbringerArmor => "LawbringerArmor",
            Self::BattlegearOfMight => "BattlegearOfMight",
            Self::NetherwindRegalia => "NetherwindRegalia",
            Self::VestmentsOfTranscendence => "VestmentsOfTranscendence",
            Self::NemesisRaiment => "NemesisRaiment",
            Self::BloodfangArmor => "BloodfangArmor",
            Self::StormrageRaiment => "StormrageRaiment",
            Self::DragonstalkerArmor => "DragonstalkerArmor",
            Self::TheTenStorms => "TheTenStorms",
            Self::JudgementArmor => "JudgementArmor",
            Self::BattlegearOfWrath => "BattlegearOfWrath",
            Self::GarbOfTheroShan => "Garb of Thero-shan",
            Self::ShardOfTheGods => "ShardOfTheGods",
            Self::SpiritOfEskhandar => "SpiritOfEskhandar",
            Self::ChampionsBattlegear => "Champion's Battlegear",
            Self::LieutenantCommandersBattlegear => "Lieutenant Commander's Battlegear",
            Self::ChampionsEarthshaker => "Champion's Earthshaker",
            Self::ImperialPlate => "ImperialPlate",
            Self::ChampionsRegalia => "Champion's Regalia",
            Self::ChampionsRaiment => "Champion's Raiment",
            Self::LieutenantCommandersRegalia => "Lieutenant Commander's Regalia",
            Self::LieutenantCommandersRaiment => "Lieutenant Commander's Raiment",
            Self::ChampionsThreads => "Champion's Threads",
            Self::LieutenantCommandersThreads => "Lieutenant Commander's Threads",
            Self::ChampionsVestments => "Champion's Vestments",
            Self::LieutenantCommandersVestments => "Lieutenant Commander's Vestments",
            Self::ChampionsPursuit => "Champion's Pursuit",
            Self::LieutenantCommandersPursuit => "Lieutenant Commander's Pursuit",
            Self::LieutenantCommandersSanctuary => "Lieutenant Commander's Sanctuary",
            Self::ChampionsSanctuary => "Champion's Sanctuary",
            Self::WarlordsBattlegear => "Warlord's Battlegear",
            Self::FieldMarshalsBattlegear => "Field Marshal's Battlegear",
            Self::WarlordsEarthshaker => "Warlord's Earthshaker",
            Self::WarlordsRegalia => "Warlord's Regalia",
            Self::FieldMarshalsRegalia => "Field Marshal's Regalia",
            Self::FieldMarshalsRaiment => "Field Marshal's Raiment",
            Self::WarlordsRaiment => "Warlord's Raiment",
            Self::WarlordsThreads => "Warlord's Threads",
            Self::FieldMarshalsThreads => "Field Marshal's Threads",
            Self::WarlordsVestments => "Warlord's Vestments",
            Self::FieldMarshalsVestments => "Field Marshal's Vestments",
            Self::FieldMarshalsPursuit => "Field Marshal's Pursuit",
            Self::WarlordsPursuit => "Warlord's Pursuit",
            Self::FieldMarshalsSanctuary => "Field Marshal's Sanctuary",
            Self::WarlordsSanctuary => "Warlord's Sanctuary",
            Self::LieutenantCommandersAegis => "Lieutenant Commander's Aegis",
            Self::FieldMarshalsAegis => "Field Marshal's Aegis",
            Self::BloodvineGarb => "BloodvineGarb",
            Self::PrimalBatskin => "PrimalBatskin",
            Self::BloodTigerHarness => "BloodTigerHarness",
            Self::BloodsoulEmbrace => "BloodsoulEmbrace",
            Self::TheDarksoul => "TheDarksoul",
            Self::TheTwinBladesOfHakkari => "TheTwinBladesOfHakkari",
            Self::ZanzilsConcentration => "Zanzil's Concentration",
            Self::PrimalBlessing => "PrimalBlessing",
            Self::OverlordsResolution => "Overlord's Resolution",
            Self::PrayerOfThePrimal => "PrayerOfThePrimal",
            Self::MajorMojoInfusion => "MajorMojoInfusion",
            Self::TheHighlandersResolution => "The Highlander's Resolution",
            Self::TheHighlandersResolve => "The Highlander's Resolve",
            Self::TheHighlandersDetermination => "The Highlander's Determination",
            Self::TheHighlandersFortitude => "The Highlander's Fortitude",
            Self::TheHighlandersPurpose => "The Highlander's Purpose",
            Self::TheHighlandersWill => "The Highlander's Will",
            Self::TheHighlandersIntent => "The Highlander's Intent",
            Self::VindicatorsBattlegear => "Vindicator's Battlegear",
            Self::FreethinkersArmor => "Freethinker's Armor",
            Self::AugursRegalia => "Augur's Regalia",
            Self::PredatorsArmor => "Predator's Armor",
            Self::MadcapsOutfit => "Madcap's Outfit",
            Self::HaruspexsGarb => "Haruspex's Garb",
            Self::ConfessorsRaiment => "Confessor's Raiment",
            Self::DemoniacsThreads => "Demoniac's Threads",
            Self::IllusionistsAttire => "Illusionist's Attire",
            Self::TheDefilersDetermination => "The Defiler's Determination",
            Self::TheDefilersFortitude => "The Defiler's Fortitude",
            Self::TheDefilersIntent => "The Defiler's Intent",
            Self::TheDefilersPurpose => "The Defiler's Purpose",
            Self::TheDefilersResolution => "The Defiler's Resolution",
            Self::TheDefilersWill => "The Defiler's Will",
            Self::BlackDragonMail => "BlackDragonMail",
            Self::GreenDragonMail => "GreenDragonMail",
            Self::BlueDragonMail => "BlueDragonMail",
            Self::TwilightTrappings => "TwilightTrappings",
            Self::GenesisRaiment => "GenesisRaiment",
            Self::SymbolsOfUnendingLife => "SymbolsOfUnendingLife",
            Self::BattlegearOfUnyieldingStrength => "BattlegearOfUnyieldingStrength",
            Self::ConquerorsBattlegear => "Conqueror's Battlegear",
            Self::DeathdealersEmbrace => "Deathdealer's Embrace",
            Self::EmblemsOfVeiledShadows => "EmblemsOfVeiledShadows",
            Self::DoomcallersAttire => "Doomcaller's Attire",
            Self::ImplementsOfUnspokenNames => "ImplementsOfUnspokenNames",
            Self::StormcallersGarb => "Stormcaller's Garb",
            Self::GiftOfTheGatheringStorm => "GiftOfTheGatheringStorm",
            Self::EnigmaVestments => "EnigmaVestments",
            Self::TrappingsOfVaultedSecrets => "TrappingsOfVaultedSecrets",
            Self::AvengersBattlegear => "Avenger's Battlegear",
            Self::BattlegearOfEternalJustice => "BattlegearOfEternalJustice",
            Self::GarmentsOfTheOracle => "GarmentsOfTheOracle",
            Self::FineryOfInfiniteWisdom => "FineryOfInfiniteWisdom",
            Self::StrikersGarb => "Striker's Garb",
            Self::TrappingsOfTheUnseenPath => "TrappingsOfTheUnseenPath",
            Self::BattlegearOfHeroism => "BattlegearOfHeroism",
            Self::DarkmantleArmor => "DarkmantleArmor",
            Self::FeralheartRaiment => "FeralheartRaiment",
            Self::VestmentsOfTheVirtuous => "VestmentsOfTheVirtuous",
            Self::BeastmasterArmor => "BeastmasterArmor",
            Self::SoulforgeArmor => "SoulforgeArmor",
            Self::SorcerersRegalia => "Sorcerer's Regalia",
            Self::DeathmistRaiment => "DeathmistRaiment",
            Self::TheFiveThunders => "TheFiveThunders",
            Self::IronweaveBattlesuit => "IronweaveBattlesuit",
            Self::DreamwalkerRaiment => "DreamwalkerRaiment",
            Self::ChampionsGuard => "Champion's Guard",
            Self::DreadnaughtsBattlegear => "Dreadnaught's Battlegear",
            Self::BonescytheArmor => "BonescytheArmor",
            Self::VestmentsOfFaith => "VestmentsOfFaith",
            Self::FrostfireRegalia => "FrostfireRegalia",
            Self::TheEarthshatterer => "TheEarthshatterer",
            Self::RedemptionArmor => "RedemptionArmor",
            Self::PlagueheartRaiment => "PlagueheartRaiment",
            Self::CryptstalkerArmor => "CryptstalkerArmor",
            Self::BattlegearOfUndeadSlaying => "BattlegearOfUndeadSlaying",
            Self::UndeadSlayersArmor => "Undead Slayer's Armor",
            Self::GarbOfTheUndeadSlayer => "GarbOfTheUndeadSlayer",
            Self::RegaliaOfUndeadCleansing => "RegaliaOfUndeadCleansing",
            Self::ChampionsBattlearmor => "Champion's Battlearmor",
            Self::ChampionsStormcaller => "Champion's Stormcaller",
            Self::ChampionsRefuge => "Champion's Refuge",
            Self::ChampionsInvestiture => "Champion's Investiture",
            Self::ChampionsDreadgear => "Champion's Dreadgear",
            Self::ChampionsArcanum => "Champion's Arcanum",
            Self::ChampionsPursuance => "Champion's Pursuance",
            Self::LieutenantCommandersRedoubt => "Lieutenant Commander's Redoubt",
            Self::LieutenantCommandersBattlearmor => "Lieutenant Commander's Battlearmor",
            Self::LieutenantCommandersArcanum => "Lieutenant Commander's Arcanum",
            Self::LieutenantCommandersDreadgear => "Lieutenant Commander's Dreadgear",
            Self::LieutenantCommandersGuard => "Lieutenant Commander's Guard",
            Self::LieutenantCommandersInvestiture => "Lieutenant Commander's Investiture",
            Self::LieutenantCommandersPursuance => "Lieutenant Commander's Pursuance",
            Self::LieutenantCommandersRefuge => "Lieutenant Commander's Refuge",
        })
    }
}
