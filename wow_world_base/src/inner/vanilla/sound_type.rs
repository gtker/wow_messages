...
impl std::fmt::Display for SoundType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::Ui => "Ui",
            Self::Footsteps => "Footsteps",
            Self::WeaponImpact => "WeaponImpact",
            Self::WeaponMiss => "WeaponMiss",
            Self::PickUpPutDown => "PickUpPutDown",
            Self::NpcCombat => "NpcCombat",
            Self::Errors => "Errors",
            Self::Objects => "Objects",
            Self::Death => "Death",
            Self::NpcGreetings => "NpcGreetings",
            Self::Test => "Test",
            Self::ArmourFoley => "ArmourFoley",
            Self::Footsteps2 => "Footsteps2",
            Self::WaterCharacter => "WaterCharacter",
            Self::WaterLiquid => "WaterLiquid",
            Self::Tradeskills => "Tradeskills",
            Self::Doodads => "Doodads",
            Self::SpellFizzle => "SpellFizzle",
            Self::NpcLoops => "NpcLoops",
            Self::ZoneMusic => "ZoneMusic",
            Self::Emotes => "Emotes",
            Self::NarrationMusic => "NarrationMusic",
            Self::Narration => "Narration",
            Self::ZoneAmbience => "ZoneAmbience",
        })
    }
}
