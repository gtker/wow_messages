...
///
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/external/external_spell_1_12.wowm:159`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/external/external_spell_1_12.wowm#L159):
/// ```text
...
impl From<u32> for AttributesEx4 {
    fn from(value: u32) -> Self {
        Self::new(value)
    }
}

impl From<u8> for AttributesEx4 {
    fn from(value: u8) -> Self {
        Self::new(value.into())
    }
}

impl From<u16> for AttributesEx4 {
    fn from(value: u16) -> Self {
        Self::new(value.into())
    }
}

impl TryFrom<u64> for AttributesEx4 {
    type Error = u64;
...
impl TryFrom<i8> for AttributesEx4 {
    type Error = i8;
...
impl TryFrom<i16> for AttributesEx4 {
    type Error = i16;
...
impl From<i32> for AttributesEx4 {
    fn from(value: i32) -> Self {
        Self::new(u32::from_le_bytes(value.to_le_bytes()))
    }
}

impl TryFrom<i64> for AttributesEx4 {
    type Error = i64;
...
impl TryFrom<usize> for AttributesEx4 {
    type Error = usize;
