...
impl AttributesEx1 {
    ...
    pub(crate) const DISMISS_PET_FIRST: u32 = 0x01;
    pub(crate) const USE_ALL_MANA: u32 = 0x02;
    pub(crate) const IS_CHANNELED: u32 = 0x04;
    pub(crate) const NO_REDIRECTION: u32 = 0x08;
    pub(crate) const NO_SKILL_INCREASE: u32 = 0x10;
    pub(crate) const ALLOW_WHILE_STEALTHED: u32 = 0x20;
    pub(crate) const IS_SELF_CHANNELED: u32 = 0x40;
    pub(crate) const NO_REFLECTION: u32 = 0x80;
    pub(crate) const ONLY_PEACEFUL_TARGETS: u32 = 0x100;
    pub(crate) const INITIATES_COMBAT_ENABLES_AUTO_ATTACK: u32 = 0x200;
    pub(crate) const NO_THREAT: u32 = 0x400;
    pub(crate) const AURA_UNIQUE: u32 = 0x800;
    pub(crate) const FAILURE_BREAKS_STEALTH: u32 = 0x1000;
    pub(crate) const TOGGLE_FARSIGHT: u32 = 0x2000;
    pub(crate) const TRACK_TARGET_IN_CHANNEL: u32 = 0x4000;
    pub(crate) const IMMUNITY_PURGES_EFFECT: u32 = 0x8000;
    pub(crate) const IMMUNITY_TO_HOSTILE_AND_FRIENDLY_EFFECTS: u32 = 0x10000;
    pub(crate) const NO_AUTOCAST_AI: u32 = 0x20000;
    pub(crate) const PREVENTS_ANIM: u32 = 0x40000;
    pub(crate) const EXCLUDE_CASTER: u32 = 0x80000;
    pub(crate) const FINISHING_MOVE_DAMAGE: u32 = 0x100000;
    pub(crate) const THREAT_ONLY_ON_MISS: u32 = 0x200000;
    pub(crate) const FINISHING_MOVE_DURATION: u32 = 0x400000;
    pub(crate) const UNK23: u32 = 0x800000;
    pub(crate) const SPECIAL_SKILLUP: u32 = 0x1000000;
    pub(crate) const AURA_STAYS_AFTER_COMBAT: u32 = 0x2000000;
    pub(crate) const REQUIRE_ALL_TARGETS: u32 = 0x4000000;
    pub(crate) const DISCOUNT_POWER_ON_MISS: u32 = 0x8000000;
    pub(crate) const NO_AURA_ICON: u32 = 0x10000000;
    pub(crate) const NAME_IN_CHANNEL_BAR: u32 = 0x20000000;
    pub(crate) const COMBO_ON_BLOCK: u32 = 0x40000000;
    pub(crate) const CAST_WHEN_LEARNED: u32 = 0x80000000;
