...
impl std::fmt::Display for SpellEffect {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::SummonWild => "SummonWild",
            Self::SummonGuardian => "SummonGuardian",
            ...
            Self::SummonPossessed => "SummonPossessed",
            Self::SummonTotem => "SummonTotem",
            ...
            Self::SummonTotemSlot1 => "SummonTotemSlot1",
            Self::SummonTotemSlot2 => "SummonTotemSlot2",
            Self::SummonTotemSlot3 => "SummonTotemSlot3",
            Self::SummonTotemSlot4 => "SummonTotemSlot4",
            Self::ThreatAll => "ThreatAll",
            Self::EnchantHeldItem => "EnchantHeldItem",
            Self::SummonPhantasm => "SummonPhantasm",
            Self::SelfResurrect => "SelfResurrect",
            Self::Skinning => "Skinning",
            Self::Charge => "Charge",
            Self::SummonCritter => "SummonCritter",
