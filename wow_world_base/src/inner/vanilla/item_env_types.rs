...
///
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/external/item_env_types.wowm:1`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/external/item_env_types.wowm#L1):
/// ```text
