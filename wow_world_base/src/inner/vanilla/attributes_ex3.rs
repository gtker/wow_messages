...
impl AttributesEx3 {
    ...
    pub(crate) const PVP_ENABLING: u32 = 0x01;
    pub(crate) const NO_PROC_EQUIP_REQUIREMENT: u32 = 0x02;
    pub(crate) const NO_CASTING_BAR_TEXT: u32 = 0x04;
    pub(crate) const COMPLETELY_BLOCKED: u32 = 0x08;
    pub(crate) const NO_RES_TIMER: u32 = 0x10;
    pub(crate) const NO_DURABILITY_LOSS: u32 = 0x20;
    pub(crate) const NO_AVOIDANCE: u32 = 0x40;
    pub(crate) const DOT_STACKING_RULE: u32 = 0x80;
    pub(crate) const ONLY_ON_PLAYER: u32 = 0x100;
    pub(crate) const NOT_A_PROC: u32 = 0x200;
    pub(crate) const REQUIRES_MAIN_HAND_WEAPON: u32 = 0x400;
    pub(crate) const ONLY_BATTLEGROUNDS: u32 = 0x800;
    pub(crate) const ONLY_ON_GHOSTS: u32 = 0x1000;
    pub(crate) const HIDE_CHANNEL_BAR: u32 = 0x2000;
    pub(crate) const HIDE_IN_RAID_FILTER: u32 = 0x4000;
    pub(crate) const NORMAL_RANGED_ATTACK: u32 = 0x8000;
    pub(crate) const SUPPRESS_CASTER_PROCS: u32 = 0x10000;
    pub(crate) const SUPPRESS_TARGET_PROCS: u32 = 0x20000;
    pub(crate) const ALWAYS_HIT: u32 = 0x40000;
    pub(crate) const INSTANT_TARGET_PROCS: u32 = 0x80000;
    pub(crate) const ALLOW_AURA_WHILE_DEAD: u32 = 0x100000;
    pub(crate) const ONLY_PROC_OUTDOORS: u32 = 0x200000;
    pub(crate) const CASTING_CANCELS_AUTOREPEAT: u32 = 0x400000;
    pub(crate) const NO_DAMAGE_HISTORY: u32 = 0x800000;
    pub(crate) const REQUIRES_OFFHAND_WEAPON: u32 = 0x1000000;
    pub(crate) const TREAT_AS_PERIODIC: u32 = 0x2000000;
    pub(crate) const CAN_PROC_FROM_PROCS: u32 = 0x4000000;
    pub(crate) const ONLY_PROC_ON_CASTER: u32 = 0x8000000;
    pub(crate) const IGNORE_CASTER_AND_TARGET_RESTRICTIONS: u32 = 0x10000000;
    pub(crate) const IGNORE_CASTER_MODIFIERS: u32 = 0x20000000;
    pub(crate) const DO_NOT_DISPLAY_RANGE: u32 = 0x40000000;
    pub(crate) const NOT_ON_AOE_IMMUNE: u32 = 0x80000000;
