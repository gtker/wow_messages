...
///
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/external/external_spell_1_12.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/external/external_spell_1_12.wowm#L3):
/// ```text
/// flag Attributes : u32 {
///     NONE = 0x00;
...
impl TryFrom<i8> for Attributes {
    type Error = i8;
...
impl TryFrom<i16> for Attributes {
    type Error = i16;
...
impl From<i32> for Attributes {
    fn from(value: i32) -> Self {
        Self::new(u32::from_le_bytes(value.to_le_bytes()))
    }
}

impl TryFrom<i64> for Attributes {
    type Error = i64;
...
impl TryFrom<usize> for Attributes {
    type Error = usize;
