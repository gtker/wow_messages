...
///
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/external/instance_type.wowm:2`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/external/instance_type.wowm#L2):
/// ```text
...
impl std::fmt::Display for InstanceType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::RaidInstance => "RaidInstance",
            Self::Battleground => "Battleground",
            Self::WorldZone => "WorldZone",
            Self::Battleground2 => "Battleground2",
        })
    }
}
