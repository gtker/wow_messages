...
impl std::fmt::Display for FriendResult {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::IgnoreAmbiguous => "IgnoreAmbiguous",
            Self::MuteFull => "MuteFull",
            Self::MuteSelf => "MuteSelf",
            Self::MuteNotFound => "MuteNotFound",
            Self::MuteAlready => "MuteAlready",
            Self::MuteAdded => "MuteAdded",
            Self::MuteRemoved => "MuteRemoved",
            Self::MuteAmbiguous => "MuteAmbiguous",
            Self::Unknown19 => "Unknown19",
            Self::Unknown20 => "Unknown20",
        })
    }
