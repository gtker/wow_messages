...
impl From<u8> for ChannelMemberFlags {
    fn from(value: u8) -> Self {
        Self::new(value)
    }
}

impl TryFrom<u16> for ChannelMemberFlags {
    type Error = u16;
...
impl TryFrom<u32> for ChannelMemberFlags {
    type Error = u32;
...
impl TryFrom<u64> for ChannelMemberFlags {
    type Error = u64;
...
impl From<i8> for ChannelMemberFlags {
    fn from(value: i8) -> Self {
        Self::new(u8::from_le_bytes(value.to_le_bytes()))
    }
}

impl TryFrom<i16> for ChannelMemberFlags {
    type Error = i16;
...
impl TryFrom<i32> for ChannelMemberFlags {
    type Error = i32;
...
impl TryFrom<i64> for ChannelMemberFlags {
    type Error = i64;
...
impl TryFrom<usize> for ChannelMemberFlags {
    type Error = usize;
