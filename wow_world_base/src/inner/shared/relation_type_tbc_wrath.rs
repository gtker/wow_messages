...
impl TryFrom<u64> for RelationType {
    type Error = u64;
...
impl TryFrom<i8> for RelationType {
    type Error = i8;
...
impl TryFrom<i16> for RelationType {
    type Error = i16;
...
impl TryFrom<i64> for RelationType {
    type Error = i64;
