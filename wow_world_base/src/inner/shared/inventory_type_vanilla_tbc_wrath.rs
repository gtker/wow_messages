...
impl std::fmt::Display for InventoryType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::Ranged => "Ranged",
            Self::Cloak => "Cloak",
            Self::TwoHandedWeapon => "TwoHandedWeapon",
            Self::Bag => "Bag",
            Self::Tabard => "Tabard",
            Self::Robe => "Robe",
            Self::WeaponMainHand => "WeaponMainHand",
            Self::WeaponOffHand => "WeaponOffHand",
            Self::Holdable => "Holdable",
            Self::Ammo => "Ammo",
            Self::Thrown => "Thrown",
            Self::RangedRight => "RangedRight",
            Self::Quiver => "Quiver",
            Self::Relic => "Relic",
        })
    }
