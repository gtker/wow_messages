/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/chat/smsg_channel_notify.wowm:76`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/chat/smsg_channel_notify.wowm#L76):
/// ```text
/// enum ChatNotify : u8 {
///     JOINED_NOTICE = 0x00;
///     LEFT_NOTICE = 0x01;
...
impl std::fmt::Display for ChatNotify {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            Self::JoinedNotice => "JoinedNotice",
            Self::LeftNotice => "LeftNotice",
            Self::YouJoinedNotice => "YouJoinedNotice",
            Self::YouLeftNotice => "YouLeftNotice",
            Self::WrongPasswordNotice => "WrongPasswordNotice",
            Self::NotMemberNotice => "NotMemberNotice",
            Self::NotModeratorNotice => "NotModeratorNotice",
            Self::PasswordChangedNotice => "PasswordChangedNotice",
            Self::OwnerChangedNotice => "OwnerChangedNotice",
            Self::PlayerNotFoundNotice => "PlayerNotFoundNotice",
            Self::NotOwnerNotice => "NotOwnerNotice",
            Self::ChannelOwnerNotice => "ChannelOwnerNotice",
            Self::ModeChangeNotice => "ModeChangeNotice",
            Self::AnnouncementsOnNotice => "AnnouncementsOnNotice",
            Self::AnnouncementsOffNotice => "AnnouncementsOffNotice",
            Self::ModerationOnNotice => "ModerationOnNotice",
            Self::ModerationOffNotice => "ModerationOffNotice",
            Self::MutedNotice => "MutedNotice",
            Self::PlayerKickedNotice => "PlayerKickedNotice",
            Self::BannedNotice => "BannedNotice",
            Self::PlayerBannedNotice => "PlayerBannedNotice",
            Self::PlayerUnbannedNotice => "PlayerUnbannedNotice",
            Self::PlayerNotBannedNotice => "PlayerNotBannedNotice",
            Self::PlayerAlreadyMemberNotice => "PlayerAlreadyMemberNotice",
            Self::InviteNotice => "InviteNotice",
            Self::InviteWrongFactionNotice => "InviteWrongFactionNotice",
            Self::WrongFactionNotice => "WrongFactionNotice",
            Self::InvalidNameNotice => "InvalidNameNotice",
            Self::NotModeratedNotice => "NotModeratedNotice",
            Self::PlayerInvitedNotice => "PlayerInvitedNotice",
            Self::PlayerInviteBannedNotice => "PlayerInviteBannedNotice",
            Self::ThrottledNotice => "ThrottledNotice",
            Self::NotInAreaNotice => "NotInAreaNotice",
            Self::NotInLfgNotice => "NotInLfgNotice",
            Self::VoiceOnNotice => "VoiceOnNotice",
            Self::VoiceOffNotice => "VoiceOffNotice",
        })
    }
}
