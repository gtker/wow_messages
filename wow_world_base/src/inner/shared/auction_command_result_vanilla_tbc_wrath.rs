/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/auction/smsg/smsg_auction_command_result.wowm:12`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/auction/smsg/smsg_auction_command_result.wowm#L12):
/// ```text
...
impl std::fmt::Display for AuctionCommandResult {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            Self::Ok => "Ok",
            Self::ErrInventory => "ErrInventory",
            Self::ErrDatabase => "ErrDatabase",
            Self::ErrNotEnoughMoney => "ErrNotEnoughMoney",
            Self::ErrItemNotFound => "ErrItemNotFound",
            Self::ErrHigherBid => "ErrHigherBid",
            Self::ErrBidIncrement => "ErrBidIncrement",
            Self::ErrBidOwn => "ErrBidOwn",
            Self::ErrRestrictedAccount => "ErrRestrictedAccount",
        })
    }
}
...
impl TryFrom<u8> for AuctionCommandResult {
    type Error = crate::errors::EnumError;
...
impl TryFrom<u16> for AuctionCommandResult {
    type Error = crate::errors::EnumError;
...
impl TryFrom<u64> for AuctionCommandResult {
    type Error = crate::errors::EnumError;
...
impl TryFrom<i8> for AuctionCommandResult {
    type Error = crate::errors::EnumError;
...
impl TryFrom<i16> for AuctionCommandResult {
    type Error = crate::errors::EnumError;
...
impl TryFrom<i32> for AuctionCommandResult {
    type Error = crate::errors::EnumError;
...
impl TryFrom<i64> for AuctionCommandResult {
    type Error = crate::errors::EnumError;
...
impl TryFrom<usize> for AuctionCommandResult {
    type Error = crate::errors::EnumError;
