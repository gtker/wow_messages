/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/faction/faction.wowm:358`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/faction/faction.wowm#L358):
/// ```text
/// enum Faction : u16 {
///     NONE = 0;
///     PLAYER_HUMAN = 1;
...
impl Faction {
    pub const fn as_int(&self) -> u16 {
        match self {
            ...
            Self::MonsterForceReaction => 0x438,
...
impl Faction {
    pub const fn as_test_case_value(&self) -> &'static str {
        match self {
            ...
            Self::MonsterForceReaction => "MONSTER_FORCE_REACTION",
...
impl std::fmt::Display for Faction {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Self::CtfFlags => f.write_str("CTF - Flags"),
            ...
            Self::MonsterForceReaction => f.write_str("Monster, Force Reaction"),
