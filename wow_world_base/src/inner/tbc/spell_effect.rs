/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/spell/smsg_spelllogexecute.wowm:215`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/spell/smsg_spelllogexecute.wowm#L215):
/// ```text
...
impl SpellEffect {
    ...
    pub const fn variants() -> [Self; 154] {
        [
            Self::None,
            Self::Instakill,
            Self::SchoolDamage,
...
impl std::fmt::Display for SpellEffect {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::HealthFunnel => "HealthFunnel",
            Self::PowerFunnel => "PowerFunnel",
