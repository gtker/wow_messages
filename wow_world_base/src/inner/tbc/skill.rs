/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/enums/skill.wowm:131`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/enums/skill.wowm#L131):
/// ```text
/// enum Skill : u16 {
///     NONE = 0;
///     FROST = 6;
...
impl std::fmt::Display for Skill {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::Fury => "Fury",
            Self::Protection => "Protection",
            Self::BeastTraining => "BeastTraining",
            Self::Protection2 => "Protection2",
