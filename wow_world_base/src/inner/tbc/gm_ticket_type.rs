...
impl std::fmt::Display for GmTicketType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::Character => "Character",
            Self::ArenaHonorItemIssues => "ArenaHonorItemIssues",
            Self::ArenaHonorPointsIssues => "ArenaHonorPointsIssues",
            Self::BottingCheatingHacking => "BottingCheatingHacking",
            Self::BugReport => "BugReport",
            Self::CompromisedAccountIssue => "CompromisedAccountIssue",
            Self::GameSuggestions => "GameSuggestions",
            Self::GameplayQuestion => "GameplayQuestion",
            Self::GuildBankIssue => "GuildBankIssue",
            Self::GuildMasterIssue => "GuildMasterIssue",
            Self::HarassmentScamReport => "HarassmentScamReport",
            Self::InappropriateNameGuildArenaCharacterPet => "InappropriateNameGuildArenaCharacterPet",
            Self::KnownIssueFix => "KnownIssueFix",
            Self::LatencyLagReport => "LatencyLagReport",
            Self::LootingIssueMistake => "LootingIssueMistake",
            Self::MailIssue => "MailIssue",
            Self::NonInGameRelatedInquiry => "NonInGameRelatedInquiry",
            Self::ParentalControlsCais => "ParentalControlsCais",
            Self::Pcnc => "Pcnc",
            Self::Pct => "Pct",
            Self::RestorationStatusFollowUp => "RestorationStatusFollowUp",
            Self::ServerInstanceIssues => "ServerInstanceIssues",
            Self::Spam => "Spam",
            Self::SuicideCase => "SuicideCase",
            Self::SuspensionQuestions => "SuspensionQuestions",
            Self::TechnicalSoundGraphicsIssue => "TechnicalSoundGraphicsIssue",
            Self::UiIssue => "UiIssue",
        })
    }
}
