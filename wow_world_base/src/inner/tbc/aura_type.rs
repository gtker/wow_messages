...
impl std::fmt::Display for AuraType {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::HasteAll => "HasteAll",
            Self::ModDepricated1 => "ModDepricated1",
            Self::ModDepricated2 => "ModDepricated2",
            Self::ModCooldown => "ModCooldown",
            Self::ModAttackerSpellAndWeaponCritChance => "ModAttackerSpellAndWeaponCritChance",
            Self::ModAllWeaponSkills => "ModAllWeaponSkills",
            ...
            Self::ModAttackerSpellCritDamage => "ModAttackerSpellCritDamage",
            Self::ModFlightSpeed => "ModFlightSpeed",
            Self::ModFlightSpeedMounted => "ModFlightSpeedMounted",
            Self::ModFlightSpeedStacking => "ModFlightSpeedStacking",
            Self::ModFlightSpeedMountedStacking => "ModFlightSpeedMountedStacking",
            Self::ModFlightSpeedNotStacking => "ModFlightSpeedNotStacking",
            Self::ModFlightSpeedMountedNotStacking => "ModFlightSpeedMountedNotStacking",
            ...
            Self::Unknown223 => "Unknown223",
            Self::Unknown224 => "Unknown224",
            Self::PrayerOfMending => "PrayerOfMending",
