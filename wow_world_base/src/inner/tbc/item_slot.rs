/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/item/cmsg_swap_inv_item.wowm:140`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/item/cmsg_swap_inv_item.wowm#L140):
/// ```text
/// enum ItemSlot : u8 {
///     HEAD = 0;
///     NECK = 1;
...
impl std::fmt::Display for ItemSlot {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        f.write_str(match self {
            ...
            Self::VanityPet1 => "VanityPet1",
            Self::VanityPet2 => "VanityPet2",
            Self::VanityPet3 => "VanityPet3",
            Self::VanityPet4 => "VanityPet4",
            Self::VanityPet5 => "VanityPet5",
            Self::VanityPet6 => "VanityPet6",
            Self::VanityPet7 => "VanityPet7",
            Self::VanityPet8 => "VanityPet8",
            Self::VanityPet9 => "VanityPet9",
            Self::VanityPet10 => "VanityPet10",
            Self::VanityPet11 => "VanityPet11",
            Self::VanityPet12 => "VanityPet12",
            Self::VanityPet13 => "VanityPet13",
            Self::VanityPet14 => "VanityPet14",
            Self::VanityPet15 => "VanityPet15",
            Self::VanityPet16 => "VanityPet16",
            Self::VanityPet17 => "VanityPet17",
            Self::VanityPet18 => "VanityPet18",
        })
    }
}
