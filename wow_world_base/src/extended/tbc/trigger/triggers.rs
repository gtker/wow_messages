...
(107, (
    ...
    &[
        Trigger::Teleport { location: Position::new(Map::Unusedstormwindprison, -0.9, 40.6, -24.2, 0.0),required_level: 0,required_item: 0,required_quest: 0,failed_text: None,
heroic_keys: None,heroic_required_quest: 0 },
    ]
)),
(109, (
    AreaTrigger::Circle { position: Position::new(Map::Unusedstormwindprison, -0.9, 16.4, -14.2, 0.0), radius: 7.0 }, 
    &[
