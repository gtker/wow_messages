...
impl CMD_AUTH_LOGON_PROOF_Client {
    pub fn to_test_case_string(&self) -> Option<String> {
        ...
        writeln!(s, "];").unwrap();
        writeln!(s, "    security_flag = {};", crate::logon::version_3::SecurityFlag::try_from(self.security_flag.as_int()).unwrap().as_test_case_value()).unwrap();
        match &self.security_flag {
            crate::logon::version_3::CMD_AUTH_LOGON_PROOF_Client_SecurityFlag::Pin {
                pin_hash,
                pin_salt,
            } => {
        ...
        match &self.security_flag {
            crate::logon::version_3::CMD_AUTH_LOGON_PROOF_Client_SecurityFlag::Pin {
                ...
                crate::util::write_bytes(&mut s, &mut bytes, pin_hash.len(), "pin_hash", "    ");
            }
            _ => {}
        }
