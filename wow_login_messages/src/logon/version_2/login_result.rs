...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/login/common.wowm:17`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/login/common.wowm):
/// ```text
/// enum LoginResult : u8 {
///     SUCCESS = 0x00;
///     FAIL_UNKNOWN0 = 0x01;
