...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/login/cmd_realm/server.wowm:57`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/login/cmd_realm/server.wowm#L57):
/// ```text
...
mod test_version_2 {
    ...
    // Generated from `wow_message_parser/wowm/login/cmd_realm/server.wowm` line 221.
    #[cfg(feature = "sync")]
    ...
    // Generated from `wow_message_parser/wowm/login/cmd_realm/server.wowm` line 252.
    #[cfg(feature = "sync")]
    #[cfg_attr(feature = "sync", test)]
