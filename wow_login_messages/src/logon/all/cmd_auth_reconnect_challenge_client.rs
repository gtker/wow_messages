...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/login/cmd_auth_reconnect/challenge_client.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/login/cmd_auth_reconnect/challenge_client.wowm):
/// ```text
/// clogin CMD_AUTH_RECONNECT_CHALLENGE_Client = 0x2 {
///     u8 protocol_version;
///     u16 size = self.size;
///     u32 game_name = "\0WoW";
///     Version version;
