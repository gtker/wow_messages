...
impl crate::private::Sealed for CMD_AUTH_LOGON_CHALLENGE_Client {}
...
impl Message for CMD_AUTH_LOGON_CHALLENGE_Client {
    const OPCODE: u8 = 0x00;

    #[cfg(feature = "sync")]
    fn read<R: std::io::Read, I: crate::private::Sealed>(r: R) -> Result<Self, crate::errors::ParseError> {
        Self::read_inner(r).map_err(|kind| crate::errors::ParseError::new(0, "CMD_AUTH_LOGON_CHALLENGE_Client", kind))
    }
    ...
    >> where
        ...
        Self: 'async_trait,
     {
        Box::pin(async move {Self::tokio_read_inner(r).await.map_err(|kind| crate::errors::ParseError::new(0, "CMD_AUTH_LOGON_CHALLENGE_Client", kind))})
    }
    ...
    >> where
        ...
        Self: 'async_trait,
     {
        Box::pin(async move {Self::astd_read_inner(r).await.map_err(|kind| crate::errors::ParseError::new(0, "CMD_AUTH_LOGON_CHALLENGE_Client", kind))})
    }
...
mod test {
    ...
    fn assert(t: &CMD_AUTH_LOGON_CHALLENGE_Client, expected: &CMD_AUTH_LOGON_CHALLENGE_Client) {
