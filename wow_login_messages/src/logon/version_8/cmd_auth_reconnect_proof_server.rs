...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/login/cmd_auth_reconnect/proof_server.wowm` line 52.
    #[cfg(feature = "sync")]
    ...
    // Generated from `wow_message_parser/wowm/login/cmd_auth_reconnect/proof_server.wowm` line 71.
    #[cfg(feature = "sync")]
    #[cfg_attr(feature = "sync", test)]
