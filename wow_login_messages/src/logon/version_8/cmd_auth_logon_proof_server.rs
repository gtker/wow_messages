...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/login/cmd_auth_logon/proof_server.wowm:46`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/login/cmd_auth_logon/proof_server.wowm#L46):
/// ```text
...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/login/cmd_auth_logon/proof_server.wowm` line 61.
    #[cfg(feature = "sync")]
    ...
    // Generated from `wow_message_parser/wowm/login/cmd_auth_logon/proof_server.wowm` line 70.
    #[cfg(feature = "sync")]
    #[cfg_attr(feature = "sync", test)]
