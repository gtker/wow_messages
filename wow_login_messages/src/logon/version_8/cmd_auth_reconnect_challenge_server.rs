...
impl CMD_AUTH_RECONNECT_CHALLENGE_Server {
    pub(crate) fn write_into_vec(&self, w: &mut Vec<u8>) -> Result<(), std::io::Error> {
        ...
        match &self.result {
            ...
            CMD_AUTH_RECONNECT_CHALLENGE_Server_LoginResult::FAIL_LOCKED_ENFORCED => {}
        }
...
impl ServerMessage for CMD_AUTH_RECONNECT_CHALLENGE_Server {
    ...
    fn read<R: std::io::Read>(r: &mut R) -> std::result::Result<Self, crate::errors::ParseError> {
        ...
        let result_if = match result {
            ...
            LoginResult::FAIL_LOCKED_ENFORCED => CMD_AUTH_RECONNECT_CHALLENGE_Server_LoginResult::FAIL_LOCKED_ENFORCED,
        };
