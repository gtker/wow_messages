/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/login/common.wowm:50`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/login/common.wowm#L50):
/// ```text
/// enum LoginResult : u8 {
///     SUCCESS = 0x00;
///     FAIL_UNKNOWN0 = 0x01;
...
impl LoginResult {
    pub const fn as_test_case_value(&self) -> &'static str {
        match self {
            ...
            Self::FailLockedEnforced => "FAIL_LOCKED_ENFORCED",
        }
    }
