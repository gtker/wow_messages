...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/common.wowm:56`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/common.wowm#L56).
