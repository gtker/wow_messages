...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/pet/smsg_pet_cast_failed.wowm:36`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/pet/smsg_pet_cast_failed.wowm#L36).
```rust,ignore
smsg SMSG_PET_CAST_FAILED = 0x0138 {
    u8 cast_count;
    u32 id;
