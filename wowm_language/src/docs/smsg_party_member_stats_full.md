...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/social/smsg_party_member_stats_full.wowm:72`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/social/smsg_party_member_stats_full.wowm#L72).
```rust,ignore
smsg SMSG_PARTY_MEMBER_STATS_FULL = 0x02F2 {
    PackedGuid guid;
    GroupUpdateFlags mask;
...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/social/smsg_party_member_stats_full.wowm:143`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/social/smsg_party_member_stats_full.wowm#L143).
```rust,ignore
smsg SMSG_PARTY_MEMBER_STATS_FULL = 0x02F2 {
    PackedGuid guid;
    GroupUpdateFlags mask;
