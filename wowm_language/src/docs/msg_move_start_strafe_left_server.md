...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/movement/msg/msg_move_start_strafe_left.wowm:88`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_start_strafe_left.wowm#L88).
```rust,ignore
smsg MSG_MOVE_START_STRAFE_LEFT_Server = 0x00B8 {
    PackedGuid guid;
    MovementInfo info;
