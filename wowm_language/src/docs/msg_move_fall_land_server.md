...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/movement/msg/msg_move_fall_land.wowm:88`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_fall_land.wowm#L88).
```rust,ignore
smsg MSG_MOVE_FALL_LAND_Server = 0x00C9 {
    PackedGuid guid;
    MovementInfo info;
