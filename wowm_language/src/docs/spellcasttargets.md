...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/common.wowm:79`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/common.wowm#L79).
```rust,ignore
