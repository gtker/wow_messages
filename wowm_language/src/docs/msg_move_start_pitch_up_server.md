...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/movement/msg/msg_move_start_pitch_up.wowm:34`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_start_pitch_up.wowm#L34).
```rust,ignore
smsg MSG_MOVE_START_PITCH_UP_Server = 0x00BF {
    PackedGuid guid;
    MovementInfo info;
