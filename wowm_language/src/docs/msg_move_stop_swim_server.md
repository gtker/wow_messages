...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/movement/msg/msg_move_stop_swim.wowm:34`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_stop_swim.wowm#L34).
```rust,ignore
smsg MSG_MOVE_STOP_SWIM_Server = 0x00CB {
    PackedGuid guid;
    MovementInfo info;
