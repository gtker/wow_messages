...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/unimplemented/vanilla/smsg_auction_command_result.wowm:47`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/unimplemented/vanilla/smsg_auction_command_result.wowm#L47).
```rust,ignore
...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/unimplemented/vanilla/smsg_auction_command_result.wowm:109`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/unimplemented/vanilla/smsg_auction_command_result.wowm#L109).
```rust,ignore
smsg SMSG_AUCTION_COMMAND_RESULT = 0x025B {
    u32 auction_id;
    AuctionCommandAction action;
