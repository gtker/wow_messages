...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/quest/smsg_questgiver_offer_reward.wowm:24`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/quest/smsg_questgiver_offer_reward.wowm#L24).
```rust,ignore
smsg SMSG_QUESTGIVER_OFFER_REWARD = 0x018D {
    Guid npc;
    u32 quest_id;
...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/quest/smsg_questgiver_offer_reward.wowm:54`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/quest/smsg_questgiver_offer_reward.wowm#L54).
```rust,ignore
smsg SMSG_QUESTGIVER_OFFER_REWARD = 0x018D {
    Guid npc;
    u32 quest_id;
