...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/movement/msg/msg_move_teleport_ack.wowm:12`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_teleport_ack.wowm#L12).
```rust,ignore
...
0, 0, 135, 69, // Vector4d.x: f32
0, 160, 37, 197, // Vector4d.y: f32
0, 0, 0, 0, // Vector4d.z: f32
