...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/movement/msg/msg_move_jump.wowm:104`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_jump.wowm#L104).
```rust,ignore
smsg MSG_MOVE_JUMP_Server = 0x00BB {
    PackedGuid guid;
    MovementInfo info;
