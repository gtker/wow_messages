...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/spell/smsg_spell_start.wowm:18`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/spell/smsg_spell_start.wowm#L18).
```rust,ignore
smsg SMSG_SPELL_START = 0x0131 {
    PackedGuid cast_item;
    PackedGuid caster;
...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/spell/smsg_spell_start.wowm:36`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/spell/smsg_spell_start.wowm#L36).
```rust,ignore
smsg SMSG_SPELL_START = 0x0131 {
    PackedGuid cast_item;
    PackedGuid caster;
