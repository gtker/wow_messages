...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/movement/msg/msg_move_set_walk_mode.wowm:60`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/msg/msg_move_set_walk_mode.wowm#L60).
```rust,ignore
smsg MSG_MOVE_SET_WALK_MODE_Server = 0x00C3 {
    PackedGuid guid;
    MovementInfo info;
