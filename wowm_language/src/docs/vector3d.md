...
Autogenerated from `wowm` file at [`wow_message_parser/wowm/world/vector.wowm:11`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/vector.wowm#L11).
```rust,ignore
struct Vector3d {
    f32 x;
    f32 y;
