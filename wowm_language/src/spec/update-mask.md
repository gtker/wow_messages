...
| Name | Offset | Size | Type |
|------|--------|------|------|
|`OBJECT_FIELD_GUID`| 0x0000 | 2 | GUID |
|`OBJECT_TYPE`| 0x0002 | 1 | INT |
|`OBJECT_FIELD_TYPE`| 0x0002 | 1 | INT |
|`OBJECT_FIELD_ENTRY`| 0x0003 | 1 | INT |
|`OBJECT_FIELD_SCALE_X`| 0x0004 | 1 | FLOAT |
|`OBJECT_FIELD_CREATED_BY`| 0x0006 | 2 | GUID |
...
| Name | Offset | Size | Type |
|------|--------|------|------|
|`ITEM_FIELD_OWNER`| 0x0006 | 2 | GUID |
|`ITEM_FIELD_CONTAINED`| 0x0008 | 2 | GUID |
|`ITEM_FIELD_CREATOR`| 0x000a | 2 | GUID |
|`ITEM_FIELD_GIFTCREATOR`| 0x000c | 2 | GUID |
|`ITEM_FIELD_STACK_COUNT`| 0x000e | 1 | INT |
|`ITEM_FIELD_DURATION`| 0x000f | 1 | INT |
|`ITEM_FIELD_SPELL_CHARGES`| 0x0010 | 5 | INT |
|`ITEM_FIELD_FLAGS`| 0x0015 | 1 | INT |
|`ITEM_FIELD_ENCHANTMENT_1_1`| 0x0016 | 33 | INT |
|`ITEM_FIELD_PROPERTY_SEED`| 0x0037 | 1 | INT |
|`ITEM_FIELD_RANDOM_PROPERTIES_ID`| 0x0038 | 1 | INT |
|`ITEM_FIELD_ITEM_TEXT_ID`| 0x0039 | 1 | INT |
|`ITEM_FIELD_DURABILITY`| 0x003a | 1 | INT |
|`ITEM_FIELD_MAXDURABILITY`| 0x003b | 1 | INT |
...
| Name | Offset | Size | Type |
|------|--------|------|------|
|`CONTAINER_FIELD_NUM_SLOTS`| 0x003c | 1 | INT |
|`CONTAINER_FIELD_SLOT_1`| 0x003e | 72 | GUID |
...
| Name | Offset | Size | Type |
|------|--------|------|------|
|`UNIT_FIELD_CHARM`| 0x0006 | 2 | GUID |
|`UNIT_FIELD_SUMMON`| 0x0008 | 2 | GUID |
|`UNIT_FIELD_CHARMEDBY`| 0x000a | 2 | GUID |
|`UNIT_FIELD_SUMMONEDBY`| 0x000c | 2 | GUID |
|`UNIT_FIELD_CREATEDBY`| 0x000e | 2 | GUID |
|`UNIT_FIELD_TARGET`| 0x0010 | 2 | GUID |
|`UNIT_FIELD_PERSUADED`| 0x0012 | 2 | GUID |
|`UNIT_FIELD_CHANNEL_OBJECT`| 0x0014 | 2 | GUID |
|`UNIT_FIELD_HEALTH`| 0x0016 | 1 | INT |
|`UNIT_FIELD_POWER1`| 0x0017 | 1 | INT |
|`UNIT_FIELD_POWER2`| 0x0018 | 1 | INT |
|`UNIT_FIELD_POWER3`| 0x0019 | 1 | INT |
|`UNIT_FIELD_POWER4`| 0x001a | 1 | INT |
|`UNIT_FIELD_POWER5`| 0x001b | 1 | INT |
|`UNIT_FIELD_MAXHEALTH`| 0x001c | 1 | INT |
|`UNIT_FIELD_MAXPOWER1`| 0x001d | 1 | INT |
|`UNIT_FIELD_MAXPOWER2`| 0x001e | 1 | INT |
|`UNIT_FIELD_MAXPOWER3`| 0x001f | 1 | INT |
|`UNIT_FIELD_MAXPOWER4`| 0x0020 | 1 | INT |
|`UNIT_FIELD_MAXPOWER5`| 0x0021 | 1 | INT |
|`UNIT_FIELD_LEVEL`| 0x0022 | 1 | INT |
|`UNIT_FIELD_FACTIONTEMPLATE`| 0x0023 | 1 | INT |
|`UNIT_FIELD_BYTES_0`| 0x0024 | 1 | BYTES |
|`UNIT_VIRTUAL_ITEM_SLOT_DISPLAY`| 0x0025 | 3 | INT |
|`UNIT_VIRTUAL_ITEM_INFO`| 0x0028 | 6 | BYTES |
|`UNIT_FIELD_FLAGS`| 0x002e | 1 | INT |
|`UNIT_FIELD_FLAGS_2`| 0x002f | 1 | INT |
|`UNIT_FIELD_AURA`| 0x0030 | 56 | INT |
|`UNIT_FIELD_AURAFLAGS`| 0x0068 | 14 | BYTES |
|`UNIT_FIELD_AURALEVELS`| 0x0076 | 14 | BYTES |
|`UNIT_FIELD_AURAAPPLICATIONS`| 0x0084 | 14 | BYTES |
|`UNIT_FIELD_AURASTATE`| 0x0092 | 1 | INT |
|`UNIT_FIELD_BASEATTACKTIME`| 0x0093 | 2 | INT |
|`UNIT_FIELD_RANGEDATTACKTIME`| 0x0095 | 1 | INT |
|`UNIT_FIELD_BOUNDINGRADIUS`| 0x0096 | 1 | FLOAT |
|`UNIT_FIELD_COMBATREACH`| 0x0097 | 1 | FLOAT |
|`UNIT_FIELD_DISPLAYID`| 0x0098 | 1 | INT |
|`UNIT_FIELD_NATIVEDISPLAYID`| 0x0099 | 1 | INT |
|`UNIT_FIELD_MOUNTDISPLAYID`| 0x009a | 1 | INT |
|`UNIT_FIELD_MINDAMAGE`| 0x009b | 1 | FLOAT |
|`UNIT_FIELD_MAXDAMAGE`| 0x009c | 1 | FLOAT |
|`UNIT_FIELD_MINOFFHANDDAMAGE`| 0x009d | 1 | FLOAT |
|`UNIT_FIELD_MAXOFFHANDDAMAGE`| 0x009e | 1 | FLOAT |
|`UNIT_FIELD_BYTES_1`| 0x009f | 1 | BYTES |
|`UNIT_FIELD_PETNUMBER`| 0x00a0 | 1 | INT |
|`UNIT_FIELD_PET_NAME_TIMESTAMP`| 0x00a1 | 1 | INT |
|`UNIT_FIELD_PETEXPERIENCE`| 0x00a2 | 1 | INT |
|`UNIT_FIELD_PETNEXTLEVELEXP`| 0x00a3 | 1 | INT |
...
|`UNIT_FIELD_STRENGTH`| 0x00ab | 1 | INT |
|`UNIT_FIELD_AGILITY`| 0x00ac | 1 | INT |
|`UNIT_FIELD_STAMINA`| 0x00ad | 1 | INT |
|`UNIT_FIELD_INTELLECT`| 0x00ae | 1 | INT |
|`UNIT_FIELD_SPIRIT`| 0x00af | 1 | INT |
|`UNIT_FIELD_POSSTAT1`| 0x00b1 | 1 | INT |
|`UNIT_FIELD_POSSTAT2`| 0x00b2 | 1 | INT |
|`UNIT_FIELD_POSSTAT3`| 0x00b3 | 1 | INT |
|`UNIT_FIELD_NEGSTAT1`| 0x00b6 | 1 | INT |
|`UNIT_FIELD_NEGSTAT2`| 0x00b7 | 1 | INT |
|`UNIT_FIELD_NEGSTAT3`| 0x00b8 | 1 | INT |
|`UNIT_FIELD_RESISTANCES`| 0x00ba | 7 | INT |
|`UNIT_FIELD_BASE_MANA`| 0x00cf | 1 | INT |
|`UNIT_FIELD_BASE_HEALTH`| 0x00d0 | 1 | INT |
|`UNIT_FIELD_BYTES_2`| 0x00d1 | 1 | BYTES |
|`UNIT_FIELD_ATTACK_POWER`| 0x00d2 | 1 | INT |
|`UNIT_FIELD_ATTACK_POWER_MODS`| 0x00d3 | 1 | TWO_SHORT |
|`UNIT_FIELD_ATTACK_POWER_MULTIPLIER`| 0x00d4 | 1 | FLOAT |
|`UNIT_FIELD_RANGED_ATTACK_POWER`| 0x00d5 | 1 | INT |
|`UNIT_FIELD_RANGED_ATTACK_POWER_MODS`| 0x00d6 | 1 | TWO_SHORT |
|`UNIT_FIELD_RANGED_ATTACK_POWER_MULTIPLIER`| 0x00d7 | 1 | FLOAT |
|`UNIT_FIELD_MINRANGEDDAMAGE`| 0x00d8 | 1 | FLOAT |
|`UNIT_FIELD_MAXRANGEDDAMAGE`| 0x00d9 | 1 | FLOAT |
|`UNIT_FIELD_POWER_COST_MODIFIER`| 0x00da | 7 | INT |
|`UNIT_FIELD_POWER_COST_MULTIPLIER`| 0x00e1 | 7 | FLOAT |
|`UNIT_FIELD_MAXHEALTHMODIFIER`| 0x00e8 | 1 | FLOAT |
...
| Name | Offset | Size | Type |
|------|--------|------|------|
|`PLAYER_FIELD_POSSTAT0`| 0x00b0 | 1 | INT |
|`PLAYER_FIELD_POSSTAT4`| 0x00b4 | 1 | INT |
|`PLAYER_FIELD_NEGSTAT0`| 0x00b5 | 1 | INT |
|`PLAYER_FIELD_NEGSTAT4`| 0x00b9 | 1 | INT |
|`PLAYER_FIELD_RESISTANCEBUFFMODSPOSITIVE`| 0x00c1 | 7 | INT |
|`PLAYER_FIELD_RESISTANCEBUFFMODSNEGATIVE`| 0x00c8 | 7 | INT |
|`PLAYER_DUEL_ARBITER`| 0x00ea | 2 | GUID |
|`PLAYER_FLAGS`| 0x00ec | 1 | INT |
|`PLAYER_GUILDID`| 0x00ed | 1 | INT |
|`PLAYER_GUILDRANK`| 0x00ee | 1 | INT |
|`PLAYER_BYTES`| 0x00ef | 1 | BYTES |
...
|`PLAYER_FIELD_INV_SLOT_HEAD`| 0x028a | 46 | GUID |
|`PLAYER_FIELD_PACK_SLOT_1`| 0x02b8 | 32 | GUID |
|`PLAYER_FIELD_BANK_SLOT_1`| 0x02d8 | 56 | GUID |
|`PLAYER_FIELD_BANKBAG_SLOT_1`| 0x0310 | 14 | GUID |
|`PLAYER_FIELD_VENDORBUYBACK_SLOT_1`| 0x031e | 24 | GUID |
|`PLAYER_FIELD_KEYRING_SLOT_1`| 0x0336 | 64 | GUID |
|`PLAYER_FIELD_VANITYPET_SLOT_1`| 0x0376 | 36 | GUID |
|`PLAYER_FARSIGHT`| 0x039a | 2 | GUID |
|`PLAYER__FIELD_KNOWN_TITLES`| 0x039c | 2 | GUID |
|`PLAYER_XP`| 0x039e | 1 | INT |
|`PLAYER_NEXT_LEVEL_XP`| 0x039f | 1 | INT |
|`PLAYER_SKILL_INFO_1_1`| 0x03a0 | 384 | TWO_SHORT |
...
|`PLAYER_FIELD_COINAGE`| 0x05b5 | 1 | INT |
|`PLAYER_FIELD_MOD_DAMAGE_DONE_POS`| 0x05b6 | 7 | INT |
|`PLAYER_FIELD_MOD_DAMAGE_DONE_NEG`| 0x05bd | 7 | INT |
|`PLAYER_FIELD_MOD_DAMAGE_DONE_PCT`| 0x05c4 | 7 | INT |
|`PLAYER_FIELD_MOD_HEALING_DONE_POS`| 0x05cb | 1 | INT |
|`PLAYER_FIELD_MOD_TARGET_RESISTANCE`| 0x05cc | 1 | INT |
|`PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE`| 0x05cd | 1 | INT |
|`PLAYER_FIELD_BYTES`| 0x05ce | 1 | BYTES |
|`PLAYER_AMMO_ID`| 0x05cf | 1 | INT |
|`PLAYER_SELF_RES_SPELL`| 0x05d0 | 1 | INT |
|`PLAYER_FIELD_PVP_MEDALS`| 0x05d1 | 1 | INT |
|`PLAYER_FIELD_BUYBACK_PRICE_1`| 0x05d2 | 12 | INT |
|`PLAYER_FIELD_BUYBACK_TIMESTAMP_1`| 0x05de | 12 | INT |
|`PLAYER_FIELD_KILLS`| 0x05ea | 1 | TWO_SHORT |
|`PLAYER_FIELD_TODAY_CONTRIBUTION`| 0x05eb | 1 | INT |
|`PLAYER_FIELD_YESTERDAY_CONTRIBUTION`| 0x05ec | 1 | INT |
|`PLAYER_FIELD_LIFETIME_HONORABLE_KILLS`| 0x05ed | 1 | INT |
|`PLAYER_FIELD_BYTES2`| 0x05ee | 1 | BYTES |
|`PLAYER_FIELD_WATCHED_FACTION_INDEX`| 0x05ef | 1 | INT |
|`PLAYER_FIELD_COMBAT_RATING_1`| 0x05f0 | 24 | INT |
|`PLAYER_FIELD_ARENA_TEAM_INFO_1_1`| 0x0608 | 18 | INT |
|`PLAYER_FIELD_HONOR_CURRENCY`| 0x061a | 1 | INT |
|`PLAYER_FIELD_ARENA_CURRENCY`| 0x061b | 1 | INT |
|`PLAYER_FIELD_MOD_MANA_REGEN`| 0x061c | 1 | FLOAT |
|`PLAYER_FIELD_MOD_MANA_REGEN_INTERRUPT`| 0x061d | 1 | FLOAT |
|`PLAYER_FIELD_MAX_LEVEL`| 0x061e | 1 | INT |
|`PLAYER_FIELD_DAILY_QUESTS_1`| 0x061f | 25 | INT |
...
| Name | Offset | Size | Type |
|------|--------|------|------|
|`CORPSE_FIELD_OWNER`| 0x0006 | 2 | GUID |
|`CORPSE_FIELD_PARTY`| 0x0008 | 2 | GUID |
|`CORPSE_FIELD_FACING`| 0x000a | 1 | FLOAT |
|`CORPSE_FIELD_POS_X`| 0x000b | 1 | FLOAT |
|`CORPSE_FIELD_POS_Y`| 0x000c | 1 | FLOAT |
|`CORPSE_FIELD_POS_Z`| 0x000d | 1 | FLOAT |
|`CORPSE_FIELD_DISPLAY_ID`| 0x000e | 1 | INT |
|`CORPSE_FIELD_ITEM`| 0x000f | 19 | INT |
|`CORPSE_FIELD_BYTES_1`| 0x0022 | 1 | BYTES |
|`CORPSE_FIELD_BYTES_2`| 0x0023 | 1 | BYTES |
|`CORPSE_FIELD_GUILD`| 0x0024 | 1 | INT |
|`CORPSE_FIELD_FLAGS`| 0x0025 | 1 | INT |
|`CORPSE_FIELD_DYNAMIC_FLAGS`| 0x0026 | 1 | INT |
...
|`PLAYER_SKILL_INFO_1_1`| 0x027c | 384 | TWO_SHORT |
