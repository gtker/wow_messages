...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/27needs_msg/needs_msg.wowm:106`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/27needs_msg/needs_msg.wowm#L106):
/// ```text
...
impl WorldMessageBody for MSG_MOVE_START_PITCH_DOWN {
...
impl VariableSized for MSG_MOVE_START_PITCH_DOWN {
    fn size(&self) -> usize {
        self.info.size() // info: MovementInfo
    }
}

impl MaximumPossibleSized for MSG_MOVE_START_PITCH_DOWN {
