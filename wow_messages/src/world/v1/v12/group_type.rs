...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/9needs_optional/needs_optional.wowm:213`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/9needs_optional/needs_optional.wowm):
/// ```text
/// enum GroupType : u8 {
///     NORMAL = 0;
///     RAID = 1;
