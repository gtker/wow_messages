...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/smsg_friend_list.wowm:13`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/smsg_friend_list.wowm):
/// ```text
