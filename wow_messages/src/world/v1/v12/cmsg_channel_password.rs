...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/cmsg_channel_password.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/cmsg_channel_password.wowm#L3):
/// ```text
...
impl WorldClientMessageWrite for CMSG_CHANNEL_PASSWORD {
...
impl WorldMessageBody for CMSG_CHANNEL_PASSWORD {
...
impl MaximumPossibleSized for CMSG_CHANNEL_PASSWORD {
