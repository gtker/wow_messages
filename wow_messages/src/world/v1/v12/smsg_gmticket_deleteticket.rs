...
#[derive(Copy)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/smsg_gmticket_deleteticket.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/smsg_gmticket_deleteticket.wowm#L3):
/// ```text
...
impl WorldServerMessageWrite for SMSG_GMTICKET_DELETETICKET {
...
impl WorldMessageBody for SMSG_GMTICKET_DELETETICKET {
