...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/movement.wowm:12`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/movement.wowm#L12):
/// ```text
...
impl WorldServerMessageWrite for SMSG_FORCE_RUN_BACK_SPEED_CHANGE {
    const OPCODE: u16 = 0xe4;
...
impl WorldMessageBody for SMSG_FORCE_RUN_BACK_SPEED_CHANGE {
