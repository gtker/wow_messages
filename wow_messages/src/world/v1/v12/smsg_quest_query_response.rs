...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/queries/smsg_quest_query_response.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/queries/smsg_quest_query_response.wowm#L3):
/// ```text
...
impl WorldServerMessageWrite for SMSG_QUEST_QUERY_RESPONSE {
...
impl WorldMessageBody for SMSG_QUEST_QUERY_RESPONSE {
