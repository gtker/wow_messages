...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/cmsg_guild_promote.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/cmsg_guild_promote.wowm#L3):
/// ```text
...
impl WorldClientMessageWrite for CMSG_GUILD_PROMOTE {
...
impl WorldMessageBody for CMSG_GUILD_PROMOTE {
