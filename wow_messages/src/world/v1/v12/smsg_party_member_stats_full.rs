...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/2needs_aura_mask/needs_aura_mask.wowm:223`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/2needs_aura_mask/needs_aura_mask.wowm#L223):
/// ```text
...
impl WorldServerMessageWrite for SMSG_PARTY_MEMBER_STATS_FULL {
    const OPCODE: u16 = 0x2f2;
...
impl WorldMessageBody for SMSG_PARTY_MEMBER_STATS_FULL {
