...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/cmsg_pet_rename.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/cmsg_pet_rename.wowm#L3):
/// ```text
...
impl WorldClientMessageWrite for CMSG_PET_RENAME {
    const OPCODE: u32 = 0x177;
...
impl WorldMessageBody for CMSG_PET_RENAME {
