...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/add_messages.wowm:194`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/add_messages.wowm#L194):
/// ```text
/// smsg SMSG_WHO = 0x63 {
///     u32 listed_players;
///     u32 online_players;
