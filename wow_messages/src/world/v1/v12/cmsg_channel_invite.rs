...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/cmsg_channel_invite.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/cmsg_channel_invite.wowm#L3):
/// ```text
...
impl WorldClientMessageWrite for CMSG_CHANNEL_INVITE {
...
impl WorldMessageBody for CMSG_CHANNEL_INVITE {
