...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/smsg_chat_player_not_found.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/smsg_chat_player_not_found.wowm#L3):
/// ```text
...
impl WorldServerMessageWrite for SMSG_CHAT_PLAYER_NOT_FOUND {
...
impl WorldMessageBody for SMSG_CHAT_PLAYER_NOT_FOUND {
