...
#[derive(Copy)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/character_screen/character_msgs.wowm:50`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/character_screen/character_msgs.wowm#L50):
/// ```text
...
impl WorldServerMessageWrite for SMSG_CHAR_DELETE {
    const OPCODE: u16 = 0x3c;
...
impl WorldMessageBody for SMSG_CHAR_DELETE {
