...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/new5.wowm:784`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/new5.wowm#L784):
/// ```text
...
impl WorldMessageBody for SMSG_PETITION_QUERY_RESPONSE {
