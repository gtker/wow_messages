...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/add_messages.wowm:261`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/add_messages.wowm#L261):
/// ```text
...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/world/add_messages.wowm` line 266.
    #[test]
    ...
    // Generated from `wow_message_parser/wowm/world/add_messages.wowm` line 276.
    #[test]
