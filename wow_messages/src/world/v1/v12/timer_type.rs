...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/remaining.wowm:376`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/remaining.wowm#L376):
/// ```text
/// enum TimerType : u32 {
///     FATIGUE = 0;
///     BREATH = 1;
