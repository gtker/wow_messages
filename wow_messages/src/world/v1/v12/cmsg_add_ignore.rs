...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/add_messages.wowm:210`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/add_messages.wowm#L210):
/// ```text
...
impl WorldClientMessageWrite for CMSG_ADD_IGNORE {
...
impl WorldMessageBody for CMSG_ADD_IGNORE {
