...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/cmsg_force_run_speed_change_ack.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/cmsg_force_run_speed_change_ack.wowm#L3):
/// ```text
...
impl WorldClientMessageWrite for CMSG_FORCE_RUN_SPEED_CHANGE_ACK {
    const OPCODE: u32 = 0xe3;
...
impl WorldMessageBody for CMSG_FORCE_RUN_SPEED_CHANGE_ACK {
