...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/add_messages.wowm:325`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/add_messages.wowm#L325):
/// ```text
...
impl WorldServerMessageWrite for SMSG_GROUP_SET_LEADER {
    const OPCODE: u16 = 0x79;
...
impl WorldMessageBody for SMSG_GROUP_SET_LEADER {
