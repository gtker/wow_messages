...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/new5.wowm:609`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/new5.wowm#L609):
/// ```text
/// cmsg CMSG_BUG = 0x1CA {
///     u32 suggestion;
///     u32 content_length;
