...
#[derive(Copy)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/new4.wowm:65`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/new4.wowm#L65):
/// ```text
...
impl WorldServerMessageWrite for SMSG_AUCTION_REMOVED_NOTIFICATION {
    const OPCODE: u16 = 0x28d;
...
impl WorldMessageBody for SMSG_AUCTION_REMOVED_NOTIFICATION {
