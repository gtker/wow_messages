...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/smsg_battlefield_status.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/smsg_battlefield_status.wowm#L3):
/// ```text
/// enum StatusId : u8 {
///     NONE = 0;
///     WAIT_QUEUE = 1;
