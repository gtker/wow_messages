...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/remaining.wowm:181`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/remaining.wowm#L181):
/// ```text
