...
#[derive(Copy)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/add_messages.wowm:58`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/add_messages.wowm#L58):
/// ```text
...
mod test {
    ...
    // Generated from `wow_message_parser/wowm/world/unsorted/add_messages.wowm` line 60.
    #[test]
