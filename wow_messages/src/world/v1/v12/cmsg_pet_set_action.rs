...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/9needs_optional/needs_optional.wowm:184`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/9needs_optional/needs_optional.wowm#L184):
/// ```text
