...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/movement.wowm:72`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/movement.wowm#L72):
/// ```text
...
impl WorldServerMessageWrite for SMSG_SPLINE_SET_WALK_SPEED {
...
impl WorldMessageBody for SMSG_SPLINE_SET_WALK_SPEED {
