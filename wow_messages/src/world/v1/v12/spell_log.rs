...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/needs_else_if_else.wowm:645`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/needs_else_if_else.wowm#L645):
/// ```text
/// struct SpellLog {
///     SpellEffect effect;
