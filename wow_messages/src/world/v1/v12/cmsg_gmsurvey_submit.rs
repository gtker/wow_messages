...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/cmsg_gmsurvey_submit.wowm:12`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/cmsg_gmsurvey_submit.wowm#L12):
/// ```text
...
impl WorldMessageBody for CMSG_GMSURVEY_SUBMIT {
