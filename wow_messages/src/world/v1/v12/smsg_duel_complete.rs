...
#[derive(Copy)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/smsg_duel_complete.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/smsg_duel_complete.wowm#L3):
/// ```text
...
impl WorldServerMessageWrite for SMSG_DUEL_COMPLETE {
...
impl WorldMessageBody for SMSG_DUEL_COMPLETE {
