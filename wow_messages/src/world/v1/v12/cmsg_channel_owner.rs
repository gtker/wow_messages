...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/cmsg_channel_owner.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/cmsg_channel_owner.wowm#L3):
/// ```text
...
impl WorldClientMessageWrite for CMSG_CHANNEL_OWNER {
    const OPCODE: u32 = 0x9e;
...
impl WorldMessageBody for CMSG_CHANNEL_OWNER {
