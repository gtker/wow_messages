...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/9needs_optional/needs_optional.wowm:147`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/9needs_optional/needs_optional.wowm#L147):
/// ```text
...
impl WorldMessageBody for SMSG_CREATURE_QUERY_RESPONSE {
