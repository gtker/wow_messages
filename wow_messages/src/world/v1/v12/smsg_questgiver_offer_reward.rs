...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/new5.wowm:634`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/new5.wowm#L634):
/// ```text
...
impl WorldServerMessageWrite for SMSG_QUESTGIVER_OFFER_REWARD {
    const OPCODE: u16 = 0x18d;
