...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/cmsg_guild_demote.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/cmsg_guild_demote.wowm#L3):
/// ```text
...
impl WorldClientMessageWrite for CMSG_GUILD_DEMOTE {
...
impl WorldMessageBody for CMSG_GUILD_DEMOTE {
...
impl VariableSized for CMSG_GUILD_DEMOTE {
    fn size(&self) -> usize {
        self.player_name.len() + 1 // player_name: CString and Null Terminator
    }
}

impl MaximumPossibleSized for CMSG_GUILD_DEMOTE {
