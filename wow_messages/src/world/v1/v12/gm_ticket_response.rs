...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/remaining.wowm:385`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/remaining.wowm#L385):
/// ```text
