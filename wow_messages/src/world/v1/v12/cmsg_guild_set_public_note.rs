...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/cmsg_guild_set_public_note.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/cmsg_guild_set_public_note.wowm#L3):
/// ```text
...
impl WorldClientMessageWrite for CMSG_GUILD_SET_PUBLIC_NOTE {
    const OPCODE: u32 = 0x234;
