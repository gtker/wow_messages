...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/5needs_endless_array/cmsg_auth_session.wowm:31`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/5needs_endless_array/cmsg_auth_session.wowm):
/// ```text
