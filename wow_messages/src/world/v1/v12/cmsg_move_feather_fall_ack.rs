...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/movement/movement.wowm:85`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/movement/movement.wowm):
/// ```text
...
impl WorldClientMessageWrite for CMSG_MOVE_FEATHER_FALL_ACK {
...
impl WorldMessageBody for CMSG_MOVE_FEATHER_FALL_ACK {
