...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/movement.wowm:82`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/movement.wowm#L82):
/// ```text
...
impl WorldServerMessageWrite for SMSG_SPLINE_SET_TURN_RATE {
...
impl WorldMessageBody for SMSG_SPLINE_SET_TURN_RATE {
