...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/new5.wowm:1034`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/new5.wowm#L1034):
/// ```text
...
impl WorldServerMessageWrite for SMSG_AUCTION_BIDDER_LIST_RESULT {
...
impl WorldMessageBody for SMSG_AUCTION_BIDDER_LIST_RESULT {
