...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/cmsg_channel_unmute.wowm:3`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/cmsg_channel_unmute.wowm#L3):
/// ```text
...
impl WorldClientMessageWrite for CMSG_CHANNEL_UNMUTE {
    const OPCODE: u32 = 0xa2;
...
impl WorldMessageBody for CMSG_CHANNEL_UNMUTE {
