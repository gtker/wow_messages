...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/add_messages.wowm:295`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/add_messages.wowm#L295):
/// ```text
...
impl WorldClientMessageWrite for CMSG_GROUP_INVITE {
    const OPCODE: u32 = 0x6e;
...
impl WorldMessageBody for CMSG_GROUP_INVITE {
