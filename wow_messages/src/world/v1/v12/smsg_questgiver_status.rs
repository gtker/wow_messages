...
#[derive(Copy)]
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/new2.wowm:103`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/new2.wowm#L103):
/// ```text
...
impl WorldServerMessageWrite for SMSG_QUESTGIVER_STATUS {
...
impl WorldMessageBody for SMSG_QUESTGIVER_STATUS {
