...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/27needs_msg/needs_msg.wowm:53`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/27needs_msg/needs_msg.wowm#L53):
/// ```text
