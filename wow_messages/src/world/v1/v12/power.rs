...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/remaining.wowm:18`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/remaining.wowm#L18):
/// ```text
/// enum Power : u8 {
///     MANA = 0;
///     RAGE = 1;
