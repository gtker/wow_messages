...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/needs_not_equals.wowm:450`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/needs_not_equals.wowm#L450):
/// ```text
...
impl WorldServerMessageWrite for SMSG_CAST_RESULT {
    const OPCODE: u16 = 0x130;
...
impl WorldMessageBody for SMSG_CAST_RESULT {
