...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/needs_packed_guid.wowm:133`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/needs_packed_guid.wowm):
/// ```text
