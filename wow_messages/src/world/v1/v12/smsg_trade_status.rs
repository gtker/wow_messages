...
/// Auto generated from the original `wowm` in file [`wow_message_parser/wowm/world/unsorted/smsg_trade_status.wowm:102`](https://github.com/gtker/wow_messages/tree/main/wow_message_parser/wowm/world/unsorted/smsg_trade_status.wowm#L102):
/// ```text
...
impl WorldServerMessageWrite for SMSG_TRADE_STATUS {
...
impl WorldMessageBody for SMSG_TRADE_STATUS {
